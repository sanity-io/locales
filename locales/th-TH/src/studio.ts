...
export default removeUndefinedLocaleResources({
  ...
  "asset-source.usage-list.documents-using-image_unnamed_zero":
    "ไม่มีเอกสารใดกำลังใช้รูปภาพนี้",
  ...
  "calendar.error.must-be-in-format":
    "ต้องอยู่ในรูปแบบ <Emphasis>{{exampleDate}}</Emphasis>",
  ...
  "changes.action.revert-changes-description":
    "คุณแน่ใจหรือไม่ว่าต้องการย้อนการเปลี่ยนแปลง?",
  ...
  "changes.error-boundary.developer-info":
    "ตรวจสอบคอนโซลนักพัฒนาเพื่อข้อมูลเพิ่มเติม",
  /** Text shown when a diff component crashes during rendering, triggering the error boundary */
  "changes.error-boundary.title":
    "การแสดงการเปลี่ยนแปลงในฟิลด์นี้ทำให้เกิดข้อผิดพลาด",
  ...
  "changes.portable-text.empty-inline-object":
    "วัตถุอินไลน์ว่างเปล่า {{inlineObjectType}}",
  /** Portable Text diff: An empty object is the result of adding/removing an annotation */
  "changes.portable-text.empty-object-annotation":
    "วัตถุว่างเปล่า {{annotationType}}",
  ...
  "changes.portable-text.inline-object_unchanged":
    "ออบเจ็กต์อินไลน์ที่ไม่มีการเปลี่ยนแปลง",
  ...
  "inputs.array.error.json-representation-description":
    "การแสดงข้อมูล JSON ของรายการนี้:",
  ...
  "inputs.file.upload-failed.description":
    "การอัปโหลดไม่สามารถเสร็จสิ้นได้ในขณะนี้",
  /** Upload failed */
  ...
  "inputs.invalid-value.convert-button.text":
    "แปลงเป็น <code>{{targetType}}</code>",
  /** The current value (<code>`{{actualType}}`</code>) */
  "inputs.invalid-value.current-type":
    "ค่าปัจจุบัน (<code>{{actualType}}</code>)",
  ...
  "inputs.invalid-value.details.multi-type-description":
    "เฉพาะประเภทต่อไปนี้ที่ถูกต้องตามสคีมา:",
  ...
  "inputs.portable-text.invalid-value.orphaned-marks.action":
    "ลบเครื่องหมายที่ไม่ได้รับอนุญาต",
  ...
  "inputs.reference.no-results-for-query":
    "ไม่มีผลลัพธ์สำหรับ <strong>“{{searchTerm}}”</strong>",
  ...
  "inputs.untyped-value.description":
    "พบค่าของวัตถุที่ไม่มีคุณสมบัติ <code>_type</code>",
  ...
  "inputs.untyped-value.details.json-dump-prefix":
    "ค่าปัจจุบัน (<code>object</code>):",
  /** The following types are valid here according to schema: */
  "inputs.untyped-value.details.multi-type-description":
    "ประเภทต่อไปนี้ถูกต้องที่นี่ตามสคีมา:",
  /** Developer info */
  ...
  "member-field-error.unexpected-error":
  ...
  "new-document.no-results":
    "ไม่พบผลลัพธ์สำหรับ <strong>{{searchQuery}}</strong>",
  ...
  "presence.no-one-else-description":
    "เชิญคนเข้าโปรเจ็กต์เพื่อดูสถานะออนไลน์ของพวกเขา",
  ...
  "search.error.unspecified-error-help-description":
    "โปรดลองอีกครั้งหรือตรวจสอบการเชื่อมต่อของคุณ",
  ...
  "search.no-results-help-description":
    "ลองใช้คำค้นหาอื่นหรือปรับตัวกรองของคุณ",
  ...
  "search.operator.defined.description":
    "<Field/> <Operator>คือ</Operator> <Value>ไม่ว่าง</Value>",
  ...
  "timeline.error.load-document-changes-title":
    "เกิดข้อผิดพลาดขณะเรียกดูการเปลี่ยนแปลงของเอกสาร",
  ...
  "timeline.operation.unpublished_timestamp":
    "ยกเลิกการเผยแพร่: {{timestamp, datetime}}",
  /**
