...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.reload-to-update': 'โหลด Studio ใหม่เพื่ออัปเดต',
  ...
  'about-dialog.version-info.tooltip.up-to-date': 'ปัจจุบัน',
  ...
  'release.dialog.edit-schedule.body': 'เลือกวันและเวลาใหม่สำหรับการเผยแพร่ตามตารางเวลา',
  ...
  'release.dialog.publish-scheduled-draft.body':
    'คุณแน่ใจหรือไม่ว่าต้องการเผยแพร่ร่างที่มีตารางเวลานี้ทันที?',
  /** Confirm button text for running a scheduled draft immediately */
  'release.dialog.publish-scheduled-draft.confirm': 'ใช่, ทำตอนนี้เลย',
  /** Header for the dialog confirming running a scheduled draft immediately */
  'release.dialog.publish-scheduled-draft.header': 'เผยแพร่ร่างเอกสารตอนนี้',
  ...
  'release.schedule-dialog.publish-date-in-past-warning':
    'กำหนดการเผยแพร่นี้ให้เป็นเวลาและวันในอนาคต.',
  ...
  'release.toast.delete-schedule-draft.error':
    'ไม่สามารถลบร่างเอกสารที่กำหนดการไว้ <strong>{{title}}</strong>: {{error}}',
  /** Success toast for deleting a scheduled draft */
  'release.toast.delete-schedule-draft.success':
    'ร่างเอกสารที่กำหนดการไว้ <strong>{{title}}</strong> ได้ถูกลบแล้ว.',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.not-found-release.title': "ไม่พบการปล่อย '{{title}}'",
  /** Error toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.error':
    'ไม่สามารถเผยแพร่ร่างเอกสารที่กำหนดการไว้ <strong>{{title}}</strong>: {{error}}',
  /** Success toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.success':
    'ร่างเอกสารที่กำหนดการไว้ <strong>{{title}}</strong> ได้ถูกเผยแพร่แล้ว.',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'ไม่สามารถกำหนดการใหม่สำหรับร่างเอกสารที่กำหนดการไว้ <strong>{{title}}</strong>: {{error}}',
  /** Success toast for rescheduling a draft */
  'release.toast.reschedule-scheduled-draft.success':
    'ร่างเอกสารที่กำหนดการไว้ <strong>{{title}}</strong> ได้ถูกกำหนดการใหม่แล้ว.',
  ...
  'schedule-publish-dialog.description': 'เลือกเวลาที่เอกสารนี้ควรจะถูกเผยแพร่.',
  /** Header for the schedule publish dialog */
  'schedule-publish-dialog.header': 'กำหนดการเผยแพร่ร่างเอกสาร',
