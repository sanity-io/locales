...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.configuration-issue.missing-appid':
    'การอัปเดตอัตโนมัติถูกเปิดใช้งาน แต่ไม่มี <code>deployment.appId</code> ที่กำหนดค่าใน <code>sanity.cli.ts</code> สตูดิโอนี้กำลังอัปเดตตามช่อง <strong>ล่าสุด</strong>',
  ...
  'about-dialog.version-info.tooltip.prerelease': 'เวอร์ชันก่อนการเปิดตัว',
  ...
  'release.dialog.delete-schedule-draft.body':
    'คุณแน่ใจหรือไม่ว่าต้องการลบร่างที่กำหนดเวลาไว้นี้? การกระทำนี้ไม่สามารถย้อนกลับได้',
  /** Confirm button text for deleting a scheduled draft */
  'release.dialog.delete-schedule-draft.confirm': 'ใช่ ลบตารางเวลา',
  /** Header for the dialog confirming deletion of a scheduled draft */
  'release.dialog.delete-schedule-draft.header': 'ลบร่างที่กำหนดเวลาไว้',
  /** Body text for change schedule dialog */
  'release.dialog.edit-schedule.body': 'เลือกวันและเวลาใหม่สำหรับการเผยแพร่ที่กำหนดเวลาไว้',
  /** Confirm button text for change schedule dialog */
  'release.dialog.edit-schedule.confirm': 'อัปเดตตารางเวลา',
  /** Header for change schedule dialog */
  'release.dialog.edit-schedule.header': 'เปลี่ยนตารางเวลา',
  /** Body text for the dialog confirming running a scheduled draft immediately */
  'release.dialog.publish-scheduled-draft.body':
    'คุณแน่ใจหรือไม่ว่าต้องการเผยแพร่ร่างที่กำหนดเวลาไว้ทันที?',
  ...
  'release.schedule-dialog.publish-date-in-past-warning':
    'กำหนดตารางเวลาการเผยแพร่นี้สำหรับเวลาและวันในอนาคต.',
  /** Label for date picker when scheduling a release */
  'release.schedule-dialog.select-publish-date-label': 'กำหนดตารางเวลาเมื่อ',
  ...
  'release.toast.delete-schedule-draft.error':
    'ไม่สามารถลบเอกสารร่างที่กำหนดเวลาไว้ <strong>{{title}}</strong>: {{error}}',
  /** Success toast for deleting a scheduled draft */
  'release.toast.delete-schedule-draft.success':
    'เอกสารร่างที่กำหนดเวลาไว้ <strong>{{title}}</strong> ได้ถูกลบแล้ว.',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.not-found-release.title': "ไม่พบการปล่อย '{{title}}'",
  /** Error toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.error':
    'ไม่สามารถเผยแพร่เอกสารร่างที่กำหนดเวลาไว้ <strong>{{title}}</strong>: {{error}}',
  /** Success toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.success':
    'เอกสารร่างที่กำหนดเวลาไว้ <strong>{{title}}</strong> ได้ถูกเผยแพร่แล้ว.',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'ไม่สามารถกำหนดตารางเวลาใหม่สำหรับเอกสารร่างที่กำหนดเวลาไว้ <strong>{{title}}</strong>: {{error}}',
  /** Success toast for rescheduling a draft */
  'release.toast.reschedule-scheduled-draft.success':
    'เอกสารร่างที่กำหนดเวลาไว้ <strong>{{title}}</strong> ได้ถูกกำหนดตารางเวลาใหม่แล้ว.',
  ...
  'schedule-publish-dialog.confirm': 'กำหนดตารางเวลา',
  /** Description for the schedule publish dialog */
  'schedule-publish-dialog.description': 'เลือกเมื่อไหร่ที่เอกสารนี้ควรถูกเผยแพร่.',
  /** Header for the schedule publish dialog */
  'schedule-publish-dialog.header': 'กำหนดตารางเวลาการเผยแพร่ร่าง',
