...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.configuration-issue.missing-appid':
    'การอัปเดตอัตโนมัติถูกเปิดใช้งาน แต่ไม่มี <code>deployment.appId</code> ที่กำหนดค่าใน <code>sanity.cli.ts</code> สตูดิโอนี้กำลังอัปเดตตามช่อง <strong>latest</strong>.',
  ...
  'about-dialog.version-info.new-auto-update-version-available': 'มีเวอร์ชันใหม่',
  ...
  'asset-sources.media-library.select-dialog.title':
    'กำลังเลือก {{assetType}} สำหรับ {{targetTitle}}',
  ...
  'release.dialog.delete-schedule-draft.header': 'ลบร่างที่มีตารางเวลา',
  /** Body text for change schedule dialog */
  'release.dialog.edit-schedule.body': 'เลือกวันที่และเวลาใหม่สำหรับการเผยแพร่ตามตารางเวลา',
  ...
  'release.schedule-dialog.publish-date-in-past-warning':
    'กำหนดตารางเวลาการเผยแพร่นี้ให้เป็นเวลาและวันในอนาคต.',
  ...
  'schedule-publish-dialog.description': 'เลือกเมื่อไหร่ที่เอกสารนี้ควรจะถูกเผยแพร่.',
