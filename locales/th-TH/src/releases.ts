...
export default removeUndefinedLocaleResources({
  ...
  'activity.panel.close': 'ปิดกิจกรรม',
  ...
  'document-validation.error_other': 'ข้อผิดพลาดการตรวจสอบ {{count}} รายการ',
  /** Tooltip for the validation status when a document has no errors (the "ready" state) */
  'document-validation.valid': 'ไม่มีข้อผิดพลาดในการตรวจสอบ',
  ...
  'overview.back-to-all-releases': 'รีลีสทั้งหมด',
  ...
  'permissions.error.archive': 'คุณไม่มีสิทธิ์เก็บถาวร release นี้',
  /** Tooltip label when the user doesn't have permission to delete release */
  'permissions.error.delete': 'คุณไม่มีสิทธิ์ลบ release นี้',
  /** Tooltip label when the user doesn't have permission for discarding a version */
  'permissions.error.discard-version': 'คุณไม่มีสิทธิ์ยกเลิกเวอร์ชันนี้',
  /** Tooltip label when the user doesn't have permission to duplicate release */
  'permissions.error.duplicate': 'คุณไม่มีสิทธิ์ทำสำเนา release นี้',
  /** Tooltip label when the user doesn't have permission to unarchive release */
  'permissions.error.unarchive': 'คุณไม่มีสิทธิ์ยกเลิกการเก็บถาวร release นี้',
  ...
  'presence.tooltip.one-without-release': '{{displayName}} กำลังแก้ไขเอกสารนี้อยู่',
  ...
  'publish-dialog.confirm-publish.update-drafts-description_other':
    'แบบร่างที่มีอยู่ของเอกสาร {{draftDocumentsLength}} รายการจะถูกลบทิ้ง เพื่อให้แบบร่างตรงกับรีลีสที่เผยแพร่แล้ว การเปลี่ยนแปลงแบบร่างที่ยังไม่ได้เผยแพร่จะสูญหาย',
  ...
  'table-header.edited-by': 'แก้ไขโดย',
  ...
  'table-header.last-edited': 'แก้ไขล่าสุด',
  ...
  'toast.revert.error': 'ไม่สามารถรีเวิร์ต release: {{error}}',
  /** Text for toast when release failed to schedule */
  'toast.schedule.error': "ไม่สามารถกำหนดเวลา '<strong>{{title}}</strong>': {{error}}",
  /** Text for toast when release has been scheduled */
  'toast.schedule.success': "กำหนดเวลา release '<strong>{{title}}</strong>' แล้ว",
  /** Text for toast when release failed to unarchive */
  'toast.unarchive.error': "ไม่สามารถยกเลิกการเก็บถาวร '<strong>{{title}}</strong>': {{error}}",
  /** Text for toast when release failed to unschedule */
  'toast.unschedule.error': "ไม่สามารถยกเลิกกำหนดเวลา '<strong>{{title}}</strong>': {{error}}",
