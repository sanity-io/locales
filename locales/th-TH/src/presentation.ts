...
export default removeUndefinedLocaleResources({
  ...
  'preview-location-input.error_same-base-path':
    'URL ไม่สามารถมี base path เดียวกับ Studio {{basePath}} ได้',
  ...
  'preview-search-param.configuration.error.title': 'URL การแสดงตัวอย่างถูกบล็อก',
  ...
  'preview-url-secret.missing-grants':
    'คุณไม่มีสิทธิ์สร้าง URL Preview Secrets ซึ่งอาจทำให้การแสดงตัวอย่างโหลดไม่สำเร็จ',

  /** Menu item in the share preview menu that allows copying the current preview URL, if sharing is enabled */
  'share-preview-menu.copy-url.text': 'คัดลอกลิงก์การแสดงตัวอย่าง',
