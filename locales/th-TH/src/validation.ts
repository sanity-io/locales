...
export default removeUndefinedLocaleResources({
  ...
  "array.exact-length":
    "ต้องมีจำนวนรายการทั้งหมด {{wantedLength}} รายการเท่านั้น",
  /** Portable Text array must have exactly "$wantedLength" blocks, but has more/less */
  "array.exact-length_blocks":
    "ต้องมีจำนวนบล็อกทั้งหมด {{wantedLength}} บล็อกเท่านั้น",
  ...
  "generic.incorrect-type":
    'คาดหวังประเภท "{{expectedType}}", แต่ได้ "{{actualType}}"',
  ...
  "object.reference-not-published":
    "เอกสารที่อ้างอิงต้องเป็นเอกสารที่ได้รับการเผยแพร่",
