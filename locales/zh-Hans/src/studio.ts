...
export default removeUndefinedLocaleResources({
  ...
  "asset-source.dialog.accept-message":
    "仅显示接受类型的资产：<strong>{{acceptTypes}}</strong>",
  ...
  "calendar.error.must-be-in-format":
    "必须是以下格式 <Emphasis>{{exampleDate}}</Emphasis>",
  ...
  "inputs.array.error.type-is-incompatible-prompt":
    "类型<code>{{typeName}}</code>的项对此列表无效",
  ...
  "inputs.reference.no-results-for-query":
    "没有找到与<strong>“{{searchTerm}}”</strong>匹配的文档",
  ...
  "new-document.no-results":
    "没有找到与<strong>{{searchQuery}}</strong>相关的结果",
  ...
  "search.operator.date-range.description":
    "<Field/> <Operator>在之间</Operator> <Value/>",
