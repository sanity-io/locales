...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.delete-schedule-draft.body': '您确定要删除这个预定草稿吗？此操作无法撤销。',
  ...
  'release.dialog.edit-schedule.body': '为预定发布选择一个新的日期和时间。',
  ...
  'release.schedule-dialog.publish-date-in-past-warning': '请将此发布计划安排在未来的时间和日期。',
  ...
  'release.toast.delete-schedule-draft.error':
    '无法删除预定的草稿文档 <strong>{{title}}</strong>：{{error}}',
  ...
  'release.toast.publish-scheduled-draft.error':
    '无法发布预定的草稿文档 <strong>{{title}}</strong>：{{error}}',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    '无法重新安排预定的草稿文档 <strong>{{title}}</strong>：{{error}}',
