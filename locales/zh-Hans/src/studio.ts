...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.configuration-issue.missing-appid':
    '自动更新已启用，但在 <code>sanity.cli.ts</code> 中未配置 <code>deployment.appId</code>。此 Studio 正在针对 <strong>latest</strong> 频道更新。',
  ...
  'about-dialog.version-info.reload-to-update': '重新加载 Studio 以更新',
  ...
  'help-resources.studio-auto-update-now': '重新加载以更新至 v{{newVersion}}',
  ...
  'release.dialog.delete-schedule-draft.header': '删除计划草稿',
  /** Body text for change schedule dialog */
  'release.dialog.edit-schedule.body': '为计划发布选择一个新的日期和时间。',
  ...
  'release.schedule-dialog.publish-date-in-past-warning': '请将此发布计划安排在将来的时间和日期。',
  ...
  'release.toast.delete-schedule-draft.error':
    '删除预定草稿文档 <strong>{{title}}</strong> 失败：{{error}}',
  /** Success toast for deleting a scheduled draft */
  'release.toast.delete-schedule-draft.success':
    '预定草稿文档 <strong>{{title}}</strong> 已被删除。',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.not-found-release.title': "找不到 '{{title}}' 发布",
  /** Error toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.error':
    '发布预定草稿文档 <strong>{{title}}</strong> 失败：{{error}}',
  /** Success toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.success':
    '预定草稿文档 <strong>{{title}}</strong> 已被发布。',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    '重新安排预定草稿文档 <strong>{{title}}</strong> 失败：{{error}}',
  /** Success toast for rescheduling a draft */
  'release.toast.reschedule-scheduled-draft.success':
    '预定草稿文档 <strong>{{title}}</strong> 已被重新安排。',
  ...
  'schedule-publish-dialog.description': '选择此文档应何时发布。',
