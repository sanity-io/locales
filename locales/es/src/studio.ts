...
export default removeUndefinedLocaleResources({
  ...
  'changes.action.revert-all-description': `¿Estás seguro de que quieres revertir los {{count}} cambios?`,
  ...
  'changes.action.revert-changes-description_one': `¿Estás seguro de que quieres revertir el cambio?`,
  ...
  'timeline.create': 'Creado',
  'timeline.delete': 'Eliminado',
  'timeline.discardDraft': 'Borrador descartado',
  'timeline.initial': 'Creado',
  'timeline.editDraft': 'Editado',
  'timeline.editLive': 'Editado en vivo',
  'timeline.publish': 'Publicado',
  'timeline.unpublish': 'Despublicado',

  /** --- Slug Input --- */
  /** Error message for when the source to generate a slug from is missing */
  'inputs.slug.error.missing-source': `Falta la fuente. Verifica la fuente en el tipo {{schemaType}} en el esquema`,
  ...
  'inputs.files.common.drop-message.drop-to-upload.rejected-file-message_one': `{{count}} archivo no se puede subir aquí`,

  /** `{{count}}` files can't be uploaded here */
  'inputs.files.common.drop-message.drop-to-upload.rejected-file-message_other': `{{count}} archivos no se pueden subir aquí`,

  /** Can't upload this file here */
  'inputs.files.common.drop-message.drop-to-upload.no-accepted-file-message_one': `No se puede subir este archivo aquí`,

  /** Can't upload any of these files here */
  'inputs.files.common.drop-message.drop-to-upload.no-accepted-file-message_other': `No se pueden subir ninguno de estos archivos aquí`,
  ...
  'inputs.reference.error.invalid-search-result-type-title': `La búsqueda devolvió un tipo que no es válido para esta referencia: "{{returnedType}}"`,
  ...
  'inputs.reference.cross-dataset.feature-disabled-actions': `Todavía puedes borrar la referencia existente de este campo, pero no se puede cambiar a un documento diferente mientras la función esté deshabilitada.`,
  ...
  'inputs.array.error.type-is-incompatible-prompt': `Elemento de tipo <code>{{typeName}}</code> no válido para esta lista`,
  ...
  'form.error.field-not-found': `Campo "{{fieldName}}" no encontrado entre los miembros – verifique que esté definido en el esquema y que no haya sido ocultado condicionalmente.`,
  ...
  'search.error.no-valid-asset-source-check-config-description': `Por favor, asegúrate de que esté habilitado en tu archivo de configuración del estudio.`,
