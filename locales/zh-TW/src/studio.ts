...
export default removeUndefinedLocaleResources({
  ...
  'asset-source.file.asset-list.delete-failed': '檔案無法被刪除',
  'asset-source.file.asset-list.delete-successful': '檔案已被刪除',
  ...
  'asset-source.usage-list.documents-using-file_named_other':
    '{{count}}份文件正在使用檔案<code>{{filename}}</code>',
  /** Text shown in usage dialog for a file asset when there are zero, one or more documents using the *named* file **/
  'asset-source.usage-list.documents-using-file_named_zero':
    '沒有文件正在使用檔案<code>{{filename}}</code>',
  'asset-source.usage-list.documents-using-file_unnamed_other': '{{count}}份文件正在使用此檔案',
  /** Text shown in usage dialog for a file asset when there are zero, one or more documents using the *unnamed* file **/
  'asset-source.usage-list.documents-using-file_unnamed_zero': '沒有文件正在使用此檔案',
  ...
  /** Image diff: Text shown in tooltip when hovering hotspot that has changed in diff view */
  'changes.image.hotspot-changed': '熱點已變更',
  ...
  'changes.no-changes-title': '沒有變更',
  /** Portable Text diff: An annotation was added */
  'changes.portable-text.annotation_added': '已添加註釋',
  /** Portable Text diff: An annotation was changed */
  'changes.portable-text.annotation_changed': '已更改註釋',
  /** Portable Text diff: An annotation was removed */
  'changes.portable-text.annotation_removed': '已移除註釋',
  /** Portable Text diff: An annotation was left unchanged */
  'changes.portable-text.annotation_unchanged': '註釋未變更',
  /** Portable Text diff: A block changed from one style to another (eg `normal` to `h1` or similar) */
  'changes.portable-text.block-style-changed': '區塊樣式從「{{fromStyle}}」變更為「{{toStyle}}」',
  ...
  'form.error.duplicate-keys-alert.details.description':
    '這通常發生在使用 API 客戶端創建項目時，每個元素的 <code>_key</code> 屬性被生成為非唯一。',
  /** Developer info */
  ...
  /** Non-unique keys */
  'form.error.duplicate-keys-alert.title': '非唯一的鍵值',
  /** Error text shown when a field with a given name cannot be found in the schema or is conditionally hidden but explicitly told to render  */
  'form.error.field-not-found':
    '在成員中找不到名為 "{{fieldName}}" 的字段 - 請確認它已在架構中定義並且沒有被條件隱藏。',
  /** Add missing keys */
  ...
  'form.error.missing-keys-alert.details.description':
    '這通常發生在使用 API 客戶端創建項目時，並且沒有包含 <code>_key</code> 屬性。',
  /** Developer info */
  ...
  'form.error.mixed-array-alert.details.description':
    '這通常發生在使用 API 客戶端創建項目，或者當自定義輸入組件向列表中添加了無效數據時。',
  /** Developer info */
  ...
  'form.error.mixed-array-alert.summary':
    '此列表中的一些項目不是物件。必須修正這個問題才能編輯列表。',
  /** Invalid list values */
  'form.error.mixed-array-alert.title': '無效的列表值',
  /** Error text shown when form is unable to find an array item at a given indexed path */
  'form.error.no-array-item-at-index':
    '在路徑 <code>{{path}}</code> 上找不到索引 <code>{{index}}</code> 的陣列項目',
  /** Error text shown when form is unable to find an array item at a given keyed path */
  'form.error.no-array-item-at-key':
    '在路徑 <code>{{path}}</code> 上找不到 `_key` <code>"{{key}}"</code> 的陣列項目',
   ...
   */
  'help-resources.action.contact-sales': '聯絡銷售',
  /**
  ...
  'inputs.file.actions-menu.file-options.aria-label': '開啟檔案選項菜單',
  /** Browse */
  'inputs.file.browse-button.text': '瀏覽',
  /** Select file */
  'inputs.file.dialog.title': '選擇檔案',
  /** Unknown member kind: `{{kind}}` */
  'inputs.file.error.unknown-member-kind': '未知的成員類型：{{kind}}',
  /** The value of this field is not a valid file. Resetting this field will let you choose a new file. */
  'inputs.file.invalid-file-warning.description':
    '此欄位的值不是有效的檔案。重置此欄位將允許您選擇新檔案。',
  /** Reset value */
  'inputs.file.invalid-file-warning.reset-button.text': '重置值',
  /** Invalid file value */
  'inputs.file.invalid-file-warning.title': '無效的檔案值',
  /** Select */
  ...
  'inputs.files.common.placeholder.drag-or-paste-to-upload_file': '拖曳或貼上檔案到此處',
  /** Drag or paste image here */
  'inputs.files.common.placeholder.drag-or-paste-to-upload_image': '拖曳或貼上圖片到此處',
  /** Drop to upload file */
  ...
  'inputs.object.unknown-fields.read-only.description':
    '根據文件的架構，此欄位為<strong>唯讀</strong>，無法取消設定。如果您希望在Studio中能夠取消設定此欄位，請確保您從架構中的封閉類型中移除<code>readOnly</code>欄位。',
  /** Remove field */
  'inputs.object.unknown-fields.remove-field-button.text': '移除欄位',
  'inputs.object.unknown-fields.warning.description_other': '遇到{{count}}個未在模式中定義的欄位。',
  'inputs.object.unknown-fields.warning.details.description_other':
    '這些欄位未在文件的模式中定義，這可能意味著欄位定義已被移除，或者有人在他們自己的本地項目中添加了這些欄位，但尚未部署他們的更改。',
  /** Developer info */
  ...
  'inputs.portable-text.action.edit-annotation': '編輯註解',
  ...
  'inputs.portable-text.action.remove-annotation': '移除註解',
  ...
  'inputs.portable-text.block.open-menu-aria-label': '開啟菜單',
  /** Label for action to open a reference, in the case of block-level reference types */
  'inputs.portable-text.block.open-reference': '開啟參考',
  ...
  'inputs.portable-text.decorator.underline': '底線',
  ...
  'inputs.portable-text.invalid-value.disallowed-child-type.action': '移除物件',
  /** Text explaining that the Portable Text field value is invalid, when block with key `{{key}}` has a child with key `{{childKey}}` of type `{{childType}}` which is not allowed by the schema definition */
  'inputs.portable-text.invalid-value.disallowed-child-type.description':
    '鍵為 {{childKey}} 的子項目屬於鍵為 <code>{{key}}</code> 的塊的類型 <code>{{childType}}</code>，該類型不被模式定義允許。',
  /** Action presented when the Portable Text field value is invalid, when child with key `{{key}}` has a type (`{{typeName}}`) that is not an allowed block type for this field */
  'inputs.portable-text.invalid-value.disallowed-type.action': '移除塊',
  ...
  'inputs.portable-text.invalid-value.invalid-span-text.description':
    '鍵為 {{childKey}} 的塊的鍵為 <code>{{key}}</code> 的跨度具有缺失或無效的 <code>text</code> 屬性。',
  ...
  'inputs.portable-text.invalid-value.missing-child-type.action': '移除物件',
  /** Text explaining that the Portable Text field value is invalid, when block with key `{{key}}` has a child with key `{{childKey}}` which is missing a `_type` property */
  'inputs.portable-text.invalid-value.missing-child-type.description':
    '鍵為 {{childKey}} 的塊的鍵為 <code>{{key}}</code> 的子項目缺少 <code>_type</code> 屬性。',
  ...
  'inputs.portable-text.invalid-value.missing-or-invalid-children.action': '移除區塊',
  ...
  'inputs.portable-text.invalid-value.missing-type.action': '移除區塊',
  /** Text explaining that the Portable Text field value is invalid, when child with key `{{key}}` is missing a `_type` property  */
  'inputs.portable-text.invalid-value.missing-type.description':
    '鍵值為<code>{{key}}</code>的區塊缺少類型名稱。',
  /** Action presented when the Portable Text field value is invalid, when block with key `{{key}}` contains a non-object child at index `{{index}}` */
  'inputs.portable-text.invalid-value.non-object-child.action': '移除項目',
  /** Text explaining that the Portable Text field value is invalid, when block with key `{{key}}` contains a non-object child at index `{{index}}` */
  'inputs.portable-text.invalid-value.non-object-child.description':
    '鍵值為<code>{{key}}</code>的區塊中索引<code>{{index}}</code>的子項不是一個物件。',
  ...
  'inputs.reference.cross-dataset.feature-disabled-actions':
    '您仍然可以清除這個欄位現有的參考，但只要功能被禁用，就無法更改為不同的文件。',
  ...
  'inputs.reference.document-opens-in-new-tab': '此文件將在新標籤頁中打開',
  /** Error title for when the document is unavailable (for any possible reason) */
  'inputs.reference.error.document-unavailable-title': '文件不可用',
  /** Error title for when the referenced document failed to be loaded */
  'inputs.reference.error.failed-to-load-document-title': '無法加載參考文件',
  ...
  'inputs.reference.error.invalid-type-description':
    '參考的文件（<code>{{documentId}}</code>）的類型為<code>{{actualType}}</code>。根據模式，參考文件只能是<AllowedTypes />類型。',
  /** Error title for when the document referenced is not one of the types declared as allowed target types in schema */
  'inputs.reference.error.invalid-type-title': '文件類型無效',
  /** Error description for when the user does not have permissions to read the referenced document */
  'inputs.reference.error.missing-read-permissions-description': '由於權限不足，無法訪問參考的文件',
  ...
  'inputs.reference.incomplete-reference.finalize-action-description':
    '<strong>{{referencedDocument}}</strong> 已發布，此參考應該現在完成。',
  /** Title for alert shown when a reference in a live-edit document is marked as being weak, the referenced document exists, AND the reference is supposed to be have been strengthened on publish */
  'inputs.reference.incomplete-reference.finalize-action-title': '完成參考',
  /** Description for alert shown when a reference in a live-edit document points to a document that exists and has been published, but the reference is still marked as weak */
  'inputs.reference.incomplete-reference.strengthen-action-description':
    '<strong>{{referencedDocument}}</strong> 已發布，此參考現在應轉換為強參考。',
  ...
  'inputs.reference.no-results-for-query': '沒有結果符合 <strong>“{{searchTerm}}”</strong>',
  ...
  'inputs.reference.strength-mismatch.is-weak-description':
    '這個參考是<em>弱</em>的，但根據當前的架構它應該是<em>強</em>的。',
  ...
  /** Developer info */
  'inputs.untyped-value.details.title': '開發者資訊',
  ...
  'new-document.no-results': '對於<strong>{{searchQuery}}</strong>沒有找到結果',
  ...
  'preview.image.file-is-being-uploaded.alt-text': '正在上傳的圖片',

  /* Relative time, just now */
  'relative-time.just-now': '剛剛',

  /** Accessibility label to open search action when the search would go fullscreen (eg on narrower screens) */
  'search.action-open-aria-label': '開啟搜索',
  ...
  'search.error.no-valid-asset-source-only-default-description': '目前，僅支持默認資產來源。',
  /** Title for error when no valid asset sources found */
  'search.error.no-valid-asset-source-title': '未找到有效的資產來源。',
   ...
   */
  'search.filter-all-fields-header': '所有欄位',
  ...
  'search.no-results-help-description': '嘗試另一個關鍵字或調整您的篩選條件',
  ...
  'timeline.error.no-document-history-description': '更改文件內容時，文件版本將顯示在此菜單中。',
  ...
  'user-menu.action.manage-project': '管理專案',
  /** Accessibility label for the action to manage the current project */
  'user-menu.action.manage-project-aria-label': '管理專案',
