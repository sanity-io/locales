...
export default removeUndefinedLocaleResources({
  ...
  'action.delete.disabled.not-ready': '操作尚未準備好',
  ...
  /** Tooltip when action button is disabled because the operation is not ready   */
  'action.discard-changes.disabled.not-ready': '操作尚未準備好',
  /** Label for the "Discard changes" document action */
  'action.discard-changes.label': '放棄更改',
  /** Tooltip when action is disabled because the operation is not ready   */
  'action.duplicate.disabled.not-ready': '操作尚未準備好',
  ...
  'action.publish.disabled.not-ready': '操作尚未準備好',
  ...
  'action.publish.live-edit.tooltip': '此內容類型已啟用即時編輯，您進行更改時將自動發布',
  ...
  'action.publish.validation-issues.tooltip': '在此文件可以發布之前，需要修正驗證錯誤',
  /** Tooltip when publish button is waiting for validation and async tasks to complete.*/
  'action.publish.waiting': '等待任務完成後才能發布',
  /** Message prompting the user to confirm that they want to restore to an earlier version*/
  'action.restore.confirm-dialog.confirm-discard-changes': '您確定要還原這份文件嗎？',
  /** Fallback tooltip for when user is looking at the initial version */
  'action.restore.disabled.cannot-restore-initial': '您不能還原到最初版本',
  ...
  /** Tooltip when action is disabled because the operation is not ready   */
  'action.unpublish.disabled.not-ready': '操作尚未準備就緒',
  ...
  'banners.permission-check-banner.missing-permission_create_other':
    '您的角色<Roles/>沒有權限創建此文件。',
  /** The text for the permission check banner if the user only has multiple roles, but they do not allow updating this document */
  'banners.permission-check-banner.missing-permission_update_other':
    '您的角色<Roles/>沒有權限更新此文件。',
  /** The text for the reload button */
  'banners.reference-changed-banner.reason-changed.reload-button.text': '重新載入參考',
  /** The text for the reference change banner if the reason is that the reference has been changed */
  'banners.reference-changed-banner.reason-changed.text': '自您打開它以來，此參考已更改。',
  /** The text for the close button */
  'banners.reference-changed-banner.reason-removed.close-button.text': '關閉參考',
  /** The text for the reference change banner if the reason is that the reference has been deleted */
  'banners.reference-changed-banner.reason-removed.text': '自您打開它以來，此參考已被移除。',
  ...
  'confirm-delete-dialog.cdr-summary.title_other': '{{documentCount}} 個文件在 {{count}} 個數據集',
  ...
  'document-inspector.search.placeholder': '搜尋',
  ...
  'no-document-types-screen.subtitle': '請在您的架構中定義至少一種文檔類型。',
  ...
  'panes.document-operation-results.operation-success': '文件{{context}}成功',
