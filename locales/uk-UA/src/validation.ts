...
export default removeUndefinedLocaleResources({
  ...
  'object.media-not-found': 'Актив не вдалося знайти в Медіатеці',
  /** Media object is missing a reference to a document in its `_ref` field */
  'object.not-media-library-asset': 'Має бути посиланням на актив Медіатеки',
  ...
  'panel.unpublish-message':
    'Документ буде знятий з публікації, помилки валідації не відображаються',
