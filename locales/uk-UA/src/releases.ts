...
export default removeUndefinedLocaleResources({
  ...
  'activity.panel.close': 'Закрити активність',
  ...
  'changes-published-docs.title': 'Зміни в опублікованих документах',
  ...
  'dashboard.details.metadata.status-empty': 'Немає документів',
  /** Status badge value when one or more documents have validation errors. */
  'dashboard.details.metadata.status-errors': 'Помилки',
  /** Status badge value when every document in the release is valid. */
  'dashboard.details.metadata.status-valid': 'Дійсно',
  /** Status badge value while document validation is still running. */
  'dashboard.details.metadata.status-validating': 'Перевірка',
  ...
  'document-validation.valid': 'Немає помилок перевірки',
  ...
  'overview.back-to-all-releases': 'Усі релізи',
  ...
  'passed-intended-publish-date': 'Цей реліз минув запланову дату публікації',

  /** Tooltip text for scheduled drafts that have passed their intended publish date */
  'passed-intended-publish-date-draft': 'Ця чернетка минула заплановану дату публікації',
  ...
  'presence.tooltip.one-without-release': '{{displayName}} редагує цей документ прямо зараз',
  ...
  'table-header.edited-by': 'Ким редаговано',
  ...
  'table-header.last-edited': 'Останнє редагування',
  ...
  'unpublish-dialog.description.to-draft':
    'Це зніме документ з публікації в рамках релізу <Label>{{title}}</Label> та створить чернетку, якщо на момент релізу її не існує.',
