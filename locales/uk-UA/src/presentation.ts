...
export default removeUndefinedLocaleResources({
  ...
  'preview-location-input.error_missing-origin': 'URL повинен починатися з {{origin}}',
  ...
  'preview-search-param.configuration.error.description':
    'Маршрутизатор хоче перейти до <Code>{{previewSearchParam}}</Code>, але джерело <Code>{{blockedOrigin}}</Code> не дозволено. Оновіть конфігурацію <Code>presentationTool.allowOrigins</Code>, щоб дозволити його.',
  ...
  'preview-url-secret.missing-grants':
    'У вас немає дозволу на створення URL Preview Secrets. Це, ймовірно, призведе до помилки завантаження попереднього перегляду.',
