...
export default removeUndefinedLocaleResources({
  ...
  'start-in-create-banner.subtitle':
    'Вільний, підтримуваний штучним інтелектом редактор, який синхронізується безпосередньо з вашими документами в Studio.',
  /** Header of the "Start writing in Create" banner */
  'start-in-create-banner.title': 'Почніть роботу з Sanity Create',
  /** Header badge of the "Start writing in Create" banner */
  'start-in-create-banner.title-badge': 'Ранній доступ',
  ...
  'start-in-create-link.label': 'Почати в Create',
