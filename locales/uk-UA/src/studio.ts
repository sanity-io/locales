...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.copy-to-clipboard-button.copied-text':
    'Скопійовано до буферу обміну. З радістю вставляйте!',
  /** "Copy to Clipboard" button text for copying version details from About-dialog */
  'about-dialog.version-info.copy-to-clipboard-button.text': 'Копіювати до буферу обміну',
  ...
  'input.files.common.upload-placeholder.file-input-button.default-source.badge': 'Стандартний',
  ...
  'inputs.files.common.placeholder.select-asset-source-upload-destination': 'Завантажте файли до:',
