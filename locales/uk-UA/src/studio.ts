...
export default removeUndefinedLocaleResources({
  ...
  'changes.from-base-variant.label': 'Змінено відносно базового варіанту',
  ...
  'document-group-inventory.action.manage-versions': 'Керувати версіями',
  ...
  'release.action.edit-details': 'Редагувати деталі',
  ...
  'release.dialog.edit.confirm': 'Зберегти',
  /** Field label for the release description in the edit release dialog */
  'release.dialog.edit.description-label': 'Опис',
  /** Title for the edit release dialog */
  'release.dialog.edit.title': 'Редагувати реліз',
  ...
  'release.toast.edit-release-error.title': 'Не вдалося зберегти деталі релізу',
  ...
  'user-menu.action.claim-project': 'Заявити права на цей проєкт',
