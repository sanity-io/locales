...
export default removeUndefinedLocaleResources({
  ...
  'inputs.dateTime.past-date-warning': 'Виберіть дату в майбутньому.',
  ...
  'release.action.discard-version.success': 'Версію <strong>{{title}}</strong> успішно відхилено',
  ...
  'release.dialog.tooltip.description':
    'Приблизний час релізу використовується для створення кращих попередніх переглядів та підказок про те, чи є конфлікти в документах.',
  ...
  'release.toast.not-found-release.title': "Реліз '{{title}}' не може бути знайдений",
  ...
  'release.tooltip.locked':
    'Цей реліз було заплановано. Відмініть планування, щоб додати більше документів.',
