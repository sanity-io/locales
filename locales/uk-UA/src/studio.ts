...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.delete-schedule-draft.body-already-current':
    'Видалити цей запланований чернетку? Ваш чернетка вже актуальна.',
  ...
  'release.dialog.delete-schedule-draft.different-changes-explanation':
    'Ваш запланований чернетка містить інші зміни, ніж ваша поточна чернетка.',
   ...
   * @deprecated – no longer needed
   * */
  'release.toast.scheduled-draft-published.title': 'Запланований чернетку було опубліковано',
  ...
  'releases.upsell.misconfiguration.contact-support': 'Звернутися в службу підтримки',
  ...
  'releases.upsell.misconfiguration.message':
    'Випуски контенту активовані для вашого проекту, але, схоже, є проблема з конфігурацією лімітів випусків. Будь ласка, зверніться в службу підтримки, щоб належним чином налаштувати випуски вашого контенту.',
