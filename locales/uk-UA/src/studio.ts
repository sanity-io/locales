...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.reload-to-update': 'Перезавантажте Studio для оновлення',
  ...
  'about-dialog.version-info.tooltip.up-to-date': 'Актуальна версія',
  ...
  'release.toast.delete-schedule-draft.error':
    'Не вдалося видалити запланований документ чернетки <strong>{{title}}</strong>: {{error}}',
  /** Success toast for deleting a scheduled draft */
  'release.toast.delete-schedule-draft.success':
    'Запланований документ чернетки <strong>{{title}}</strong> було видалено.',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.not-found-release.title': "Реліз '{{title}}' не вдалося знайти",
  /** Error toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.error':
    'Не вдалося опублікувати запланований документ чернетки <strong>{{title}}</strong>: {{error}}',
  /** Success toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.success':
    'Запланований документ чернетки <strong>{{title}}</strong> було опубліковано.',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'Не вдалося перепланувати запланований документ чернетки <strong>{{title}}</strong>: {{error}}',
  /** Success toast for rescheduling a draft */
  'release.toast.reschedule-scheduled-draft.success':
    'Запланований документ чернетки <strong>{{title}}</strong> було переплановано.',
  ...
  'sheet-list.edit-columns': 'Редагувати стовпці',
  /** Label for the header menu option to hide a field from the sheet list */
  'sheet-list.hide-field': 'Прибрати з таблиці',
  /** Label for reset column visibilities button */
  'sheet-list.reset-columns': 'Скинути стовпці',
  /** Title for the edit columns menu */
  'sheet-list.select-fields': 'Виберіть до 5 типів полів',
