...
export default removeUndefinedLocaleResources({
  ...
  'asset-sources.media-library.error.no-media-library-provisioned':
    'Для цієї організації не налаштовано медіа-бібліотеку.',
  ...
  'help-resources.studio-auto-update-now': 'Перезавантажте для оновлення до v{{newVersion}}',
  ...
  'release.action.revert-unpublish-version.failure.description':
    "Будь ласка, спробуйте ще раз або перевірте ваше з'єднання. Документ все ще буде непублікований після випуску.",
  /** Error message title for when a version is reverted from being unpublished */
  'release.action.revert-unpublish-version.failure.title':
    'Не вдалося скасувати налаштування на зняття з публікації під час випуску.',
  ...
  'release.action.revert-unpublish-version.success.title':
    'Успішно скасовано налаштування на зняття з публікації під час випуску.',
