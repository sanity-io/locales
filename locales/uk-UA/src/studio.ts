...
export default removeUndefinedLocaleResources({
  ...
  'document-group.delete.error.message':
    'Під час спроби видалити цей документ сталася помилка. Зазвичай це означає, що інші документи посилаються на нього.',
  ...
  'document-group.delete.other-reference-count.tooltip':
    'Ми не можемо відобразити метадані для цих посилань через відсутній токен доступу до відповідних dataset.',
