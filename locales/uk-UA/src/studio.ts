...
export default removeUndefinedLocaleResources({
  ...
  'changes.error-description': 'Ми не можемо завантажити зміни для цього документа.',
  ...
  'release.navbar.published': 'Опубліковано',
  ...
  'release.toast.not-found-release.title': "Реліз '{{title}}' не можна було знайти",
  ...
  'release.type.undecided': 'Невизначено',
