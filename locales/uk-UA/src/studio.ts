...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.up-to-date': 'Актуальна',
  ...
  'asset-source.dialog.insert-asset-error':
    'Помилка вставки активу. Дивіться консоль для отримання додаткової інформації.',
  ...
  'asset-sources.media-library.file.title': 'Медіатека',
  'asset-sources.media-library.image.title': 'Медіатека',
  ...
  'document.type.not-found': 'Тип документа "{{type}}" не знайдено',
  ...
  'inputs.reference.global.invalid-type': 'Посилання на документ недійсного типу ({{typeName}})',
