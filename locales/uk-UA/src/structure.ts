...
export default removeUndefinedLocaleResources({
  ...
  'banners.release.not-in-release': 'Не в релізі <VersionBadge>{{title}}</VersionBadge>.',
  /** The text content for the unpublished document banner when is part of a release */
  'banners.unpublished-release-banner.text':
    'Цей документ буде знятий з публікації як частина релізу <VersionBadge>{{title}}</VersionBadge>',
  ...
  'events.inspect.release': 'Переглянути документ <VersionBadge>{{releaseTitle}}</VersionBadge>',
  /**The title for the menu items that will be shown when expanding a publish draft event to inspect the draft document*/
  'events.open.draft': 'Відкрити документ <VersionBadge>draft</VersionBadge>',
  /**The title for the menu items that will be shown when expanding a publish release event to inspect the release*/
  'events.open.release': 'Відкрити реліз <VersionBadge>{{releaseTitle}}</VersionBadge>',
  ...
  'panes.document-operation-results.operation-success_createVersion':
    '<Strong>{{title}}</Strong> було додано до релізу',
