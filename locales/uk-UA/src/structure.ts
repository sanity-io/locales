...
export default removeUndefinedLocaleResources({
  ...
  'banners.archived-scheduled-draft.description': 'Цей запланований чернетку заархівовано',
  ...
  'banners.scheduled-draft-override-banner.text':
    'Чернетка цього документа вже запланована до публікації. Зміни, які ви тут внесете, можуть бути перезаписані цією версією.',
