...
export default removeUndefinedLocaleResources({
   ...
   * */
  'banners.release.navigate-to-edit-description-none': 'Цей документ не є частиною жодного релізу',
  ...
  'buttons.focus-pane-button.aria-label.focus': 'Увійти в режим фокусування (приховати навігацію)',
