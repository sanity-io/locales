...
export default removeUndefinedLocaleResources({
  ...
  'action.link-document-disabled.initial-value-not-resolved': '請等待文檔的初始值解析完成',
  ...
  'dialog.unlink-from-canvas.description':
    '一旦取消連結，將可以在此處編輯，未來在 Canvas 中的編輯將不再自動映射到此文檔。',
  /** The text for the "Unlink from Canvas" dialog error message. */
  'dialog.unlink-from-canvas.error': '取消連結 Canvas 失敗',
  /** The text for the "Unlink from Canvas" dialog success message. */
  'dialog.unlink-from-canvas.success': '已從 Canvas 取消連結',
  ...
  'dialog.unlink-from-canvas.unlink-action': '現在取消連結',
