...
export default removeUndefinedLocaleResources({
  ...
  /** The status of the channel connection */
  'channel.status_disconnected': '已中斷連線',
  /** The status of the channel connection */
  ...
  'preview-frame.configuration.error.description':
    '預覽 iframe 已設定為載入 <Code>{{targetOrigin}}</Code>，但回報的來源為 <Code>{{reportedOrigin}}</Code>。Presentation Tool 基於安全考量，無法連線至未知來源。請更新您的 <Code>presentationTool.allowOrigins</Code> 設定，以允許連線至 Visual Editing 和 Loaders。',
  ...
  'share-preview-menu.qr-code.title': '編碼了以下網址的 QR Code：{{url}}',
