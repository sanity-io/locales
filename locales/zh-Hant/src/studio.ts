...
export default removeUndefinedLocaleResources({
  ...
  /** Insert asset error */
  'asset-source.dialog.insert-asset-error': '插入資產時出錯。查看控制台以獲取更多信息。',
  ...
  'asset-sources.common.uploader.upload-failed.description': '查看控制台以獲取更多信息。',
  ...
  'document.type.not-found': '未找到文檔類型 "{{type}}"',
  ...
  'input.files.common.upload-placeholder.file-input-button.default-source.badge': '默認',
  ...
  'inputs.array.insert-menu.search.no-results': '未找到項目',
  ...
  'inputs.array.insert-menu.toggle-grid-view.tooltip': '切換網格視圖',
  /** Tooltip for the array insert menu list view toggle */
  'inputs.array.insert-menu.toggle-list-view.tooltip': '切換列表視圖',
  ...
  'inputs.files.common.placeholder.select-asset-source-upload-destination': '將文件上傳到：',
  ...
  'release.chip.tooltip.archived': '此發行版本已存檔，無法編輯。',
  ...
  'release.dialog.create.confirm': '創建發行版本',
  ...
  'release.toast.archived-release.description': '此發行版本已被取消釘選',
  ...
  'release.toast.published-release.description': '此發行版本已被取消釘選',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.published-release.title': '「{{title}}」發行版本已發布',
