...
export default removeUndefinedLocaleResources({
  ...
  /** Browse button text */
  'asset-source.browse-button.text': '選擇',
  ...
  'divergence.action.takeFromUpstream.label': '從基礎版本複製',
  ...
  /** Select file */
  'inputs.files.select-dialog.title': '為「{{targetTitle}}」選擇檔案',
  ...
  /** Select image */
  'inputs.image.select-dialog.title': '為「{{targetTitle}}」選擇圖片',
  /** The upload could not be completed at this time. */
  ...
  /** Select video */
  'inputs.video.select-dialog.title': '為「{{targetTitle}}」選擇影片',
