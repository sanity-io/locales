...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.reload-to-update': '重新加載Studio以更新',
  ...
  'asset-sources.media-library.error.no-media-library-provisioned': '該組織尚未配置媒體庫。',
  ...
  'release.action.revert-unpublish-version.failure.description':
    '請再試一次或檢查您的連接。發布時文檔仍將被取消發布。',
  /** Error message title for when a version is reverted from being unpublished */
  'release.action.revert-unpublish-version.failure.title': '無法還原為發布時取消發布的設置。',
  /** Action message description for when a version is reverted from being unpublished */
  'release.action.revert-unpublish-version.success.description': '您現在可以編輯此版本。',
  /** Action message title for when a version is reverted from being unpublished */
  'release.action.revert-unpublish-version.success.title': '成功還原為發布時取消發布的設置。',
