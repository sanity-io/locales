...
export default removeUndefinedLocaleResources({
  ...
  "asset-source.dialog.accept-message":
    "僅顯示接受類型的資產：<strong>{{acceptTypes}}</strong>",
  ...
  "calendar.error.must-be-in-format":
    "必須是以下格式 <Emphasis>{{exampleDate}}</Emphasis>",
  ...
  "inputs.reference.no-results-for-query":
    "沒有符合<strong>“{{searchTerm}}”</strong>的結果",
  ...
  "search.operator.date-range.description":
    "<Field/> <Operator>介於</Operator> <Value/>",
  ...
  "search.operator.not-defined.description":
    "<Field/> <Operator>是</Operator> <Value>空的</Value>",
