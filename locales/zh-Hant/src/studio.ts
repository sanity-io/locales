...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.configuration-issue.missing-appid':
    '自動更新已啟用，但在<code>sanity.cli.ts</code>中未配置<code>deployment.appId</code>。這個Studio正在針對<strong>最新</strong>頻道更新。',
  ...
  'release.dialog.edit-schedule.confirm': '更新日程',
  /** Header for change schedule dialog */
  'release.dialog.edit-schedule.header': '更改日程',
  ...
  'release.toast.publish-scheduled-draft.error':
    '無法發布預定草稿文件 <strong>{{title}}</strong>：{{error}}',
