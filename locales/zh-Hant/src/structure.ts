...
export default removeUndefinedLocaleResources({
  ...
  'banners.choose-new-document-destination.cannot-create-draft-document': '無法創建草稿文件。',
  /** The explanation displayed when a user attempts to create a new published document, but the schema type doesn't support live-editing */
  'banners.choose-new-document-destination.cannot-create-published-document':
    '無法創建已發布的文件。',
  /** The prompt displayed when a user must select a different perspective in order to create a document */
  'banners.choose-new-document-destination.choose-destination': '選擇此文件的目的地：',
  ...
  'banners.obsolete-draft.draft-model-inactive.text': '工作區未啟用草稿，但此文件的草稿版本存在。',
