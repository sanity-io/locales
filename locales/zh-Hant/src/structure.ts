...
export default removeUndefinedLocaleResources({
  ...
  'action.unpublish.disabled.already-unpublished': '此文件已設定為取消發布',
  ...
  'confirm-delete-dialog.confirm-anyway-button.text_delete_other': '仍然刪除所有版本',
  ...
  'document-target-badges.not-in-target.tooltip': '文件尚未存在於所選的視角中。',
