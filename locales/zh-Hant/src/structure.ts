...
export default removeUndefinedLocaleResources({
  ...
  'banners.variant.not-in-variant':
    '<VariantBadge>{{variantTitle}}</VariantBadge> 目前沒有 <PerspectiveTitle>{{perspectiveTitle}}</PerspectiveTitle> 的 variant 文件。',
  ...
  'document-group-inventory.onboarding-hint': '版本按鈕去哪了？',
  ...
  'document-inspector.error.description': '渲染此面板時發生錯誤。',
  ...
  'document-target-badges.not-in-target.tooltip': '此文件尚未存在於所選的 perspective 中。',
  ...
  'panes.document-list-pane.search-ordering.label': '依 {{order}} 排序',
  ...
  'panes.document-list-pane.search-ordering.summary-relevance': '依相關性排序',
