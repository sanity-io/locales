...
export default removeUndefinedLocaleResources({
  ...
  'action.disabled-by-canvas.tooltip': '由於文檔與Canvas鏈接，某些文檔操作被禁用',
  ...
  'canvas.banner.edit-in-canvas-action': '在Canvas中編輯',
  /** The text for the canvas linked banner when the document is a draft */
  'canvas.banner.linked-text.draft': '此草稿文檔與Canvas鏈接',
  /** The text for the canvas linked banner when the document is a live document */
  'canvas.banner.linked-text.published': '此現行文檔與Canvas鏈接',
  /** The text for the canvas linked banner when the document is a version document */
  'canvas.banner.linked-text.version': '此版本文檔與Canvas鏈接',
  /** The text for the canvas linked banner popover button */
  'canvas.banner.popover-button-text': '了解更多',
  /** The description for the canvas linked banner popover */
  'canvas.banner.popover-description':
    'Canvas允許您在自由形式的編輯器中創作，同時自動映射回Studio作為結構化內容 - 隨著您的輸入。',
  ...
  'panes.document-list-pane.reconnecting': '嘗試重新連接…',
