...
export default removeUndefinedLocaleResources({
  ...
  'banner.release-not-found': '找不到此 release',
  ...
  'confirm-active-scheduled-drafts-dialog.past-dates-warning':
    '部分已排程草稿的排程日期已過。確認排程將立即發布這些版本的文件。',
  ...
  'dashboard.details.metadata.status-validating': '驗證中',
  /** Text for the releases detail screen in the pin release button. */
  'dashboard.details.pin-release': '將 release 固定至 studio',
  ...
  'dashboard.details.unpin-release': '從 studio 取消固定 release',

  /** Label for the button to proceed deleting a release */
  'delete-dialog.confirm-delete-button': '是，刪除 release',
  ...
  'delete-dialog.confirm-delete.header': '您確定要刪除此 release 嗎？',

  /** Label when a release has been deleted by a different user */
  'deleted-release': "'<strong>{{title}}</strong>' release 已被刪除",
  ...
  'document-validation.valid': '無驗證錯誤',
  ...
  'overview.back-to-all-releases': '所有發行版本',
  ...
  'presence.tooltip.one-without-release': '{{displayName}} 目前正在編輯此文件',
  ...
  'schedule-dialog.confirm-description_other':
    '<strong>{{title}}</strong> 版本及其 {{count}} 個文件版本將會被排程。',
  ...
  'table-header.last-edited': '最後編輯時間',
