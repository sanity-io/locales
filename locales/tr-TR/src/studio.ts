...
export default removeUndefinedLocaleResources({
  ...
  'asset-sources.media-library.error.library-could-not-be-resolved':
    'Bu projenin Medya Kütüphanesi çözümlenirken bir hata oluştu.',
  ...
  'release.chip.tooltip.archived': 'Bu sürüm arşivlenmiştir ve düzenlenemez.',
