...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.auto-updates.manage-version': 'Versiyonu yönet',
  ...
  'about-dialog.version-info.new-auto-update-version-available': 'Yeni versiyon mevcut',
  /** "New version" header in version info dialog - Note that this is not necessary a *higher* version compared to current:
   *  It's a new version configured for auto updates which in some cases could even be a version below current  */
  'about-dialog.version-info.new-version.text': 'Yeni versiyon',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'Zamanlanmış taslak belgesi <strong>{{title}}</strong> yeniden planlanamadı: {{error}}',
  /** Success toast for rescheduling a draft */
  'release.toast.reschedule-scheduled-draft.success':
    'Zamanlanmış taslak belgesi <strong>{{title}}</strong> yeniden planlandı.',
