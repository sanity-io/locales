...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.delete-schedule-draft.copy-checkbox':
    'Zamanlanmış değişikliklerimi taslağa kopyalayarak sakla (önerilir)',
  ...
  'releases.upsell.misconfiguration.message':
    'Projeniz için içerik yayınları etkinleştirilmiş, ancak yayın limitlerinizle ilgili bir yapılandırma sorunu var gibi görünüyor. İçerik yayınlarınızın doğru şekilde yapılandırılması için lütfen destek ile iletişime geçin.',
