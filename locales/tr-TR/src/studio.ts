...
export default removeUndefinedLocaleResources({
  ...
  "asset-source.usage-list.documents-using-file_unnamed_one":
    "Bir belge bu dosyayı kullanıyor",
  ...
  "asset-source.usage-list.documents-using-image_unnamed_zero":
    "Hiçbir belge bu resmi kullanmıyor",
  ...
  "calendar.error.must-be-in-format":
    "<Emphasis>{{exampleDate}}</Emphasis> formatında olmalıdır",
  ...
  "changes.array.item-removed-from-position":
    "{{position}} pozisyonundan kaldırıldı",
  ...
  "changes.error-boundary.title":
    "Bu alanın değişikliklerini işlerken bir hata oluştu",
  ...
  "form.error.mixed-array-alert.remove-button.text":
    "Nesne olmayan değerleri kaldır",
  ...
  "inputs.image.actions-menu.edit-details.aria-label":
    "Resim düzenleme diyalogunu aç",
  /** Accessibility label for button to open image options menu */
  "inputs.image.actions-menu.options.aria-label":
    "Resim seçenekleri menüsünü aç",
  /** Select */
  ...
  "inputs.image.hotspot-dialog.title":
    "Odak noktasını ve kırpma alanını düzenle",
  ...
  "inputs.invalid-value.convert-button.text":
    "<code>{{targetType}}</code> dönüştür",
  /** The current value (<code>`{{actualType}}`</code>) */
  "inputs.invalid-value.current-type":
    "Mevcut değer (<code>{{actualType}}</code>)",
  ...
  "inputs.object.unknown-fields.warning.title_other":
    "Bilinmeyen alanlar bulundu",
  /** Collapse the editor to save screen space  */
  "inputs.portable-text.action.collapse-editor":
    "Editörü daraltarak ekran alanından tasarruf edin",
  /** Label for action to edit an existing annotation */
  "inputs.portable-text.action.edit-annotation": "Mevcut açıklamayı düzenle",
  ...
  "inputs.portable-text.action.insert-inline-object-aria-label":
    "{{typeName}} (satır içi) Ekle",
  /** Label for action to remove an annotation */
  "inputs.portable-text.action.remove-annotation": "Notu Kaldır",
  ...
  "inputs.portable-text.invalid-value.orphaned-marks.action":
    "İzin verilmeyen işaretleri kaldır",
  ...
  "inputs.reference.document-opens-in-new-tab":
    "Bu belge yeni bir sekmede açılır",
  ...
  "inputs.reference.error.failed-to-load-document-title":
    "Referans gösterilen belge yüklenemedi",
  ...
  "inputs.reference.error.search-failed-title":
    "Referans araması başarısız oldu",
  /** Alternative text for the image shown in cross-dataset reference input */
  "inputs.reference.image-preview-alt-text":
    "Referans gösterilen belgenin resim önizlemesi",
  ...
  "inputs.reference.preview.edited-at-time":
    "<RelativeTime/> tarihinde düzenlendi",
  ...
  "inputs.reference.preview.published-at-time":
    "<RelativeTime/> tarihinde yayınlandı",
  ...
  "inputs.untyped-value.convert-button.text":
    "<code>{{targetType}}</code> olarak dönüştür",
  ...
  "search.document-types-no-matches-found":
    "{{filter}} için eşleşme bulunamadı",
  ...
  "search.error.display-filter-title":
    "Bu filtre gösterilirken bir hata oluştu.",
  ...
  "search.error.no-valid-asset-source-title":
    "Geçerli varlık kaynakları bulunamadı.",
  ...
  "search.error.unspecified-error-title":
    "Arama yapılırken bir şeyler ters gitti",
  /**
  ...
  "search.operator.date-range.description":
    "<Field/> <Operator> arasındadır </Operator> <Value/>",
  ...
  "search.ordering.created-ascending-label":
    "Oluşturulma: En eskiden başlayarak",
  /** Label for the "Created: Newest first" search ordering type */
  "search.ordering.created-descending-label":
    "Oluşturulma: En yeniden başlayarak",
  /** Label for the "Updated: Oldest first" search ordering type */
  "search.ordering.updated-ascending-label":
    "Güncellenme: En eskiden başlayarak",
  /** Label for the "Updated: Newest first" search ordering type */
  "search.ordering.updated-descending-label":
    "Güncellenme: En yeniden başlayarak",
  ...
  "timeline.error.load-document-changes-description":
    "Belge geçmişi işlemleri etkilenmedi.",
  /** Title for error when the timeline for the given document can't be loaded */
  "timeline.error.load-document-changes-title":
    "Belge değişikliklerini alırken bir hata oluştu.",
  ...
  "timeline.operation.created_timestamp":
    "Oluşturuldu: {{timestamp, datetime}}",
  ...
  "timeline.operation.unpublished_timestamp":
    "Yayından kaldırıldı: {{timestamp, datetime}}",
  /**
