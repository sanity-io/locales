...
export default removeUndefinedLocaleResources({
  ...
  'action.link-document-disabled.version-document':
    "Versiyon belgeleri henüz Canvas'ta desteklenmiyor",
  ...
  'dialog.unlink-from-canvas.description':
    "Bir kez bağlantısı kesildikten sonra, burada düzenlenebilir ve Canvas'taki gelecekteki düzenlemeler bu belgeyle otomatik olarak eşleşmeyecek.",
  ...
  'dialog.unlink-from-canvas.title': "Canvas'tan Bağlantıyı Kes",
