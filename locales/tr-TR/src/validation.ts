...
export default removeUndefinedLocaleResources({
  ...
  "object.reference-not-published":
    "Referans verilen belge yayınlanmış olmalıdır",
  ...
  "string.exact-length":
    "Tam olarak {{wantedLength}} karakter uzunluğunda olmalı",
  ...
  "string.url.disallowed-scheme":
    "İzin verilen protokollerle/şemalarla eşleşmiyor",
