...
export default removeUndefinedLocaleResources({
  ...
  'copy-paste.on-copy.validation.clipboard-not-supported.description':
    'Bu içeriği kopyalamak için panoya erişim gereklidir. Tarayıcı ayarlarınızdan pano izinlerine izin verin, ardından tekrar kopyalamayı deneyin.',
  /** The error message that is shown when the clipboard is not supported */
  ...
  'copy-paste.on-paste.validation.read-only-fields-skipped.description':
    'Atlandı salt okunur alanlar: {{fieldNames}}',
  /** --- On paste --- */
