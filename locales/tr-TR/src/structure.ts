...
export default removeUndefinedLocaleResources({
  ...
  'compare-versions.menu-item.disabled-reason':
    'Karşılaştırılacak bu belgenin başka sürümleri yok.',
  ...
  'panes.document-list-pane.error.retrying': 'Yeniden deneniyor…',
  ...
  /** The help text saying that we'll retry fetching the document list */
  'panes.document-list-pane.error.will-retry-automatically_one': 'Yeniden deneniyor…',
  'panes.document-list-pane.error.will-retry-automatically_other':
    'Yeniden deneniyor… (#{{count}}).',
