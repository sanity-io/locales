...
export default removeUndefinedLocaleResources({
  ...
  "action.delete.disabled.nothing-to-delete":
    "Bu belge henüz mevcut değil veya zaten silinmiş",
  ...
  "action.discard-changes.disabled.no-change":
    "Bu belgede yayımlanmamış değişiklik yok",
  ...
  "action.publish.already-published.tooltip":
    "{{timeSincePublished}} önce yayımlandı",
  ...
  "action.restore.confirm-dialog.confirm-discard-changes":
    "Bu belgeyi geri yüklemek istediğinizden emin misiniz?",
  /** Fallback tooltip for when user is looking at the initial version */
  "action.restore.disabled.cannot-restore-initial":
    "İlk sürüme geri yüklenemez",
  ...
  "banners.reference-changed-banner.reason-changed.reload-button.text":
    "Referansı Yeniden Yükle",
  /** The text for the reference change banner if the reason is that the reference has been changed */
  "banners.reference-changed-banner.reason-changed.text":
    "Bu referansı açtığınızdan beri değişti.",
  ...
  "confirm-delete-dialog.cdr-table.id-copied-toast.title":
    "Belge kimliği panoya kopyalandı!",
  ...
  "confirm-delete-dialog.other-reference-count.title_one":
    "1 diğer referans gösterilmiyor",
  /** Shown if there are references to other documents but the user does not have the permission to see the relevant document IDs */
  ...
  "no-document-types-screen.link-text":
    "Belge tipi nasıl ekleneceğini öğrenin →",
  /** The subtitle of the no document type screen that appears directly below the title */
  "no-document-types-screen.subtitle":
    "Lütfen şemanızda en az bir belge türü tanımlayın.",
  ...
  "pane-item.draft-status.has-draft.tooltip":
  ...
  "pane-item.missing-schema-type.subtitle":
    "Belge: <Code>{{documentId}}</Code>",
  /** The title tor pane item previews if there isn't a matching schema type found */
  "pane-item.missing-schema-type.title":
    "Türü için şema bulunamadı <Code>{{documentType}}</Code>",
  /** The text shown in the tooltip of pane item previews of documents if there are unpublished edits */
  ...
  "panes.document-list-pane.max-items.text":
    "Maksimum {{limit}} belge gösteriliyor",
  ...
  "status-bar.review-changes-button.tooltip.changes-saved":
