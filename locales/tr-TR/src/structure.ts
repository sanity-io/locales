...
export default removeUndefinedLocaleResources({
  ...
  'action.discard-changes.confirm-dialog.confirm-discard-changes-draft':
    'Tüm değişiklikleri iptal etmek ve bu taslak belgeyi silmek istediğinizden emin misiniz?',
  /**Header for the confirm discard dialog */
  'action.discard-changes.confirm-dialog.header.text': 'Değişiklikleri iptal et?',
