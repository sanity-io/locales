...
export default removeUndefinedLocaleResources({
  ...
  'activity.panel.close': 'Aktiviteyi kapat',
  ...
  'archive-info.description':
    '{{retentionDays}} gün boyunca kullanılabilir olacak, ardından {{removalDate}} tarihinde otomatik olarak kaldırılacak. <Link>Saklama hakkında bilgi edinin</Link>.',
  ...
  'banner.confirm-active-scheduled-drafts_one':
    'Zamanlama onayı gerektiren {{count}} Zamanlanmış Taslak var',
  ...
  'banner.drafts-mode-disabled':
    'Taslaklar modu devre dışı bırakıldı ancak hâlâ yayımlanmayı bekleyen zamanlanmış taslaklar var.',
  /** Banner text shown when navigating to a release that does not exist */
  'banner.release-not-found': 'Bu sürüm bulunamadı',
  ...
  'banner.scheduled-drafts-disabled':
    'Zamanlanmış taslaklar devre dışı bırakıldı ancak hâlâ yayımlanmayı bekleyen zamanlanmış taslaklar var.',
  ...
  'confirm-active-scheduled-drafts-dialog.description':
    'Duraklatılmış tüm Zamanlanmış Taslakları hedeflenen yayın tarihlerine göre zamanla',
  /** Dialog warning when some scheduled drafts have past dates */
  'confirm-active-scheduled-drafts-dialog.past-dates-warning':
    'Bu Zamanlanmış Taslakların bir kısmı geçmiş tarihler için zamanlanmış. Zamanlamaları onaylamak, bu belge sürümlerini hemen yayımlayacaktır.',
  /** Dialog title for confirming active scheduled drafts */
  'confirm-active-scheduled-drafts-dialog.title': 'Zamanlanmış Taslakları Sürdür',

  /** Suffix for when a release is a copy of another release */
  'copy-suffix': 'Kopya',

  /** Confirm button text for overriding existing draft */
  'copy-to-draft-dialog.confirm-button': 'Evet, Taslağı geçersiz kıl',
  /** Description for dialog when copying version to draft that already exists */
  'copy-to-draft-dialog.description':
    'Bu belgenin bir taslak sürümü zaten mevcut. Mevcut sürümü taslağa kopyala ve mevcut taslak sürümünü geçersiz kıl.',
  ...
  'dashboard.details.unpin-release': "Sürümün studio'daki sabitlemesini kaldır",

  /** Label for the button to proceed deleting a release */
  'delete-dialog.confirm-delete-button': 'Evet, sürümü sil',
  ...
  'document-validation.valid': 'Doğrulama hatası yok',
  ...
  'overview.back-to-all-releases': 'Tüm sürümler',
  ...
  'presence.tooltip.one-without-release': '{{displayName}} şu anda bu belgeyi düzenliyor',
  ...
  'schedule-unpublish-dialog.header': 'Taslağı Yayından Kaldırmak İçin Zamanla',
  ...
  'toast.copy-release-id.success': 'Release ID panoya kopyalandı',
  /** Toast message after copying release link */
  'toast.copy-release-link.success': 'Release bağlantısı panoya kopyalandı',
  /** Toast message after copying release title */
  'toast.copy-release-title.success': 'Release başlığı panoya kopyalandı',
  /** Description for toast when creating new version of document in release failed */
  'toast.create-version.error': "Belge release'e eklenemedi: {{error}}",
  /** Description for toast when release deletion failed */
  'toast.delete.error': "'<strong>{{title}}</strong>' silinemedi: {{error}}",
  /** Description for toast when release is successfully deleted */
  'toast.delete.success': "'<strong>{{title}}</strong>' release'i başarıyla silindi",
  ...
  'toast.duplicate.success': "'<strong>{{title}}</strong>' release'i çoğaltıldı. <Link/>",
  /** Link text for toast link to the duplicated release */
  'toast.duplicate.success-link': "Çoğaltılan release'i görüntüle",
  ...
  'toast.revert-stage.success-link': "Geri alma release'ini görüntüle",
  /** Text for toast when release failed to revert */
  'toast.revert.error': 'Release geri alınamadı: {{error}}',
  /** Text for toast when release failed to schedule */
  'toast.schedule.error': "'<strong>{{title}}</strong>' zamanlanamadı: {{error}}",
  /** Text for toast when release has been scheduled */
  'toast.schedule.success': "'<strong>{{title}}</strong>' release'i zamanlandı.",
  ...
  'type-picker.tooltip.scheduled':
    'Release zamanlandı, türü değiştirmek için zamanlamayı iptal edin',
  ...
  'unpublish-dialog.action.unpublish': 'Evet, yayımdan kaldır',
  ...
  'unpublish-dialog.description.to-draft':
    "Bu, belgeyi <Label>{{title}}</Label> release'inin bir parçası olarak yayımdan kaldıracak ve release sırasında taslak yoksa bir taslak oluşturacaktır.",
  /** Title for the dialog confirming the unpublish of a release */
  'unpublish-dialog.header':
    'Bu belgeyi yayımlarken yayımdan kaldırmak istediğinizden emin misiniz?',

  /** Text for when a document is unpublished */
  'unpublish.already-unpublished': 'Bu belge zaten yayımdan kaldırılmış.',
  /** Tooltip label for when a document is unpublished */
  'unpublish.no-published-version': 'Bu belgenin yayımlanmış bir sürümü yok.',

  /** Description shown in unschedule relaease dialog */
  'unschedule-dialog.confirm-description': 'Sürüm, planlanan tarihte artık yayımlanmayacak.',
  /** Title for unschedule release dialog */
  'unschedule-dialog.confirm-title':
    'Sürümün zamanlamasını iptal etmek istediğinizden emin misiniz?',
})
