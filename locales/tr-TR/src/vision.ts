...
export default removeUndefinedLocaleResources({
  ...
  'action.save-personal-copy': 'Kişisel kopyayı kaydet',
  /** Label for saving a personal query */
  'action.save-personal-query': 'Kişisel olarak kaydet',
  /** Label for saving a query */
  'action.save-query': 'Sorguyu Kaydet',
  /** Label for saving a shared query */
  'action.save-shared-query': 'Paylaşılan olarak kaydet',
  /** Label for unsharing a query */
  'action.unshare': 'Paylaşımı kaldır',
  ...
  'label.shared': 'Paylaşılan',
  /** Label for saved query type "team" */
  'label.team': 'Takım',
  /** Label for untitled query fallback */
  'label.untitled-query': 'Adsız',
  ...
  'save-query.personal-copy-success': 'Kişisel kopya kaydedildi',
  /** Warning displayed before sharing a query */
  'save-query.share-warning':
    "Paylaşılan sorgular, dataset'inizde belgeler olarak depolanır ve belge kotanıza dahil edilir.",
  /** Save shared query success label */
  'save-query.shared-success': 'Paylaşılan sorgu kaydedildi',
  /** Save success label */
  'save-query.success': 'Sorgu kaydedildi',
  /** Save unshared query success label */
  'save-query.unshared-success': 'Sorgu kişisele taşındı',
  ...
  'settings.api-version-locked-for-variant': 'Bir varyant seçildiğinde, API sürümü vX olmalıdır.',
  ...
  'settings.perspectives.scheduled-drafts': 'Zamanlanmış taslaklar',
