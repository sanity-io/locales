...
export default removeUndefinedLocaleResources({
  ...
  'asset-source.asset-usage-dialog.loading': '正在加載…',
  ...
  'asset-source.delete-dialog.loading': '正在加載…',
  ...
  'asset-source.usage-list.documents-using-file_unnamed_other': '{{count}}份文件正在使用此文件',
  /** Text shown in usage dialog for a file asset when there are zero, one or more documents using the *unnamed* file **/
  'asset-source.usage-list.documents-using-file_unnamed_zero': '沒有文件正在使用此文件',
  ...
  'asset-source.usage-list.documents-using-image_unnamed_other': '{{count}}份文件正在使用此圖片',
  /** Text shown in usage dialog for an image asset when there are zero, one or more documents using the *unnamed* image **/
  'asset-source.usage-list.documents-using-image_unnamed_zero': '沒有文件正在使用此圖片',
  ...
  'calendar.action.go-to-previous-month': '前往上一個月',
  ...
  'changes.error-boundary.title': '渲染此字段的更改時出現錯誤',
  ...
  'changes.no-changes-description':
    '編輯文檔或在時間線中選擇較舊的版本，以在此面板中查看更改列表。',
  ...
  'changes.portable-text.block-style-changed': '區塊樣式從「{{fromStyle}}」更改為「{{toStyle}}」',
  ...
  'changes.portable-text.inline-object_removed': '已移除內聯物件',
  /** Portable Text diff: An inline object was left unchanged */
  'changes.portable-text.inline-object_unchanged': '內聯物件未變更',
  /** Portable Text diff: Added a chunk of text */
  'changes.portable-text.text_added': '已新增文字',
  /** Portable Text diff: Removed a chunk of text */
  'changes.portable-text.text_removed': '已移除文字',
  /** Portable Text diff: Annotation has an unknown schema type */
  'changes.portable-text.unknown-annotation-schema-type': '未知的註釋架構類型',
  /** Portable Text diff: Inline object has an unknown schema type */
  'changes.portable-text.unknown-inline-object-schema-type': '未知的內聯物件架構類型',
  ...
  'form.error.duplicate-keys-alert.details.additional-description':
    '<code>_key</code> 屬性的值必須是唯一的字符串。',
  /** This usually happens when items are created using an API client, and the <code>_key</code> property of each elements has been generated non-uniquely. */
  'form.error.duplicate-keys-alert.details.description':
    '這通常發生在使用 API 客戶端創建項目時，並且每個元素的 <code>_key</code> 屬性生成的不是唯一的。',
  /** Developer info */
  ...
  'form.error.duplicate-keys-alert.summary':
    '此列表中的幾個項目共享相同的標識符（鍵）。每個項目必須有一個唯一的標識符。',
  /** Non-unique keys */
  ...
  'form.error.missing-keys-alert.details.description':
    '這通常發生在使用 API 客戶端創建項目時，並且沒有包括 <code>_key</code> 屬性。',
  /** Developer info */
  'form.error.missing-keys-alert.details.title': '開發者資訊',
  /** Some items in the list are missing their keys. This must be fixed in order to edit the list. */
  'form.error.missing-keys-alert.summary': '列表中的一些項目缺少鍵值。必須修正此問題才能編輯列表。',
  /** Missing keys */
  'form.error.missing-keys-alert.title': '缺失的鍵值',
  /** This usually happens when items are created using an API client, or when a custom input component has added invalid data to the list. */
  'form.error.mixed-array-alert.details.description':
    '這通常發生在使用 API 客戶端創建項目時，或者當自定義輸入組件向列表中添加了無效數據。',
  /** Developer info */
  ...
  'form.error.mixed-array-alert.summary':
    '此列表中的一些項目不是物件。必須修正此問題才能編輯列表。',
  /** Invalid list values */
  'form.error.mixed-array-alert.title': '無效的列表值',
  /** Error text shown when form is unable to find an array item at a given indexed path */
  'form.error.no-array-item-at-index':
    '在路徑 <code>{{path}}</code> 未找到索引 <code>{{index}}</code> 的陣列項目',
  /** Error text shown when form is unable to find an array item at a given keyed path */
  'form.error.no-array-item-at-key':
    '在路徑 <code>{{path}}</code> 未找到 `_key` <code>"{{key}}"</code> 的陣列項目',
   ...
   */
  'help-resources.action.contact-sales': '聯絡銷售部門',
  /**
   * Label for "help and support" call to action
   * These are titles for fallback links in the event the help & resources endpoint isn't able to be fetched
   */
  'help-resources.action.help-and-support': '幫助與支援',
  /**
  ...
  'help-resources.latest-sanity-version': '最新版本為 {{latestVersion}}',
  ...
  'inputs.array.action.add-after': '在後面添加項目',
  /** Label for adding item before a specific array item */
  'inputs.array.action.add-before': '在前面添加項目',
  ...
  'inputs.array.error.cannot-resolve-initial-value-title':
    '無法解析類型為{{schemaTypeTitle}}的初始值：{{errorMessage}}。',
  ...
  'inputs.array.error.current-schema-not-declare-description':
    '當前架構沒有聲明類型為<code>{{typeName}}</code>的項目對此列表有效。這可能意味著該類型已被移除為有效項目類型，或者有人將其添加到尚未部署的本地架構中。',
  ...
  'inputs.array.error.type-is-incompatible-prompt':
    '類型為<code>{{typeName}}</code>的項目對此列表無效',
  ...
  'inputs.array.read-only-label': '此字段為唯讀',
  ...
  'inputs.files.common.drop-message.drop-to-upload-multi_other': '拖放以上傳 {{count}} 個文件',
  ...
  'inputs.files.common.drop-message.drop-to-upload.rejected-file-message_other':
    '{{count}} 個文件無法在此上傳',
  'inputs.files.common.placeholder.cannot-upload-some-files_other': '無法上傳 {{count}} 個文件',
  /** Drag or paste type here */
  'inputs.files.common.placeholder.drag-or-paste-to-upload_file': '拖放或粘貼文件到這裡',
  /** Drag or paste image here */
  'inputs.files.common.placeholder.drag-or-paste-to-upload_image': '拖放或粘貼圖片到這裡',
  /** Drop to upload file */
  'inputs.files.common.placeholder.drop-to-upload_file': '拖放以上傳文件',
  /** Drop to upload image */
  'inputs.files.common.placeholder.drop-to-upload_image': '拖放以上傳圖片',
  /** Read only */
  'inputs.files.common.placeholder.read-only': '只讀',
  /** Can't upload files here */
  'inputs.files.common.placeholder.upload-not-supported': '無法在此上傳文件',
  /** Clear upload */
  'inputs.files.common.stale-upload-warning.clear': '清除上傳',
  /** An upload has made no progress for at least `{{staleThresholdMinutes}}` minutes and likely got interrupted. You can safely clear the incomplete upload and try uploading again. */
  'inputs.files.common.stale-upload-warning.description':
    '至少 {{staleThresholdMinutes}} 分鐘沒有上傳進度，很可能已經中斷。您可以安全地清除未完成的上傳並再次嘗試上傳。',
  /** Incomplete upload */
  'inputs.files.common.stale-upload-warning.title': '未完成的上傳',
  /** Tooltip text for action to crop image */
  'inputs.image.actions-menu.crop-image-tooltip': '裁剪圖片',
  /** Accessibility label for button to open image edit dialog */
  'inputs.image.actions-menu.edit-details.aria-label': '打開圖片編輯對話框',
  /** Accessibility label for button to open image options menu */
  'inputs.image.actions-menu.options.aria-label': '打開圖片選項菜單',
  /** Select */
  'inputs.image.browse-menu.text': '選擇',
  /** Cannot upload this file here */
  'inputs.image.drag-overlay.cannot-upload-here': '無法在此上傳此文件',
  /** Drop image to upload */
  'inputs.image.drag-overlay.drop-to-upload-image': '拖放圖片以上傳',
  /** This field is read only */
  'inputs.image.drag-overlay.this-field-is-read-only': '此字段為唯讀',
  /** Unknown member kind: `{{kind}}` */
  'inputs.image.error.unknown-member-kind': '未知成員類型：{{kind}}',
  /** Edit hotspot and crop */
  'inputs.image.hotspot-dialog.title': '編輯熱點和裁剪',
  /** The value of this field is not a valid image. Resetting this field will let you choose a new image. */
  'inputs.image.invalid-image-warning.description':
    '此字段的值不是有效的圖片。重置此字段將允許您選擇新圖片。',
  /** Reset value */
  'inputs.image.invalid-image-warning.reset-button.text': '重置值',
  /** Invalid image value */
  'inputs.image.invalid-image-warning.title': '圖片值無效',
  /** Preview of uploaded image */
  'inputs.image.preview-uploaded-image': '上傳圖片預覽',
  /** The upload could not be completed at this time. */
  'inputs.image.upload-error.description': '此時無法完成上傳。',
  /** Upload failed */
  ...
  'inputs.invalid-value.description': '屬性值存儲為與預期類型不匹配的值類型。',
  ...
  /** Developer info */
  'inputs.invalid-value.details.title': '開發者信息',
  /** -- Invalid Value Input -- */
  /** Reset value */
  'inputs.invalid-value.reset-button.text': '重置值',
  /** Invalid property value */
  'inputs.invalid-value.title': '屬性值無效',
  /** Field groups */
  'inputs.object.field-group-tabs.aria-label': '字段組',
  /** Read-only field description */
  'inputs.object.unknown-fields.read-only.description':
    '根據文檔的架構，此字段為<strong>唯讀</strong>，不能被取消設置。如果您希望在Studio中能夠取消設置此字段，請確保您從架構中的封閉類型中刪除<code>readOnly</code>字段。',
  /** Remove field */
  'inputs.object.unknown-fields.remove-field-button.text': '移除字段',
  'inputs.object.unknown-fields.warning.description_other': '遇到{{count}}个未在架构中定义的字段。',
  'inputs.object.unknown-fields.warning.details.description_other':
    '这些字段未在文档的架构中定义，这可能意味着字段定义已被移除，或者有人在他们自己的本地项目中添加了这些字段，但尚未部署他们的更改。',
  /** Developer info */
  ...
  'inputs.portable-text.action.insert-block-aria-label': '插入{{typeName}}（区块）',
  ...
  'inputs.portable-text.inline-object.edit': '編輯對象',
  /** Label for action to remove an inline object item */
  'inputs.portable-text.inline-object.remove': '移除對象',
  /** Disclaimer text shown on invalid Portable Text value, when an action is available to unblock the user, but it is not guaranteed to be safe */
  'inputs.portable-text.invalid-value.action-disclaimer':
    '注意：執行上述操作通常是安全的，但如果您有疑問，請聯繫負責配置您工作室的相關人員。',
  /** Action presented when the Portable Text field value is invalid, when block with key `{{key}}` has a child with key `{{childKey}}` of type `{{childType}}` which is not allowed by the schema definition */
  'inputs.portable-text.invalid-value.disallowed-child-type.action': '移除該對象',
  /** Text explaining that the Portable Text field value is invalid, when block with key `{{key}}` has a child with key `{{childKey}}` of type `{{childType}}` which is not allowed by the schema definition */
  'inputs.portable-text.invalid-value.disallowed-child-type.description':
    '鍵為 {{childKey}} 的子項目是鍵為 <code>{{key}}</code> 的塊的類型 <code>{{childType}}</code>，該類型不被模式定義允許。',
  ...
  'inputs.portable-text.invalid-value.disallowed-type.description':
    '鍵為 <code>{{key}}</code> 的塊是類型 <code>{{typeName}}</code>，該類型不被模式定義允許。',
  ...
  'inputs.portable-text.invalid-value.invalid-span-text.description':
    '鍵為 {{childKey}} 的跨度是鍵為 <code>{{key}}</code> 的塊，具有缺失或無效的 <code>text</code> 屬性。',
  ...
  'inputs.portable-text.invalid-value.missing-child-type.action': '移除該對象',
  /** Text explaining that the Portable Text field value is invalid, when block with key `{{key}}` has a child with key `{{childKey}}` which is missing a `_type` property */
  'inputs.portable-text.invalid-value.missing-child-type.description':
    '鍵為 {{childKey}} 的子項目是鍵為 <code>{{key}}</code> 的塊，缺少 <code>_type</code> 屬性。',
  /** Action presented when the Portable Text field value is invalid, when child at `{{index}}` is missing the required `_key` property */
  'inputs.portable-text.invalid-value.missing-key.action': '分配隨機鍵',
  /** Text explaining that the Portable Text field value is invalid, when child at `{{index}}` is missing the required `_key` property */
  'inputs.portable-text.invalid-value.missing-key.description':
    '位於索引<code>{{index}}</code>的區塊缺少必需的<code>_key</code>屬性。',
  ...
  'inputs.portable-text.invalid-value.non-object-child.description':
    '鍵值為<code>{{key}}</code>的區塊中索引為<code>{{index}}</code>的子項不是一個對象。',
  ...
  'inputs.reference.action-create-new-document-select': '創建新的…',
  ...
  'inputs.reference.cross-dataset.feature-disabled-actions':
    '您仍然可以清除這個欄位的現有參考，但只要功能被禁用，就不能更改為不同的文檔。',
  ...
  'inputs.reference.strength-mismatch.is-weak-consquences':
    '這樣可以在不先刪除此參考的情況下刪除被參考的文檔，留下此字段參考一個不存在的文檔。',
  ...
  'inputs.untyped-value.description': '遇到沒有<code>_type</code>屬性的對象值。',
  /** Either remove the <code>name</code> property of the object declaration, or set <code>_type</code> property on items. */
  'inputs.untyped-value.details.description':
    '要麼移除對象聲明的<code>name</code>屬性，要麼在項目上設置<code>_type</code>屬性。',
  /** Current value (<code>object</code>): */
  'inputs.untyped-value.details.json-dump-prefix': '當前值（<code>object</code>）：',
  /** The following types are valid here according to schema: */
  'inputs.untyped-value.details.multi-type-description': '根據架構，以下類型在這裡有效：',
  /** Developer info */
   ...
   */
  'new-document.create-new-document-label': '新文件…',
  /** Placeholder for the "filter" input within the new document menu */
  'new-document.filter-placeholder': '篩選',
  /** Loading indicator text within the new document menu */
  'new-document.loading': '正在加載…',
  /** Accessibility label for the list displaying options in the new document menu */
  'new-document.new-document-aria-label': '新文件',
  ...
  'search.filter-asset-change_file': '更改文件',
  /** Label for the action of changing from one image to a different image in asset search filter */
  'search.filter-asset-change_image': '更改圖片',
  /** Label for the action of clearing the currently selected asset in an image/file filter */
  'search.filter-asset-clear': '清除',
  /** Label for the action of selecting a file in asset search filter */
  'search.filter-asset-select_file': '選擇文件',
  ...
  'search.filter-field-tooltip-name': '字段名稱',
  /** Label for "Used in document types", a list of the document types a field appears in. Shown in tooltip when navigating list of possible fields to filter */
  'search.filter-field-tooltip-used-in-document-types': '用於文檔類型',
  /** Label for when no fields/filters are found for the given term */
  'search.filter-no-matches-found': '沒有符合{{filter}}的匹配項',
  ...
  'search.no-results-help-description': '嘗試另一個關鍵詞或調整您的篩選器',
  ...
  'search.operator.array-reference-includes.description':
    '<Field/> <Operator>包括</Operator> <Value>{{value}}</Value>',
  'search.operator.array-reference-includes.name': '包括',
  /* Array should not include the given reference */
  'search.operator.array-reference-not-includes.description':
    '<Field/> <Operator>不包括</Operator> <Value>{{value}}</Value>',
  'search.operator.array-reference-not-includes.name': '不包括',
  ...
  'search.operator.date-range.description': '<Field/> <Operator>在之間</Operator> <Value/>',
  'search.operator.date-range.name': '介乎於',
  ...
  'search.operator.date-time-range.description': '<Field/> <Operator>介乎於</Operator> <Value/>',
  'search.operator.date-time-range.name': '介乎於',
  ...
  'search.operator.number-range.name': '介乎於',
  ...
  'timeline.error.no-document-history-description': '更改文檔內容時，文檔版本將顯示在此菜單中。',
