...
export default removeUndefinedLocaleResources({
  ...
  'action.delete.disabled.not-ready': '操作未準備好',
  ...
  'action.discard-changes.disabled.not-published': '此文件未發布',
  /** Tooltip when action button is disabled because the operation is not ready   */
  'action.discard-changes.disabled.not-ready': '操作未準備好',
  /** Label for the "Discard changes" document action */
  'action.discard-changes.label': '放棄更改',
  /** Tooltip when action is disabled because the operation is not ready   */
  'action.duplicate.disabled.not-ready': '操作未準備好',
  ...
  'action.publish.disabled.not-ready': '操作未準備好',
  /** Label for action when there are pending changes.*/
  'action.publish.draft.label': '發布',
  /** Label for the "Publish" document action when the document has live edit enabled.*/
  'action.publish.live-edit.label': '發布',
  /** Fallback tooltip for the "Publish" document action when publish is invoked for a document with live edit enabled.*/
  'action.publish.live-edit.publish-disabled': '由於此文件類型啟用了實時編輯，因此無法發布',
  /** Tooltip for the "Publish" document action when the document has live edit enabled.*/
  'action.publish.live-edit.tooltip': '此內容類型已啟用實時編輯，您進行更改時將自動發布',
  ...
  'action.publish.validation-issues.tooltip': '在可以發布此文件之前，需要修復驗證錯誤',
  /** Tooltip when publish button is waiting for validation and async tasks to complete.*/
  'action.publish.waiting': '等待任務完成後才發布',
  /** Message prompting the user to confirm that they want to restore to an earlier version*/
  'action.restore.confirm-dialog.confirm-discard-changes': '您確定要還原此文件嗎？',
  ...
  'action.unpublish.live-edit.disabled': '此文件已啟用即時編輯，不能被取消發布',
  ...
  'banners.reference-changed-banner.reason-removed.text': '自您打開它以來，此引用已被移除。',
  ...
  'confirm-delete-dialog.confirm-anyway-button.text_delete': '無論如何刪除',
  /** The text in the "Unpublish anyway" button in the confirm delete dialog that confirms the action */
  'confirm-delete-dialog.confirm-anyway-button.text_unpublish': '無論如何取消發布',
  ...
  'document-view.form-view.sync-lock-toast.description':
    '文件同步時請稍候。這通常在文件發布後立即發生，並且不應該超過幾秒鐘',
  ...
  /** The text shown in the tooltip of pane item previews of documents if there are unpublished edits */
  'pane-item.published-status.has-published.tooltip': '已於<RelativeTime/>發布',
  /** The text shown in the tooltip of pane item previews of documents if there are no unpublished edits */
  ...
  'panes.document-list-pane.no-matching-documents.text': '無匹配文件',
  ...
  'panes.document-pane-provider.reconnecting.title': '連接丟失。正在重新連接…',
  ...
  'production-preview.menu-item.title': '打開預覽',
