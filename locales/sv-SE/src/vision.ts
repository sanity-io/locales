...
export default removeUndefinedLocaleResources({
  ...
  'settings.perspectives.new-default.description':
    'Standardperspektivet kommer att ändras från "<code>raw</code>" till "<code>published</code>" i en kommande API-version. Vänligen se dokumentationen för mer information.',
