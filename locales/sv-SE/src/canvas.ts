...
export default removeUndefinedLocaleResources({
  ...
  'action.link-document-disabled.missing-permissions':
    'Du har inte behörighet att länka detta dokument till Canvas',
  /** The text for the "Link to Canvas" action when the document is not in the dashboard. */
  'action.link-document-disabled.not-in-dashboard':
    'Öppna detta dokument i Dashboard för att länka till Canvas',
  ...
  'banner.linked-to-canvas': 'Detta dokument är länkat till Canvas',
  ...
  'dialog.unlink-from-canvas.description':
    'När det är avlänkat kommer det att vara redigerbart här och framtida redigeringar i Canvas kommer inte längre att automatiskt mappa till detta dokument.',
