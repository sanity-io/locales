...
export default removeUndefinedLocaleResources({
  ...
  'archive-info.description':
    'Den kommer att vara tillgänglig i {{retentionDays}} dagar och tas sedan automatiskt bort den {{removalDate}}. <Link>Läs om lagring</Link>.',
  ...
  'banner.drafts-mode-disabled':
    'Utkastsläget har inaktiverats men det finns fortfarande schemalagda utkast som ska publiceras.',
  /** Banner text shown when navigating to a release that does not exist */
  'banner.release-not-found': 'Den här versionen kunde inte hittas',
  ...
  'banner.scheduled-drafts-disabled':
    'Scheduled drafts har inaktiverats men det finns fortfarande schemalagda utkast som ska publiceras.',
  ...
  'copy-to-draft-dialog.confirm-button': 'Ja, skriv över utkast',
  ...
  'dashboard.details.pin-release': 'Fäst version i studio',
  ...
  'dashboard.details.unpin-release': 'Lossa version från studio',

  /** Label for the button to proceed deleting a release */
  'delete-dialog.confirm-delete-button': 'Ja, ta bort version',
  ...
  'deleted-release': "'<strong>{{title}}</strong>'-releasen har raderats",
  ...
  'discard-version-dialog.description-release':
    "Detta kommer permanent att ta bort alla ändringar som gjorts i det här dokumentet inom '<strong>{{releaseTitle}}</strong>'-releasen. Denna åtgärd kan inte ångras.",
  ...
  'discard-version-dialog.header-release':
    "Ta bort dokumentet från '<strong>{{releaseTitle}}</strong>'-releasen?",
  /** Title for dialog for discarding a draft of a document */
  ...
  'toast.copy-release-link.success': 'Release-länk kopierad till urklipp',
  /** Toast message after copying release title */
  'toast.copy-release-title.success': 'Release-titel kopierad till urklipp',
  /** Description for toast when creating new version of document in release failed */
  'toast.create-version.error': 'Det gick inte att lägga till dokumentet i release: {{error}}',
  /** Description for toast when release deletion failed */
  'toast.delete.error': "Det gick inte att ta bort '<strong>{{title}}</strong>': {{error}}",
  /** Description for toast when release is successfully deleted */
  'toast.delete.success': "Release '<strong>{{title}}</strong>' togs bort.",
  ...
  'toast.duplicate.success': "Release '<strong>{{title}}</strong>' duplicerades. <Link/>",
  ...
  'toast.immediate-revert.success': "Release '{{title}}' återställdes.",
  ...
  'toast.revert.error': 'Det gick inte att återställa release: {{error}}',
  /** Text for toast when release failed to schedule */
  'toast.schedule.error': "Det gick inte att schemalägga '<strong>{{title}}</strong>': {{error}}",
  /** Text for toast when release has been scheduled */
  'toast.schedule.success': "Release '<strong>{{title}}</strong>' schemalagdes.",
  ...
  'unpublish-dialog.action.unpublish': 'Ja, avpublicera vid release',
  ...
  'unpublish-dialog.description.to-draft':
    'Detta kommer att avpublicera dokumentet som en del av releasen <Label>{{title}}</Label> och skapa ett utkast om inget utkast finns vid tidpunkten för releasen.',
  /** Title for the dialog confirming the unpublish of a release */
  'unpublish-dialog.header':
    'Är du säker på att du vill avpublicera det här dokumentet vid release?',
