...
export default removeUndefinedLocaleResources({
  ...
  'action.discard-changes.confirm-dialog.confirm-discard-changes-draft':
    'Är du säker på att du vill kasta alla ändringar och radera detta utkastdokument?',
  /**Header for the confirm discard dialog */
  'action.discard-changes.confirm-dialog.header.text': 'Kasta ändringar?',
  ...
  'canvas.banner.editable.popover-description':
    'Canvas låter dig skriva fritt, sedan uppdatera innehåll i Studio utan manuell kopiering fält-för-fält.',
  /** The heading for the canvas linked banner popover in editable mode*/
  'canvas.banner.editable.popover-heading': 'Fritt formulerat skrivande',
