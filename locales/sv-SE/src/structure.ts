...
export default removeUndefinedLocaleResources({
  ...
  "action.discard-changes.disabled.no-change":
    "Detta dokument har inga opubliserade ändringar",
  /** Tooltip when action is disabled because the document is not published */
  "action.discard-changes.disabled.not-published":
    "Detta dokument är inte publicerat",
  /** Tooltip when action button is disabled because the operation is not ready   */
  ...
  "action.publish.already-published.tooltip":
    "Publicerad för {{timeSincePublished}} sedan",
  ...
  "action.publish.waiting":
    "Väntar på att uppgifter ska slutföras innan publicering",
  /** Message prompting the user to confirm that they want to restore to an earlier version*/
  "action.restore.confirm-dialog.confirm-discard-changes":
    "Är du säker på att du vill återställa detta dokument?",
  ...
  "confirm-delete-dialog.cdr-table.id-copied-toast.title":
    "Kopierade dokument-ID till urklipp!",
  ...
  "no-document-types-screen.link-text":
    "Lär dig hur du lägger till en dokumenttyp →",
  /** The subtitle of the no document type screen that appears directly below the title */
  "no-document-types-screen.subtitle":
    "Vänligen definiera minst en dokumenttyp i ditt schema.",
  ...
  "pane-item.published-status.has-published.tooltip":
    "Publicerad <RelativeTime/>",
  /** The text shown in the tooltip of pane item previews of documents if there are no unpublished edits */
  "pane-item.published-status.no-published.tooltip":
    "Inga opublicerade ändringar",
  ...
  "panes.document-operation-results.operation-error":
    "Ett fel inträffade under {{context}}",
  ...
  "panes.document-operation-results.operation-success":
    "Lyckades utföra {{context}} på dokumentet",
  /** The text when a delete operation succeded  */
  "panes.document-operation-results.operation-success_delete":
    "Dokumentet raderades framgångsrikt",
  ...
  "panes.document-pane-provider.reconnecting.title":
    "Anslutningen förlorad. Återansluter…",
