...
export default removeUndefinedLocaleResources({
  ...
  'action.unpublish.disabled.already-unpublished':
    'Detta dokument är redan inställt på att avpubliceras',
  ...
  'banners.obsolete-draft.actions.compare-draft.tooltip':
    'Det publicerade dokumentet finns inte, så det här utkastet kan inte jämföras.',
  ...
  'compare-version.error.loadVersions.title': 'Det gick inte att läsa in versioner',
  ...
  'confirm-delete-dialog.confirm-anyway-button.text_delete_one': 'Ta bort ändå',
  /** The text in the "Delete anyway" button when the document has multiple versions */
  'confirm-delete-dialog.confirm-anyway-button.text_delete_other': 'Ta bort alla versioner ändå',
  ...
  'confirm-delete-dialog.confirm-button.text_delete_one': 'Ta bort dokument',
  /** The text in the "Delete now" button when the document has multiple versions */
  'confirm-delete-dialog.confirm-button.text_delete_other': 'Ta bort alla versioner',
  ...
  'confirm-delete-dialog.confirmation.text_delete_one':
    'Är du säker på att du vill ta bort detta dokument?',
  /** The confirmation text when the document has multiple versions */
  'confirm-delete-dialog.confirmation.text_delete_other':
    'Är du säker på att du vill ta bort alla versioner av detta dokument?',
  /** If no referring documents are found, this text appears above the cancel and confirmation buttons */
  ...
  'panes.document-operation-results.operation-success_unpublishVersion':
    'Versionen kommer att avpubliceras när utgåvan publiceras',
