...
export default removeUndefinedLocaleResources({
  ...
  'confirm-delete-dialog.confirm-anyway-button.text_delete_one': 'Radera trots allt',
  ...
  'confirm-delete-dialog.confirm-anyway-button.text_delete_other':
    'Radera alla versioner trots allt',
  ...
  'confirm-delete-dialog.confirm-button.text_delete_one': 'Radera dokument',
  /** The text in the "Delete now" button when the document has multiple versions */
  'confirm-delete-dialog.confirm-button.text_delete_other': 'Radera alla versioner',
  ...
  'confirm-delete-dialog.confirmation.text_delete_one':
    'Är du säker på att du vill radera detta dokument?',
  /** The confirmation text when the document has multiple versions */
  'confirm-delete-dialog.confirmation.text_delete_other':
    'Är du säker på att du vill radera alla versioner av detta dokument?',
  /** If no referring documents are found, this text appears above the cancel and confirmation buttons */
