...
export default removeUndefinedLocaleResources({
  ...
  /** The text that appears for the action button to add the current document to the global release */
  'banners.release.action.open-to-edit': 'Öppna release för redigering',
  ...
  'compare-version.error.invalidNextDocumentParam': 'Parametern för nästa dokument är ogiltig.',
  ...
  'compare-version.error.invalidPreviousDocumentParam':
    'Parametern för föregående dokument är ogiltig.',
