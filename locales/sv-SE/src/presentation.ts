...
export default removeUndefinedLocaleResources({
  ...
  'preview-frame.configuration.error.title': 'Förhandsgranskningens URL-ursprung stämmer inte',
  ...
  'preview-location-input.error_missing-origin': 'URL måste börja med {{origin}}',
  ...
  'preview-location-input.error_same-base-path':
    'URL kan inte ha samma bassökväg som Studio {{basePath}}',
  ...
  'share-preview-menu.error_toggle-sharing':
    'Du har inte behörighet att aktivera eller inaktivera delning av den här förhandsgranskningen',
