...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.delete-schedule-draft.body':
    'Är du säker på att du vill ta bort det schemalagda utkastet? Denna åtgärd kan inte ångras.',
  ...
  'release.menu.label': 'Utgivningsmeny',
  ...
  'release.schedule-dialog.publish-date-in-past-warning':
    'Schemalägg denna utgivning för en framtida tid och datum.',
