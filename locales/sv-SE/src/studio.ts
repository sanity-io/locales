...
export default removeUndefinedLocaleResources({
  ...
  "asset-source.usage-list.documents-using-file_unnamed_one":
    "Ett dokument använder denna fil",
  ...
  "asset-source.usage-list.documents-using-file_unnamed_zero":
    "Inga dokument använder denna fil",
  ...
  "asset-source.usage-list.documents-using-image_unnamed_one":
    "Ett dokument använder denna bild",
  ...
  "calendar.error.must-be-in-format":
    "Måste vara i formatet <Emphasis>{{exampleDate}}</Emphasis>",
  ...
  "changes.array.item-removed-from-position":
    "Borttagen från position {{position}}",
  ...
  "changes.error-boundary.developer-info":
    "Kontrollera utvecklarkonsolen för mer information",
  /** Text shown when a diff component crashes during rendering, triggering the error boundary */
  "changes.error-boundary.title":
    "Att rendera ändringarna för detta fält orsakade ett fel",
  ...
  "help-resources.latest-sanity-version":
    "Senaste versionen är {{latestVersion}}",
  ...
  "inputs.array.error.json-representation-description":
    "JSON-representation av detta objekt:",
  ...
  "inputs.file.upload-failed.description":
    "Uppladdningen kunde inte slutföras just nu.",
  /** Upload failed */
  ...
  "inputs.files.common.actions-menu.notification.url-copied":
    "URL:en är kopierad till urklipp",
  /** Replace */
  ...
  "inputs.files.common.placeholder.drag-or-paste-to-upload_file":
    "Dra eller klistra in filen här",
  ...
  "inputs.invalid-value.convert-button.text":
    "Konvertera till <code>{{targetType}}</code>",
  /** The current value (<code>`{{actualType}}`</code>) */
  "inputs.invalid-value.current-type":
    "Det aktuella värdet (<code>{{actualType}}</code>)",
  ...
  "inputs.portable-text.action.collapse-editor":
    "Fäll ihop redigeraren för att spara skärmutrymme",
  /** Label for action to edit an existing annotation */
  "inputs.portable-text.action.edit-annotation": "Redigera anteckning",
  ...
  "inputs.portable-text.action.insert-inline-object-aria-label":
    "Infoga {{typeName}} (inline)",
  /** Label for action to remove an annotation */
  "inputs.portable-text.action.remove-annotation": "Ta bort anteckning",
  ...
  "inputs.reference.document-opens-in-new-tab":
    "Detta dokument öppnas i en ny flik",
  ...
  "inputs.reference.image-preview-alt-text":
    "Bildförhandsvisning av refererat dokument",
  ...
  "inputs.reference.no-results-for-query":
    "Inga resultat för <strong>“{{searchTerm}}”</strong>",
  ...
  "inputs.untyped-value.details.json-dump-prefix":
    "Nuvarande värde (<code>objekt</code>):",
  ...
  "new-document.no-results":
    "Inga resultat för <strong>{{searchQuery}}</strong>",
  ...
  "preview.image.file-is-being-uploaded.alt-text":
    "Bilden som för närvarande laddas upp",
  ...
  "search.error.display-filter-title":
    "Ett fel uppstod vid visning av detta filter.",
  ...
  "search.error.no-valid-asset-source-title":
    "Inga giltiga källor för tillgångar hittades.",
  /** Helpful description for when search returned an error that we are not able to describe in detail */
  "search.error.unspecified-error-help-description":
    "Försök igen eller kontrollera din anslutning",
  ...
  "search.no-results-help-description":
    "Prova ett annat sökord eller justera dina filter",
  ...
  "search.operator.date-range.description":
    "<Field/> <Operator>är mellan</Operator> <Value/>",
  ...
  "search.operator.defined.description":
    "<Field/> <Operator>är</Operator> <Value>inte tom</Value>",
  "search.operator.defined.name": "inte tom",
  /* Value should not be defined */
  "search.operator.not-defined.description":
    "<Field/> <Operator>är</Operator> <Value>tom</Value>",
