...
export default removeUndefinedLocaleResources({
  ...
  'inputs.imagetool.vector-warning.developer-info':
    "Asset Pipeline stöder inte hotspot och beskärning för vektorformat. För att aktivera hotspot & beskärning, exportera denna bild till något av de stödda rasterformaten. Till exempel: <code>fm=jpg</code> till <ImageUrlDocumentationLink>bildens URL</ImageUrlDocumentationLink> eller anropa <code>.format('png')</code> med <ImageUrlPackageDocumentationLink>@sanity/image-url</ImageUrlPackageDocumentationLink>.",
  /** See developer info */
