...
export default removeUndefinedLocaleResources({
  ...
  'asset-sources.media-library.error.library-could-not-be-resolved':
    'Något gick fel när man försökte lösa Media Library för detta projekt.',
  ...
  'asset-sources.media-library.info.provisioning':
    'Vänligen vänta medan vi förbereder ditt Media Library',
  ...
  'release.toast.archived-release.description': 'Denna release har blivit avnålad',
  ...
  'release.toast.published-release.description': 'Denna release har blivit avnålad',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.published-release.title': "Releasen '{{title}}' publicerades",
