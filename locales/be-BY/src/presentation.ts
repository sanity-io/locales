...
export default removeUndefinedLocaleResources({
  ...
  'error-card.continue-button.text': 'Працягнуць у любым выпадку',
  ...
  'preview-frame.continue-button.text': 'Працягнуць у любым выпадку',
  /** The label for the loader's connection status */
  'preview-frame.loader.connection-status.label': 'Статус падключэння загрузчыка',
  ...
  'preview-frame.overlay.connection-status.label': 'Статус злучэння overlay',
  ...
  'preview-frame.overlay.toggle-button.tooltip_disable': 'Адключыць overlay рэдагавання',
  /** The text shown on the overlay toggle tooltip when overlays are disabled */
  'preview-frame.overlay.toggle-button.tooltip_enable': 'Уключыць overlay рэдагавання',
  ...
  'preview-frame.refresh-button.aria-label': 'Абнавіць прагляд',
  /** The tooltip text for the refresh button */
  'preview-frame.refresh-button.tooltip': 'Абнавіць прагляд',
  /** The `aria-label` for the button that opens the share menu */
  'preview-frame.share-button.aria-label': 'Падзяліцца гэтым праглядам',
  ...
  'preview-search-param.configuration.error.title': 'Заблакаваны URL прагляду',
  ...
  'preview-url-secret.missing-grants':
    'У вас няма дазволу на стварэнне сакрэтаў URL прагляду. Гэта, верагодна, прывядзе да збою загрузкі прагляду.',

  /** Menu item in the share preview menu that allows copying the current preview URL, if sharing is enabled */
  'share-preview-menu.copy-url.text': 'Скапіяваць спасылку прагляду',
  /** Fallback message shown when the current user is not permitted to share previews */
  'share-preview-menu.error_missing-grants': 'У вас няма дазволу на абмен праглядамі. ',
  ...
  'share-preview-menu.error_toggle-sharing':
    'У вас няма дазволу на пераключэнне абмену гэтым праглядам',
  ...
  'share-preview-menu.toggle-button.label_first-line': 'Падзяліцца гэтым папярэднім праглядам',
