...
export default removeUndefinedLocaleResources({
  ...
  'preview-search-param.configuration.error.description':
    'Маршрутызатар хоча перайсці да <Code>{{previewSearchParam}}</Code>, але паходжанне <Code>{{blockedOrigin}}</Code> не дазволена. Абнавіце канфігурацыю <Code>presentationTool.allowOrigins</Code>, каб дазволіць яго.',
