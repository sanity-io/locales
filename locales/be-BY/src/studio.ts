...
export default removeUndefinedLocaleResources({
  ...
  'release.action.view-release': 'Прагледзець рэліз',
  ...
  'release.chip.tooltip.not-published': 'Не апублікаваны',
  ...
  'release.dialog.tooltip.description':
    'Прыблізны час рэлізу выкарыстоўваецца для стварэння лепшых папярэдніх праглядаў і падказак аб магчымых канфліктах дакументаў.',
  ...
  'release.toast.create-release-error.title': 'Не атрымалася стварыць рэліз',
  /**The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.not-found-release.title': "Выпуск '{{title}}' не можа быць знойдзены",
  ...
  'release.tooltip.locked':
    'Гэты выпуск быў запланаваны. Адмяніце планаванне, каб дадаць больш дакументаў.',
