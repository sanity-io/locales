...
export default removeUndefinedLocaleResources({
  ...
  'document-group-inventory.feedback.sentiment-label':
    'Наколькі лёгка або складана карыстацца новай версіяй інвентара?',
  ...
  'document-group.delete.error.message':
    'Адбылася памылка пры спробе выдаліць гэты дакумент. Звычайна гэта азначае, што існуюць іншыя дакументы, якія спасылаюцца на яго.',
  ...
  'document-group.delete.other-reference-count.tooltip':
    'Мы не можам адлюстраваць метаданыя для гэтых спасылак з-за адсутнасці токена доступу для звязаных datasets.',
  ...
  'inputs.portable-text.table.add-column': 'Дадаць слупок у канец',
  /** Label for the table lane that appends a row */
  'inputs.portable-text.table.add-row': 'Дадаць радок у канец',
  ...
  'login.logged-out.generic': 'Ваша сесія больш не дзейнічае. Калі ласка, увайдзіце зноў.',
  /** Body of the logged-out banner shown above the login form when the session expired */
  'login.logged-out.session-expired':
    'Тэрмін дзеяння вашай сесіі скончыўся. Калі ласка, увайдзіце зноў.',
