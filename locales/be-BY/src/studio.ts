...
export default removeUndefinedLocaleResources({
  ...
  'asset-source.dialog.insert-asset-error':
    'Памылка пры ўстаўцы актыву. Глядзіце кансоль для атрымання дадатковай інфармацыі.',
  ...
  'inputs.files.common.placeholder.select-asset-source-upload-destination': 'Загрузіце файлы ў:',
  ...
  'inputs.reference.global.invalid-type': 'Згаданы дакумент мае няправільны тып ({{typeName}})',
