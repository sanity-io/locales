...
export default removeUndefinedLocaleResources({
  ...
  'document-group.create-variant.target-releases': 'У выпуск',
  ...
  'release.dialog.edit.title': 'Рэдагаваць выпуск',
  ...
  'release.toast.edit-release-error.title': 'Не ўдалося захаваць дэталі выпуску',
  ...
  'user-menu.action.claim-project': 'Заявіць правы на гэты праект',
