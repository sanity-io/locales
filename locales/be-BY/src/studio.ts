...
export default removeUndefinedLocaleResources({
  ...
  'releases.upsell.misconfiguration.message':
    'Выпускі кантэнту ўключаны для вашага праекта, але ёсць праблема з канфігурацыяй лімітаў выпускаў. Калі ласка, звярніцеся ў службу падтрымкі, каб правільна наладзіць выпускі вашага кантэнту.',
