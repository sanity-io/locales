...
export default removeUndefinedLocaleResources({
  ...
  'asset-sources.media-library.select-dialog.title': 'Выбар {{assetType}} для {{targetTitle}}',
  /** Warning message shown when uploading already existing files to the Media Library Asset Source */
  'asset-sources.media-library.warning.file-already-exist.description':
    'Выкарыстанне існуючага файла з бібліятэкі.',
  ...
  'help-resources.studio-auto-update-now': 'Перазагрузіць для абнаўлення да версіі v{{newVersion}}',
  ...
  'release.dialog.delete-schedule-draft.body':
    'Вы ўпэўнены, што хочаце выдаліць гэты запланаваны чарнавік? Гэта дзеянне нельга адмяніць.',
  /** Confirm button text for deleting a scheduled draft */
  'release.dialog.delete-schedule-draft.confirm': 'Так, выдаліць расклад',
  /** Header for the dialog confirming deletion of a scheduled draft */
  'release.dialog.delete-schedule-draft.header': 'Выдаленне запланаванага чарнавіка',
  ...
  'release.schedule-dialog.publish-date-in-past-warning':
    'Заплануйце гэты выпуск на будучы час і дату.',
  /** Label for date picker when scheduling a release */
  'release.schedule-dialog.select-publish-date-label': 'Запланаваць на',
  ...
  'release.toast.delete-schedule-draft.error':
    'Не ўдалося выдаліць запланаваны чарнавік дакумента <strong>{{title}}</strong>: {{error}}',
  /** Success toast for deleting a scheduled draft */
  'release.toast.delete-schedule-draft.success':
    'Запланаваны чарнавік дакумента <strong>{{title}}</strong> быў выдалены.',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.not-found-release.title': "Рэліз '{{title}}' не можа быць знойдзены",
  /** Error toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.error':
    'Не ўдалося апублікаваць запланаваны чарнавік дакумента <strong>{{title}}</strong>: {{error}}',
  /** Success toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.success':
    'Запланаваны чарнавік дакумента <strong>{{title}}</strong> быў апублікаваны.',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'Не ўдалося перанесці запланаваны чарнавік дакумента <strong>{{title}}</strong>: {{error}}',
  /** Success toast for rescheduling a draft */
  'release.toast.reschedule-scheduled-draft.success':
    'Запланаваны чарнавік дакумента <strong>{{title}}</strong> быў перанесены.',
  ...
  'workspaces.action.switch-workspace': 'Пераключыць працоўную прастору',
