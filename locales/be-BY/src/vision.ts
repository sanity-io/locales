...
export default removeUndefinedLocaleResources({
  ...
  'query.error.unsupported-release-perspective':
    'Гэтая версія API не падтрымлівае складаныя перспектывы. Выкарыстоўвайце {{apiVersion}} або навейшую.',
  /** Extra explanation when a 400 is returned for a variant on an incompatible API version */
  'query.error.unsupported-variant':
    'Гэтая версія API не падтрымлівае варыянты кантэнту. Выкарыстоўвайце эксперыментальную версію API ({{apiVersion}}).',
