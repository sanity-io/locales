...
export default removeUndefinedLocaleResources({
  ...
  'action.link-document-disabled.initial-value-not-resolved':
    'Калі ласка, пачакайце, пакуль не будуць вырашаны пачатковыя значэнні дакумента',
  /** The text for the "Link to Canvas" action when the user doesn't have permissions to link the document to Canvas. */
  'action.link-document-disabled.missing-permissions':
    'У вас няма дазволу спасылаць гэты дакумент на Canvas',
  ...
  'dialog.link-to-canvas.redirecting': 'Перанакіроўваем вас на Canvas для завяршэння спасылкі...',
