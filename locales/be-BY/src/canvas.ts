...
export default removeUndefinedLocaleResources({
  ...
  'action.link-document-disabled.initial-value-not-resolved':
    'Калі ласка, пачакайце, пакуль будуць вызначаны пачатковыя значэнні дакумента',
  /** The text for the "Link to Canvas" action when the user doesn't have permissions to link the document to Canvas. */
  'action.link-document-disabled.missing-permissions':
    'У вас няма дазволаў для спасылкі гэтага дакумента на Canvas',
  /** The text for the "Link to Canvas" action when the document is not in the dashboard. */
  'action.link-document-disabled.not-in-dashboard':
    'Адкрыйце гэты дакумент у Dashboard, каб стварыць спасылку на Canvas',
  ...
  'banner.linked-to-canvas': 'Гэты дакумент злучаны з Canvas',
  ...
  'dialog.confirm-document-changes.description':
    'Гэты дакумент патрабуе абнаўлення, каб быць сумяшчальным з Canvas.\n Існуючы змест можа быць адрэдагаваны або выдалены ў рамках гэтага працэсу.',
  ...
  'dialog.link-to-canvas.error': 'Не атрымалася стварыць спасылку на Canvas',
  /** The text for the "Link to Canvas" dialog when the document is being redirected. */
  'dialog.link-to-canvas.redirecting': 'Перанакіроўваем вас у Canvas для завяршэння злучэння...',
  ...
  'dialog.unlink-from-canvas.description':
    'Пасля адлучэння дакумент будзе даступны для рэдагавання тут, і будучыя змены ў Canvas больш не будуць аўтаматычна перадавацца ў гэты дакумент.',
  /** The text for the "Unlink from Canvas" dialog error message. */
  'dialog.unlink-from-canvas.error': 'Не атрымалася адлучыць ад Canvas',
