...
export default removeUndefinedLocaleResources({
  ...
  'action.copy-release-id.label': 'Скапіяваць ID release',
  /** Menu item label for copying release URL */
  'action.copy-release-link.label': 'Скапіяваць URL release',
  /** Menu item label for copying release title */
  'action.copy-release-title.label': 'Скапіяваць назву release',
  /** Tooltip for copy release actions button */
  'action.copy-release.label': 'Скапіяваць',
  ...
  'activity.panel.close': 'Закрыць актыўнасць',
  ...
  'confirm-active-scheduled-drafts-dialog.confirm-button': 'Пацвердзіць расклады',
  ...
  'confirm-active-scheduled-drafts-dialog.past-dates-warning':
    'Некаторыя з гэтых Scheduled Drafts запланаваны на мінулыя даты. Пацверджанне расклада адразу апублікуе гэтыя версіі дакументаў.',
  ...
  'document-validation.valid': 'Няма памылак праверкі',
  ...
  'overview.back-to-all-releases': 'Усе рэлізы',
  ...
  'permissions.error.discard-version': 'У вас няма дазволу на адмену гэтай версіі',
  ...
  'presence.tooltip.one-without-release': '{{displayName}} зараз рэдагуе гэты дакумент',
  ...
  'publish-dialog.confirm-publish-description_one':
    "Release '<strong>{{title}}</strong>' і яго дакумент будуць апублікаваны.",
  /** Title for the dialog confirming the publish of a release */
  'publish-dialog.confirm-publish.title':
    'Вы ўпэўнены, што хочаце апублікаваць release і ўсе версіі дакументаў?',
  /** Label for the checkbox in the publish confirmation dialog for also updating existing drafts to match the release */
  'publish-dialog.confirm-publish.update-drafts-checkbox': 'Абнавіць існуючыя чарнавікі',
  ...
  'publish-dialog.confirm-publish.update-drafts-description_one':
    'Існуючы чарнавік {{draftDocumentsLength}} дакумента будзе выдалены, каб чарнавікі адпавядалі апублікаванаму release. Неапублікаваныя змены ў чарнавіку будуць страчаны.',
  ...
  'publish-info.title': 'Гэты release паспяхова апублікаваны.',
  ...
  'revert-dialog.confirm-revert.stage-revert-checkbox-label': 'Неадкладна адкаціць release',
  /** Title for the dialog confirming the revert of a release */
  'revert-dialog.confirm-revert.title': "Вы ўпэўнены, што хочаце адкаціць release '{{title}}'?",
  /** Warning card text for when immediately revert a release with history */
  'revert-dialog.confirm-revert.warning-card':
    'Пасля публікацыі ў дакументы гэтага release былі ўнесены змены. Адкат перазапіша гэтыя змены.',

  /** Description of a reverted release */
  'revert-release.description': 'Адкаціць змены ў версіях дакументаў у "{{title}}".',
  /** Title of a reverted release */
  'revert-release.title': 'Адкат "{{title}}"',

  /** Description for the review changes button in release tool */
  'review.description': 'Дадайце дакументы ў гэты release, каб праглядзець змены',
  ...
  'schedule-button-tooltip.already-scheduled': 'Гэты release ужо запланаваны',
  ...
  'schedule-button.tooltip': 'Вы ўпэўнены, што хочаце адмяніць планаванне release?',
  ...
  'summary.no-documents-cardinality-one.title': 'У гэтым выпуску няма дакумента',
  ...
  'table-header.edited-by': 'Рэдагаваў',
  ...
  'table-header.last-edited': 'Апошняе рэдагаванне',
  ...
  'table-header.scheduled-draft.published-at': 'Апублікавана',
  ...
  'toast.duplicate.success': "Рэліз '<strong>{{title}}</strong>' быў продублікаваны. <Link/>",
  /** Link text for toast link to the duplicated release */
  'toast.duplicate.success-link': 'Прагледзець продублікаваны рэліз',
  /** Text for toast when release has been reverted immediately */
  'toast.immediate-revert.success': "Рэліз '{{title}}' быў паспяхова адкачаны",
  ...
  'toast.publish.update-drafts-error':
    'Рэліз быў апублікаваны, але існуючыя чарнавікі не ўдалося абнавіць: {{error}}',
  /** Text for toast when release has reverted release successfully staged */
  'toast.revert-stage.success': "Рэліз адкату для '{{title}}' быў паспяхова створаны. <Link/>",
  /** Link text for toast link to the generated revert release */
  'toast.revert-stage.success-link': 'Прагледзець рэліз адкату',
  /** Text for toast when release failed to revert */
  'toast.revert.error': 'Не ўдалося адкаціць рэліз: {{error}}',
  /** Text for toast when release failed to schedule */
  'toast.schedule.error': "Не ўдалося запланаваць '<strong>{{title}}</strong>': {{error}}",
  /** Text for toast when release has been scheduled */
  'toast.schedule.success': "Рэліз '<strong>{{title}}</strong>' быў запланаваны.",
  ...
  'type-picker.tooltip.scheduled': 'Рэліз запланаваны, адмяніце планаванне, каб змяніць тып',
  ...
  'unpublish-dialog.description.to-draft':
    'Гэта зніме дакумент з публікацыі ў рамках рэлізу <Label>{{title}}</Label> і створыць чарнавік, калі на момант выпуску яго не існуе.',
  ...
  /** Description shown in unschedule relaease dialog */
  'unschedule-dialog.confirm-description': 'Рэліз больш не будзе апублікаваны ў запланаваную дату',
  /** Title for unschedule release dialog */
  'unschedule-dialog.confirm-title': 'Вы ўпэўнены, што хочаце адмяніць планаванне рэлізу?',
})
