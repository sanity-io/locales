...
export default removeUndefinedLocaleResources({
  ...
  'overview.calendar.tooltip': 'Прагляд календара',
  ...
  'passed-intended-publish-date': 'Гэты рэліз прамінуў запланаваную дату публікацыі',

  /** Tooltip text for scheduled drafts that have passed their intended publish date */
  'passed-intended-publish-date-draft': 'Гэты чарнавік прамінуў запланаваную дату публікацыі',
  ...
  'revert-dialog.confirm-revert.stage-revert-checkbox-label': 'Неадкладна адкаціць выпуск',
  ...
  'schedule-unpublish-dialog.confirm': 'Запланаваць адмену публікацыі',
  /** Description for the schedule unpublish dialog */
  'schedule-unpublish-dialog.description':
    'Выберыце, калі гэты дакумент павінен быць адменены з публікацыі.',
  /** Header for the schedule unpublish dialog */
  'schedule-unpublish-dialog.header': 'Запланаваць чарнавік для адмены публікацыі',
  ...
  /** Change action type that will be shown in the table*/
  'table-body.action.unpublish': 'Адмяніць публікацыю',
