...
export default removeUndefinedLocaleResources({
  ...
  'object.media-not-found': 'Актыв не можа быць знойдзены ў Медыятэцы',
  /** Media object is missing a reference to a document in its `_ref` field */
  'object.not-media-library-asset': 'Павінна быць спасылка на актыў Медыятэкі',
  ...
  'panel.unpublish-message': 'Дакумент будзе зняты з публікацыі, памылкі праверкі не паказваюцца',
