...
export default removeUndefinedLocaleResources({
  ...
  'action.copy-document-id.label': 'Капіяваць ідэнтыфікатар дакумента',
  ...
  'action.copy-link-to-document.label': 'Капіяваць спасылку на дакумент',
  ...
  'panes.document-operation-results.operation-success_copy-id':
    'Ідэнтыфікатар дакумента скапіяваны ў буфер абмену',
