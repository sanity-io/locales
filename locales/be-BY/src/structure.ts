...
export default removeUndefinedLocaleResources({
  ...
  'action.copy-document-id.label': 'Скапіраваць ID дакумента',
  ...
  'action.copy-link-to-document.label': 'Скапіраваць URL дакумента',
  ...
  /** Label for the "Publish" document action while publish is being executed.*/
  'action.publish.validation-in-progress.label': 'Праверка дакумента…',
  /** Toast description when trying to publish with validation errors */
  'action.publish.validation-issues-toast.description':
    'Калі ласка, выпраўце памылкі праверкі перад публікацыяй',
  /** Toast title when trying to publish with validation errors */
  'action.publish.validation-issues-toast.title': 'Памылкі праверкі',
  ...
  'action.unpublish.disabled.already-unpublished':
    'Гэты дакумент ужо пазначаны для здымання з публікацыі',
  ...
  'banners.archived-scheduled-draft.description': 'Гэты запланаваны чарнавік заархіваваны',
  ...
  'banners.obsolete-draft.actions.compare-draft.tooltip':
    'Апублікаваны дакумент не існуе, таму гэты чарнавік немагчыма параўнаць.',
  ...
  'banners.paused-scheduled-draft.text':
    'Расклад зупынены падчас рэдагавання. Націсніце Расклад, каб актываваць зноў ці выбраць новую дату.',
  ...
  'banners.scheduled-draft-override-banner.text':
    'Існуе запланаваны чарнавік для гэтага дакумента. Калі вы апублікуеце змены зараз, яны будуць перазапісаны, калі расклад уступіць у сілу.',
  ...
  'compare-version.error.loadVersions.title': 'Не ўдалося загрузіць версіі',
  ...
  'confirm-delete-dialog.confirm-anyway-button.text_delete_one': 'Усё роўна выдаліць',
  ...
  'confirm-delete-dialog.confirm-button.text_delete_one': 'Выдаліць дакумент',
  ...
  'confirm-delete-dialog.confirmation.text_delete_one':
    'Вы дакладна хочаце выдаліць гэты дакумент?',
  /** If no referring documents are found, this text appears above the cancel and confirmation buttons */
  ...
  'document-inspector.error.description': 'Пры адлюстраванні гэтай панэлі адбылася памылка.',
  ...
  'document-target-badges.not-in-target.tooltip': 'Дакумент яшчэ не існуе ў абранай перспектыве.',
  ...
  'document-view.form-view.sync-stalled.description':
    'Рэдагаванне прыпынена да захавання змен. Вашы змены захоўваюцца ў браўзеры, таму пакіньце гэту ўкладку адкрытай, пакуль мы працягваем спробы.',
  ...
  'incoming-references-input.add-reference-item': 'Дадаць элемент',
  /** The aria-label for the incoming references list */
  'incoming-references-input.list-label': 'Уваходныя спасылкі тыпу {{type}}',
  /** The text for the no items in the incoming references input */
  'incoming-references-input.no-items': 'Няма элементаў',
  /** The text for the reference from in the incoming references input */
  'incoming-references-input.reference-from': 'Спасылка з {{type}}',
  /** The text for the schema type not found in the incoming references input */
  'incoming-references-input.schema-type-not-found': 'Тып схемы {{type}} не знойдзены',
  /** The text for the type to search in the incoming references input */
  'incoming-references-input.type-to-search': 'Увядзіце для пошуку',
  /** The text for the loading state in the incoming references input */
  'incoming-references-input.types-loading': 'Загрузка дакументаў...',
  /** The text for the loading state in the incoming references input */
  'incoming-references-input.types-loading-cross-dataset':
    'Загрузка дакументаў з розных набораў дадзеных...',
  ...
  'incoming-references-pane.schema-type-not-found': 'Тып схемы {{type}} не знойдзены',
  ...
  'menu-items.sort-by.restore-default.disabled-reason':
    'Ужо выкарыстоўваецца парадак сартавання па змаўчанні',
  ...
  'panes.document-list-pane.sort-order.disabled-reason':
    "Гэты параметр сартавання выкарыстоўвае палі, якія не з'яўляюцца часткай гэтага тыпу дакумента",
  ...
  'panes.document-operation-results.operation-success_unpublishVersion':
    'Версія будзе знята з публікацыі, калі рэліз будзе апублікаваны',
  ...
  'toggle-inline-changes.menu-item.title': 'Убудаваныя змены',
})
