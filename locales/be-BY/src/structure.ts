...
export default removeUndefinedLocaleResources({
  ...
  'document-inspector.error.description': 'Падчас адлюстравання гэтай панэлі адбылася памылка.',
  ...
  'document-target-badges.not-in-target.tooltip': 'Дакумент яшчэ не існуе ў выбраным perspective.',
