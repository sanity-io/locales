...
export default removeUndefinedLocaleResources({
  ...
  'document-group.delete.referring-documents-descriptor.text':
    '다음 문서들이 "<DocumentTitle/>"을(를) 참조하고 있어 삭제하지 못할 수 있습니다:',
  ...
  'document.initial-value.error.title': '초기 값을 확인할 수 없음',
  ...
  'release.chip.button.other-variants_other': '+{{count}} 변형',
  ...
  'release.chip.tooltip.other-variants_other': '{{count}} 변형',
