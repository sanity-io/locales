...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.new-auto-update-version-available': '새 버전이 준비되었습니다',
  /** "New version" header in version info dialog - Note that this is not necessary a *higher* version compared to current:
   *  It's a new version configured for auto updates which in some cases could even be a version below current  */
  'about-dialog.version-info.new-version.text': '새 버전',
  /** "Reload"-button when auto updates is enabled and a new version is available */
  'about-dialog.version-info.reload': '재시작',
  /** "Reload to update"-tooltip when auto updates is enabled and a new version is available */
  'about-dialog.version-info.reload-to-update': '업데이트를 위해 스튜디오를 재시작하세요',
  /** "New version available" tooltip in About-dialog */
  'about-dialog.version-info.tooltip.new-version-available': '새 버전이 준비되었습니다',
  ...
  'about-dialog.version-info.update-button.tooltip': 'Sanity 스튜디오 업데이트 방법 알아보기',
  ...
  'asset-sources.media-library.select-dialog.title':
    '{{assetType}}을(를) {{targetTitle}}에 선택하기',
  /** Warning message shown when uploading already existing files to the Media Library Asset Source */
  'asset-sources.media-library.warning.file-already-exist.description':
    '라이브러리에서 발견된 기존 파일을 사용합니다.',
  ...
  'help-resources.studio-auto-update-now': 'v{{newVersion}}으로 업데이트하기 위해 재시작',
  ...
  'release.action.publish-now': '지금 발행',
  ...
  'release.dialog.delete-schedule-draft.body':
    '이 예약된 초안을 삭제하시겠습니까? 이 작업은 취소할 수 없습니다.',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    '예약된 초안 문서 <strong>{{title}}</strong>의 재예약에 실패했습니다: {{error}}',
  /** Success toast for rescheduling a draft */
  'release.toast.reschedule-scheduled-draft.success':
    '예약된 초안 문서 <strong>{{title}}</strong>의 재예약이 완료되었습니다.',
