...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.new-auto-update-version-available': '새 버전이 사용 가능합니다',
  ...
  'about-dialog.version-info.reload-to-update': '업데이트를 위해 스튜디오를 재로드하세요',
  /** "New version available" tooltip in About-dialog */
  'about-dialog.version-info.tooltip.new-version-available': '새 버전이 사용 가능합니다',
  ...
  'release.dialog.publish-scheduled-draft.body': '예약된 초안을 즉시 출판하시겠습니까?',
  /** Confirm button text for running a scheduled draft immediately */
  'release.dialog.publish-scheduled-draft.confirm': '네, 지금 실행',
  /** Header for the dialog confirming running a scheduled draft immediately */
  'release.dialog.publish-scheduled-draft.header': '지금 초안 출판',
  ...
  'release.toast.publish-scheduled-draft.error':
    '예약된 초안 문서 <strong>{{title}}</strong> 출판에 실패했습니다: {{error}}',
  /** Success toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.success':
    '예약된 초안 문서 <strong>{{title}}</strong>가 출판되었습니다.',
  ...
  'schedule-publish-dialog.description': '이 문서를 언제 출판할지 선택하세요.',
  /** Header for the schedule publish dialog */
  'schedule-publish-dialog.header': '출판을 위한 초안 일정 예약',
