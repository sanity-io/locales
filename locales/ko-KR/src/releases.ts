...
export default removeUndefinedLocaleResources({
  ...
  'banner.drafts-mode-disabled':
    'Drafts 모드가 비활성화되었지만 아직 게시될 예정인 scheduled drafts가 있습니다.',
  /** Banner text shown when navigating to a release that does not exist */
  'banner.release-not-found': '이 release를 찾을 수 없습니다',
  ...
  'banner.scheduled-drafts-disabled':
    'Scheduled drafts가 비활성화되었지만 아직 게시될 예정인 scheduled drafts가 있습니다.',
  ...
  'dashboard.details.pin-release': '스튜디오에 release 고정',
  ...
  'dashboard.details.unpin-release': '스튜디오에서 release 고정 해제',

  /** Label for the button to proceed deleting a release */
  'delete-dialog.confirm-delete-button': '예, release를 삭제합니다',
  ...
  'delete-dialog.confirm-delete.header': '이 release를 삭제하시겠습니까?',

  /** Label when a release has been deleted by a different user */
  'deleted-release': "'<strong>{{title}}</strong>' release가 삭제되었습니다",
  ...
  'schedule-dialog.confirm-button': '예, 예약합니다',
  /** Description for the dialog confirming the publish of a release with multiple documents */
