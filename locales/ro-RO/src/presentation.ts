...
export default removeUndefinedLocaleResources({
  ...
  'preview-frame.loader.connection-status.label': 'Starea conexiunii Loader',
  ...
  'preview-location-input.error_same-base-path':
    'URL-ul nu poate avea aceeași cale de bază ca Studio {{basePath}}',
  ...
  'share-preview-menu.toggle-button.label_second-line': 'oricui are linkul',
  ...
  'share-url.menu-item.open.text': 'Deschideți previzualizarea',
})
