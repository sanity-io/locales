...
export default removeUndefinedLocaleResources({
  ...
  'asset-sources.media-library.warning.file-already-exist.description':
    'Se folosește fișierul existent găsit în bibliotecă.',
  ...
  'release.dialog.publish-scheduled-draft.body':
    'Sunteți sigur că doriți să publicați această schiță programată imediat?',
  ...
  'release.schedule-dialog.publish-date-in-past-warning':
    'Programați această lansare pentru un moment și o dată viitoare.',
  ...
  'schedule-publish-dialog.description': 'Selectați când ar trebui publicat acest document.',
