...
export default removeUndefinedLocaleResources({
  ...
  'banners.archived-scheduled-draft.description': 'Această versiune programată este arhivată',
  ...
  'banners.scheduled-draft-override-banner.text':
    'Ciorna acestui document este deja programată pentru publicare. Modificările pe care le faceți aici pot fi înlocuite de acea versiune.',
