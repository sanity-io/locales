...
export default removeUndefinedLocaleResources({
  ...
  'action.copy-document-id.label': 'Copiați ID-ul documentului',
  ...
  'action.copy-link-to-document.label': 'Copiați URL-ul documentului',
  ...
  'banners.obsolete-draft.actions.compare-draft.tooltip':
    'Documentul publicat nu există, așa că această ciornă nu poate fi comparată.',
  ...
  'canvas.banner.editable.linked-text': 'Acest document poate fi editat în Canvas.',
  /** The description for the canvas linked banner popover in editable mode*/
  'canvas.banner.editable.popover-description':
    'Canvas vă permite să scrieți liber, apoi să actualizați conținutul în Studio fără copiere manuală câmp cu câmp.',
  /** The heading for the canvas linked banner popover in editable mode*/
  'canvas.banner.editable.popover-heading': 'Scriere liberă',
  ...
  'compare-version.error.loadVersions.title': 'Încărcarea versiunilor a eșuat',
  ...
  'panes.document-operation-results.operation-success_copy-id':
    'ID-ul documentului a fost copiat în clipboard',
