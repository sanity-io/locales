...
export default removeUndefinedLocaleResources({
  ...
  'copy-paste.on-copy.validation.clipboard-not-supported.description':
    'Accesul la clipboard este necesar pentru a copia acest conținut. Permiteți permisiunile pentru clipboard în setările browserului, apoi încercați să copiați din nou.',
  /** The error message that is shown when the clipboard is not supported */
  ...
  'copy-paste.on-paste.validation.read-only-fields-skipped.description':
    'Câmpuri doar pentru citire omise: {{fieldNames}}',
  /** --- On paste --- */
