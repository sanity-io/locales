...
export default removeUndefinedLocaleResources({
  ...
  'timeline.create': '作成済み',
  'timeline.delete': '削除済み',
  'timeline.discardDraft': '下書きを破棄',
  'timeline.initial': '作成済み',
  'timeline.editDraft': '編集済み',
  'timeline.editLive': 'ライブ編集済み',
  'timeline.publish': '公開済み',
  'timeline.unpublish': '非公開',

  /** --- Slug Input --- */
  /** Error message for when the source to generate a slug from is missing */
  'inputs.slug.error.missing-source': `ソースがありません。スキーマの{{schemaType}}タイプでソースを確認してください`,
  ...
  'inputs.reference.error.invalid-search-result-type-title': `検索がこのリファレンスに無効なタイプを返しました: "{{returnedType}}"`,

  /** Error title for when the document referenced is not one of the types declared as allowed target types in schema */
  'inputs.reference.error.invalid-type-title': '無効なタイプのドキュメント',

  /** Error description for when the document referenced is not one of the types declared as allowed target types in schema */
  'inputs.reference.error.invalid-type-description': `参照されたドキュメント（<code>{{documentId}}</code>）はタイプ<code>{{actualType}}</code>です。スキーマによると、参照されるドキュメントは<AllowedTypes />のタイプのみにすることができます。`,
  ...
  'inputs.reference.cross-dataset.feature-disabled-actions': `このフィールドの既存の参照をクリアすることはできますが、機能が無効にされている限り、異なるドキュメントに変更することはできません。`,
  ...
  'inputs.array.error.type-is-incompatible-prompt': `このリストには<code>{{typeName}}</code>タイプのアイテムは有効ではありません`,
  ...
  'form.error.field-not-found': `フィールド "{{fieldName}}" がメンバーの中に見つからないか、条件付きで非表示になっているが明示的にレンダリングするよう指示されています – スキーマで定義されていることを確認し、条件付きで非表示になっていないかを検証してください。`,
