...
export default removeUndefinedLocaleResources({
  ...
  'settings.perspective.preview-drafts-renamed-to-drafts.description':
    'Perspektiva "<code>previewDrafts</code>" preimenovana je u "<code>drafts</code>" i sada je zastarjela. Ova promjena je učinkovita za sve verzije s podrškom za perspektivu (>= v2021-03-25).',
  ...
  'settings.perspectives.new-default.description':
    'Zadana perspektiva će se promijeniti iz "<code>raw</code>" u "<code>published</code>" u nadolazećoj verziji API-ja. Molimo konzultirajte dokumentaciju za više detalja.',
