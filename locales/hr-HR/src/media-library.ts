...
export default removeUndefinedLocaleResources({
  ...
  'invalid-video-warning.description':
    'Vrijednost ovog polja nije valjani video. Resetiranjem ovog polja možete odabrati novi video.',
  ...
  'invalid-video-warning.title': 'Neispravna vrijednost videa',
  ...
  'video-error.retry-button.text': 'Pokušaj ponovno',
})
