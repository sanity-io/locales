...
export default removeUndefinedLocaleResources({
  ...
  'dashboard.details.metadata.status-valid': 'Ispravno',
  /** Status badge value while document validation is still running. */
  'dashboard.details.metadata.status-validating': 'Provjera valjanosti',
  ...
  'document-validation.valid': 'Nema pogrešaka pri provjeri valjanosti',
