...
export default removeUndefinedLocaleResources({
  ...
  'activity.panel.close': 'Zatvori aktivnost',
  ...
  'dashboard.details.metadata.status-empty': 'Nema dokumenata',
  /** Status badge value when one or more documents have validation errors. */
  'dashboard.details.metadata.status-errors': 'Pogreške',
  /** Status badge value when every document in the release is valid. */
  'dashboard.details.metadata.status-valid': 'Valjano',
  /** Status badge value while document validation is still running. */
  'dashboard.details.metadata.status-validating': 'Provjera valjanosti u tijeku',
  ...
  'document-validation.valid': 'Nema pogrešaka u provjeri valjanosti',
  ...
  'overview.back-to-all-releases': 'Sva izdanja',
  ...
  'table-header.edited-by': 'Uredio/la',
  ...
  'table-header.last-edited': 'Zadnja izmjena',
  ...
  'table-header.variant': 'Varijanta',
