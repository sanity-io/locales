...
export default removeUndefinedLocaleResources({
  ...
  'dashboard.details.metadata.status-errors': 'Greške',
  ...
  'dashboard.details.metadata.status-validating': 'Validacija u tijeku',
  ...
  'document-validation.valid': 'Nema grešaka u validaciji',
  ...
  'table-header.last-edited': 'Zadnje uređivanje',
