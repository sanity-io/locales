...
export default removeUndefinedLocaleResources({
  ...
  'action.unpublish.disabled.already-unpublished':
    'Ovaj dokument je već postavljen za poništavanje objave',
  ...
  'banners.obsolete-draft.actions.compare-draft.tooltip':
    'Objavljeni dokument ne postoji, stoga se ova radna verzija ne može usporediti.',
  ...
  'compare-version.error.loadVersions.title': 'Učitavanje verzija nije uspjelo',
  ...
  'confirm-delete-dialog.confirm-anyway-button.text_delete_one': 'Ipak izbriši',
  /** The text in the "Delete anyway" button when the document has multiple versions */
  'confirm-delete-dialog.confirm-anyway-button.text_delete_other': 'Ipak izbriši sve verzije',
  ...
  'confirm-delete-dialog.confirm-button.text_delete_one': 'Izbriši dokument',
  /** The text in the "Delete now" button when the document has multiple versions */
  'confirm-delete-dialog.confirm-button.text_delete_other': 'Izbriši sve verzije',
  ...
  'confirm-delete-dialog.confirmation.text_delete_one':
    'Jeste li sigurni da želite izbrisati ovaj dokument?',
  /** The confirmation text when the document has multiple versions */
  'confirm-delete-dialog.confirmation.text_delete_other':
    'Jeste li sigurni da želite izbrisati sve verzije ovog dokumenta?',
  /** If no referring documents are found, this text appears above the cancel and confirmation buttons */
  ...
  'document-inspector.error.close-button.aria-label': 'Zatvori panel',
  /** Text explaining that the inspector panel failed to render */
  'document-inspector.error.description': 'Došlo je do pogreške prilikom prikazivanja ovog panela.',
  /** Label for the button that attempts to render the inspector panel again */
  'document-inspector.error.retry-button.text': 'Pokušaj ponovno',
  /** The title shown in the inspector panel header when the panel failed to render */
  'document-inspector.error.title': 'Nešto je pošlo po zlu',
  ...
  'panes.document-operation-results.operation-success_unpublishVersion':
    'Verzija će biti poništena objavom kada se izdanje objavi',
