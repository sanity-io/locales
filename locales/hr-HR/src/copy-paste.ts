...
export default removeUndefinedLocaleResources({
  ...
  'copy-paste.on-copy.validation.clipboard-not-supported.description':
    'Potreban je pristup međuspremniku da bi se sadržaj kopirao. Dopustite dozvole međuspremnika u postavkama vašeg preglednika, a zatim pokušajte ponovno kopirati.',
  /** The error message that is shown when the clipboard is not supported */
