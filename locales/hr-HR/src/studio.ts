...
export default removeUndefinedLocaleResources({
  ...
  'inputs.imagetool.vector-warning.developer-info':
    "Asset Pipeline ne podržava hotspot i crop za vektorske formate. Da biste omogućili hotspot & crop, izvedite ovu sliku u bilo koji od podržanih rasterskih formata. Na primjer: <code>fm=jpg</code> na <ImageUrlDocumentationLink>URL slike</ImageUrlDocumentationLink> ili pozovite <code>.format('png')</code> s <ImageUrlPackageDocumentationLink>@sanity/image-url</ImageUrlPackageDocumentationLink>.",
  /** See developer info */
