...
export default removeUndefinedLocaleResources({
  ...
  'document-group-inventory.feedback.sentiment-label':
    'Koliko je lako ili teško koristiti novu verziju inventara?',
  ...
  'document-group-inventory.viewing-item-label': 'pregledavanje',
  ...
  /** The text that appears in the subtitle `<summary>` that lists the datasets below the title */
  'document-group.delete.cdr-summary.subtitle_unavailable_other': 'Nedostupni datasets',
  ...
  'document-group.delete.other-reference-count.tooltip':
    'Ne možemo prikazati metapodatke za ove reference zbog nedostajućeg pristupnog tokena za povezane datasete.',
  ...
  'document-group.delete.referring-document-count.text_one':
    '1 dokument se odnosi na „<DocumentTitle/>"',
  /** Tells the user the count of how many other referring documents there are before listing them. (plural) */
  'document-group.delete.referring-document-count.text_other':
    '{{count}} dokumenata se odnosi na „<DocumentTitle/>"',
  /** Describes the list of documents that refer to the one trying to be deleted (delete) */
  'document-group.delete.referring-documents-descriptor.text':
    'Možda nećete moći izbrisati „<DocumentTitle/>" jer se sljedeći dokumenti odnose na njega:',
