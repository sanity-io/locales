...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.delete-schedule-draft.body-already-current':
    'Izbrisati ovaj zakazani draft? Vaš draft je već ažuriran.',
  ...
  'release.dialog.delete-schedule-draft.body-will-save-to-draft':
    'Izbrisati ovaj zakazani draft? Vaše promjene će biti spremljene u draft.',
  /** Body text when deleting scheduled draft with checkbox shown for user choice */
  'release.dialog.delete-schedule-draft.body-with-choice': 'Izbrisati ovaj zakazani draft?',
  ...
  'release.dialog.delete-schedule-draft.copy-checkbox':
    'Zadržite moje zakazane promjene kopiranjem u draft (preporučeno)',
  ...
  'release.dialog.delete-schedule-draft.different-changes-explanation':
    'Vaš zakazani draft ima različite promjene od vašeg trenutnog drafta.',
   ...
   * @deprecated – no longer needed
   * */
  'release.toast.scheduled-draft-published.title': 'Zakazani draft je objavljen',
