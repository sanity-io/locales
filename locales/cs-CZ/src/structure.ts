...
export default removeUndefinedLocaleResources({
  ...
  "action.delete.disabled.nothing-to-delete":
    "Tento dokument ještě neexistuje nebo je již smazán",
  ...
  "action.discard-changes.disabled.no-change":
    "Tento dokument nemá žádné nezveřejněné změny",
  /** Tooltip when action is disabled because the document is not published */
  "action.discard-changes.disabled.not-published":
    "Tento dokument není zveřejněn",
  /** Tooltip when action button is disabled because the operation is not ready   */
  ...
  "action.publish.already-published.tooltip":
    "Zveřejněno před {{timeSincePublished}}",
  ...
  "action.restore.disabled.cannot-restore-initial":
    "Nemůžete obnovit počáteční verzi",
  ...
  "confirm-delete-dialog.cdr-table.id-copied-toast.title":
    "ID dokumentu zkopírováno do schránky!",
  ...
  "confirm-delete-dialog.error.message.text":
    "Při načítání odkazujících dokumentů došlo k chybě.",
