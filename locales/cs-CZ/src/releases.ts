...
export default removeUndefinedLocaleResources({
  ...
  'activity.event.create':
    'Vytvořeno vydání <strong>{{releaseTitle}}</strong> <ScheduleTarget>s cílem </ScheduleTarget>',
  /* The text for the activity event when a document is removed from a release */
  'activity.event.discard-document': 'Odstraněna verze dokumentu',
  ...
  'banner.confirm-active-scheduled-drafts_one':
    'Existuje {{count}} Scheduled Draft, který vyžaduje potvrzení plánování',
  ...
  'banner.confirm-active-scheduled-drafts_other':
    'Existují {{count}} Scheduled Drafts, které vyžadují potvrzení plánování',
  ...
  'confirm-active-scheduled-drafts-dialog.description':
    'Naplánovat všechny pozastavené Scheduled Drafts na jejich zamýšlená data publikování',
  ...
  'copy-to-draft-dialog.description':
    'Verze konceptu tohoto dokumentu již existuje. Zkopírujte aktuální verzi do konceptu a přepište stávající verzi konceptu.',
  ...
  'delete-dialog.confirm-delete-description_other': 'Tímto odstraníte {{count}} verzí dokumentů.',
  ...
  'discard-version-dialog.description-draft':
    'Tímto trvale odstraníte všechny změny provedené v tomto dokumentu. Tuto akci nelze vrátit zpět.',
  /** Description for discarding a version of a document dialog */
  'discard-version-dialog.description-release':
    "Tímto trvale odstraníte všechny změny provedené v tomto dokumentu v rámci vydání '<strong>{{releaseTitle}}</strong>'. Tuto akci nelze vrátit zpět.",
  ...
  'error-details-title': 'Podrobnosti o chybě',
  ...
  'permissions.error.discard-version': 'Nemáte oprávnění zahodit tuto verzi',
  /** Tooltip label when the user doesn't have permission to duplicate release */
  'permissions.error.duplicate': 'Nemáte oprávnění duplikovat tento release',
  /** Tooltip label when the user doesn't have permission to unarchive release */
  'permissions.error.unarchive': 'Nemáte oprávnění obnovit tento release z archivu',
  /** Tooltip label when the user doesn't have permission for unpublishing a document */
  'permissions.error.unpublish': 'Nemáte oprávnění zrušit publikování tohoto dokumentu',

  /** Tooltip text for when one user is editing a document in a release */
  'presence.tooltip.one':
    '{{displayName}} právě upravuje tento dokument v releasu „{{releaseTitle}}"',
  ...
  'revert-dialog.confirm-revert-description_one':
    'Tím se vrátí {{releaseDocumentsLength}} verze dokumentu.',
  /** Description for the dialog confirming the revert of a release with multiple documents */
  'revert-dialog.confirm-revert-description_other':
    'Tím se vrátí {{releaseDocumentsLength}} verzí dokumentů.',
  ...
  'revert-dialog.confirm-revert.warning-card':
    'Po publikování byly v dokumentech tohoto releasu provedeny změny. Vrácením tyto změny přepíšete.',
  ...
  'review.description': 'Přidejte dokumenty do tohoto releasu pro kontrolu změn',
  ...
  'schedule-button.tooltip': 'Opravdu chcete zrušit plánování vydání?',
  ...
  'schedule-unpublish-dialog.confirm': 'Naplánovat zrušení publikování',
  /** Description for the schedule unpublish dialog */
  'schedule-unpublish-dialog.description':
    'Vyberte, kdy má být tento dokument zrušen z publikování.',
  /** Header for the schedule unpublish dialog */
  'schedule-unpublish-dialog.header': 'Naplánovat koncept pro zrušení publikování',
