...
export default removeUndefinedLocaleResources({
  ...
  'activity.panel.close': 'Zavřít aktivitu',
  ...
  'dashboard.details.metadata.created': 'Vytvořeno',
  ...
  'document-validation.valid': 'Žádné chyby ověření',
  ...
  'overview.back-to-all-releases': 'Všechna vydání',
  ...
  'presence.tooltip.one-without-release': '{{displayName}} právě upravuje tento dokument',
  ...
  'table-header.edited-by': 'Upravil',
  ...
  'table-header.last-edited': 'Naposledy upraveno',
