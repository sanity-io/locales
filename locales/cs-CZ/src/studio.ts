...
export default removeUndefinedLocaleResources({
  ...
  "asset-source.usage-list.documents-using-file_unnamed_one":
    "Jeden dokument používá tento soubor",
  ...
  "calendar.error.must-be-in-format":
    "Musí být ve formátu <Emphasis>{{exampleDate}}</Emphasis>",
  ...
  "changes.action.revert-changes-description":
    "Jste si jisti, že chcete vrátit změny?",
  /** Prompt for reverting changes for a group change, eg multiple changes */
  "changes.action.revert-changes-description_one":
    "Jste si jisti, že chcete vrátit změnu?",
  ...
  "changes.error-boundary.developer-info":
    "Pro více informací zkontrolujte konzoli pro vývojáře",
  ...
  "form.error.mixed-array-alert.remove-button.text":
    "Odstranit hodnoty, které nejsou objekty",
  ...
  "help-resources.latest-sanity-version":
    "Nejnovější verze je {{latestVersion}}",
  ...
  "inputs.array.error.json-representation-description":
    "JSON reprezentace této položky:",
  ...
  "inputs.file.upload-failed.description":
    "Nahrávání se v tuto chvíli nepodařilo dokončit.",
  /** Upload failed */
  ...
  "inputs.image.upload-error.description":
    "Nahrávání se v tuto chvíli nemohlo dokončit.",
  /** Upload failed */
  ...
  "inputs.invalid-value.convert-button.text":
    "Převést na <code>{{targetType}}</code>",
  /** The current value (<code>`{{actualType}}`</code>) */
  "inputs.invalid-value.current-type":
    "Současná hodnota (<code>{{actualType}}</code>)",
  ...
  "inputs.reference.document-opens-in-new-tab":
    "Tento dokument se otevře v novém tabu",
  ...
  "inputs.reference.image-preview-alt-text":
    "Náhled obrázku odkazovaného dokumentu",
  ...
  "inputs.reference.no-results-for-query":
    "Žádné výsledky pro <strong>“{{searchTerm}}”</strong>",
  ...
  "inputs.untyped-value.details.json-dump-prefix":
    "Aktuální hodnota (<code>object</code>):",
  ...
  "new-document.no-results":
    "Pro <strong>{{searchQuery}}</strong> nebyly nalezeny žádné výsledky",
  ...
  "preview.image.file-is-being-uploaded.alt-text":
    "Obrázek, který se právě nahrává",
  ...
  "search.error.display-filter-title":
    "Při zobrazování tohoto filtru došlo k chybě.",
  ...
  "search.error.no-valid-asset-source-title":
    "Nenalezeny žádné platné zdroje prostředků.",
  ...
  "search.filter-field-tooltip-used-in-document-types":
    "Použito v typech dokumentů",
  /** Label for when no fields/filters are found for the given term */
  "search.filter-no-matches-found":
    "Pro {{filter}} nebyly nalezeny žádné shody",
  ...
  "search.instructions":
    "Použijte <ControlsIcon/> pro upřesnění vašeho hledání",
  /** Helpful description for when no search results are found */
  "search.no-results-help-description":
    "Zkuste jiné klíčové slovo nebo upravte vaše filtry",
  ...
  "search.operator.date-range.description":
    "<Field/> <Operator>je mezi</Operator> <Value/>",
  ...
  "timeline.error.load-document-changes-title":
    "Při načítání změn dokumentu došlo k chybě.",
