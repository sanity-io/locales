...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.delete-schedule-draft.body-already-current':
    'Excluir este rascunho programado? Seu rascunho já está atualizado.',
  ...
  'release.dialog.delete-schedule-draft.body-will-save-to-draft':
    'Excluir este rascunho programado? Suas alterações serão salvas no rascunho.',
  /** Body text when deleting scheduled draft with checkbox shown for user choice */
  'release.dialog.delete-schedule-draft.body-with-choice': 'Excluir este rascunho programado?',
  ...
  'release.dialog.delete-schedule-draft.copy-checkbox':
    'Manter minhas alterações programadas copiando-as para o rascunho (recomendado)',
  ...
  'release.dialog.delete-schedule-draft.different-changes-explanation':
    'Seu rascunho programado tem alterações diferentes do seu rascunho atual.',
