...
export default removeUndefinedLocaleResources({
  ...
  "inputs.portable-text.invalid-value.empty-children.action":
    "Insira um intervalo de texto vazio",
  ...
  "inputs.untyped-value.title":
    "Valor da propriedade faltando <code>_type</code>",
  /** Unset value */
  ...
  "timeline.operation.unpublished_timestamp":
    "Não publicado: {{timestamp, datetime}}",
  /**
  ...
  "workspaces.action.choose-another-workspace":
    "Escolher outro espaço de trabalho",
