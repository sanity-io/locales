...
export default removeUndefinedLocaleResources({
  ...
  'action.delete.disabled.target-not-found':
    'A versão ou variante selecionada não contém este documento',
  ...
  'action.publish.disabled.not-publishable':
    'Esta versão é publicada como parte de sua versão de lançamento',
  ...
  'banners.paused-scheduled-draft.text':
    'Agendamento pausado durante a edição. Pressione Agendar para reativar ou escolha uma nova data.',
  ...
  'banners.variant.not-in-variant':
    'Não existe nenhum documento de variante <PerspectiveTitle>{{perspectiveTitle}}</PerspectiveTitle> para <VariantBadge>{{variantTitle}}</VariantBadge>.',
  /** Description of toast that will appear while the document is added to the variant */
  'banners.variant.waiting.description':
    'Por favor, aguarde enquanto o documento é adicionado à variante. Isso não deve demorar mais do que alguns segundos.',
  ...
  'document-view.form-view.sync-pending.description':
    'Continuaremos tentando. Suas alterações são mantidas no seu navegador enquanto isso.',
  ...
  'document-view.form-view.sync-stalled.description':
    'A edição está pausada até que as alterações sejam salvas. Suas alterações são mantidas no seu navegador, portanto, mantenha esta aba aberta enquanto continuamos tentando.',
  ...
  'incoming-references-input.type-to-search': 'Digite para pesquisar',
  ...
  'panes.document-pane.variant-target.loading': 'A carregar documento…',
