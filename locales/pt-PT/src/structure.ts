...
export default removeUndefinedLocaleResources({
  ...
  "action.delete.disabled.nothing-to-delete":
    "Este documento ainda não existe ou já foi excluído",
  ...
  "action.discard-changes.disabled.no-change":
    "Este documento não tem alterações não publicadas",
  /** Tooltip when action is disabled because the document is not published */
  "action.discard-changes.disabled.not-published":
    "Este documento não está publicado",
  /** Tooltip when action button is disabled because the operation is not ready   */
  ...
  "action.publish.already-published.tooltip":
    "Publicado há {{timeSincePublished}}",
  ...
  "action.publish.waiting":
    "Aguardando a conclusão das tarefas antes de publicar",
  ...
  "action.restore.disabled.cannot-restore-initial":
    "Você não pode restaurar para a versão inicial",
  ...
  "confirm-delete-dialog.cdr-summary.title_one":
    "{{documentCount}} em outro dataset",
  /** The text that appears in the title `<summary>` that includes the list of CDRs (plural) */
  "confirm-delete-dialog.cdr-summary.title_other":
    "{{documentCount}} em {{count}} datasets",
  ...
  "confirm-delete-dialog.confirm-anyway-button.text_unpublish":
    "Retirar publicação mesmo assim",
  ...
  "confirm-delete-dialog.header.text_unpublish":
    "Retirar publicação do documento?",
  ...
  "confirm-delete-dialog.other-reference-count.title_one":
    "1 outra referência não exibida",
  /** Shown if there are references to other documents but the user does not have the permission to see the relevant document IDs */
  ...
  "doc-title.unknown-schema-type.text":
    "Tipo de esquema desconhecido: {{schemaType}}",
  ...
  "no-document-types-screen.link-text":
    "Saiba como adicionar um tipo de documento →",
  ...
  "panes.document-list-pane.error.title":
    "Não foi possível buscar os itens da lista",
  /** The text of the document list pane if more than a maximum number of documents are returned */
  "panes.document-list-pane.max-items.text":
    "Exibindo no máximo {{limit}} documentos",
  ...
  "panes.document-operation-results.operation-error":
    "Ocorreu um erro durante {{context}}",
