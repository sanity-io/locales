...
export default removeUndefinedLocaleResources({
  ...
  'banners.release.error.description':
    'Ocorreu um erro ao adicionar o documento ao release: {{message}}',
  /** Toast title in case an error occurs when adding a document to a release  */
  'banners.release.error.title': 'Erro ao adicionar documento ao release',
  ...
  'banners.release.navigate-to-edit-description-multiple_one':
    'Este documento faz parte do <VersionBadge/> release e mais {{count}} release.',
  /** The text for the banner that appears when there are multiple versions but no drafts or published, more than one extra releases */
  'banners.release.navigate-to-edit-description-multiple_other':
    'Este documento faz parte do <VersionBadge/> release e mais {{count}} releases',
  /** The text for the banner that appears when a document only has one version but is in a draft or published pinned release */
  'banners.release.navigate-to-edit-description-single':
    'Este documento faz parte do <VersionBadge/> release',
  ...
  'banners.release.waiting.description':
    'Por favor, aguarde enquanto o documento é adicionado ao release. Não deve demorar mais do que alguns segundos.',
  /** Title of toast that will appear in case of latency between the user adding a document to a release and the UI reflecting it */
  'banners.release.waiting.title': 'Adicionando documento ao release…',
