...
export default removeUndefinedLocaleResources({
  ...
  'action.archive.tooltip': 'Desagende esta release para arquivá-la',
  ...
  'activity.event.create':
    'Criou o release <strong>{{releaseTitle}}</strong> <ScheduleTarget>com destino a </ScheduleTarget>',
  ...
  'activity.event.edit-time-asap': 'O mais breve possível',
  ...
  'activity.panel.close': 'Fechar atividade',
  /** The loading text for when releases are loading */
  'activity.panel.error': 'Ocorreu um erro ao obter a atividade do release',
  /** The loading text for when releases are loading */
  'activity.panel.loading': 'A carregar atividade do release',
  ...
  'archive-dialog.confirm-archive-description_one': 'Isto irá arquivar 1 versão de documento.',
  ...
  'archive-dialog.confirm-archive-description_other':
    'Isto irá arquivar {{count}} versões de documento.',
  /** Header for the dialog confirming the archive of a release */
  'archive-dialog.confirm-archive-header': 'Tem a certeza de que pretende arquivar este release?',
  /** Title for the dialog confirming the archive of a release */
  'archive-dialog.confirm-archive-title':
    "Tem a certeza de que pretende arquivar o release <strong>'{{title}}'</strong>?",

  /** Description for information card on a published or archived release to description retention effects */
  'archive-info.description':
    'Estará disponível durante {{retentionDays}} dias e será removido automaticamente em {{removalDate}}. <Link>Saiba mais sobre retenção</Link>.',
  ...
  'banner.drafts-mode-disabled':
    'O modo Drafts foi desativado, mas ainda há Scheduled Drafts a serem publicados.',
  /** Banner text shown when navigating to a release that does not exist */
  'banner.release-not-found': 'Esta release não foi encontrada',
  ...
  'confirm-active-scheduled-drafts-dialog.description':
    'Agendar todos os Scheduled Drafts pausados para as suas datas de publicação pretendidas',
  /** Dialog warning when some scheduled drafts have past dates */
  'confirm-active-scheduled-drafts-dialog.past-dates-warning':
    'Alguns destes Scheduled Drafts estão agendados para datas passadas. Confirmar os agendamentos irá publicar imediatamente essas versões dos documentos.',
  ...
  'copy-to-draft-dialog.confirm-button': 'Sim, substituir o Draft',
  /** Description for dialog when copying version to draft that already exists */
  'copy-to-draft-dialog.description':
    'Já existe uma versão draft deste documento. Copie a versão atual para o draft e substitua a versão draft existente.',
  /** Title for dialog when copying version to draft that already exists */
  'copy-to-draft-dialog.title': 'Versão draft já existe',
  ...
  'dashboard.details.metadata.created': 'Criado',
  ...
  'dashboard.details.metadata.schedule': 'Agendamento',
  ...
  'dashboard.details.metadata.status-empty': 'Nenhum documento',
  /** Status badge value when one or more documents have validation errors. */
  'dashboard.details.metadata.status-errors': 'Erros',
  ...
  'dashboard.details.pin-release': 'Fixar release no estúdio',
  ...
  'dashboard.details.unpin-release': 'Desafixar release do estúdio',

  /** Label for the button to proceed deleting a release */
  'delete-dialog.confirm-delete-button': 'Sim, eliminar release',
  /** Description for the dialog confirming the deleting of a release with one document */
  'delete-dialog.confirm-delete-description_one': 'Isto irá eliminar 1 versão do documento.',
  ...
  'document-validation.valid': 'Nenhum erro de validação',
  ...
  'overview.back-to-all-releases': 'Todos os releases',
  ...
  'presence.tooltip.one-without-release': '{{displayName}} está editando este documento agora',
  ...
  'publish-dialog.confirm-publish.update-drafts-description_one':
    'O rascunho existente de {{draftDocumentsLength}} documento será descartado para que os rascunhos correspondam ao release publicado. As alterações de rascunho não publicadas serão perdidas.',
  ...
  'publish-dialog.confirm-publish.update-drafts-description_other':
    'Os rascunhos existentes de {{draftDocumentsLength}} documentos serão descartados para que os rascunhos correspondam ao release publicado. As alterações de rascunho não publicadas serão perdidas.',
  ...
  'table-header.last-edited': 'Última edição',
  ...
  'toast.publish.update-drafts-error':
    'O release foi publicado, mas os rascunhos existentes não puderam ser atualizados: {{error}}',
  ...
  'unpublish-dialog.action.unpublish': 'Sim, despublicar ao lançar',
  ...
  'unpublish-dialog.description.to-draft':
    'Isso irá despublicar o documento como parte do release <Label>{{title}}</Label> e criar um rascunho caso nenhum exista no momento do lançamento.',
  /** Title for the dialog confirming the unpublish of a release */
  'unpublish-dialog.header': 'Tem certeza de que deseja despublicar este documento ao lançar?',

  /** Text for when a document is unpublished */
  'unpublish.already-unpublished': 'Este documento já está despublicado.',
  /** Tooltip label for when a document is unpublished */
  'unpublish.no-published-version': 'Não existe uma versão publicada deste documento.',
