...
export default removeUndefinedLocaleResources({
  ...
  'activity.event.add-document': 'Adicionou uma versão do documento',
  ...
  'activity.event.discard-document': 'Descartou uma versão do documento',
  ...
  'archive-dialog.confirm-archive-description_one': 'Isso arquivará 1 versão do documento.',
  ...
  'archive-dialog.confirm-archive-description_other':
    'Isso arquivará {{count}} versões do documento.',
  ...
  'delete-dialog.confirm-delete-button': 'Sim, eliminar versão',
