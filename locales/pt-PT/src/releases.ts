...
export default removeUndefinedLocaleResources({
  ...
  'dashboard.details.metadata.status-empty': 'Sem documentos',
  ...
  'document-validation.valid': 'Sem erros de validação',
  ...
  'overview.back-to-all-releases': 'Todos os lançamentos',
