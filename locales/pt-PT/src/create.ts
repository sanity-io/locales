...
export default removeUndefinedLocaleResources({
  ...
  'start-in-create-banner.subtitle':
    'Um editor livre, potencializado por IA, que sincroniza diretamente com os seus documentos do Studio.',
  /** Header of the "Start writing in Create" banner */
  'start-in-create-banner.title': 'Comece com o Sanity Create',
  ...
  'start-in-create-link.label': 'Comece no Create',
