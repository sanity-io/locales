...
export default removeUndefinedLocaleResources({
  ...
  "generic.incorrect-type":
    'Tipo esperado "{{expectedType}}", encontrado "{{actualType}}"',
  /** Value is not one of the values specifically allowed */
  "generic.not-allowed":
    "Valor não corresponde a nenhum dos valores permitidos",
  /** Value "$givenValue" is not one of the values specifically allowed */
  "generic.not-allowed_hint":
    'Valor "{{hint}}" não corresponde a nenhum dos valores permitidos',
  ...
  "object.reference-not-published":
    "O documento referenciado deve estar publicado",

  /** Accessibility label for closing the validation panel */
  "panel.close-button-aria-label": "Fechar validação",
  /** Message shown when the validation panel is opened but there are no errors/warnings */
  "panel.no-errors-message": "Sem erros de validação",
  ...
  "string.email": "Deve ser um endereço de email válido",
  /** String has a different character length than the exact number "$wantedLength" */
  "string.exact-length": "Deve ter exatamente {{wantedLength}} caracteres",
  /** String contains characters that are not in lowercase  */
  "string.lowercase": "Deve conter apenas caracteres em minúsculas",
  ...
  "string.uppercase": "Deve conter apenas caracteres em maiúsculas",
  /** String contains a protocol/scheme that is not allowed, eg (`ftp`, `mailto`…) */
  "string.url.disallowed-scheme":
    "Não corresponde aos protocolos/esquemas permitidos",
