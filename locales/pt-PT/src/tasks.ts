...
export default removeUndefinedLocaleResources({
  ...
  'dialog.remove-task.body': 'Tem certeza de que deseja excluir esta tarefa?',
  ...
  'empty-state.status.list.closed.subscribed.text':
    'Tarefas às quais você se inscreveu marcadas como concluídas aparecerão aqui',
  ...
  'empty-state.status.list.open.subscribed.text':
    'Tarefas às quais você se inscreve aparecerão aqui',
