...
export default removeUndefinedLocaleResources({
  ...
  'preview-frame.configuration.error.title': 'Discrepancia de origen en la URL de vista previa',
  ...
  'preview-frame.status_timeout':
    'No se puede conectar, consulta la consola del navegador para obtener más información.',
