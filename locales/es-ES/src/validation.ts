...
export default removeUndefinedLocaleResources({
  ...
  "array.exact-length_blocks":
    "Debe tener exactamente {{wantedLength}} bloques",
  ...
  "date.invalid-format":
    "Debe ser una cadena de fecha con formato ISO-8601 válido",
  ...
  "generic.incorrect-type":
    'Se esperaba el tipo "{{expectedType}}", se obtuvo "{{actualType}}"',
  /** Value is not one of the values specifically allowed */
  "generic.not-allowed":
    "El valor no coincide con ninguno de los valores permitidos",
  ...
  "string.exact-length":
    "Debe tener exactamente {{wantedLength}} caracteres de longitud",
  /** String contains characters that are not in lowercase  */
  "string.lowercase": "Debe estar en caracteres minúsculas",
  /** String is longer than the limit of "$maxLength" characters */
  "string.maximum-length":
    "Debe tener como máximo {{maxLength}} caracteres de longitud",
  /** String is shorter than the limit of "$minLength" characters */
  "string.minimum-length":
    "Debe tener al menos {{minLength}} caracteres de longitud",
  ...
  "string.url.includes-credentials":
    "No se permite nombre de usuario/contraseña",
