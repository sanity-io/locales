...
export default removeUndefinedLocaleResources({
  ...
  "action.delete.disabled.nothing-to-delete":
    "Este documento aún no existe o ya está eliminado",
  ...
  "action.publish.waiting":
    "Esperando a que las tareas terminen antes de publicar",
  ...
  "action.restore.disabled.cannot-restore-initial":
    "No puedes restaurar a la versión inicial",
  ...
  "doc-title.unknown-schema-type.text":
    "Tipo de esquema desconocido: {{schemaType}}",
  ...
  "no-document-types-screen.link-text":
    "Aprenda cómo agregar un tipo de documento →",
  ...
  "panes.document-list-pane.error.title":
    "No se pudieron obtener los elementos de la lista",
  /** The text of the document list pane if more than a maximum number of documents are returned */
  "panes.document-list-pane.max-items.text":
    "Mostrando un máximo de {{limit}} documentos",
  ...
  "panes.document-operation-results.operation-error":
    "Ocurrió un error durante {{context}}",
