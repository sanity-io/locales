...
export default removeUndefinedLocaleResources({
  ...
  'confirm-delete-dialog.confirm-anyway-button.text_delete_one': 'Eliminar de todos modos',
  ...
  'confirm-delete-dialog.confirm-anyway-button.text_delete_other':
    'Eliminar todas las versiones de todos modos',
  ...
  'panes.document-operation-results.operation-success_unpublishVersion':
    'La versión dejará de publicarse cuando se publique la versión',
