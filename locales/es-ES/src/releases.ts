...
export default removeUndefinedLocaleResources({
  ...
  'delete-dialog.confirm-delete.header': '¿Está seguro de que desea eliminar esta versión?',
  ...
  'discard-version-dialog.description-release':
    "Esto eliminará permanentemente todos los cambios realizados en este documento dentro de la versión '<strong>{{releaseTitle}}</strong>'. Esta acción no se puede deshacer.",
  ...
  'discard-version-dialog.header-release':
    "¿Eliminar el documento de la versión '<strong>{{releaseTitle}}</strong>'?",
  /** Title for dialog for discarding a draft of a document */
  'discard-version-dialog.title-draft': 'Descartar borrador',
  /** Title for dialog for discarding a version of a document */
  'discard-version-dialog.title-release': 'Eliminar de la versión',
  ...
  'duplicate-dialog.confirm-duplicate-description_one':
    'Esto duplicará la versión y la 1 versión del documento.',
  ...
  'duplicate-dialog.confirm-duplicate-description_other':
    'Esto duplicará la versión y las {{count}} versiones del documento.',
  /** Header for the dialog confirming the duplicate of a release */
  'duplicate-dialog.confirm-duplicate-header': '¿Está seguro de que desea duplicar esta versión?',
  ...
  'toast.create-version.error': 'Error al añadir el documento al release: {{error}}',
  ...
  'type-picker.tooltip.scheduled':
    'El release está programado, desprogramarlo para cambiar el tipo',
