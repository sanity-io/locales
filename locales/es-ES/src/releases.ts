...
export default removeUndefinedLocaleResources({
  ...
  'activity.panel.close': 'Cerrar actividad',
  ...
  'archive-dialog.confirm-archive-header': '¿Está seguro de que desea archivar este lanzamiento?',
  /** Title for the dialog confirming the archive of a release */
  'archive-dialog.confirm-archive-title':
    "¿Está seguro de que desea archivar el lanzamiento <strong>'{{title}}'</strong>?",
  ...
  'banner.confirm-active-scheduled-drafts_one':
    'Hay {{count}} Borrador Programado que requiere confirmación de programación',
  ...
  'banner.confirm-active-scheduled-drafts_other':
    'Hay {{count}} Borradores Programados que requieren confirmación de programación',
  ...
  'banner.drafts-mode-disabled':
    'El modo de borradores ha sido desactivado, pero aún hay borradores programados para publicar.',
  ...
  'banner.scheduled-drafts-disabled':
    'Los borradores programados han sido desactivados, pero aún hay borradores programados para publicar.',
  ...
  'confirm-active-scheduled-drafts-dialog.description':
    'Programar todos los Borradores Programados en pausa para sus fechas de publicación previstas',
  /** Dialog warning when some scheduled drafts have past dates */
  'confirm-active-scheduled-drafts-dialog.past-dates-warning':
    'Algunos de estos Borradores Programados están programados para fechas pasadas. Confirmar las programaciones publicará inmediatamente esas versiones de los documentos.',
  ...
  'delete-dialog.confirm-delete.header': '¿Estás seguro de que deseas eliminar este release?',

  /** Label when a release has been deleted by a different user */
  'deleted-release': "El release '<strong>{{title}}</strong>' ha sido eliminado",
  ...
  'discard-version-dialog.description-release':
    "Esto eliminará permanentemente todos los cambios realizados en este documento dentro del release '<strong>{{releaseTitle}}</strong>'. Esta acción no se puede deshacer.",
  ...
  'discard-version-dialog.header-release':
    "¿Eliminar el documento del release '<strong>{{releaseTitle}}</strong>'?",
  /** Title for dialog for discarding a draft of a document */
  'discard-version-dialog.title-draft': 'Descartar borrador',
  /** Title for dialog for discarding a version of a document */
  'discard-version-dialog.title-release': 'Eliminar del release',
  ...
  'document-validation.valid': 'Sin errores de validación',
  ...
  'duplicate-dialog.confirm-duplicate-description_one':
    'Esto duplicará el release y la 1 versión del documento.',
  ...
  'duplicate-dialog.confirm-duplicate-description_other':
    'Esto duplicará el release y las {{count}} versiones de documentos.',
  /** Header for the dialog confirming the duplicate of a release */
  'duplicate-dialog.confirm-duplicate-header': '¿Estás seguro de que deseas duplicar este release?',
  ...
  'loading-release-documents.error.description':
    'No podemos cargar los documentos de este release. Por favor, inténtalo de nuevo más tarde.',
  ...
  'no-paused-release': 'No hay borradores programados en pausa',
  ...
  'overview.back-to-all-releases': 'Todos los lanzamientos',
  /** Tooltip for the calendar button in the release overview */
  'overview.calendar.tooltip': 'Ver calendario',
  /** Description for the release tool */
  'overview.description':
    'Los releases son colecciones de cambios en documentos que pueden gestionarse, programarse y revertirse de forma conjunta.',
  ...
  'permission-missing-description':
    'Tu rol actualmente limita lo que puedes ver en este release. Es posible que no puedas publicar ni programar este release.',
  ...
  'permissions.error.archive': 'No tienes permiso para archivar este release',
  /** Tooltip label when the user doesn't have permission to delete release */
  'permissions.error.delete': 'No tienes permiso para eliminar este release',
  ...
  'presence.tooltip.one-without-release':
    '{{displayName}} está editando este documento en este momento',
  ...
  'publish-dialog.confirm-publish.update-drafts-checkbox': 'Actualizar borradores existentes',
  ...
  'publish-dialog.confirm-publish.update-drafts-description_one':
    'El borrador existente de {{draftDocumentsLength}} documento será descartado para que los borradores coincidan con la release publicada. Los cambios no publicados del borrador se perderán.',
  ...
  'publish-dialog.confirm-publish.update-drafts-description_other':
    'Los borradores existentes de {{draftDocumentsLength}} documentos serán descartados para que los borradores coincidan con la release publicada. Los cambios no publicados de los borradores se perderán.',
  ...
  'schedule-button.tooltip': '¿Estás seguro de que deseas desprogramar la versión?',

  /** Description for the confirm button for scheduling a release */
  'schedule-dialog.confirm-button': 'Sí, programar',
  /** Description shown in unschedule relaease dialog */
  'schedule-dialog.confirm-description_one':
    "La versión '<strong>{{title}}</strong>' y su documento se publicarán en la fecha seleccionada.",
  /** Description for the dialog confirming the publish of a release with multiple documents */
  'schedule-dialog.confirm-description_other':
    'La versión <strong>{{title}}</strong> y sus {{count}} versiones de documentos serán programadas.',
  ...
  'schedule-dialog.select-publish-date-label': 'Programar en',
  ...
  'summary.errors-found':
    'Para publicar o programar la versión, por favor resuelve los problemas encontrados en los documentos',
  ...
  'summary.no-documents-cardinality-one.title': 'No hay documento en esta versión',
  ...
  'table-header.edited-by': 'Editado por',
  ...
  'table-header.last-edited': 'Última edición',
  ...
  'toast.create-version.error': 'Error al añadir el documento a la versión: {{error}}',
  /** Description for toast when release deletion failed */
  'toast.delete.error': "Error al eliminar '<strong>{{title}}</strong>': {{error}}",
  /** Description for toast when release is successfully deleted */
  'toast.delete.success': "La versión '<strong>{{title}}</strong>' se eliminó correctamente",
  ...
  'toast.immediate-revert.success': "La versión '{{title}}' se revirtió correctamente",
  ...
  'toast.publish.update-drafts-error':
    'La versión fue publicada, pero los borradores existentes no pudieron actualizarse: {{error}}',
  /** Text for toast when release has reverted release successfully staged */
  'toast.revert-stage.success':
    "La versión de reversión para '{{title}}' se creó correctamente. <Link/>",
  /** Link text for toast link to the generated revert release */
  'toast.revert-stage.success-link': 'Ver versión de reversión',
  ...
  'type-picker.tooltip.scheduled':
    'La versión está programada, desprogramarla para cambiar el tipo',
  ...
  'unpublish-dialog.action.unpublish': 'Sí, cancelar publicación al lanzar',
  ...
  'unpublish-dialog.description.to-draft':
    'Esto despublicará el documento como parte del lanzamiento <Label>{{title}}</Label>, y creará un borrador si no existe ninguno en el momento del lanzamiento.',
  /** Title for the dialog confirming the unpublish of a release */
  'unpublish-dialog.header': '¿Estás seguro de que deseas despublicar este documento al lanzarlo?',
  ...
  'unschedule-dialog.confirm-description':
    'El lanzamiento ya no se publicará en la fecha programada.',
  /** Title for unschedule release dialog */
  'unschedule-dialog.confirm-title': '¿Estás seguro de que deseas desprogramar el lanzamiento?',
})
