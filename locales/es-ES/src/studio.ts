...
export default removeUndefinedLocaleResources({
  ...
  'asset-sources.media-library.select-dialog.title':
    'Seleccionando {{assetType}} para {{targetTitle}}',
  ...
  'release.dialog.edit-schedule.confirm': 'Actualizar horario',
  /** Header for change schedule dialog */
  'release.dialog.edit-schedule.header': 'Cambiar horario',
  ...
  'release.schedule-dialog.publish-date-in-past-warning':
    'Programa este lanzamiento para una fecha y hora futuras.',
  /** Label for date picker when scheduling a release */
  'release.schedule-dialog.select-publish-date-label': 'Programar en',
  ...
  'release.toast.delete-schedule-draft.error':
    'Error al eliminar el documento de borrador programado <strong>{{title}}</strong>: {{error}}',
  ...
  'release.toast.publish-scheduled-draft.error':
    'Error al publicar el documento de borrador programado <strong>{{title}}</strong>: {{error}}',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'Error al reprogramar el documento de borrador programado <strong>{{title}}</strong>: {{error}}',
