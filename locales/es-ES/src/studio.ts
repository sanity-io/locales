...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.delete-schedule-draft.copy-checkbox':
    'Mantén mis cambios programados copiándolos al borrador (recomendado)',
  ...
  'releases.upsell.misconfiguration.message':
    'Los lanzamientos de contenido están habilitados para tu proyecto, pero parece haber un problema de configuración con tus límites de lanzamiento. Por favor, contacta al soporte para que tus lanzamientos de contenido estén configurados correctamente.',
