...
export default removeUndefinedLocaleResources({
  ...
  "asset-source.asset-usage-dialog.header_file":
    "Documentos que utilizan el archivo",
  /** Header in usage dialog for image assets */
  "asset-source.asset-usage-dialog.header_image":
    "Documentos que utilizan la imagen",
  ...
  "asset-source.file.asset-list.action.select-file.title":
    "Selecciona el archivo {{filename}}",
  "asset-source.file.asset-list.action.show-usage.title": "Mostrar uso",
  "asset-source.file.asset-list.delete-failed":
  ...
  "asset-source.image.asset-list.delete-failed":
  ...
  "changes.array.item-moved_down_other":
    "Movidas {{count}} posiciones hacia abajo",
  /**
  ...
  "changes.array.item-moved_up_other":
    "Movidas {{count}} posiciones hacia arriba",
  /** Array diff: An item was removed from a given position (`{{position}}`) */
  "changes.array.item-removed-from-position":
    "Eliminado de la posición {{position}}",
  ...
  "changes.error-boundary.title":
    "Renderizar los cambios en este campo causó un error",
  ...
  "changes.portable-text.inline-object_unchanged":
    "Objeto en línea sin cambios",
  ...
  "form.error.duplicate-keys-alert.generate-button.text":
  ...
  "form.error.mixed-array-alert.remove-button.text":
    "Eliminar valores que no son objetos",
  ...
  "help-resources.latest-sanity-version":
    "La última versión es {{latestVersion}}",
  ...
  "inputs.array.error.json-representation-description":
    "Representación JSON de este elemento:",
  ...
  "inputs.file.actions-menu.file-options.aria-label":
    "Abrir el menú de opciones de archivo",
  /** Browse */
  ...
  "inputs.file.error.unknown-member-kind":
    "Tipo de miembro desconocido: {{kind}}",
  ...
  "inputs.file.upload-failed.description":
    "La carga no se pudo completar en este momento.",
  /** Upload failed */
  ...
  "inputs.files.common.placeholder.upload-not-supported":
    "No se pueden subir archivos aquí",
  /** Clear upload */
  ...
  "inputs.object.unknown-fields.warning.title_one":
    "Campo desconocido encontrado",
  "inputs.object.unknown-fields.warning.title_other":
    "Campos desconocidos encontrados",
  ...
  "inputs.portable-text.invalid-value.invalid-span-text.action":
    "Establecer valor de texto vacío",
  ...
  "inputs.portable-text.invalid-value.missing-type.action":
    "Eliminar el bloque",
  ...
  "inputs.portable-text.invalid-value.not-an-object.action":
    "Eliminar elemento",
  ...
  "inputs.portable-text.invalid-value.title":
    "Valor de Texto Portable inválido",
  ...
  "inputs.reference.error.document-unavailable-title":
  ...
  "inputs.reference.error.search-failed-title":
    "Falló la búsqueda de referencia",
  /** Alternative text for the image shown in cross-dataset reference input */
  "inputs.reference.image-preview-alt-text":
    "Vista previa de la imagen del documento referenciado",
  ...
  "inputs.reference.metadata-error.title":
    "No se pueden cargar los metadatos de referencia",
  ...
  "inputs.reference.preview.no-unpublished-edits":
    "Sin ediciones no publicadas",
  ...
  "inputs.reference.strength-mismatch.title":
    "Incongruencia en la fortaleza de la referencia",
  /** Label for button that triggers the action that weakens a reference on strength mismatch */
  "inputs.reference.strength-mismatch.weaken-button-label":
    "Convertir a referencia débil",
  ...
  "inputs.untyped-value.title":
    "Falta el valor de la propiedad <code>_type</code>",
  /** Unset value */
  ...
  "new-document.no-document-types-found":
  ...
  "presence.no-one-else-description":
    "Invita a personas al proyecto para ver su estado en línea.",
  ...
  "preview.image.file-is-being-uploaded.alt-text":
    "La imagen que se está subiendo",
  ...
  "search.document-types-no-matches-found":
  ...
  "search.error.display-filter-title":
    "Ocurrió un error al mostrar este filtro.",
  ...
  "search.error.no-valid-asset-source-title":
    "No se encontraron fuentes de activos válidas.",
  ...
  "search.filter-field-tooltip-used-in-document-types":
    "Utilizado en tipos de documentos",
  /** Label for when no fields/filters are found for the given term */
  "search.filter-no-matches-found":
    "No se encontraron coincidencias para {{filter}}",
  ...
  "search.no-results-help-description":
    "Prueba con otra palabra clave o ajusta tus filtros",
  ...
  "search.operator.defined.description":
    "<Field/> <Operator>es</Operator> <Value>no vacío</Value>",
  ...
  "search.ordering.updated-descending-label":
    "Actualizado: Más reciente primero",
  ...
  "timeline.operation.draft-discarded_timestamp":
    "Borrador descartado: {{timestamp, datetime}}",
  ...
  "timeline.operation.edited-live_timestamp":
    "Editado en vivo: {{timestamp, datetime}}",
