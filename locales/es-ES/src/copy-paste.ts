...
export default removeUndefinedLocaleResources({
  ...
  'copy-paste.on-copy.validation.clipboard-not-supported.description':
    'Se requiere acceso al portapapeles para copiar este contenido. Permita los permisos del portapapeles en la configuración de su navegador y luego intente copiar de nuevo.',
  /** The error message that is shown when the clipboard is not supported */
