...
export default removeUndefinedLocaleResources({
  ...
  "changes.portable-text.changed-formatting":
    "テキストのフォーマットを変更しました",
  ...
  "changes.portable-text.inline-object_added":
    "インラインオブジェクトを追加しました",
  ...
  "inputs.portable-text.action.edit-annotation": "注釈を編集する",
  ...
  "new-document.no-results":
    "<strong>{{searchQuery}}</strong>に対する結果はありません",
  ...
  "search.operator.date-range.description":
    "<Field/> <Operator>は範囲内</Operator> <Value/>",
  ...
  "search.operator.defined.description":
    "<Field/> <Operator>は</Operator> <Value>空でない</Value>",
  "search.operator.defined.name": "空でない",
  /* Value should not be defined */
  "search.operator.not-defined.description":
    "<Field/> <Operator>は</Operator> <Value>空</Value>",
