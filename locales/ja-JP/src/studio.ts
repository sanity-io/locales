...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.new-auto-update-version-available': '新しいバージョンが利用可能',
  ...
  'about-dialog.version-info.reload-to-update': 'アップデートするためにスタジオをリロード',
  /** "New version available" tooltip in About-dialog */
  'about-dialog.version-info.tooltip.new-version-available': '新しいバージョンが利用可能',
  ...
  'asset-sources.media-library.select-dialog.title': '{{assetType}}を{{targetTitle}}に選択',
  ...
  'release.dialog.delete-schedule-draft.header': 'スケジュールされたドラフトを削除',
  /** Body text for change schedule dialog */
  'release.dialog.edit-schedule.body':
    'スケジュールされた公開のための新しい日付と時間を選択してください。',
