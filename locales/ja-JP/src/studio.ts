...
export default removeUndefinedLocaleResources({
  ...
  'changes.from-base-variant.label': 'ベースバリアントから変更されました',
  ...
  'document-status.published-at': '{{date}}に公開済み',
  ...
  'form.field.actions-menu.title': 'フィールドアクション',
  ...
  'release.toast.edit-release-error.title': 'リリースの詳細を保存できませんでした',
  ...
  'user-menu.action.claim-project': 'このプロジェクトを請求する',
