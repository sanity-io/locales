...
export default removeUndefinedLocaleResources({
  ...
  'activity.event.create':
    '<strong>{{releaseTitle}}</strong> リリースを作成しました <ScheduleTarget>ターゲット設定: </ScheduleTarget>',
  ...
  'confirm-active-scheduled-drafts-dialog.description':
    '一時停止中のすべてのScheduled Draftsを、予定された公開日にスケジュールする',
  ...
  'copy-to-draft-dialog.confirm-button': 'はい、Draftを上書きする',
  ...
  'dashboard.details.unpin-release': 'releaseのstudioへのピン留めを解除',

  /** Label for the button to proceed deleting a release */
  'delete-dialog.confirm-delete-button': 'はい、releaseを削除する',
  ...
  'discard-version-dialog.description-draft':
    'このドキュメントに加えられたすべての変更が完全に削除されます。この操作は元に戻せません。',
  /** Description for discarding a version of a document dialog */
  'discard-version-dialog.description-release':
    'このドキュメントに対して「<strong>{{releaseTitle}}</strong>」リリース内で加えられたすべての変更が完全に削除されます。この操作は元に戻せません。',
  ...
  'duplicate-dialog.confirm-duplicate-description_other':
    'リリースと {{count}} 件のドキュメントバージョンが複製されます。',
  ...
  'loading-release': 'リリースを読み込み中',

  /** Text for when documents of a release are loading */
  'loading-release-documents': 'ドキュメントを読み込み中',
  ...
  'release-placeholder.title': 'タイトルなし',
  ...
  'summary.errors-found':
    'リリースを公開またはスケジュールするには、ドキュメントで見つかった問題を解決してください',
  ...
  'table-header.contributors': 'コントリビューター',
