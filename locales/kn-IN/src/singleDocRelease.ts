...
export default removeUndefinedLocaleResources({
  ...
  'action.schedule-publish-success-description': '{{publishAt}} ಗೆ ಪ್ರಕಟಣೆಯನ್ನು ನಿಗದಿಪಡಿಸಲಾಗಿದೆ',
  ...
  'action.schedule-publish.disabled.cardinality-one':
    'ಈ ದಾಖಲೆಗಾಗಿ ನಿಗದಿತ ಕರಡು ಈಗಾಗಲೇ ಅಸ್ತಿತ್ವದಲ್ಲಿದೆ.',
  /** Tooltip text for when schedule publish is disabled due to validation errors */
  'action.schedule-publish.disabled.validation-issues':
    'ಪ್ರಸ್ತುತ ಕರಡಿನಲ್ಲಿ ಮೌಲ್ಯೀಕರಣ ದೋಷಗಳಿರುವ ಕಾರಣ ಕರಡನ್ನು ನಿಗದಿಪಡಿಸಲು ಸಾಧ್ಯವಿಲ್ಲ.',
  ...
  'empty-state.description':
    'ಭವಿಷ್ಯದ ದಿನಾಂಕ ಮತ್ತು ಸಮಯದಲ್ಲಿ ಪ್ರಕಟಣೆಗಾಗಿ ಕರಡು ದಾಖಲೆಗಳನ್ನು ನಿಗದಿಪಡಿಸಿ ಮತ್ತು ಲಾಕ್ ಮಾಡಿ.',
  /** Empty state title for scheduled drafts */
  'empty-state.title': 'ನಿಗದಿತ ಕರಡುಗಳು',
})
