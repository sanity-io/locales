...
export default removeUndefinedLocaleResources({
  ...
  'settings.perspective.preview-drafts-renamed-to-drafts.description':
    'ಪರ್ಸ್ಪೆಕ್ಟಿವ್ "<code>previewDrafts</code>" ಅನ್ನು "<code>drafts</code>" ಎಂದು ಪುನಃನಾಮಕರಣ ಮಾಡಲಾಗಿದೆ ಮತ್ತು ಈಗ ಅಪ್ರಚಲಿತವಾಗಿದೆ. ಈ ಬದಲಾವಣೆ ಪರ್ಸ್ಪೆಕ್ಟಿವ್ ಬೆಂಬಲಿಸುವ ಎಲ್ಲಾ ಆವೃತ್ತಿಗಳಿಗೆ ಕಾರ್ಯಕಾರಿಯಾಗಿದೆ (>= v2021-03-25).',
  ...
  'settings.perspectives.new-default.description':
    'ಮುಂದಿನ API ಆವೃತ್ತಿಯಲ್ಲಿ ಡೀಫಾಲ್ಟ್ ಪರ್ಸ್ಪೆಕ್ಟಿವ್ "<code>raw</code>" ನಿಂದ "<code>published</code>" ಗೆ ಬದಲಾಗಲಿದೆ. ಹೆಚ್ಚಿನ ವಿವರಗಳಿಗಾಗಿ ದಾಖಲೆಗಳನ್ನು ಸಲಹಿಸಿ.',
