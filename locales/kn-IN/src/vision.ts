...
export default removeUndefinedLocaleResources({
  ...
  'action.save-shared-query': 'ಹಂಚಿಕೊಂಡಂತೆ ಉಳಿಸಿ',
  ...
  'save-query.personal-copy-success': 'ವೈಯಕ್ತಿಕ ಪ್ರತಿ ಉಳಿಸಲಾಗಿದೆ',
  /** Warning displayed before sharing a query */
  'save-query.share-warning':
    'ಹಂಚಿಕೊಂಡ ಪ್ರಶ್ನೆಗಳನ್ನು ನಿಮ್ಮ dataset ನಲ್ಲಿ ದಾಖಲೆಗಳಾಗಿ ಸಂಗ್ರಹಿಸಲಾಗುತ್ತದೆ ಮತ್ತು ಅವು ನಿಮ್ಮ ದಾಖಲೆ ಕೋಟಾದ ಕಡೆಗೆ ಎಣಿಸಲ್ಪಡುತ್ತವೆ.',
  /** Save shared query success label */
  'save-query.shared-success': 'ಹಂಚಿಕೊಂಡ ಪ್ರಶ್ನೆ ಉಳಿಸಲಾಗಿದೆ',
  /** Save success label */
