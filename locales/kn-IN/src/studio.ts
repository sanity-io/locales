...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.configuration-issue.missing-appid':
    'ಸ್ವಯಂ ನವೀಕರಣಗಳು ಸಕ್ರಿಯವಾಗಿದೆ, ಆದರೆ <code>deployment.appId</code> ಅನ್ನು <code>sanity.cli.ts</code> ನಲ್ಲಿ ಸಂರಚಿಸಲಾಗಿಲ್ಲ. ಈ ಸ್ಟುಡಿಯೋ <strong>ಅತ್ಯಂತ ಹೊಸ</strong>-ಚಾನೆಲ್ ವಿರುದ್ಧ ನವೀಕರಣಗೊಳ್ಳುತ್ತಿದೆ.',
  ...
  'release.dialog.delete-schedule-draft.body':
    'ಈ ನಿಗದಿತ ಮುಸುಡಿಯನ್ನು ನೀವು ಅಳಿಸಲು ಖಚಿತವಾಗಿದ್ದೀರಾ? ಈ ಕ್ರಿಯೆಯನ್ನು ಹಿಂದಿನಂತೆ ಮಾಡಲು ಸಾಧ್ಯವಿಲ್ಲ.',
  ...
  'release.dialog.publish-scheduled-draft.body':
    'ನೀವು ಈ ನಿಗದಿತ ಮುಸದ್ದೆಯನ್ನು ತಕ್ಷಣವೇ ಪ್ರಕಟಿಸಬೇಕೆಂದು ನೀವು ಖಚಿತರಾಗಿದ್ದೀರಾ?',
  /** Confirm button text for running a scheduled draft immediately */
  'release.dialog.publish-scheduled-draft.confirm': 'ಹೌದು, ಈಗ ಚಲಾಯಿಸಿ',
  /** Header for the dialog confirming running a scheduled draft immediately */
  'release.dialog.publish-scheduled-draft.header': 'ಮುಸದ್ದೆಯನ್ನು ಈಗ ಪ್ರಕಟಿಸಿ',
  ...
  'release.toast.delete-schedule-draft.error':
    'ನಿಗದಿತ ಮುಸದ್ದೆ ದಾಖಲೆಯನ್ನು ಅಳಿಸಲು ವಿಫಲವಾಗಿದೆ <strong>{{title}}</strong>: {{error}}',
  /** Success toast for deleting a scheduled draft */
  'release.toast.delete-schedule-draft.success':
    'ನಿಗದಿತ ಮುಸದ್ದೆ ದಾಖಲೆ <strong>{{title}}</strong> ಅಳಿಸಲಾಗಿದೆ.',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.not-found-release.title': "'{{title}}' ಬಿಡುಗಡೆಯನ್ನು ಹುಡುಕಲಾಗಲಿಲ್ಲ",
  /** Error toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.error':
    'ನಿಗದಿತ ಮುಸದ್ದೆ ದಾಖಲೆಯನ್ನು ಪ್ರಕಟಿಸಲು ವಿಫಲವಾಗಿದೆ <strong>{{title}}</strong>: {{error}}',
  /** Success toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.success':
    'ನಿಗದಿತ ಮುಸದ್ದೆ ದಾಖಲೆ <strong>{{title}}</strong> ಪ್ರಕಟಿಸಲಾಗಿದೆ.',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'ನಿಗದಿತ ಮುಸದ್ದೆ ದಾಖಲೆಯನ್ನು ಮರುನಿಗದಿಪಡಿಸಲು ವಿಫಲವಾಗಿದೆ <strong>{{title}}</strong>: {{error}}',
  /** Success toast for rescheduling a draft */
  'release.toast.reschedule-scheduled-draft.success':
    'ನಿಗದಿತ ಮುಸದ್ದೆ ದಾಖಲೆ <strong>{{title}}</strong> ಮರುನಿಗದಿಪಡಿಸಲಾಗಿದೆ.',
  ...
  'schedule-publish-dialog.header': 'ಪ್ರಕಟಣೆಗಾಗಿ ಮುಸದ್ದೆಯನ್ನು ನಿಗದಿಪಡಿಸಿ',
