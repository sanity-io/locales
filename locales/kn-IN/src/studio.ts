...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.configuration-issue.header': 'ಸಂರಚನಾ ಸಮಸ್ಯೆ ಪತ್ತೆಹಚ್ಚಲಾಗಿದೆ',
  /** Message shown if sanity.cli.ts is missing deployment.appId */
  'about-dialog.configuration-issue.missing-appid':
    'ಸ್ವಯಂ ನವೀಕರಣಗಳು ಸಕ್ರಿಯವಾಗಿವೆ, ಆದರೆ <code>sanity.cli.ts</code> ನಲ್ಲಿ <code>deployment.appId</code> ಸಂರಚಿಸಲಾಗಿಲ್ಲ. ಈ ಸ್ಟುಡಿಯೋ <strong>ಅತ್ಯಂತ ಹೊಸ</strong>-ಚಾನೆಲ್ ವಿರುದ್ಧ ನವೀಕರಣಗೊಳ್ಳುತ್ತಿದೆ.',
  ...
  'about-dialog.version-info.update-button.tooltip': 'ಸ್ಯಾನಿಟಿ ಸ್ಟುಡಿಯೋ ನವೀಕರಿಸುವ ಬಗ್ಗೆ ಕಲಿಯಿರಿ',
  ...
  'asset-sources.media-library.warning.file-already-exist.description':
    'ಗ್ರಂಥಾಲಯದಲ್ಲಿ ಕಂಡುಬಂದ ಇರುವ ಫೈಲ್ ಬಳಸುವುದು.',
  ...
  'release.chip.tooltip.draft-disabled.live-edit':
    'ಈ ದಾಖಲೆಯು ಲೈವ್ ಎಡಿಟ್ ಮೋಡ್‌ನಲ್ಲಿದೆ, ಡ್ರಾಫ್ಟ್‌ಗಳು ಅಸಕ್ತಗೊಳಿಸಲಾಗಿದೆ',
  ...
  'release.dialog.delete-schedule-draft.body':
    'ನೀವು ಈ ನಿಗದಿತ ಮುಸುಡಿಯನ್ನು ಅಳಿಸಲು ಖಚಿತವಾಗಿದ್ದೀರಾ? ಈ ಕ್ರಿಯೆಯನ್ನು ಹಿಂತಿರುಗಿಸಲು ಸಾಧ್ಯವಿಲ್ಲ.',
  /** Confirm button text for deleting a scheduled draft */
  'release.dialog.delete-schedule-draft.confirm': 'ಹೌದು, ವೇಳಾಪಟ್ಟಿ ಅಳಿಸಿ',
  /** Header for the dialog confirming deletion of a scheduled draft */
  'release.dialog.delete-schedule-draft.header': 'ನಿಗದಿತ ಮುಸುಡಿ ಅಳಿಸಿ',
  /** Body text for change schedule dialog */
  'release.dialog.edit-schedule.body': 'ನಿಗದಿತ ಪ್ರಕಟಣೆಗಾಗಿ ಹೊಸ ದಿನಾಂಕ ಮತ್ತು ಸಮಯವನ್ನು ಆಯ್ಕೆಮಾಡಿ.',
  ...
  'release.dialog.publish-scheduled-draft.body':
    'ನೀವು ಈ ನಿಗದಿತ ಮುಸುಡಿಯನ್ನು ತಕ್ಷಣವೇ ಪ್ರಕಟಿಸಬೇಕೆಂದು ನೀವು ಖಚಿತರಾಗಿದ್ದೀರಾ?',
  /** Confirm button text for running a scheduled draft immediately */
  'release.dialog.publish-scheduled-draft.confirm': 'ಹೌದು, ಈಗ ಚಲಾಯಿಸಿ',
  /** Header for the dialog confirming running a scheduled draft immediately */
  'release.dialog.publish-scheduled-draft.header': 'ಮುಸುಡಿಯನ್ನು ಈಗ ಪ್ರಕಟಿಸಿ',
  ...
  'release.schedule-dialog.publish-date-in-past-warning':
    'ಈ ಬಿಡುಗಡೆಯನ್ನು ಭವಿಷ್ಯದ ಸಮಯ ಮತ್ತು ದಿನಾಂಕಕ್ಕೆ ನಿಗದಿಪಡಿಸಿ.',
  /** Label for date picker when scheduling a release */
  'release.schedule-dialog.select-publish-date-label': 'ಮೇಲೆ ನಿಗದಿಪಡಿಸಿ',
  ...
  'release.toast.delete-schedule-draft.error':
    'ನಿಗದಿತ ಮುಸುಡಿ ದಾಖಲೆ <strong>{{title}}</strong> ಅಳಿಸಲು ವಿಫಲವಾಗಿದೆ: {{error}}',
  /** Success toast for deleting a scheduled draft */
  'release.toast.delete-schedule-draft.success':
    'ನಿಗದಿತ ಮುಸುಡಿ ದಾಖಲೆ <strong>{{title}}</strong> ಅಳಿಸಲಾಗಿದೆ.',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.not-found-release.title': "'{{title}}' ಬಿಡುಗಡೆಯನ್ನು ಹುಡುಕಲಾಗಲಿಲ್ಲ",
  /** Error toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.error':
    'ನಿಗದಿತ ಮುಸುಡಿ ದಾಖಲೆ <strong>{{title}}</strong> ಪ್ರಕಟಿಸಲು ವಿಫಲವಾಗಿದೆ: {{error}}',
  /** Success toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.success':
    'ನಿಗದಿತ ಮುಸುಡಿ ದಾಖಲೆ <strong>{{title}}</strong> ಪ್ರಕಟಿಸಲಾಗಿದೆ.',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'ನಿಗದಿತ ಮುಸುಡಿ ದಾಖಲೆ <strong>{{title}}</strong> ಮರುನಿಗದಿಪಡಿಸಲು ವಿಫಲವಾಗಿದೆ: {{error}}',
  /** Success toast for rescheduling a draft */
  'release.toast.reschedule-scheduled-draft.success':
    'ನಿಗದಿತ ಮುಸುಡಿ ದಾಖಲೆ <strong>{{title}}</strong> ಮರುನಿಗದಿಪಡಿಸಲಾಗಿದೆ.',
  ...
  'release.tooltip.locked':
    'ಈ ಬಿಡುಗಡೆಯನ್ನು ನಿಗದಿಪಡಿಸಲಾಗಿದೆ. ಹೆಚ್ಚು ದಾಖಲೆಗಳನ್ನು ಸೇರಿಸಲು ಅನಿಗದಿಪಡಿಸಿ.',
  ...
  'schedule-publish-dialog.header': 'ಪ್ರಕಟಣೆಗಾಗಿ ಮುಸುಡಿಯನ್ನು ನಿಗದಿಪಡಿಸಿ',
  ...
  'workspaces.action.switch-workspace': 'ಕಾರ್ಯಸ್ಥಾನ ಬದಲಾಯಿಸಿ',
