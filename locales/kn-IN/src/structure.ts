...
export default removeUndefinedLocaleResources({
  ...
  'banners.archived-scheduled-draft.description': 'ಈ ನಿಗದಿತ ಡ್ರಾಫ್ಟ್ ಆರ್ಕೈವ್ ಮಾಡಲಾಗಿದೆ',
  ...
  'banners.scheduled-draft-override-banner.text':
    'ಈ ದಾಖಲೆಯ ಡ್ರಾಫ್ಟ್ ಪ್ರಕಟಣೆಗೆ ಈಗಾಗಲೇ ನಿಗದಿತವಾಗಿದೆ. ನೀವು ಇಲ್ಲಿ ಮಾಡುವ ಬದಲಾವಣೆಗಳು ಆ ಆವೃತ್ತಿಯಿಂದ ಓವರ್‌ರೈಡ್ ಮಾಡಲ್ಪಡಬಹುದು.',
