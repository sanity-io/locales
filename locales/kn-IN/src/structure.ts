...
export default removeUndefinedLocaleResources({
  ...
  'buttons.focus-pane-button.aria-label.collapse': 'ಎಲ್ಲಾ ಪ್ಯಾನ್‌ಗಳನ್ನು ಕುಸಿತಗೊಳಿಸಿ',
  /** The aria-label for the focus pane button on the document panel header */
  'buttons.focus-pane-button.aria-label.focus': 'ಪ್ಯಾನ್‌ಗೆ ಗಮನಹರಿಸಿ',
  /** The tooltip for the collapse pane button on the document panel header */
  'buttons.focus-pane-button.tooltip.collapse': 'ಎಲ್ಲಾ ಪ್ಯಾನ್‌ಗಳನ್ನು ಕುಸಿತಗೊಳಿಸಿ',
  /** The tooltip for the focus pane button on the document panel header */
  'buttons.focus-pane-button.tooltip.focus': 'ಪ್ಯಾನ್‌ಗೆ ಗಮನಹರಿಸಿ',
