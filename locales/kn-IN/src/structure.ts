...
export default removeUndefinedLocaleResources({
  ...
  /** The text that appears for the action button to add the current document to the global release */
  'banners.release.action.open-to-edit': 'ಸಂಪಾದನೆಗೆ ಬಿಡುಗಡೆಯನ್ನು ತೆರೆ',
  ...
  'banners.release.navigate-to-edit-description': 'ದಾಖಲೆ ಕೇವಲ',
  /** The text for the banner that appears when a document only has versions but is in a draft or published pinned release */
  'banners.release.navigate-to-edit-description-end_one': 'ಬಿಡುಗಡೆಯಲ್ಲಿ',
  /** The text for the banner that appears when a document only has versions but is in a draft or published pinned release */
  'banners.release.navigate-to-edit-description-end_other': 'ಬಿಡುಗಡೆಗಳಲ್ಲಿ',
  /** The text for the banner that appears when there are multiple versions but no drafts or published, only one extra releases */
  'banners.release.navigate-to-edit-description-multiple_one':
    'ಈ ದಾಖಲೆ <VersionBadge/> ಬಿಡುಗಡೆಯ ಭಾಗವಾಗಿದೆ ಮತ್ತು {{count}} ಹೆಚ್ಚುವರಿ ಬಿಡುಗಡೆ.',
  /** The text for the banner that appears when there are multiple versions but no drafts or published, more than one extra releases */
  'banners.release.navigate-to-edit-description-multiple_other':
    'ಈ ದಾಖಲೆ <VersionBadge/> ಬಿಡುಗಡೆಯ ಭಾಗವಾಗಿದೆ ಮತ್ತು {{count}} ಹೆಚ್ಚುವರಿ ಬಿಡುಗಡೆಗಳು',
  /** The text for the banner that appears when a document only has one version but is in a draft or published pinned release */
  'banners.release.navigate-to-edit-description-single':
    'ಈ ದಾಖಲೆ <VersionBadge/> ಬಿಡುಗಡೆಯ ಭಾಗವಾಗಿದೆ',
  ...
  'banners.unpublished-release-banner.text':
    'ಈ ದಾಖಲೆ <VersionBadge>{{title}}</VersionBadge> ಬಿಡುಗಡೆಯ ಭಾಗವಾಗಿ ಅಪ್ರಕಟಿತವಾಗಿರುತ್ತದೆ',
  ...
  'compare-version.error.invalidModeParam': '"{{input}}" ಒಂದು ಮಾನ್ಯವಾದ ದಾಖಲೆ ಹೋಲಿಕೆ ಮೋಡ್ ಅಲ್ಲ.',
  ...
  'compare-versions.status.draft': 'ಮುಸದ್ದಿ',
