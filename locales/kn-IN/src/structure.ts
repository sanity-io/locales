...
export default removeUndefinedLocaleResources({
  ...
  'banners.choose-new-document-destination.cannot-create-draft-document':
    'ಮುಸದ್ದಾ ದಾಖಲೆಯನ್ನು ರಚಿಸಲು ಸಾಧ್ಯವಿಲ್ಲ.',
  ...
  'banners.obsolete-draft.actions.compare-draft.text': 'ಮುಸದ್ದಾವನ್ನು ಹೋಲಿಸಿ',
  /** The label for the "discard draft" action */
  'banners.obsolete-draft.actions.discard-draft.text': 'ಮುಸದ್ದಾವನ್ನು ತ್ಯಜಿಸಿ',
  /** The label for the "publish draft" action */
  'banners.obsolete-draft.actions.publish-draft.text': 'ಮುಸದ್ದಾವನ್ನು ಪ್ರಕಟಿಸಿ',
  /** The warning displayed when editing a document that has an obsolete draft because the draft model is not switched on */
  'banners.obsolete-draft.draft-model-inactive.text':
    'ವರ್ಕ್‌ಸ್ಪೇಸ್‌ನಲ್ಲಿ ಮುಸದ್ದಾಗಳನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಿಲ್ಲ, ಆದರೆ ಈ ದಾಖಲೆಯ ಮುಸದ್ದಾ ಆವೃತ್ತಿ ಇದೆ.',
