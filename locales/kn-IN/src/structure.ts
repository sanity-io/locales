...
export default removeUndefinedLocaleResources({
  ...
  'action.discard-changes.confirm-dialog.header.text': 'ಬದಲಾವಣೆಗಳನ್ನು ತ್ಯಜಿಸಿರಿ?',
  ...
  'buttons.focus-pane-button.aria-label.collapse': 'ಫೋಕಸ್ ಮೋಡ್ ನಿಂದ ಹೊರಬನ್ನಿ (ನ್ಯಾವಿಗೇಶನ್ ತೋರಿಸಿ)',
  /** The aria-label for the focus pane button on the document panel header */
  'buttons.focus-pane-button.aria-label.focus': 'ಫೋಕಸ್ ಮೋಡ್ ಗೆ ಪ್ರವೇಶಿಸಿ (ನ್ಯಾವಿಗೇಶನ್ ಮರೆಮಾಡಿ)',
  /** The tooltip for the collapse pane button on the document panel header */
  'buttons.focus-pane-button.tooltip.collapse': 'ಫೋಕಸ್ ಮೋಡ್ ನಿಂದ ಹೊರಬನ್ನಿ',
