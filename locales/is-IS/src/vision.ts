...
export default removeUndefinedLocaleResources({
  ...
  'settings.perspectives.new-default.description':
    'Sjálfgefna perspective mun breytast úr "<code>raw</code>" í "<code>published</code>" í væntanlegri API útgáfu. Vinsamlegast konsúlterið skjöl fyrir frekari upplýsingar.',
