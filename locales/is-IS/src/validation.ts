...
export default removeUndefinedLocaleResources({
  ...
  'object.media-not-found': 'Ekki var hægt að finna eignina í Myndasafninu',
  /** Media object is missing a reference to a document in its `_ref` field */
  'object.not-media-library-asset': 'Verður að vera tilvísun í eign Myndasafnsins',
  ...
  'panel.unpublish-message':
    'Skjal er að fara í afbirtingu, engar villur í staðfestingu eru sýndar',
