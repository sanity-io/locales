...
export default removeUndefinedLocaleResources({
  ...
  'copy-paste.on-paste.validation.mime-type-incompatible.description':
    'MIME gerð "{{mimeType}}" er ekki samþykkt fyrir þennan reit',
  /** The error message that is shown when the MIME type validation fails */
  'copy-paste.on-paste.validation.mime-type-validation-failed.description':
    'MIME gerðarstaðfesting mistókst',
  ...
  'copy-paste.on-paste.validation.primitive-type-incompatible.description':
    'Gildi af gerðinni "{{type}}" er ekki leyfilegt í þessum reit',
  /** --- On paste --- */
  /** The validation message that is shown when pasting a value into a read-only target */
  'copy-paste.on-paste.validation.read-only-target.description': 'Markmiðið er aðeins-lesið',
  /** The validation message that is shown when reference is incompatible with filter */
  'copy-paste.on-paste.validation.reference-filter-incompatible.description':
    'Tilvísun er ekki leyfileg í tilvísunarreit samkvæmt síu',
  /** The validation message that is shown when reference types are incompatible */
  'copy-paste.on-paste.validation.reference-type-incompatible.description':
    'Tilvísanir af gerðinni "{{sourceReferenceType}}" eru ekki leyfðar í tilvísunarreit sem samþykkir gerðir "{{targetReferenceTypes}}"',
