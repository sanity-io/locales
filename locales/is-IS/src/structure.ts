...
export default removeUndefinedLocaleResources({
  ...
  'action.unpublish.disabled.already-unpublished': 'Þetta skjal er þegar stillt á að verða óbirt',
  ...
  'banners.obsolete-draft.actions.compare-draft.tooltip':
    'Útgefna skjalið er ekki til, svo ekki er hægt að bera þessi drög saman.',
  ...
  'compare-version.error.loadVersions.title': 'Ekki tókst að hlaða útgáfum',
  ...
  'confirm-delete-dialog.confirm-anyway-button.text_delete_one': 'Eyða samt',
  /** The text in the "Delete anyway" button when the document has multiple versions */
  'confirm-delete-dialog.confirm-anyway-button.text_delete_other': 'Eyða öllum útgáfum samt',
  ...
  'confirm-delete-dialog.confirm-button.text_delete_one': 'Eyða skjali',
  /** The text in the "Delete now" button when the document has multiple versions */
  'confirm-delete-dialog.confirm-button.text_delete_other': 'Eyða öllum útgáfum',
  ...
  'panes.document-operation-results.operation-success_unpublishVersion':
    'Útgáfan verður óbirt þegar útgáfan (release) er birt',
