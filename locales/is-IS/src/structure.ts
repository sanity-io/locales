...
export default removeUndefinedLocaleResources({
  ...
  'compare-version.error.invalidModeParam':
    '"{{input}}" er ekki studdur samanburðarhamur fyrir skjöl.',
  /** The error message shown when the next document for comparison could not be extracted from the URL */
  'compare-version.error.invalidNextDocumentParam': 'Næsta skjals færibreytan er ógild.',
  /** The error message shown when the document comparison URL could not be parsed */
  'compare-version.error.invalidParams.title': 'Ekki hægt að bera saman skjöl',
  /** The error message shown when the previous document for comparison could not be extracted from the URL */
  'compare-version.error.invalidPreviousDocumentParam': 'Fyrri skjals færibreytan er ógild.',
