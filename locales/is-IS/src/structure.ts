...
export default removeUndefinedLocaleResources({
  ...
  'buttons.focus-pane-button.aria-label.collapse': 'Fella saman alla fláka',
  /** The aria-label for the focus pane button on the document panel header */
  'buttons.focus-pane-button.aria-label.focus': 'Beina sjónum að flák',
  /** The tooltip for the collapse pane button on the document panel header */
  'buttons.focus-pane-button.tooltip.collapse': 'Fella saman alla fláka',
  /** The tooltip for the focus pane button on the document panel header */
  'buttons.focus-pane-button.tooltip.focus': 'Beina sjónum að flák',
