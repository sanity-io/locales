...
export default removeUndefinedLocaleResources({
  ...
  'activity.panel.close': 'Loka virkniglugga',
  ...
  'dashboard.details.metadata.status-validating': 'Í villuleit',
  ...
  'document-validation.valid': 'Engar villur við villuleit',
