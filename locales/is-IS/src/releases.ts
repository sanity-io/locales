...
export default removeUndefinedLocaleResources({
  ...
  'activity.panel.close': 'Loka virkni',
  ...
  'document-validation.valid': 'Engar villur fundust',
  ...
  'overview.back-to-all-releases': 'Allar útgáfur',
  ...
  'presence.tooltip.one-without-release': '{{displayName}} er að breyta þessu skjali núna',
  ...
  'table-header.edited-by': 'Breytt af',
  ...
  'table-header.last-edited': 'Síðast breytt',
  ...
  'table-header.variant': 'Tilbrigði',
