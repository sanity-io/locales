...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.user-agent.header': 'Notandaskilaboð',
  ...
  'asset-source.dialog.insert-asset-error':
    'Villa við að setja inn eign. Sjáðu í stjórnborðinu fyrir frekari upplýsingar.',
  ...
  'asset-sources.common.uploader.upload-failed.description':
    'Sjáðu í stjórnborðinu fyrir frekari upplýsingar.',
  ...
  'asset-sources.media-library.file.title': 'Fjölmiðlasafn',
  'asset-sources.media-library.image.title': 'Fjölmiðlasafn',
  ...
  'document.type.not-found': 'Skjalategund "{{type}}" fannst ekki',
  ...
  'inputs.reference.global.invalid-type': 'Tilvísunarskjalið er af ógildri gerð ({{typeName}})',
  ...
  'release.chip.tooltip.archived': 'Þessi útgáfa er arkíveruð og ekki er hægt að breyta henni.',
  ...
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.published-release.title': "'{{title}}' útgáfan var gefin út",
