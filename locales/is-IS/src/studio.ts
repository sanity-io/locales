...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.delete-schedule-draft.body-already-current':
    'Eyða þessum áætluðu drögum? Drögin þín eru nú þegar uppfærð.',
  ...
  'releases.upsell.misconfiguration.message':
    'Innihaldsútgáfur eru virkjaðar fyrir verkefnið þitt, en það virðist vera stillingarvandamál með takmörk útgáfunnar þinnar. Vinsamlegast hafðu samband við þjónustuver til að fá innihaldsútgáfurnar þínar rétt stilltar.',
