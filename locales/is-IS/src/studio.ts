...
export default removeUndefinedLocaleResources({
  ...
  'release.action.discard-version.success':
    '<strong>{{title}}</strong> útgáfan var hafnað með góðum árangri',
  /** Action message for when a new release is created off an existing version, draft or published document */
  'release.action.new-release': 'Ný útgáfa',
  /** Tooltip message for not having permissions for creating new releases */
  'release.action.permission.error': 'Þú hefur ekki heimild til að framkvæma þessa aðgerð',
  ...
  'release.banner.scheduled-for-publishing-on': 'Áætluð birting á {{date}}',
  ...
  'release.toast.archived-release.title': "Útgáfunni '{{title}}' var safnað",
  ...
  'release.toast.not-found-release.title': "Ekki tókst að finna útgáfuna '{{title}}'",
