...
export default removeUndefinedLocaleResources({
  ...
  'asset-source.dialog.insert-asset-error':
    'Villa við að setja inn eign. Sjáðu í stjórnborðið fyrir frekari upplýsingar.',
  ...
  'asset-sources.common.uploader.upload-failed.description':
    'Sjáðu í stjórnborðið fyrir frekari upplýsingar.',
  ...
  'asset-sources.media-library.error.library-could-not-be-resolved':
    'Eitthvað fór úrskeiðis við að leysa úr Media Library fyrir þetta verkefni.',
  ...
  'asset-sources.media-library.info.provisioning':
    'Vinsamlegast bíðið á meðan við undirbúum Media Library ykkar',
  ...
  'calendar.action.select-time': 'Velja tíma',
  ...
  'document.type.not-found': 'Ekki fannst skjalategund "{{type}}"',
  ...
  'inputs.reference.global.invalid-type': 'Tilvísunarskjalið er af ógildri tegund ({{typeName}})',
  ...
  'release.chip.tooltip.archived': 'Þessi útgáfa er skjalasafnað og ekki er hægt að breyta henni.',
  ...
  'release.toast.archived-release.description': 'Þessari útgáfu hefur verið aflétt festingu',
  ...
  'release.toast.published-release.description': 'Þessari útgáfu hefur verið aflétt festingu',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.published-release.title': "Útgáfunni '{{title}}' hefur verið birt",
