...
export default removeUndefinedLocaleResources({
  ...
  'changes.from-base-variant.label': 'Breytt frá grunnútgáfu',
  ...
  'diagnostics.menu-item': 'Greiningar',
  ...
  'document-status.published-at': 'Birt {{date}}',
  ...
  'form.field.actions-menu.title': 'Aðgerðir fyrir svæði',
