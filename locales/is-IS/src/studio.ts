...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.configuration-issue.header': 'Uppsetningarvandamál greint',
  ...
  'release.dialog.publish-scheduled-draft.body':
    'Ertu viss um að þú viljir birta þennan áætlaða drög strax?',
  ...
  'release.menu.label': 'Útgáfuvalmynd',
  ...
  'release.schedule-dialog.select-publish-date-label': 'Áætla á',
  ...
  'release.toast.delete-schedule-draft.success':
    'Áætluðu drögunum <strong>{{title}}</strong> hefur verið eytt.',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.not-found-release.title': "Ekki tókst að finna '{{title}}' útgáfuna",
  /** Error toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.error':
    'Mistókst að birta áætluðu drögunum <strong>{{title}}</strong>: {{error}}',
  /** Success toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.success':
    'Áætluðu drögunum <strong>{{title}}</strong> hefur verið birt.',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'Mistókst að endurtímasetja áætluðu drögunum <strong>{{title}}</strong>: {{error}}',
  /** Success toast for rescheduling a draft */
  'release.toast.reschedule-scheduled-draft.success':
    'Áætluðu drögunum <strong>{{title}}</strong> hefur verið endurtímasett.',
  ...
  'schedule-publish-dialog.description': 'Veldu hvenær þessi skjal ætti að vera birt.',
  ...
  'workspaces.action.switch-workspace': 'Skipta um vinnusvæði',
