...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.delete-schedule-draft.body-already-current':
    'Eyða þessum áætlaða drögum? Drögin þín eru þegar uppfærð.',
  ...
  'release.dialog.delete-schedule-draft.body-will-save-to-draft':
    'Eyða þessum áætlaða drögum? Breytingarnar þínar verða vistaðar í drögum.',
  /** Body text when deleting scheduled draft with checkbox shown for user choice */
  'release.dialog.delete-schedule-draft.body-with-choice': 'Eyða þessum áætlaða drögum?',
  ...
  'releases.upsell.misconfiguration.message':
    'Innihaldsútgáfur eru virkjaðar fyrir verkefnið þitt, en það virðist vera stillingarvandamál með útgáfumörk þín. Vinsamlegast hafðu samband við þjónustuver til að fá innihaldsútgáfurnar þínar rétt stilltar.',
