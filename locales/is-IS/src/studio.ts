...
export default removeUndefinedLocaleResources({
  ...
  'inputs.imagetool.vector-warning.developer-info':
    "Eignaleiðslan styður ekki miðju og skurð fyrir vektorsnið. Til að virkja miðju & skurð, veldu úttak þessarar myndar í einhverju af studdu rastersniðunum. Til dæmis: <code>fm=jpg</code> við <ImageUrlDocumentationLink>myndar-URL</ImageUrlDocumentationLink> eða kallaðu <code>.format('png')</code> með <ImageUrlPackageDocumentationLink>@sanity/image-url</ImageUrlPackageDocumentationLink>.",
  /** See developer info */
  ...
  'inputs.imagetool.vector-warning.title':
    'Viðvörun: Miðja og skurð gætu ekki verið beitt á þessa mynd þar sem hún er kynnt.',
