...
export default removeUndefinedLocaleResources({
  ...
  "asset-source.usage-list.documents-using-file_unnamed_one":
    "Eitt skjal er að nota þessa skrá",
  ...
  "asset-source.usage-list.documents-using-file_unnamed_zero":
    "Engin skjöl eru að nota þessa skrá",
  ...
  "asset-source.usage-list.documents-using-image_unnamed_one":
    "Eitt skjal er að nota þessa mynd",
  ...
  "changes.error-boundary.developer-info":
    "Athugaðu þróunarvalmyndina fyrir frekari upplýsingar",
  /** Text shown when a diff component crashes during rendering, triggering the error boundary */
  "changes.error-boundary.title":
    "Það kom upp villa við að sýna breytingarnar á þessu sviði",
  ...
  "form.error.mixed-array-alert.remove-button.text":
    "Fjarlægja gildi sem eru ekki hlutir",
  ...
  "help-resources.latest-sanity-version":
    "Nýjasta útgáfan er {{latestVersion}}",
  ...
  "inputs.array.error.json-representation-description":
    "JSON framsetning á þessu atriði:",
  ...
  "inputs.file.actions-menu.file-options.aria-label":
    "Opna valmynd fyrir skráarvalkosti",
  /** Browse */
  ...
  "inputs.file.upload-failed.description":
    "Ekki var hægt að ljúka upphleðslu á þessum tíma.",
  /** Upload failed */
  ...
  "inputs.files.common.actions-menu.notification.url-copied":
    "Vefslóð er afrituð á klippiborð",
  /** Replace */
  ...
  "inputs.image.upload-error.description":
    "Upphleðslan gat ekki verið lokið að þessu sinni.",
  /** Upload failed */
  ...
  "inputs.invalid-value.convert-button.text":
    "Breyta í <code>{{targetType}}</code>",
  /** The current value (<code>`{{actualType}}`</code>) */
  "inputs.invalid-value.current-type":
    "Núverandi gildi (<code>{{actualType}}</code>)",
  ...
  "inputs.portable-text.invalid-value.missing-child-key.action":
    "Úthluta handahófskenndum lykli",
  ...
  "inputs.reference.document-opens-in-new-tab":
    "Þetta skjal opnast í nýjum flipa",
  ...
  "inputs.reference.error.failed-to-load-document-title":
    "Mistókst að hlaða tilvísað skjali",
  ...
  "inputs.reference.image-preview-alt-text":
    "Myndforskoðun af tilvísaðu skjali",
  ...
  "inputs.reference.metadata-error.title":
    "Ekki hægt að hlaða inn tilvísunarmetagegnum",
  ...
  "inputs.untyped-value.description":
    "Mætti á hlutgildi án <code>_type</code> eignar.",
  ...
  "inputs.untyped-value.details.json-dump-prefix":
    "Núverandi gildi (<code>object</code>):",
  ...
  "new-document.no-results":
    "Engar niðurstöður fyrir <strong>{{searchQuery}}</strong>",
  ...
  "presence.no-one-else-description":
    "Bjóddu fólki í verkefnið til að sjá netsögu þeirra.",
  ...
  "preview.image.file-is-being-uploaded.alt-text":
    "Myndin sem er verið að hlaða upp",
  ...
  "search.error.no-valid-asset-source-title":
    "Engar gildar eignauppsprettur fundust.",
  ...
  "search.no-results-help-description":
    "Prófaðu annað leitarorð eða aðlagaðu síurnar þínar",
  ...
  "search.operator.defined.description":
    "<Field/> <Operator>er</Operator> <Value>ekki tóm</Value>",
  "search.operator.defined.name": "ekki tóm",
  /* Value should not be defined */
  "search.operator.not-defined.description":
    "<Field/> <Operator>er</Operator> <Value>tóm</Value>",
  ...
  "timeline.error.load-document-changes-title":
    "Villa kom upp við að sækja breytingar á skjali.",
