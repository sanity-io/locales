...
export default removeUndefinedLocaleResources({
  ...
  'document-group-inventory.feedback.sentiment-label':
    'Hversu auðvelt eða erfitt er að nota nýju útgáfuskrána?',
  ...
  'document-group.delete.other-reference-count.tooltip':
    'Við getum ekki birt lýsigögn fyrir þessar tilvísanir vegna þess að aðgangslykill vantar fyrir viðkomandi datasets.',
  ...
  'document-group.delete.referring-document-count.text_one': '1 skjal vísar til „<DocumentTitle/>"',
  /** Tells the user the count of how many other referring documents there are before listing them. (plural) */
  'document-group.delete.referring-document-count.text_other':
    '{{count}} skjöl vísa til „<DocumentTitle/>"',
  /** Describes the list of documents that refer to the one trying to be deleted (delete) */
  'document-group.delete.referring-documents-descriptor.text':
    'Þú gætir ekki getað eytt „<DocumentTitle/>" vegna þess að eftirfarandi skjöl vísa til þess:',
