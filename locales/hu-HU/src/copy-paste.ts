...
export default removeUndefinedLocaleResources({
  ...
  'copy-paste.on-copy.validation.clipboard-not-supported.description':
    'Vágólap hozzáférés szükséges a tartalom másolásához. Engedélyezze a vágólap engedélyeket a böngésző beállításaiban, majd próbálja meg újra másolni.',
  /** The error message that is shown when the clipboard is not supported */
  ...
  'copy-paste.on-paste.validation.read-only-fields-skipped.description':
    'Kihagyott csak olvasható mezők: {{fieldNames}}',
  /** --- On paste --- */
