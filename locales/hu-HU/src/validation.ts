...
export default removeUndefinedLocaleResources({
  ...
  'object.media-not-found': 'A tartalom nem található a Média Könyvtárban',
  /** Media object is missing a reference to a document in its `_ref` field */
  'object.not-media-library-asset': 'Egy Média Könyvtári tartalomra kell hivatkoznia',
  ...
  'panel.unpublish-message':
    'A dokumentum közzétételét visszavonják, nincsenek megjelenített érvényesítési hibák',
