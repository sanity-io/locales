...
export default removeUndefinedLocaleResources({
  ...
  'action.link-document-disabled.missing-permissions':
    'Nincs jogosultsága ehhez a dokumentumhoz hivatkozni a Vásznon',
  ...
  'dialog.confirm-document-changes.confirm': 'Elfogad és folytat',
  ...
  'dialog.confirm-document-changes.title': 'Dokumentum változásainak megerősítése',
  ...
  'dialog.unlink-from-canvas.description':
    'Ha megszünteti a hivatkozást, itt lesz szerkeszthető, és a jövőbeli szerkesztések a Vásznon már nem fognak automatikusan a dokumentumhoz rendelődni.',
  ...
  'dialog.unlink-from-canvas.unlinking':
    'Megszünteti a hivatkozást a <strong>“{{documentTitle}}”</strong> dokumentumról a Vászonról.',
