...
export default removeUndefinedLocaleResources({
  ...
  'releases.upsell.misconfiguration.header': 'Tartalomkiadások konfigurációs problémája',
  /** Message shown in the releases misconfiguration dialog */
  'releases.upsell.misconfiguration.message':
    'A tartalomkiadások engedélyezve vannak a projektedhez, de úgy tűnik, hogy konfigurációs probléma van a kiadási korlátokkal kapcsolatban. Kérjük, lépj kapcsolatba a támogatással, hogy a tartalomkiadásaid megfelelően legyenek konfigurálva.',
