...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.configuration-issue.missing-appid':
    'Az automatikus frissítések engedélyezve vannak, de nincs <code>deployment.appId</code> beállítva a <code>sanity.cli.ts</code>-ben. Ez a Studio a <strong>legújabb</strong>-csatornán frissül.',
  ...
  'about-dialog.version-info.reload-to-update': 'A Studio frissítéséhez újratöltés szükséges',
  ...
  'release.dialog.delete-schedule-draft.body':
    'Biztosan törölni szeretnéd ezt az ütemezett vázlatot? Ezt a műveletet nem lehet visszavonni.',
  ...
  'release.dialog.edit-schedule.body':
    'Válassz új dátumot és időpontot az ütemezett közzétételhez.',
  ...
  'schedule-publish-dialog.description': 'Válassza ki, mikor legyen közzétéve a dokumentum.',
  ...
  'sheet-list.edit-columns': 'Oszlopok szerkesztése',
  /** Label for the header menu option to hide a field from the sheet list */
  'sheet-list.hide-field': 'Eltávolítás a táblázatból',
