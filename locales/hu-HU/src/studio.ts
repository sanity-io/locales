...
export default removeUndefinedLocaleResources({
  ...
  'help-resources.studio-auto-update-now': 'Újratöltés a frissítéshez a v{{newVersion}} verzióra',
  ...
  'release.action.revert-unpublish-version.failure.description':
    'Kérjük, próbálja újra vagy ellenőrizze az internetkapcsolatot. A dokumentum továbbra is közzététlen marad a kiadás után.',
  /** Error message title for when a version is reverted from being unpublished */
  'release.action.revert-unpublish-version.failure.title':
    'Nem sikerült visszavonni a közzététel megszüntetésének beállítását.',
  ...
  'release.action.revert-unpublish-version.success.title':
    'Sikeresen visszavonva a közzététel megszüntetésének beállítása.',
