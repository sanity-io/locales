...
export default removeUndefinedLocaleResources({
  ...
  'divergence.action.markResolved.label': 'Mellőzés',
  ...
  'divergence.unresolved-divergence_one': 'Megoldatlan változás a {{versionName}} verzióban',
  /** Label for divergences in multiple nodes */
  'divergence.unresolved-divergence_other':
    '{{count}} megoldatlan változás a {{versionName}} verzióban',
