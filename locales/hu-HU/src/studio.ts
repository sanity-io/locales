...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.reload-to-update': 'Újratöltés a frissítéshez',
  ...
  'release.dialog.publish-scheduled-draft.body':
    'Biztosan azonnal közzé szeretnéd tenni ezt az ütemezett vázlatot?',
  /** Confirm button text for running a scheduled draft immediately */
  'release.dialog.publish-scheduled-draft.confirm': 'Igen, futtassuk most',
  ...
  'release.schedule-dialog.publish-date-in-past-warning':
    'Ütemezze ezt a kiadást egy jövőbeli időpontra és dátumra.',
