...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.how-to-upgrade': 'Frissítési útmutató',
  ...
  'asset-source.dialog.insert-asset-error':
    'Hiba az eszköz beillesztésekor. További információk a konzolon.',
  ...
  'asset-sources.common.uploader.upload-failed.description': 'További információk a konzolon.',
  ...
  'document.type.not-found': 'A "{{type}}" dokumentumtípus nem található',
  ...
  'release.toast.archived-release.description': 'Ez a kiadás már nincs kitűzve',
  ...
  'release.toast.published-release.description': 'Ez a kiadás már nincs kitűzve',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.published-release.title': "A '{{title}}' kiadás közzétéve lett",
