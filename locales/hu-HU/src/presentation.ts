...
export default removeUndefinedLocaleResources({
  ...
  'preview-frame.configuration.error.title': 'Az előnézeti URL forrása nem egyezik',
  ...
  'preview-search-param.configuration.error.description':
    'Az útválasztó a következő helyre szeretne navigálni: <Code>{{previewSearchParam}}</Code>, de a <Code>{{blockedOrigin}}</Code> forrás nem engedélyezett. Frissítse a <Code>presentationTool.allowOrigins</Code> konfigurációját az engedélyezéséhez.',
