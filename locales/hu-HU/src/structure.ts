...
export default removeUndefinedLocaleResources({
  ...
  'action.copy-document-id.label': 'Dokumentumazonosító másolása',
  ...
  'action.copy-link-to-document.label': 'Dokumentum URL-jének másolása',
  ...
  'panes.document-operation-results.operation-success_copy-id':
    'A dokumentumazonosító vágólapra másolva',
