...
export default removeUndefinedLocaleResources({
  ...
  'start-in-create-banner.subtitle':
    'Egy szabad formátumú, AI által hajtott szerkesztő, ami közvetlenül szinkronizál a Stúdió dokumentumaiddal.',
  /** Header of the "Start writing in Create" banner */
  'start-in-create-banner.title': 'Kezdj el dolgozni a Sanity Create-tel',
