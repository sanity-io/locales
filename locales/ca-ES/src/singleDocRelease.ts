...
export default removeUndefinedLocaleResources({
  ...
  'action.schedule-publish.disabled.variant':
    'La programació encara no està disponible per a les variants.',

  /** Empty state action documentation for scheduled drafts */
  'empty-state.action.documentation': 'Aprèn sobre la programació',
  /** Empty state description for scheduled drafts */
  'empty-state.description':
    'Programa i bloqueja documents esborranys per a la seva publicació en una data i hora futures.',
