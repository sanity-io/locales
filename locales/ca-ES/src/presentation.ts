...
export default removeUndefinedLocaleResources({
  ...
  'main-document.missing.text': 'Falta un document principal per a <Code>{{path}}</Code>',
  ...
  'preview-frame.loader.connection-status.label': 'Estat de connexió del Loader',
  ...
  'preview-frame.perspective.published.text': 'Visualitza aquesta pàgina amb el contingut publicat',
  ...
  'preview-frame.viewport-button.aria-label': 'Commuta la mida de la finestra de visualització',
  /** The viewport size button tooltip text when switching to a full width viewport */
  'preview-frame.viewport-button.tooltip_full': 'Canvia a la finestra de visualització completa',
  /** The viewport size button tooltip text when switching to a narrow viewport */
  'preview-frame.viewport-button.tooltip_narrow': 'Canvia a la finestra de visualització estreta',
  ...
  'share-preview-menu.error_toggle-sharing':
    "No teniu permís per activar o desactivar el compartiment d'aquesta previsualització",
  ...
  'share-preview-menu.toggle-button.tooltip_disable': 'Desactiva el compartiment',
  /** The text shown on the sharing toggle tooltip when sharing is disabled */
  'share-preview-menu.toggle-button.tooltip_enable': 'Activa el compartiment',
