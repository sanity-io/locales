...
export default removeUndefinedLocaleResources({
  ...
  'document-list-pane.ordering.by-appearance': "Per ordre d'aparició",
  ...
  'share-preview-menu.error_toggle-sharing':
    'No teniu permís per activar o desactivar el fet de compartir aquesta previsualització',
  ...
  'share-preview-menu.toggle-button.tooltip_disable': 'Desactiva el fet de compartir',
  /** The text shown on the sharing toggle tooltip when sharing is disabled */
  'share-preview-menu.toggle-button.tooltip_enable': 'Activa el fet de compartir',
