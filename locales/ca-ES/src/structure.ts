...
export default removeUndefinedLocaleResources({
  ...
  'banners.variant.not-in-variant':
    'No existeix cap document de la variant <PerspectiveTitle>{{perspectiveTitle}}</PerspectiveTitle> per a <VariantBadge>{{variantTitle}}</VariantBadge>.',
  ...
  'banners.variant.waiting.title': "S'està afegint el document a la variant…",
  ...
  'document-inspector.error.close-button.aria-label': 'Tanca el tauler',
  /** Text explaining that the inspector panel failed to render */
  'document-inspector.error.description': "S'ha produït un error en renderitzar aquest tauler.",
  /** Label for the button that attempts to render the inspector panel again */
  'document-inspector.error.retry-button.text': 'Torna-ho a intentar',
  ...
  'document-target-badges.not-in-target.tooltip':
    'El document encara no existeix en la perspective seleccionada.',
  ...
  'document-view.form-view.sync-recovering.title': "S'estan desant els vostres canvis…",
  ...
  'document-view.form-view.sync-stalled.description':
    "L'edició està en pausa fins que es desin. Els vostres canvis es conserven al navegador, de manera que mantingueu aquesta pestanya oberta mentre ho continuem intentant.",
  ...
  'menu-items.sort-by.restore-default.disabled-reason':
    "Ja s'està utilitzant l'ordenació predeterminada",
