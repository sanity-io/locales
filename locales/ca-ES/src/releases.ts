...
export default removeUndefinedLocaleResources({
  ...
  'action.archive.tooltip': 'Desplanifica aquesta release per arxivar-la',
  ...
  'action.schedule': 'Planifica la release...',
  ...
  'confirm-active-scheduled-drafts-dialog.past-dates-warning':
    "Alguns d'aquests Scheduled Drafts estan programats per a dates passades. En confirmar les programacions, es publicaran immediatament aquestes versions dels documents.",
  ...
  'discard-version-dialog.description-draft':
    'Això eliminarà permanentment tots els canvis fets en aquest document. Aquesta acció no es pot desfer.',
  /** Description for discarding a version of a document dialog */
  'discard-version-dialog.description-release':
    "Això eliminarà permanentment tots els canvis fets en aquest document dins de la versió '<strong>{{releaseTitle}}</strong>'. Aquesta acció no es pot desfer.",
  ...
  'duplicate-dialog.confirm-duplicate-description_one':
    "Això duplicarà la versió i l'1 versió del document.",
  ...
  'toast.publish.update-drafts-error':
    "La versió s'ha publicat, però els esborranys existents no s'han pogut actualitzar: {{error}}",
