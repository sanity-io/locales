...
export default removeUndefinedLocaleResources({
  ...
  'action.archive': 'Arxiva la release',
  /** Tooltip for when the archive release action is disabled due to release being scheduled  */
  'action.archive.tooltip': "Cancel·la la programació d'aquesta release per arxivar-la",
  /** Action text for showing the archived releases */
  'action.archived': 'Arxivades',
  /** Menu item label for copying release ID */
  'action.copy-release-id.label': "Copia l'ID de la release",
  /** Menu item label for copying release URL */
  'action.copy-release-link.label': "Copia l'URL de la release",
  /** Menu item label for copying release title */
  'action.copy-release-title.label': 'Copia el títol de la release',
  /** Tooltip for copy release actions button */
  'action.copy-release.label': 'Copia',
  /** Action text for staging a new revert release */
  'action.create-revert-release': 'Crea una nova release',
  /** Action text for deleting a release */
  'action.delete-release': 'Elimina la release',
  /** Menu item label for showing scheduled drafts */
  'action.drafts': 'Esborranys programats',
  /** Action text for duplicating a release */
  'action.duplicate-release': 'Duplica la release',
  /** Action text for editing a release */
  'action.edit': 'Edita la release',
  ...
  'action.schedule': 'Programa la release...',
  /** Action text for scheduling unpublish of a draft document */
  'action.schedule-unpublish': 'Programa la despublicació',
  ...
  'action.schedule-unpublish.disabled.not-published':
    "El document ha d'estar publicat per programar la despublicació",
  /** Label for unarchiving a release */
  'action.unarchive': 'Desarxiva la release',
  ...
  'banner.confirm-active-scheduled-drafts_one':
    'Hi ha {{count}} Esborrany Programat que requereix confirmació de programació',
  ...
  'banner.confirm-active-scheduled-drafts_other':
    'Hi ha {{count}} Esborranys Programats que requereixen confirmació de programació',
  ...
  'banner.scheduled-drafts-disabled':
    "Els esborranys programats s'han desactivat, però encara hi ha esborranys programats per publicar.",
  ...
  'confirm-active-scheduled-drafts-dialog.description':
    'Programa tots els Esborranys Programats en pausa per a les seves dates de publicació previstes',
  /** Dialog warning when some scheduled drafts have past dates */
  'confirm-active-scheduled-drafts-dialog.past-dates-warning':
    "Alguns d'aquests Esborranys Programats estan programats per a dates passades. En confirmar les programacions, es publicaran immediatament aquestes versions dels documents.",
  /** Dialog title for confirming active scheduled drafts */
  'confirm-active-scheduled-drafts-dialog.title': 'Reprendre els Esborranys Programats',
  ...
  'dashboard.details.metadata.status-empty': 'Sense documents',
  ...
  'delete-dialog.confirm-delete-description_other':
    'Això eliminarà {{count}} versions del document.',
  ...
  'document-validation.valid': 'Cap error de validació',
  ...
  'duplicate-dialog.confirm-duplicate-description_one':
    "Això duplicarà la versió i la versió d'1 document.",
  ...
  'overview.back-to-all-releases': 'Totes les publicacions',
  /** Tooltip for the calendar button in the release overview */
  'overview.calendar.tooltip': 'Veure el calendari',
  /** Description for the release tool */
  'overview.description':
    'Les versions són col·leccions de canvis de documents que es poden gestionar, programar i revertir conjuntament.',
  ...
  'publish-dialog.confirm-publish.update-drafts-checkbox': 'Actualitza els esborranys existents',
  ...
  'publish-dialog.confirm-publish.update-drafts-description_one':
    "L'esborrany existent de {{draftDocumentsLength}} document es descartarà perquè els esborranys coincideixin amb la release publicada. Els canvis d'esborranys no publicats es perdran.",
  ...
  'publish-dialog.confirm-publish.update-drafts-description_other':
    "Els esborranys existents de {{draftDocumentsLength}} documents es descartaran perquè els esborranys coincideixin amb la release publicada. Els canvis d'esborranys no publicats es perdran.",
  /** Label for when documents in release have validation errors */
  'publish-dialog.validation.error': 'Alguns documents tenen errors de validació',
  /** Label for when documents are being validated */
  'publish-dialog.validation.loading': "S'estan validant els documents...",
  ...
  'revert-release.title': 'S\'està revertint "{{title}}"',
  ...
  'schedule-button-tooltip.already-scheduled': 'Aquest llançament ja està programat',
  ...
  'schedule-button-tooltip.validation.loading': 'Validant documents...',
  ...
  'summary.no-documents-cardinality-one.title': 'Cap document en aquesta versió',
  ...
  'toast.copy-release-id.success': 'ID de la versió copiada al porta-retalls',
  ...
  'toast.publish.update-drafts-error':
    "La versió s'ha publicat, però no s'han pogut actualitzar els esborranys existents: {{error}}",
  ...
  'unpublish-dialog.action.cancel': 'Cancel·lar',
  /** Text action in unpublish dialog to unpublish */
  'unpublish-dialog.action.unpublish': 'Sí, despublicar en alliberar',
  ...
  'unpublish-dialog.description.lost-changes':
    'Qualsevol canvi fet a aquesta versió del document es perdrà.',
  ...
  'unpublish-dialog.description.to-draft':
    "Això despublicarà el document com a part del llançament <Label>{{title}}</Label>, i crearà un esborrany si no n'existeix cap en el moment del llançament.",
  /** Title for the dialog confirming the unpublish of a release */
  'unpublish-dialog.header':
    'Esteu segur que voleu despublicar aquest document en fer el llançament?',
  ...
  'unschedule-dialog.confirm-description':
    'El llançament ja no es publicarà en la data programada.',
  /** Title for unschedule release dialog */
  'unschedule-dialog.confirm-title': 'Esteu segur que voleu desprogramar el llançament?',
})
