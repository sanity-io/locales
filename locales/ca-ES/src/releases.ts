...
export default removeUndefinedLocaleResources({
  ...
  'duplicate-dialog.confirm-duplicate-description_other':
    'Això duplicarà la versió i les {{count}} versions de documents.',
  ...
  'loading-release-documents.error.description':
    "No podem carregar els documents d'aquesta versió. Torneu-ho a provar més tard.",
  ...
  'overview.search-releases-placeholder': 'Cercar versions',
  ...
  'schedule-dialog.confirm-description_one':
    "El llançament '<strong>{{title}}</strong>' i el seu document es publicaran en la data seleccionada.",
  /** Description for the dialog confirming the publish of a release with multiple documents */
