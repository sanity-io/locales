...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.configuration-issue.missing-appid':
    "Les actualitzacions automàtiques estan habilitades, però no s'ha configurat <code>deployment.appId</code> a <code>sanity.cli.ts</code>. Aquest Studio s'està actualitzant contra el canal <strong>latest</strong>.",
  ...
  'help-resources.studio-auto-update-now': 'Recarregar per actualitzar a v{{newVersion}}',
  ...
  'release.action.delete-schedule': 'Eliminar programació',
  /** Action message for when document is already in release  */
  ...
  'release.action.edit-schedule': 'Editar programació',
  ...
  'release.action.publish-now': 'Publicar ara',
  ...
  'release.dialog.delete-schedule-draft.confirm': 'Sí, eliminar programació',
  /** Header for the dialog confirming deletion of a scheduled draft */
  'release.dialog.delete-schedule-draft.header': 'Eliminar esborrany programat',
  /** Body text for change schedule dialog */
  'release.dialog.edit-schedule.body':
    'Selecciona una nova data i hora per a la publicació programada.',
  /** Confirm button text for change schedule dialog */
  'release.dialog.edit-schedule.confirm': "Actualitza l'horari",
  /** Header for change schedule dialog */
  'release.dialog.edit-schedule.header': "Canvia l'horari",
  ...
  'schedule-publish-dialog.header': "Programa l'esborrany per a Publicar",
