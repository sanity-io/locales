...
export default removeUndefinedLocaleResources({
  ...
  'document-group-inventory.feedback.sentiment-label':
    "Quina facilitat o dificultat té l'ús del nou inventari de versions?",
  ...
  'document-group.delete.confirm-button.text_one': 'Suprimeix (1)',
  /** The text in the "Delete now" button in the confirm delete dialog that confirms the action (plural) */
  'document-group.delete.confirm-button.text_other': 'Suprimeix ({{count}})',
  /** The message shown after deletion fails */
  'document-group.delete.error.message':
    "S'ha produït un error en intentar suprimir aquest document. Normalment això significa que hi ha altres documents que hi fan referència.",
