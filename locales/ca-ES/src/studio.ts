...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.delete-schedule-draft.body-already-current':
    'Voleu suprimir aquest esborrany programat? El vostre esborrany ja està actualitzat.',
  ...
  'release.dialog.delete-schedule-draft.body-will-save-to-draft':
    "Voleu suprimir aquest esborrany programat? Els vostres canvis es desaran a l'esborrany.",
  ...
  'release.dialog.delete-schedule-draft.body-with-choice':
    'Voleu suprimir aquest esborrany programat?',
  ...
  'release.dialog.delete-schedule-draft.different-changes-explanation':
    'El vostre esborrany programat té canvis diferents del vostre esborrany actual.',
