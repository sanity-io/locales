...
export default removeUndefinedLocaleResources({
  ...
  'document-group.create-variant.target-releases': 'En una release',
  ...
  'release.dialog.edit.title': 'Edita la release',
  ...
  'release.toast.edit-release-error.title': "No s'han pogut desar els detalls de la release",
