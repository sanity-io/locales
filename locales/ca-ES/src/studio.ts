...
export default removeUndefinedLocaleResources({
  ...
  'document-group-inventory.feedback.sentiment-label':
    "Quina facilitat o dificultat té la nova versió de l'inventari per utilitzar?",
  ...
  'document-group.create-variant.target-releases': 'En una versió',
  ...
  'document-group.delete.other-reference-count.tooltip':
    "No podem mostrar les metadades d'aquestes referències a causa d'un testimoni d'accés que falta per als datasets relacionats.",
  ...
  'inputs.portable-text.table.delete-table': 'Eliminar taula',
  ...
  'inputs.portable-text.table.select-table': 'Seleccionar taula',
  ...
  'login.logged-out.generic':
    'La vostra sessió ja no és vàlida. Si us plau, inicieu sessió de nou.',
  /** Body of the logged-out banner shown above the login form when the session expired */
  'login.logged-out.session-expired':
    'La vostra sessió ha caducat. Si us plau, inicieu sessió de nou.',
