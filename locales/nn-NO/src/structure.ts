...
export default removeUndefinedLocaleResources({
  ...
  'buttons.action-menu-button.aria-label': 'Opne dokumenthandlinger',
  ...
  'document-view.form-view.sync-lock-toast.description':
    'Vennligst vent medan dokumentet blir synkronisert. Dette skjer vanlegvis rett etter at dokumentet har blitt publisert, og det burde ikkje ta meir enn nokre sekund',
  ...
  'panes.document-operation-results.operation-success_delete': 'Dokumentet blei sletta med hell',
