...
export default removeUndefinedLocaleResources({
  ...
  'canvas.banner.popover-description':
    'Canvas lar deg forfatte i ein fri-form redigerar som automatisk kartlegg tilbake til Studio som strukturert innhald - medan du skriv.',
  ...
  'panes.document-list-pane.error.text.offline':
    'Internettforbindelsen ser ut til å vere fråkopla.',
  ...
  'panes.document-list-pane.reconnecting': 'Prøver å kople til…',
