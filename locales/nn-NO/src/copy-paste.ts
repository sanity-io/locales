...
export default removeUndefinedLocaleResources({
  ...
  'copy-paste.on-copy.validation.clipboard-not-supported.description':
    'Tilgang til utklippstavla er nødvendig for å kopiere dette innhaldet. Tillat utklippstavleløyve i nettlesarinnstillingane dine, og prøv å kopiere på nytt.',
  /** The error message that is shown when the clipboard is not supported */
  ...
  'copy-paste.on-paste.validation.read-only-fields-skipped.description':
    'Hoppa over skriveverna felt: {{fieldNames}}',
  /** --- On paste --- */
