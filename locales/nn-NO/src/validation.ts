...
export default removeUndefinedLocaleResources({
  ...
  'generic.incorrect-type': 'Forventa type "{{expectedType}}", fekk "{{actualType}}"',
  /** Value is not one of the values specifically allowed */
  'generic.not-allowed': 'Verdien samsvarar ikkje med nokon tillatne verdiar',
  /** Value "$givenValue" is not one of the values specifically allowed */
  'generic.not-allowed_hint': 'Verdien "{{hint}}" samsvarar ikkje med nokon tillatne verdiar',
  ...
  'object.media-not-found': 'Fila kunne ikkje finnast i Mediebiblioteket',
  /** Media object is missing a reference to a document in its `_ref` field */
  'object.not-media-library-asset': 'Må vere ei referanse til eit Mediebibliotek-objekt',
  ...
  'string.url.disallowed-scheme': 'Samsvarar ikkje med tillatne protokollar/skjema',
