...
export default removeUndefinedLocaleResources({
  ...
  'deleted-release': "'<strong>{{title}}</strong>'-utgivinga har vorte sletta",
  ...
  'discard-version-dialog.description-release':
    "Dette vil permanent fjerne alle endringar som er gjort i dette dokumentet i '<strong>{{releaseTitle}}</strong>'-utgivinga. Denne handlinga kan ikkje angrast.",
  ...
  'discard-version-dialog.header-release':
    "Fjerne dokumentet frå '<strong>{{releaseTitle}}</strong>'-utgivinga?",
  /** Title for dialog for discarding a draft of a document */
