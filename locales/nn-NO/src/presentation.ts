...
export default removeUndefinedLocaleResources({
  ...
  'preview-frame.navigator.toggle-button.aria-label': 'Slå navigatoren av/på',
  /** The tooltip text for the navigator toggle button */
  'preview-frame.navigator.toggle-button.tooltip': 'Slå navigatoren av/på',
  ...
  'preview-frame.refresh-button.aria-label': 'Oppdater førehandsvising',
  /** The tooltip text for the refresh button */
  'preview-frame.refresh-button.tooltip': 'Oppdater førehandsvising',
  ...
  'preview-frame.viewport-button.aria-label': 'Byt storleik på visingsområdet',
  /** The viewport size button tooltip text when switching to a full width viewport */
  'preview-frame.viewport-button.tooltip_full': 'Byt til fullt visingsområde',
  /** The viewport size button tooltip text when switching to a narrow viewport */
  'preview-frame.viewport-button.tooltip_narrow': 'Byt til smalt visingsområde',
