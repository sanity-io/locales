...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.delete-schedule-draft.body':
    'Er du sikker på at du vil slette dette planlagde utkastet? Denne handlinga kan ikkje angjerast.',
  ...
  'release.dialog.publish-scheduled-draft.confirm': 'Ja, kjør no',
