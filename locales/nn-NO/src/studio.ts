...
export default removeUndefinedLocaleResources({
  ...
  'release.action.new-release.limit-reached_other':
    'Denne arbeidsområdet er avgrensa til {{count}} utgjevingar',
  ...
  'time-zone.dialog-info.content-releases':
    'Den valde tidssonen vil endre korleis datoar vert representerte i innhaldsutgjevingar.',
  /* Dialog info for the time zone dialog */
  'time-zone.dialog-info.input':
    'Den valde tidssonen vil endre korleis datoar vert representerte berre for dette inndatafeltet i dette dokumentet.',
  /* Dialog info for the time zone dialog */
  'time-zone.dialog-info.scheduled-publishing':
    'Den valde tidssonen vil endre korleis datoar vert representerte i planlagde publiseringar.',
  /* Label for the local time zone button */
  ...
  'time-zone.time-zone-tooltip-scheduled-publishing':
    'Viser planar i {{alternativeName}} GMT{{offset}}',
