...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.reload-to-update': 'Last inn Studio på nytt for å oppdatere',
  ...
  'asset-sources.media-library.warning.file-already-exist.description':
    'Brukar den eksisterande fila funnen i biblioteket.',
  ...
  'release.menu.label': 'Utgjevingsmeny',
