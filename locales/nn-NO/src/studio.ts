...
export default removeUndefinedLocaleResources({
  ...
  'asset-sources.media-library.error.library-could-not-be-resolved':
    'Noko gjekk gale med å løyse Media Library for dette prosjektet.',
  ...
  'document.type.not-found': 'Dokumenttypen "{{type}}" blei ikkje funnen',
  ...
  'inputs.reference.global.invalid-type':
    'Det refererte dokumentet er av ein ugyldig type ({{typeName}})',
  ...
  'release.chip.tooltip.archived': 'Denne utgåva er arkivert og kan ikkje redigerast.',
  ...
  'release.dialog.create.confirm': 'Opprett utgåve',
  ...
  'release.toast.archived-release.description': 'Denne utgåva har blitt fråkopla',
  ...
  'release.toast.published-release.description': 'Denne utgåva har blitt fråkopla',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.published-release.title': "Utgåva '{{title}}' blei publisert",
