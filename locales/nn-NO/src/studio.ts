...
export default removeUndefinedLocaleResources({
  ...
  'asset-source.asset-usage-dialog.header_image': 'Dokument som bruker bilde',
  ...
  'asset-source.delete-dialog.usage-list.image-preview-alt': 'Førehandsvising av biletet',
  ...
  'asset-source.delete-dialog.usage-list.warning-file-is-in-use_unnamed':
    'Denne fila kan ikkje slettast fordi den er i bruk. For å slette henne, må du først fjerne all bruk av henne.',
  /** Warning message showing when *named* image can't be deleted because it is in use */
  'asset-source.delete-dialog.usage-list.warning-image-is-in-use_named':
    '{{filename}} kan ikkje slettast fordi det er i bruk. For å slette dette biletet, må du først fjerne all bruk av det.',
  ...
  'asset-source.dialog.default-title_image': 'Vel bilde',
  ...
  'calendar.action.set-to-current-time': 'Still til noverande tid',
  ...
  'changes.action.revert-all-confirm': 'Tilbakestill alt',
  ...
  'changes.error.incorrect-type-message':
    'Verdifor: Verdien er av typen "<code>{{actualType}}</code>", forventa "<code>{{expectedType}}</code>"',
  ...
  'form.error.no-array-item-at-index':
    'Ingen element i array ved indeks <code>{{index}}</code> funne på sti <code>{{path}}</code>',
  /** Error text shown when form is unable to find an array item at a given keyed path */
  'form.error.no-array-item-at-key':
    'Ingen element i array med `_key` <code>"{{key}}"</code> funne på sti <code>{{path}}</code>',
  ...
  'inputs.files.common.stale-upload-warning.description':
    'Ei opplasting har ikkje gjort framgang på minst {{staleThresholdMinutes}} minutt og har sannsynlegvis blitt avbrote. Du kan trygt fjerne den ufullstendige opplastinga og prøve igjen.',
  /** Incomplete upload */
  ...
  'inputs.image.preview-uploaded-image': 'Førehandsvising av opplasta bilete',
  /** The upload could not be completed at this time. */
  ...
  /** Loading image… */
  'inputs.imagetool.loading': 'Lastar bilde…',
  /** Hotspot & Crop */
  'inputs.imagetool.title': 'Hotspot & Crop',
  /** Convert to <code>`{{targetType}}`</code> */
  'inputs.invalid-value.convert-button.text': 'Konverter til <code>{{targetType}}</code>',
  /** The current value (<code>`{{actualType}}`</code>) */
  'inputs.invalid-value.current-type': 'Den nåverande verdien (<code>{{actualType}}</code>)',
  /** The property value is stored as a value type that does not match the expected type. */
  'inputs.invalid-value.description':
    'Eigedomsverdien er lagra som ein verdi type som ikkje samsvarar med den forventa typen.',
  /** The value of this property must be of type <code>`{{validType}}`</code> according to the schema. */
  'inputs.invalid-value.details.description':
    'Verdien av denne eigedomen må vere av typen <code>{{validType}}</code> i følge skjemaet.',
  /** Only the following types are valid here according to schema: */
  'inputs.invalid-value.details.multi-type-description':
    'Berre dei følgjande typene er gyldige her i følge skjemaet:',
  /** Mismatching value types typically occur when the schema has recently been changed. */
  'inputs.invalid-value.details.possible-reason':
    'Uoverensstemmende verdi typar oppstår typisk når skjemaet nyleg har blitt endra.',
  /** Developer info */
  ...
  'inputs.invalid-value.title': 'Ugyldig eigedomsverdi',
  /** Field groups */
  ...
  'inputs.portable-text.invalid-value.empty-children.action': 'Sett inn tom tekstspann',
  /** Text explaining that the Portable Text field value is invalid, when block with key `{{key}}` contains no children */
  'inputs.portable-text.invalid-value.empty-children.description':
    'Tekstblokken med nøkkel <code>{{key}}</code> har ingen tekstspann.',
  ...
  'inputs.portable-text.invalid-value.incorrect-block-type.description':
    'Blokken med nøkkel <code>{{key}}</code> har eit ugyldig typenamn. Ifølgje skjemadefinisjonen, bør det vere <code>{{expectedTypeName}}</code>.',
  ...
  'inputs.portable-text.invalid-value.missing-block-type.description':
    'Blokken med nøkkel <code>{{key}}</code> manglar eit typenamn. Ifølgje skjemadefinisjonen, bør det vere <code>{{expectedTypeName}}</code>.',
  ...
  'inputs.portable-text.invalid-value.missing-key.description':
    'Blokken på indeks <code>{{index}}</code> manglar den påkrevde <code>_key</code> eigenskapen.',
  ...
  'inputs.portable-text.invalid-value.missing-or-invalid-children.description':
    'Tekstblokken med nøkkel <code>{{key}}</code> har ein ugyldig eller manglande `children` eigenskap.',
  ...
  'inputs.portable-text.invalid-value.missing-or-invalid-markdefs.description':
    'Tekstblokken med nøkkel <code>{{key}}</code> har ein ugyldig eller manglande `markDefs` eigenskap.',
  ...
  'inputs.portable-text.invalid-value.non-object-child.description':
    'Barn på indeks <code>{{index}}</code> av blokk med nøkkel <code>{{key}}</code> er ikkje eit objekt.',
  ...
  'inputs.portable-text.invalid-value.not-an-object.description':
    'Element på <code>{{index}}</code> er ikkje eit objekt,.',
  ...
  'inputs.reference.cross-dataset.feature-disabled-actions':
    'Du kan framleis tømme denne feltets eksisterande referanse, men det kan ikkje endrast til eit anna dokument så lenge funksjonen er deaktivert.',
  ...
  'inputs.reference.error.failed-to-load-document-title':
    'Klarte ikkje å laste det refererte dokumentet',
  ...
  'inputs.reference.error.missing-read-permissions-description':
    'Det refererte dokumentet kunne ikkje bli tilgjengeleg på grunn av utilstrekkelege tillatelser',
  /** Error title for when the user does not have permissions to read the referenced document */
  'inputs.reference.error.missing-read-permissions-title': 'Utilstrekkelege tillatelser',
  ...
  'inputs.reference.image-preview-alt-text': 'Biletførevisning av det refererte dokumentet',
  /** Description for alert shown when a reference in a live-edit document is marked as being weak, the referenced document exists, AND the reference is supposed to be have been strengthened on publish */
  'inputs.reference.incomplete-reference.finalize-action-description':
    '<strong>{{referencedDocument}}</strong> er publisert og denne referansen bør no bli fullført.',
  ...
  'inputs.reference.referenced-document-insufficient-permissions':
    'Det refererte dokumentet kunne ikkje visast på grunn av utilstrekkelege rettigheiter',
  ...
  'inputs.reference.strength-mismatch.is-weak-consquences':
    'Dette gjer det mogleg å slette det refererte dokumentet utan å først slette denne referansen, noko som etterlet dette feltet som refererer til eit ikkje-eksisterande dokument.',
  ...
  'inputs.untyped-value.description':
    'Støtte på ein objektverdi utan ein <code>_type</code>-eigenskap.',
  ...
  'inputs.untyped-value.details.multi-type-description':
    'Dei følgjande typane er gyldige her i følgje skjemaet:',
  /** Developer info */
  ...
  'insufficient-permissions-message.title': 'Utilstrekkelege løyve',
  ...
  'preview.image.file-is-being-uploaded.alt-text': 'Bildet som for tida blir lasta opp',
   ...
   */
  'search.action.search-all-types': 'Søk i alle dokument',
  /**
  ...
  'search.error.display-filter-description':
    'Dette kan tyde på ugyldige alternativ definert i skjemaet ditt.',
  /** Title for error when a filter cannot be displayed (mainly a developer-oriented error) */
  'search.error.display-filter-title': 'Ein feil oppstod under vising av dette filteret.',
  ...
  'search.error.unspecified-error-help-description': 'Prøv igjen eller sjekk tilkoplinga di',
