...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.delete-schedule-draft.body':
    'Er du sikker på at du vil slette dette planlagte utkastet? Denne handlinga kan ikkje angjerast.',
  ...
  'release.dialog.edit-schedule.body': 'Vel ein ny dato og tid for den planlagte publiseringa.',
  ...
  'release.dialog.publish-scheduled-draft.body':
    'Er du sikker på at du vil publisere dette planlagde utkastet med ein gong?',
  ...
  'release.schedule-dialog.publish-date-in-past-warning':
    'Planlegg denne utgjevinga for ein framtidig tid og dato.',
  /** Label for date picker when scheduling a release */
  'release.schedule-dialog.select-publish-date-label': 'Planlegg på',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'Klarte ikkje å planleggje det planlagde utkastdokumentet <strong>{{title}}</strong> på nytt: {{error}}',
