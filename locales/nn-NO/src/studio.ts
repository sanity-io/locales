...
export default removeUndefinedLocaleResources({
  ...
  "asset-source.usage-list.documents-using-file_unnamed_one":
    "Eitt dokument brukar denne fila",
  ...
  "asset-source.usage-list.documents-using-file_unnamed_zero":
    "Ingen dokument brukar denne fila",
  ...
  "asset-source.usage-list.documents-using-image_unnamed_one":
    "Eitt dokument brukar dette biletet",
  ...
  "calendar.error.must-be-in-format":
    "Må vere i formatet <Emphasis>{{exampleDate}}</Emphasis>",
  ...
  "changes.error-boundary.developer-info":
    "Sjekk utviklarkonsollen for meir informasjon",
  /** Text shown when a diff component crashes during rendering, triggering the error boundary */
  "changes.error-boundary.title":
    "Å gjengi endringane til dette feltet forårsaka ein feil",
  ...
  "inputs.array.error.json-representation-description":
    "JSON-representasjon av dette elementet:",
  ...
  "inputs.files.common.actions-menu.notification.url-copied":
    "URL-en er kopiert til utklippstavla",
  /** Replace */
  ...
  "inputs.image.actions-menu.edit-details.aria-label":
    "Opne dialog for å redigere bilete",
  /** Accessibility label for button to open image options menu */
  "inputs.image.actions-menu.options.aria-label":
    "Opne meny for biletealternativ",
  /** Select */
  ...
  "inputs.image.drag-overlay.drop-to-upload-image":
    "Slepp bilete for å laste opp",
  /** This field is read only */
  "inputs.image.drag-overlay.this-field-is-read-only":
    "Dette feltet er berre lese",
  /** Unknown member kind: `{{kind}}` */
  ...
  /** Loading image… */
  "inputs.imagetool.loading": "Lastar inn bilete…",
  /** Hotspot & Crop */
  "inputs.imagetool.title": "Hotspot & Crop",
  /** Convert to <code>`{{targetType}}`</code> */
  "inputs.invalid-value.convert-button.text":
    "Konverter til <code>{{targetType}}</code>",
  /** The current value (<code>`{{actualType}}`</code>) */
  "inputs.invalid-value.current-type":
    "Den gjeldande verdien (<code>{{actualType}}</code>)",
  ...
  "inputs.reference.document-opens-in-new-tab":
    "Dette dokumentet opnast i ein ny fane",
  ...
  "inputs.reference.image-preview-alt-text":
    "Biletførehandsvisning av referert dokument",
  ...
  "inputs.reference.no-results-for-query":
    "Ingen resultat for <strong>“{{searchTerm}}”</strong>",
  ...
  "inputs.untyped-value.details.json-dump-prefix":
    "Noeverande verdi (<code>objekt</code>):",
  ...
  "new-document.no-results":
    "Ingen resultat for <strong>{{searchQuery}}</strong>",
  ...
  "presence.no-one-else-description":
    "Inviter folk til prosjektet for å sjå deira online status.",
  ...
  "preview.image.file-is-being-uploaded.alt-text":
    "Biletet som for tida blir lasta opp",
  ...
  "search.error.display-filter-title":
    "Ein feil oppstod ved visning av dette filteret.",
  ...
  "search.error.no-valid-asset-source-title":
    "Ingen gyldige ressurskjelder funne.",
  /** Helpful description for when search returned an error that we are not able to describe in detail */
  "search.error.unspecified-error-help-description":
    "Prøv igjen eller sjekk tilkoblinga di",
  ...
  "search.no-results-help-description":
    "Prøv eit anna søkeord eller juster filtrene dine",
  ...
  "search.operator.date-range.description":
    "<Field/> <Operator>er mellom</Operator> <Value/>",
  ...
  "search.operator.not-defined.description":
    "<Field/> <Operator>er</Operator> <Value>tom</Value>",
