...
export default removeUndefinedLocaleResources({
  ...
  'invalid-video-warning.description':
    'Verdien av dette feltet er ikkje ein gyldig video. Å tilbakestille dette feltet vil la deg velje ein ny video.',
  ...
  'video-error.description': 'Klarte ikkje å laste video',
