...
export default removeUndefinedLocaleResources({
  ...
  'activity.panel.close': 'Chiudi attività',
  ...
  'document-validation.valid': 'Nessun errore di convalida',
  ...
  'overview.back-to-all-releases': 'Tutte le release',
  ...
  'presence.tooltip.one-without-release':
    '{{displayName}} sta modificando questo documento in questo momento',
  ...
  'table-header.edited-by': 'Modificato da',
  ...
  'table-header.last-edited': 'Ultima modifica',
