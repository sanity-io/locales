...
export default removeUndefinedLocaleResources({
  ...
  'summary.all-documents-errors-found': 'Tutti i documenti validati, problemi riscontrati',
  /** Text for when the release has validated all documents */
  'summary.all-documents-validated': 'Tutti i documenti validati, nessun problema riscontrato',
  ...
  'summary.errors-found':
    'Per pubblicare o pianificare la release, risolvi i problemi riscontrati nei documenti',
  ...
  'summary.validating-documents': 'Validazione documenti: {{validatedCount}} di {{totalCount}}',
