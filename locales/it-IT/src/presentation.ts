...
export default removeUndefinedLocaleResources({
  ...
  'preview-frame.configuration.error.description':
    "L'iframe di anteprima è configurato per caricare <Code>{{targetOrigin}}</Code>, ma l'origine segnalata è <Code>{{reportedOrigin}}</Code>. Presentation Tool non è in grado di connettersi a origini sconosciute per motivi di sicurezza. Aggiorna la configurazione <Code>presentationTool.allowOrigins</Code> per consentire la connessione a Visual Editing e Loaders.",
