...
export default removeUndefinedLocaleResources({
  ...
  "array.exact-length_blocks":
    "Deve contenere esattamente {{wantedLength}} blocchi",
  ...
  "array.maximum-length_blocks":
    "Deve contenere al massimo {{maxLength}} blocchi",
  ...
  "date.invalid-format":
    "Deve essere una stringa di data formattata ISO-8601 valida",
  ...
  "generic.incorrect-type":
    'Tipo atteso "{{expectedType}}", trovato "{{actualType}}"',
  /** Value is not one of the values specifically allowed */
  "generic.not-allowed":
    "Il valore non corrisponde a nessuno dei valori consentiti",
  ...
  "object.reference-not-published":
    "Il documento di riferimento deve essere pubblicato",
  ...
  "string.maximum-length":
    "Deve essere lungo al massimo {{maxLength}} caratteri",
  ...
  "string.url.disallowed-scheme":
    "Non corrisponde ai protocolli/schemi consentiti",
