...
export default removeUndefinedLocaleResources({
  ...
  'action.schedule-publish-error': 'Pianificazione della pubblicazione non riuscita',
  ...
  'action.schedule-publish.disabled.variant':
    'La pianificazione non è ancora disponibile per le varianti.',

  /** Empty state action documentation for scheduled drafts */
  'empty-state.action.documentation': 'Scopri la pianificazione',
  /** Empty state description for scheduled drafts */
  'empty-state.description':
    "Pianifica e blocca i documenti in bozza per la pubblicazione in una data e un'ora future.",
