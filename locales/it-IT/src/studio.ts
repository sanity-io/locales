...
export default removeUndefinedLocaleResources({
  ...
  'release.toast.archived-release.description': 'Questa release è stata deselezionata',
  ...
  'release.toast.published-release.description': 'Questa release è stata deselezionata',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
