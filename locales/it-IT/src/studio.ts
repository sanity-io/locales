...
export default removeUndefinedLocaleResources({
  ...
  'document-group-inventory.feedback.sentiment-label':
    "Quanto è facile o difficile utilizzare la nuova versione dell'inventario?",
  ...
  'document-group.delete.error.message':
    'Si è verificato un errore durante il tentativo di eliminazione di questo documento. Di solito ciò significa che ci sono altri documenti che vi fanno riferimento.',
