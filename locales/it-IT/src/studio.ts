...
export default removeUndefinedLocaleResources({
  ...
  "asset-source.asset-usage-dialog.header_file":
    "Documenti che utilizzano il file",
  /** Header in usage dialog for image assets */
  "asset-source.asset-usage-dialog.header_image":
    "Documenti che utilizzano l’immagine",
  ...
  "changes.array.item-moved_down_other":
    "Spostato di {{count}} posizioni in giù",
  /**
  ...
  "changes.array.item-removed-from-position":
    "Rimosso dalla posizione {{position}}",
  ...
  "help-resources.latest-sanity-version":
    "L'ultima versione è {{latestVersion}}",
  /** Information for what studio version the current studio is running */
  "help-resources.studio-version":
    "Versione di Sanity Studio {{studioVersion}}",
  ...
  "inputs.array.error.json-representation-description":
    "Rappresentazione JSON di questo elemento:",
  ...
  "inputs.file.actions-menu.file-options.aria-label":
    "Apri il menu delle opzioni del file",
  /** Browse */
  ...
  "inputs.file.error.unknown-member-kind":
    "Tipo di membro sconosciuto: {{kind}}",
  ...
  "inputs.files.common.placeholder.drag-or-paste-to-upload_file":
    "Trascina o incolla qui il file",
  ...
  "inputs.files.common.placeholder.upload-not-supported":
    "Non è possibile caricare file qui",
  /** Clear upload */
  ...
  "inputs.image.actions-menu.edit-details.aria-label":
    "Apri la finestra di modifica dell'immagine",
  /** Accessibility label for button to open image options menu */
  "inputs.image.actions-menu.options.aria-label":
    "Apri il menu delle opzioni dell'immagine",
  /** Select */
  ...
  "inputs.invalid-value.convert-button.text":
    "Converti in <code>{{targetType}}</code>",
  /** The current value (<code>`{{actualType}}`</code>) */
  "inputs.invalid-value.current-type":
    "Il valore attuale (<code>{{actualType}}</code>)",
  ...
  "inputs.portable-text.action.insert-inline-object-aria-label":
    "Inserisci {{typeName}} (inline)",
  /** Label for action to remove an annotation */
  "inputs.portable-text.action.remove-annotation": "Rimuovi annotazione",
  ...
  "inputs.portable-text.invalid-value.empty-children.action":
    "Inserisci intervallo di testo vuoto",
  ...
  "inputs.reference.document-opens-in-new-tab":
    "Questo documento si apre in una nuova scheda",
  ...
  "inputs.reference.error.search-failed-title":
    "Ricerca della referenza fallita",
  /** Alternative text for the image shown in cross-dataset reference input */
  "inputs.reference.image-preview-alt-text":
    "Anteprima immagine del documento di riferimento",
  ...
  "inputs.reference.metadata-error.title":
    "Impossibile caricare i metadati del riferimento",
  ...
  "inputs.untyped-value.details.json-dump-prefix":
    "Valore corrente (<code>object</code>):",
  ...
  "inputs.untyped-value.title":
    "Valore della proprietà mancante di <code>_type</code>",
  /** Unset value */
  ...
  "presence.no-one-else-description":
    "Invita persone al progetto per vedere il loro stato online.",
  ...
  "preview.image.file-is-being-uploaded.alt-text":
    "L'immagine attualmente in caricamento",
  ...
  "search.document-types-no-matches-found":
    "Nessuna corrispondenza per {{filter}}",
  ...
  "search.error.no-valid-asset-source-title":
    "Nessuna fonte di asset valida trovata.",
  ...
  "search.filter-field-tooltip-used-in-document-types":
    "Utilizzato nei tipi di documento",
  ...
  "search.no-results-help-description":
    "Prova un'altra parola chiave o aggiusta i tuoi filtri",
  ...
  "search.operator.date-range.description":
    "<Field/> <Operator>è tra</Operator> <Value/>",
  ...
  "search.operator.defined.description":
    "<Field/> <Operator>è</Operator> <Value>non vuoto</Value>",
  "search.operator.defined.name": "non vuoto",
  /* Value should not be defined */
  "search.operator.not-defined.description":
    "<Field/> <Operator>è</Operator> <Value>vuoto</Value>",
  ...
  "timeline.error.no-document-history-title":
    "Nessuna cronologia del documento",
  ...
  "workspaces.action.choose-another-workspace":
    "Scegli un altro spazio di lavoro",
