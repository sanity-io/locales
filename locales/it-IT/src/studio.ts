...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.copy-to-clipboard-button.copied-text':
    'Copiato negli Appunti. Buon incollaggio!',
  ...
  /** "Latest version" header in about dialog */
  'about-dialog.version-info.latest-version.text': "L'ultima versione è {{latestVersion}}",
  ...
  'asset-sources.media-library.file.title': 'Libreria multimediale',
  'asset-sources.media-library.image.title': 'Libreria multimediale',
  ...
  'calendar.action.select-time': 'Seleziona orario',
  ...
  'form.reconnecting.toast.title': 'Connessione persa. Riconnessione in corso…',
  ...
  'inputs.files.common.placeholder.select-asset-source-upload-destination': 'Carica file su:',
  ...
  'inputs.reference.global.invalid-type':
    'Il documento di riferimento è di tipo non valido ({{typeName}})',
