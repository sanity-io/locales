...
export default removeUndefinedLocaleResources({
  ...
  "action.discard-changes.disabled.no-change":
    "Questo documento non ha modifiche non pubblicate",
  /** Tooltip when action is disabled because the document is not published */
  "action.discard-changes.disabled.not-published":
    "Questo documento non è pubblicato",
  /** Tooltip when action button is disabled because the operation is not ready   */
  ...
  "action.publish.already-published.tooltip":
    "Pubblicato {{timeSincePublished}} fa",
  ...
  "action.publish.waiting":
    "In attesa che le attività vengano completate prima di pubblicare",
  /** Message prompting the user to confirm that they want to restore to an earlier version*/
  "action.restore.confirm-dialog.confirm-discard-changes":
    "Sei sicuro di voler ripristinare questo documento?",
  ...
  "confirm-delete-dialog.cdr-summary.title_one":
    "{{documentCount}} in un altro dataset",
  /** The text that appears in the title `<summary>` that includes the list of CDRs (plural) */
  "confirm-delete-dialog.cdr-summary.title_other":
    "{{documentCount}} in {{count}} dataset",
  ...
  "confirm-delete-dialog.confirm-anyway-button.text_unpublish":
    "Rimuovi pubblicazione comunque",
  /** The text in the "Delete now" button in the confirm delete dialog that confirms the action */
  "confirm-delete-dialog.confirm-button.text_delete": "Elimina ora",
  /** The text in the "Unpublish now" button in the confirm delete dialog that confirms the action */
  "confirm-delete-dialog.confirm-button.text_unpublish":
    "Rimuovi pubblicazione ora",
  ...
  /** The header of the confirm delete dialog */
  "confirm-delete-dialog.header.text_unpublish":
    "Rimuovere la pubblicazione del documento?",
  /** The text that appears while the referring documents are queried */
  "confirm-delete-dialog.loading.text":
    "Ricerca dei documenti di riferimento in corso…",
  /** Shown if there are references to other documents but the user does not have the permission to see the relevant document IDs */
  "confirm-delete-dialog.other-reference-count.title_one":
    "1 altro riferimento non mostrato",
  /** Shown if there are references to other documents but the user does not have the permission to see the relevant document IDs */
  ...
  "doc-title.unknown-schema-type.text":
    "Tipo di schema sconosciuto: {{schemaType}}",
  ...
  "document-view.form-view.sync-lock-toast.title":
    "Sincronizzazione documento in corso…",

  /** The loading messaging for when the tooltip is still loading permission info */
  "insufficient-permissions-message-tooltip.loading-text":
  ...
  "no-document-types-screen.link-text":
    "Scopri come aggiungere un tipo di documento →",
  /** The subtitle of the no document type screen that appears directly below the title */
  "no-document-types-screen.subtitle":
    "Definisci almeno un tipo di documento nel tuo schema.",
  ...
  "panes.document-list-pane.error.title":
    "Impossibile recuperare gli elementi dell'elenco",
  /** The text of the document list pane if more than a maximum number of documents are returned */
  "panes.document-list-pane.max-items.text":
    "Visualizzazione di un massimo di {{limit}} documenti",
  ...
  "panes.document-list-pane.no-matching-documents.text":
    "Nessun documento corrispondente",
  ...
  "panes.document-pane.document-not-found.loading":
  ...
  "panes.document-pane.document-not-found.title":
  ...
  "status-bar.review-changes-button.status.syncing.text":
  ...
  "structure-error.header.text":
    "Si è verificato un errore durante la lettura della struttura",
