...
export default removeUndefinedLocaleResources({
  ...
  'banners.deleted-bundle-banner.text': "La release '<strong>{{title}}</strong>' a été supprimée.",
  ...
  'new-document.disabled-published.tooltip':
    'Vous ne pouvez pas créer de nouveaux documents publiés',
  ...
  'new-document.disabled-release.tooltip':
    'Vous ne pouvez pas ajouter de documents à cette release',
  ...
  'release.action.add-to-new-release': 'Ajouter à la release',
  /** Action message to add document to release */
  'release.action.add-to-release': 'Ajouter à {{title}}',
  /** Action message for when document is already in release  */
  'release.action.already-in-release': 'Déjà dans la release {{title}}',
  /** Action message for when you click to view all versions you can copy the current document to */
  'release.action.copy-to': 'Copier la version vers',
  /** Action message for creating new releases */
  'release.action.create-new': 'Nouvelle release',
  /** Action message for when document is already in release  */
  ...
  'release.action.discard-version.success':
    'La version <strong>{{title}}</strong> a été supprimée avec succès',
  /** Action message for when a new release is created off an existing version, draft or published document */
  'release.action.new-release': 'Nouvelle Release',
  /** Tooltip message for not having permissions for creating new releases */
  'release.action.permission.error': "Vous n'avez pas la permission d'effectuer cette action",
  /** Error message for when a version is set to be unpublished */
  'release.action.unpublish-version.failure':
    'Échec de la définition de la version à dépublier sur la release',
  /** Action message for when a version is set to be unpublished successfully */
  'release.action.unpublish-version.success':
    'La version <strong>{{title}}</strong> a été définie avec succès pour être dépubliée sur la release',
  /** Action message for when the view release is pressed */
  'release.action.view-release': 'Voir la release',
  /** Label for banner when release is scheduled */
  'release.banner.scheduled-for-publishing-on': 'Programmée pour la publication le {{date}}',
  ...
  'release.dialog.tooltip.note': 'Vous pouvez toujours le modifier plus tard.',
  /** Title for tooltip to explain release time */
  'release.dialog.tooltip.title': 'Heure approximative de sortie',
  /** The placeholder text when the release doesn't have a description */
  'release.form.placeholder-describe-release': 'Décrire la version…',
  ...
  'release.toast.create-release-error.title': 'Échec de la création de la version',
