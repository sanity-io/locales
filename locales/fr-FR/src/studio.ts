...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.reload-to-update': 'Rechargez le Studio pour mettre à jour',
  ...
  'about-dialog.version-info.update-button.tooltip': 'Apprenez comment mettre à jour Sanity Studio',
  ...
  'release.dialog.delete-schedule-draft.body':
    'Êtes-vous sûr de vouloir supprimer ce brouillon programmé ? Cette action est irréversible.',
