...
export default removeUndefinedLocaleResources({
  ...
  "asset-source.asset-usage-dialog.header_file":
    "Documents utilisant le fichier",
  ...
  "asset-source.file.asset-list.action.select-file.title":
    "Sélectionnez le fichier {{filename}}",
  "asset-source.file.asset-list.action.show-usage.title":
  ...
  "asset-source.usage-list.documents-using-file_unnamed_one":
    "Un document utilise ce fichier",
  ...
  "asset-source.usage-list.documents-using-image_unnamed_one":
    "Un document utilise cette image",
  ...
  "calendar.error.must-be-in-format":
    "Doit être au format <Emphasis>{{exampleDate}}</Emphasis>",
  ...
  "changes.action.revert-changes-confirm-change_other":
  ...
  "changes.array.item-moved_down_other":
    "Déplacé de {{count}} positions vers le bas",
  /**
  ...
  "changes.array.item-moved_up_other":
    "Déplacé de {{count}} positions vers le haut",
  /** Array diff: An item was removed from a given position (`{{position}}`) */
  "changes.array.item-removed-from-position":
    "Retiré de la position {{position}}",
  ...
  "changes.error-boundary.title":
    "Le rendu des modifications de ce champ a provoqué une erreur",
  ...
  /** Add missing keys */
  "form.error.missing-keys-alert.add-button.text":
  ...
  "form.error.mixed-array-alert.remove-button.text":
    "Supprimer les valeurs non-objet",
  ...
  "help-resources.latest-sanity-version":
    "La dernière version est {{latestVersion}}",
  ...
  "inputs.array.error.json-representation-description":
    "Représentation JSON de cet élément :",
  ...
  "inputs.file.actions-menu.file-options.aria-label":
    "Ouvrir le menu des options de fichier",
  /** Browse */
  ...
  /** Reset value */
  "inputs.file.invalid-file-warning.reset-button.text":
  ...
  "inputs.image.actions-menu.options.aria-label":
    "Ouvrir le menu des options d’image",
  /** Select */
  ...
  "inputs.image.drag-overlay.drop-to-upload-image":
    "Déposez l’image pour la télécharger",
  ...
  /** Reset value */
  "inputs.image.invalid-image-warning.reset-button.text":
    "Réinitialiser la valeur",
  /** Invalid image value */
  ...
  "inputs.invalid-value.convert-button.text":
    "Convertir en <code>{{targetType}}</code>",
  /** The current value (<code>`{{actualType}}`</code>) */
  "inputs.invalid-value.current-type":
    "La valeur actuelle (<code>{{actualType}}</code>)",
  ...
  "inputs.portable-text.invalid-value.empty-children.action":
    "Insérer un segment de texte vide",
  ...
  "inputs.portable-text.invalid-value.invalid-span-text.action":
    "Définir une valeur de texte vide",
  ...
  "inputs.portable-text.invalid-value.title":
    "Valeur de Portable Text invalide",
  ...
  "inputs.reference.document-opens-in-new-tab":
    "Ce document s’ouvre dans un nouvel onglet",
  ...
  "inputs.reference.error.search-failed-title":
    "Échec de la recherche de référence",
  /** Alternative text for the image shown in cross-dataset reference input */
  "inputs.reference.image-preview-alt-text":
    "Aperçu de l’image du document référencé",
  ...
  "inputs.reference.metadata-error.title":
    "Impossible de charger les métadonnées de référence",
  ...
  "inputs.reference.resolving-initial-value":
    "Résolution de la valeur initiale…",
  ...
  "inputs.untyped-value.details.json-dump-prefix":
    "Valeur actuelle (<code>object</code>) :",
  ...
  "inputs.untyped-value.title":
    "Valeur de propriété manquante <code>_type</code>",
  /** Unset value */
  ...
  "preview.image.file-is-being-uploaded.alt-text":
    "L’image en cours de téléchargement",
  ...
  "search.action.search-specific-types-truncated":
    "Rechercher {{types, list}} +{{count}} de plus",
  ...
  "search.document-types-no-matches-found":
    "Aucune correspondance pour {{filter}}",
  ...
  "search.error.no-valid-asset-source-title":
    "Aucune source d’actif valide trouvée.",
  ...
  "search.error.unspecified-error-title":
    "Un problème est survenu lors de la recherche",
  /**
  ...
  "search.filter-field-tooltip-used-in-document-types":
    "Utilisé dans les types de documents",
  ...
  "search.instructions":
    "Utilisez <ControlsIcon/> pour affiner votre recherche",
  /** Helpful description for when no search results are found */
  "search.no-results-help-description":
    "Essayez un autre mot-clé ou ajustez vos filtres",
  ...
  "search.operator.date-range.description":
    "<Field/> <Operator>est entre</Operator> <Value/>",
  ...
  "search.ordering.created-descending-label":
    "Créé : Le plus récent en premier",
  /** Label for the "Updated: Oldest first" search ordering type */
  "search.ordering.updated-ascending-label":
    "Mis à jour : Le plus ancien en premier",
  /** Label for the "Updated: Newest first" search ordering type */
  "search.ordering.updated-descending-label":
    "Mis à jour : Le plus récent en premier",
  ...
  "user-menu.color-scheme.system-description":
    "Utiliser l’apparence du système",
  ...
  "workspaces.action.choose-another-workspace":
    "Choisissez un autre espace de travail",
  /** Label for heading that indicates that you can choose your workspace */
  "workspaces.choose-your-workspace-label":
