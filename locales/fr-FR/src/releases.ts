...
export default removeUndefinedLocaleResources({
  ...
  'discard-version-dialog.header-draft': 'Ignorer le brouillon ?',
  ...
  /** Title for dialog for discarding a draft of a document */
  'discard-version-dialog.title-draft': 'Ignorer le brouillon',
  ...
  'loading-release-documents.error.description':
    'Nous ne sommes pas en mesure de charger les documents pour cette version. Veuillez réessayer plus tard.',
  ...
  'unpublish-dialog.description.to-draft':
    "Cela dépubliera le document dans le cadre de la version <Label>{{title}}</Label>, et créera un brouillon si aucun brouillon n'existe au moment de la mise en ligne.",
  /** Title for the dialog confirming the unpublish of a release */
  'unpublish-dialog.header':
    'Êtes-vous sûr de vouloir dépublier ce document lors de la mise en ligne ?',
