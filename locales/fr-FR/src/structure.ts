...
export default removeUndefinedLocaleResources({
  ...
  'canvas.banner.popover-description':
    'Canvas vous permet de rédiger dans un éditeur libre qui se convertit automatiquement en contenu structuré dans le Studio au fur et à mesure de votre saisie.',
