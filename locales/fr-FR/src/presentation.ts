...
export default removeUndefinedLocaleResources({
  ...
  'document-list-pane.ordering.by-appearance': "Par ordre d'apparition",
  /** The label for the ordering that lists documents by when they were last edited */
  'document-list-pane.ordering.last-edited': 'Dernière modification',
  ...
  'preview-frame.configuration.error.description':
    "L'iframe de prévisualisation est configurée pour charger <Code>{{targetOrigin}}</Code>, mais l'origine signalée est <Code>{{reportedOrigin}}</Code>. Presentation Tool ne peut pas se connecter à des origines inconnues pour des raisons de sécurité. Mettez à jour votre configuration <Code>presentationTool.allowOrigins</Code> pour autoriser la connexion à Visual Editing et aux Loaders.",
  ...
  'preview-frame.loader.connection-status.label': 'Statut de connexion du chargeur',
  ...
  'preview-frame.overlay.connection-status.label': "Statut de connexion de l'overlay",
  ...
  'share-preview-menu.copy-url.text': 'Copier le lien de prévisualisation',
  /** Fallback message shown when the current user is not permitted to share previews */
  'share-preview-menu.error_missing-grants':
    "Vous n'avez pas la permission de partager des prévisualisations. ",
  ...
  'share-preview-menu.error_toggle-sharing':
    "Vous n'avez pas la permission d'activer ou désactiver le partage de cette prévisualisation",
  /** The text show below the QR Code SVG, with instructions on how to use it */
  'share-preview-menu.qr-code.instructions':
    'Scannez le QR Code pour ouvrir la prévisualisation sur votre téléphone.',
  ...
  'share-preview-menu.toggle-button.label_first-line': 'Partager cette prévisualisation',
  ...
  'share-url.menu-item.open.text': 'Ouvrir la prévisualisation',
})
