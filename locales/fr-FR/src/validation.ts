...
export default removeUndefinedLocaleResources({
  ...
  "array.exact-length_blocks":
    "Doit contenir exactement {{wantedLength}} blocs",
  ...
  "date.invalid-format":
    "Doit être une chaîne de date formatée ISO-8601 valide",
  ...
  "string.exact-length":
    "Doit comporter exactement {{wantedLength}} caractères",
  ...
  "string.url.disallowed-scheme":
    "Ne correspond pas aux protocoles/schémas autorisés",
  /** String contains a URL with a username or password specified before the host */
  "string.url.includes-credentials":
    "Nom d’utilisateur/mot de passe non autorisé",
