...
export default removeUndefinedLocaleResources({
  ...
  'settings.perspective.preview-drafts-renamed-to-drafts.description':
    'La perspective "<code>previewDrafts</code>" a été renommée en "<code>drafts</code>" et est maintenant obsolète. Ce changement est effectif pour toutes les versions avec support de perspective (>= v2021-03-25).',
