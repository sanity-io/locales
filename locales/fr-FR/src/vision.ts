...
export default removeUndefinedLocaleResources({
  ...
  'settings.perspectives.new-default.description':
    'La perspective par défaut passera de "<code>raw</code>" à "<code>published</code>" dans une version ultérieure de l\'API. Veuillez consulter la documentation pour plus de détails.',
