...
export default removeUndefinedLocaleResources({
  ...
  'changes.error.incorrect-type-message':
    '值错误：值的类型为 "<code>{{actualType}}</code>", 预期为 "<code>{{expectedType}}</code>"',
  ...
  'changes.inspector.meta-label': '元信息',
  ...
  'changes.portable-text.block-style-changed': '已将区块样式从“{{fromStyle}}”更改为“{{toStyle}}”',
  ...
  'changes.portable-text.inline-object_unchanged': '内联对象未改变',
  ...
  'form.error.duplicate-keys-alert.details.additional-description':
    '<code>_key</code>属性的值必须是唯一的字符串。',
  /** This usually happens when items are created using an API client, and the <code>_key</code> property of each elements has been generated non-uniquely. */
  'form.error.duplicate-keys-alert.details.description':
    '这通常发生在使用API客户端创建项目时，每个元素的<code>_key</code>属性生成不唯一。',
  /** Developer info */
  ...
  'form.error.duplicate-keys-alert.summary':
    '此列表中的几个项目共享相同的标识符（键）。每个项目必须有一个唯一的标识符。',
  /** Non-unique keys */
  ...
  'form.error.missing-keys-alert.details.description':
    '这通常发生在使用API客户端创建项目时，且没有包含<code>_key</code>属性。',
  /** Developer info */
  'form.error.missing-keys-alert.details.title': '开发者信息',
  /** Some items in the list are missing their keys. This must be fixed in order to edit the list. */
  'form.error.missing-keys-alert.summary': '列表中的一些项目缺少键值。必须修复此问题才能编辑列表。',
  /** Missing keys */
  ...
  'form.error.mixed-array-alert.summary':
    '此列表中的一些项目不是对象。必须修复此问题才能编辑列表。',
  /** Invalid list values */
  'form.error.mixed-array-alert.title': '无效的列表值',
  /** Error text shown when form is unable to find an array item at a given indexed path */
  'form.error.no-array-item-at-index':
    '在路径 <code>{{path}}</code> 未找到索引为 <code>{{index}}</code> 的数组项',
  /** Error text shown when form is unable to find an array item at a given keyed path */
  'form.error.no-array-item-at-key':
    '在路径 <code>{{path}}</code> 未找到 `_key` 为 <code>"{{key}}"</code> 的数组项',
  ...
  'help-resources.latest-sanity-version': '最新版本为 {{latestVersion}}',
  ...
  'inputs.array.error.current-schema-not-declare-description':
    '当前模式没有声明类型为<code>{{typeName}}</code>的项对此列表有效。这可能意味着该类型已被移除为有效项类型，或者有人已将其添加到尚未部署的本地模式中。',
  ...
  'inputs.array.error.type-is-incompatible-prompt':
    '类型为<code>{{typeName}}</code>的项对此列表无效',
  ...
  'inputs.files.common.stale-upload-warning.description':
    '上传至少{{staleThresholdMinutes}}分钟没有进展，很可能被中断了。您可以安全地清除未完成的上传并再次尝试上传。',
  /** Incomplete upload */
  ...
  /** Loading image… */
  'inputs.imagetool.loading': '正在加载图片…',
  /** Hotspot & Crop */
  ...
  'inputs.invalid-value.details.possible-reason': '当架构最近发生变化时，通常会出现值类型不匹配。',
  /** Developer info */
  ...
  'inputs.object.unknown-fields.read-only.description':
    '根据文档的架构，此字段为<strong>只读</strong>，不能被取消设置。如果您希望在Studio中能够取消设置此项，请确保从架构中的封闭类型中删除<code>readOnly</code>字段。',
  /** Remove field */
  ...
  'inputs.portable-text.invalid-value.action-disclaimer':
    '注意：通常执行上述操作是安全的，但如果您有疑问，请与负责配置您的工作室的人员联系。',
  ...
  'inputs.portable-text.invalid-value.incorrect-block-type.description':
    '键为 <code>{{key}}</code> 的块的类型名称无效。根据模式，它应该是 <code>{{expectedTypeName}}</code>。',
  ...
  'inputs.portable-text.invalid-value.invalid-span-text.description':
    '键为 {{childKey}} 的块的键为 <code>{{key}}</code> 的跨度缺少或具有无效的 <code>text</code> 属性。',
  ...
  'inputs.portable-text.invalid-value.missing-child-key.description':
    '键为 <code>{{key}}</code> 的块的索引 <code>{{index}}</code> 处的子项缺少 <code>_key</code> 属性。',
  ...
  'inputs.portable-text.invalid-value.missing-child-type.description':
    '键为 <code>{{key}}</code> 的块的键为 {{childKey}} 的子项缺少 <code>_type</code> 属性。',
  ...
  'inputs.portable-text.invalid-value.missing-or-invalid-children.description':
    '键为 <code>{{key}}</code> 的文本块有一个无效或缺失的 `children` 属性。',
  ...
  'inputs.portable-text.invalid-value.non-object-child.description':
    '键为 <code>{{key}}</code> 的块中索引为 <code>{{index}}</code> 的子项不是一个对象。',
  ...
  'inputs.portable-text.invalid-value.orphaned-marks.description':
    '键为 <code>{{key}}</code> 的文本块包含不被架构允许的标记 <code>({{orphanedMarks, list}})</code>。',
  /** Title for the alert indicating that the Portable Text field has an invalid value */
  'inputs.portable-text.invalid-value.title': '无效的Portable Text值',
  ...
  'inputs.reference.cross-dataset.feature-disabled-actions':
    '您仍然可以清除此字段的现有引用，但只要该功能被禁用，就无法将其更改为不同的文档。',
  ...
  'inputs.reference.referenced-document-does-not-exist':
    '引用的文档不再存在，可能已被删除（文档 ID：<code>{{documentId}}</code>）。',
  ...
  'inputs.reference.strength-mismatch.is-weak-consquences':
    '这使得可以在不先删除此引用的情况下删除被引用的文档，留下一个引用不存在的文档的字段。',
  ...
  'inputs.slug.error.missing-source': '源缺失。检查模式中类型{{schemaType}}的源',
  /** Convert to <code>`{{targetType}}`</code> */
  ...
  'inputs.untyped-value.details.description':
    '要么移除对象声明的<code>name</code>属性，要么在项目上设置<code>_type</code>属性。',
  ...
  'search.error.no-valid-asset-source-only-default-description': '目前，只支持默认资产来源。',
  /** Title for error when no valid asset sources found */
  'search.error.no-valid-asset-source-title': '未找到有效的资产来源。',
  /** Helpful description for when search returned an error that we are not able to describe in detail */
  'search.error.unspecified-error-help-description': '请重试或检查您的连接',
  ...
  'search.filter-no-matches-found': '没有找到与{{filter}}相符的结果',
  ...
  'search.operator.date-time-after.description':
    '<Field/> <Operator>之后</Operator> <Value>{{value}}</Value>',
  'search.operator.date-time-after.name': '之后',
  /* Date and time should be before (earlier than) given filter value */
  'search.operator.date-time-before.description':
    '<Field/> <Operator>之前</Operator> <Value>{{value}}</Value>',
  ...
  'search.operator.reference-asset-image.description':
    '<Field/> <Operator>→</Operator> <Value>{{value}}</Value>',
  'search.operator.reference-asset-image.name': '图片',
