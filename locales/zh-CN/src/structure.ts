...
export default removeUndefinedLocaleResources({
  ...
  'action.publish.live-edit.publish-disabled': '无法发布，因为此文档类型已启用实时编辑',
  ...
  'action.restore.confirm-dialog.confirm-discard-changes': '您确定要还原此文档吗？',
  ...
  'confirm-delete-dialog.cdr-table.id-copied-toast.title': '已复制文档 ID 到剪贴板！',
  ...
  'confirm-delete-dialog.other-reference-count.title_other': '未显示的 {{count}} 个其他引用',
  ...
  'document-view.form-view.sync-lock-toast.description':
    '文档同步时请稍候。这通常在文档发布后立即发生，不会超过几秒钟',
  ...
  'panes.document-list-pane.no-matching-documents.text': '无匹配文档',
  ...
  'panes.document-operation-results.operation-error': '在 {{context}} 期间发生错误',
  ...
  'panes.document-operation-results.operation-success_unpublish':
    '文档已取消发布。已从最新发布版本创建了草稿。',
  /** The title of the reconnecting toast */
  'panes.document-pane-provider.reconnecting.title': '连接丢失。正在重新连接…',
