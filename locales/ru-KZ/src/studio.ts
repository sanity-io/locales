...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.edit.description-label': 'Сипаттама',
  /** Title for the edit release dialog */
  'release.dialog.edit.title': 'Релизді өңдеу',
  /** Field label for the release title in the edit release dialog */
  'release.dialog.edit.title-label': 'Тақырып',
  ...
  'release.toast.edit-release-error.title': 'Релиз мәліметтерін сақтау сәтсіз аяқталды',
