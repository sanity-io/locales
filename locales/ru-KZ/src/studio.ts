...
export default removeUndefinedLocaleResources({
  ...
  'asset-sources.media-library.error.library-could-not-be-resolved':
    'Что-то пошло не так при попытке разрешить Медиа-библиотеку для этого проекта.',
  /** Menu Items for Media Library Asset Source */
  'asset-sources.media-library.file.title': 'Медиа-библиотека',
  'asset-sources.media-library.image.title': 'Медиа-библиотека',
  /** Info messages for the Media Library Asset Source  */
  'asset-sources.media-library.info.provisioning':
    'Пожалуйста, подождите, пока мы подготовим вашу Медиа-библиотеку',
  ...
  'common.reconnecting.toast.title': 'Пытаемся подключиться…',
  ...
  'release.chip.tooltip.archived': 'Этот релиз архивирован и не может быть отредактирован.',
