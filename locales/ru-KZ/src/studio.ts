...
export default removeUndefinedLocaleResources({
  ...
  'release.action.edit-schedule': 'Изменить расписание',
  ...
  'release.dialog.publish-scheduled-draft.confirm': 'Да, запустить сейчас',
  ...
  'release.schedule-dialog.publish-date-in-past-warning':
    'Запланируйте этот выпуск на будущее время и дату.',
  /** Label for date picker when scheduling a release */
  'release.schedule-dialog.select-publish-date-label': 'Запланировать на',
  ...
  'release.toast.delete-schedule-draft.error':
    'Не удалось удалить запланированный черновик документа <strong>{{title}}</strong>: {{error}}',
  /** Success toast for deleting a scheduled draft */
  'release.toast.delete-schedule-draft.success':
    'Запланированный черновик документа <strong>{{title}}</strong> был удален.',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.not-found-release.title': "Релиз '{{title}}' не был найден",
  /** Error toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.error':
    'Не удалось опубликовать запланированный черновик документа <strong>{{title}}</strong>: {{error}}',
  /** Success toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.success':
    'Запланированный черновик документа <strong>{{title}}</strong> был опубликован.',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'Не удалось перенести запланированный черновик документа <strong>{{title}}</strong>: {{error}}',
  /** Success toast for rescheduling a draft */
  'release.toast.reschedule-scheduled-draft.success':
    'Запланированный черновик документа <strong>{{title}}</strong> был перенесен.',
  ...
  'schedule-publish-dialog.header': 'Запланировать черновик для публикации',
