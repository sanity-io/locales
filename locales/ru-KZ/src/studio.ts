...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.delete-schedule-draft.body-already-current':
    'Удалить этот запланированный draft? Ваш draft уже обновлен.',
  ...
  'release.dialog.delete-schedule-draft.body-will-save-to-draft':
    'Удалить этот запланированный draft? Ваши изменения будут сохранены в draft.',
  /** Body text when deleting scheduled draft with checkbox shown for user choice */
  'release.dialog.delete-schedule-draft.body-with-choice': 'Удалить этот запланированный draft?',
  ...
  'release.dialog.delete-schedule-draft.copy-checkbox':
    'Сохранить мои запланированные изменения, скопировав их в draft (рекомендуется)',
  ...
  'release.dialog.delete-schedule-draft.different-changes-explanation':
    'Ваш запланированный draft содержит изменения, отличные от текущего draft.',
