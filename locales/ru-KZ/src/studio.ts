...
export default removeUndefinedLocaleResources({
  ...
  'changes.unknown-schema-field.description':
    'Это поле не определено в схеме. Значения отображаются в формате JSON.',
  ...
  'divergence.unresolved-divergence_one': 'Неразрешённое изменение в версии {{versionName}}',
