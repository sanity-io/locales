...
export default removeUndefinedLocaleResources({
  ...
  'document-validation.valid': 'Тексеру қателері жоқ',
  ...
  'overview.back-to-all-releases': 'Барлық релиздер',
  ...
  'table-header.edited-by': 'Өңдеген',
  ...
  'table-header.last-edited': 'Соңғы өңдеу',
