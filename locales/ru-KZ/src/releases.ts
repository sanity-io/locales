...
export default removeUndefinedLocaleResources({
  ...
  'activity.event.schedule': 'Отмечено как запланированное',
  /** The text for the activity event when the release is unarchived */
  'activity.event.unarchive': 'Выпуск <strong>{{releaseTitle}}</strong> разархивирован',
  /** The text for the activity event when the release is unscheduled */
  'activity.event.unschedule': 'Отмечено как незапланированное',
  /** The loading text for when releases are loading */
  'activity.panel.error': 'При получении активности выпуска произошла ошибка',
  /** The loading text for when releases are loading */
  ...
  'archive-dialog.confirm-archive-description_one': 'Будет архивирована 1 версия документа.',
  ...
  'error-details-title': 'Сведения об ошибке',
  ...
  'menu.group.when-releasing': 'При публикации релиза',
  ...
  'permission-missing-description':
    'Ваша роль в настоящее время ограничивает то, что вы можете видеть в этом релизе. Вы не можете опубликовать или запланировать этот релиз.',
  ...
  'presence.tooltip.one':
    '{{displayName}} прямо сейчас редактирует этот документ в релизе «{{releaseTitle}}»',
  ...
  'publish-dialog.confirm-publish-description_one':
    "Release '<strong>{{title}}</strong>' және оның құжаты жарияланады.",
  /** Title for the dialog confirming the publish of a release */
  'publish-dialog.confirm-publish.title':
    'Release мен барлық құжат нұсқаларын жариялағыңыз келетініне сенімдісіз бе?',
  /** Label for when documents in release have validation errors */
  'publish-dialog.validation.error': 'Кейбір құжаттарда тексеру қателері бар',
  /** Label for when documents are being validated */
  'publish-dialog.validation.loading': 'Құжаттар тексерілуде...',
  /** Label for the button when the user doesn't have permissions to publish a release */
  'publish-dialog.validation.no-permission': 'Сізде жариялауға рұқсат жоқ',

  /** Title for information card on a published release */
  'publish-info.title': 'Бұл release сәтті жарияланды.',

  /** Placeholder title for a release with no title */
  'release-placeholder.title': 'Атаусыз',
  ...
  'revert-dialog.confirm-revert-description_one':
    'Бұл {{releaseDocumentsLength}} құжат нұсқасын қайтарады.',
  /** Checkbox label to confirm whether to create a staged release for revert or immediately revert */
  'revert-dialog.confirm-revert.stage-revert-checkbox-label': 'Release-ті дереу қайтару',
  /** Title for the dialog confirming the revert of a release */
  'revert-dialog.confirm-revert.title':
    "'{{title}}' release-ін қайтарғыңыз келетініне сенімдісіз бе?",
  /** Warning card text for when immediately revert a release with history */
  'revert-dialog.confirm-revert.warning-card':
    'Бұл release жарияланғаннан кейін құжаттарға өзгерістер енгізілді. Қайтару осы өзгерістерді қайта жазады.',

  /** Description of a reverted release */
  'revert-release.description':
    '"{{title}}" ішіндегі құжат нұсқаларына енгізілген өзгерістерді қайтару.',
  /** Title of a reverted release */
  'revert-release.title': '"{{title}}" қайтарылуда',

  /** Description for the review changes button in release tool */
  'review.description': 'Өзгерістерді қарап шығу үшін осы release-ке құжаттар қосыңыз',
  /** Text for when a document is edited */
  'review.edited': 'Өңделді <RelativeTime/>',

  /** Schedule release button tooltip when there are no documents to schedule */
  'schedule-action.validation.no-documents': 'Жоспарлауға арналған құжаттар жоқ',

  /** Schedule release button tooltip when the release is already scheduled */
  'schedule-button-tooltip.already-scheduled': 'Бұл release қазірдің өзінде жоспарланған',
  /** Schedule release button tooltip when there are validation errors */
  'schedule-button-tooltip.validation.error': 'Кейбір құжаттарда тексеру қателері бар',
  /** Schedule release button tooltip when validation is loading */
  'schedule-button-tooltip.validation.loading': 'Құжаттар тексерілуде...',
  /** Schedule release button tooltip when user has no permissions to schedule */
  'schedule-button-tooltip.validation.no-permission': 'Сізде жоспарлауға рұқсат жоқ',

  /** Title of unschedule release dialog */
  'schedule-button.tooltip': 'Release-тің жоспарын бұзғыңыз келетініне сенімдісіз бе?',

  /** Description for the confirm button for scheduling a release */
  'schedule-dialog.confirm-button': 'Иә, жоспарлау',
  /** Description shown in unschedule relaease dialog */
  'schedule-dialog.confirm-description_one':
    "'<strong>{{title}}</strong>' release және оның құжаты таңдалған күні жарияланады.",
  /** Title for unschedule release dialog */
  'schedule-dialog.confirm-title': 'Release-ті жоспарлау',
  ...
  'toast.unschedule.error':
    "Не удалось отменить расписание '<strong>{{title}}</strong>': {{error}}",

  /** Text for tooltip when a release has been scheduled */
  'type-picker.tooltip.scheduled': 'Релиз запланирован, отмените расписание, чтобы изменить тип',
  ...
  'unpublish-dialog.action.unpublish': 'Иә, релиз кезінде жарияланымнан алу',
  ...
  'unpublish-dialog.description.to-draft':
    'Бұл құжатты <Label>{{title}}</Label> релизінің бөлігі ретінде жарияланымнан алады және релиз кезінде жоба болмаса, жоба жасайды.',
  /** Title for the dialog confirming the unpublish of a release */
  'unpublish-dialog.header':
    'Релиз кезінде бұл құжатты жарияланымнан алғыңыз келетініне сенімдісіз бе?',

  /** Text for when a document is unpublished */
  'unpublish.already-unpublished': 'Бұл құжат әлдеқашан жарияланымнан алынған.',
  ...
  /** Title for unschedule release dialog */
  'unschedule-dialog.confirm-title': 'Релиздің кестесін бұзғыңыз келетініне сенімдісіз бе?',
})
