...
export default removeUndefinedLocaleResources({
  ...
  'action.link-document-disabled.initial-value-not-resolved':
    'Пожалуйста, подождите, пока не будут определены начальные значения документа',
  ...
  'dialog.unlink-from-canvas.description':
    'После отвязки он будет доступен для редактирования здесь, и будущие изменения в Canvas больше автоматически не будут применяться к этому документу.',
