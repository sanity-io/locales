...
export default removeUndefinedLocaleResources({
  ...
  'canvas.banner.linked-text.draft': 'Этот черновой документ связан с Canvas',
  /** The text for the canvas linked banner when the document is a live document */
  'canvas.banner.linked-text.published': 'Этот опубликованный документ связан с Canvas',
  /** The text for the canvas linked banner when the document is a version document */
  'canvas.banner.linked-text.version': 'Этот версионный документ связан с Canvas',
  /** The text for the canvas linked banner popover button */
  'canvas.banner.popover-button-text': 'Узнать больше',
  /** The description for the canvas linked banner popover */
  'canvas.banner.popover-description':
    'Canvas позволяет создавать контент в свободной форме редактора, который автоматически отображается в Studio как структурированный контент - по мере ввода.',
