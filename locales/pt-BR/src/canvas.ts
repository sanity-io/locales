...
export default removeUndefinedLocaleResources({
  ...
  'dialog.confirm-document-changes.title': 'Confirmar alterações no documento',
  /** The text for the Link to Canvas dialog when there is a error. */
  'dialog.link-to-canvas.error': 'Falha ao vincular ao Canvas',
  /** The text for the "Link to Canvas" dialog when the document is being redirected. */
  'dialog.link-to-canvas.redirecting':
    'Redirecionando para o Canvas para completar a vinculação...',
  ...
  'dialog.unlink-from-canvas.description':
    'Uma vez desvinculado, ele poderá ser editado aqui e futuras edições no Canvas não serão mais automaticamente mapeadas para este documento.',
