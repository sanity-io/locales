...
export default removeUndefinedLocaleResources({
  ...
  /** "Latest version" header in about dialog */
  'about-dialog.version-info.latest-version.text': 'A última versão é {{latestVersion}}',
  ...
  'asset-sources.media-library.info.provisioning':
    'Aguarde enquanto preparamos sua Biblioteca de Mídia',
  ...
  'release.action.revert-unpublish-version.failure.description':
    'Por favor, tente novamente ou verifique sua conexão. O documento ainda vai estar não publicado ao ser lançado.',
  /** Error message title for when a version is reverted from being unpublished */
  'release.action.revert-unpublish-version.failure.title':
    'Falha ao reverter a configuração para não publicar na liberação.',
  ...
  'release.action.revert-unpublish-version.success.title':
    'Revertido com sucesso a configuração para não publicar na liberação.',
