...
export default removeUndefinedLocaleResources({
  ...
  'asset-sources.dataset.file.title': 'Arquivos do Workspace',
  'asset-sources.dataset.image.title': 'Imagens do Workspace',
  ...
  'release.chip.tooltip.archived': 'Esta release está arquivada e não pode ser editada.',
  ...
  'release.dialog.create.confirm': 'Criar release',
  ...
  'release.toast.archived-release.description': 'Esta release foi desafixada',
  ...
  'release.toast.published-release.description': 'Esta release foi desafixada',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.published-release.title': "A release '{{title}}' foi publicada",
