...
export default removeUndefinedLocaleResources({
  ...
  "asset-source.delete-dialog.usage-list.image-preview-alt":
  ...
  "asset-source.file.asset-list.action.select-file.title":
  ...
  "calendar.error.must-be-in-format":
    "Deve estar no formato <Emphasis>{{exampleDate}}</Emphasis>",
  ...
  "changes.action.revert-changes-description":
    "Tem certeza de que deseja reverter as alterações?",
  ...
  "changes.array.item-removed-from-position":
    "Removido da posição {{position}}",
  ...
  "changes.error-boundary.title":
    "Renderizar as alterações neste campo causou um erro",
  ...
  "changes.portable-text.unknown-annotation-schema-type":
    "Tipo de esquema desconhecido",
  ...
  /** Developer info */
  "form.error.duplicate-keys-alert.details.title":
  ...
  /** Developer info */
  "form.error.missing-keys-alert.details.title":
    "Informações para desenvolvedores",
  ...
  /** Developer info */
  "form.error.mixed-array-alert.details.title":
    "Informações para desenvolvedores",
  /**  Remove non-object values */
  "form.error.mixed-array-alert.remove-button.text":
    "Remover valores que não são objetos",
  ...
  "input.files.common.upload-placeholder.file-input-button.text":
    "Fazer upload",
  /** Uploading <FileName/> */
  ...
  "inputs.array.error.type-is-incompatible-title":
  ...
  "inputs.file.actions-menu.file-options.aria-label":
    "Abrir menu de opções de arquivo",
  /** Browse */
  "inputs.file.browse-button.text": "Procurar",
  /** Select file */
  "inputs.file.dialog.title": "Selecionar arquivo",
  /** Unknown member kind: `{{kind}}` */
  "inputs.file.error.unknown-member-kind":
    "Tipo de membro desconhecido: {{kind}}",
  ...
  "inputs.file.upload-failed.description":
    "O upload não pôde ser concluído neste momento.",
  /** Upload failed */
  ...
  "inputs.files.common.placeholder.drag-or-paste-to-upload_file":
    "Arraste ou cole o arquivo aqui",
  /** Drag or paste image here */
  "inputs.files.common.placeholder.drag-or-paste-to-upload_image":
    "Arraste ou cole a imagem aqui",
  /** Drop to upload file */
  "inputs.files.common.placeholder.drop-to-upload_file":
    "Solte para fazer upload do arquivo",
  /** Drop to upload image */
  "inputs.files.common.placeholder.drop-to-upload_image":
    "Solte para fazer upload da imagem",
  /** Read only */
  ...
  "inputs.image.actions-menu.options.aria-label":
    "Abrir menu de opções de imagem",
  /** Select */
  ...
  "inputs.image.upload-error.description":
    "Não foi possível completar o upload neste momento.",
  /** Upload failed */
  ...
  "inputs.invalid-value.convert-button.text":
    "Converter para <code>{{targetType}}</code>",
  /** The current value (<code>`{{actualType}}`</code>) */
  "inputs.invalid-value.current-type":
    "O valor atual (<code>{{actualType}}</code>)",
  ...
  /** Developer info */
  "inputs.object.unknown-fields.warning.details.title":
    "Informações para desenvolvedores",
  /** Unknown field found */
  "inputs.object.unknown-fields.warning.title_one":
    "Campo desconhecido encontrado",
  "inputs.object.unknown-fields.warning.title_other":
    "Campos desconhecidos encontrados",
  /** Collapse the editor to save screen space  */
  "inputs.portable-text.action.collapse-editor": "Recolher editor",
  /** Label for action to edit an existing annotation */
  "inputs.portable-text.action.edit-annotation": "Editar anotação",
  ...
  "inputs.portable-text.action.insert-inline-object-aria-label":
    "Inserir {{typeName}} (inline)",
  /** Label for action to remove an annotation */
  "inputs.portable-text.action.remove-annotation": "Remover anotação",
  ...
  "inputs.portable-text.invalid-value.empty-children.action":
    "Insira um trecho de texto vazio",
  ...
  "inputs.portable-text.invalid-value.invalid-span-text.action":
    "Defina um valor de texto vazio",
  ...
  "inputs.portable-text.invalid-value.missing-key.action":
    "Atribuir chave aleatória",
  ...
  "inputs.portable-text.invalid-value.not-an-array.action":
    "Desconfigurar o valor",
  ...
  "inputs.portable-text.invalid-value.orphaned-marks.action":
    "Remova as marcas não permitidas",
  ...
  "inputs.portable-text.invalid-value.title":
    "Valor inválido de Texto Portátil",
  ...
  "inputs.reference.document-opens-in-new-tab":
    "Este documento será aberto em uma nova aba",
  ...
  "inputs.reference.error.missing-read-permissions-title":
  ...
  "inputs.reference.image-preview-alt-text":
    "Pré-visualização da imagem do documento referenciado",
  ...
  "inputs.reference.metadata-error.title":
    "Não foi possível carregar os metadados da referência",
  ...
  "inputs.reference.strength-mismatch.title":
    "Incompatibilidade de força da referência",
  /** Label for button that triggers the action that weakens a reference on strength mismatch */
  "inputs.reference.strength-mismatch.weaken-button-label":
    "Converter para referência fraca",
  ...
  /** Convert to <code>`{{targetType}}`</code> */
  "inputs.untyped-value.convert-button.text":
    "Converter para <code>{{targetType}}</code>",
  ...
  "inputs.untyped-value.details.json-dump-prefix":
    "Valor atual (<code>object</code>):",
  ...
  "preview.image.file-is-being-uploaded.alt-text":
    "A imagem que está sendo carregada",
  ...
  "search.action.filter-by-document-type-aria-label":
  ...
  "search.error.no-valid-asset-source-title":
    "Nenhuma fonte de ativos válida encontrada.",
  ...
  "search.no-results-help-description":
    "Tente outra palavra-chave ou ajuste seus filtros",
  ...
  "search.operator.defined.description":
    "<Field/> <Operator>é</Operator> <Value>não vazio</Value>",
  "search.operator.defined.name": "não vazio",
  /* Value should not be defined */
  "search.operator.not-defined.description":
    "<Field/> <Operator>é</Operator> <Value>vazio</Value>",
  ...
  "search.ordering.updated-ascending-label":
    "Atualizado: Mais antigos primeiro",
  /** Label for the "Updated: Newest first" search ordering type */
  "search.ordering.updated-descending-label":
    "Atualizado: Mais recentes primeiro",
  ...
  "timeline.error.unable-to-load-revision":
  ...
  "timeline.operation.created-initial_timestamp":
    "Criado: {{timestamp, datetime}}",
   ...
   */
  "workspaces.action.choose-another-workspace":
    "Escolha outro espaço de trabalho",
