...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.delete-schedule-draft.body':
    'Você tem certeza de que deseja excluir este rascunho agendado? Esta ação não pode ser desfeita.',
  ...
  'release.dialog.publish-scheduled-draft.body':
    'Você tem certeza de que deseja publicar este rascunho agendado imediatamente?',
  ...
  'release.schedule-dialog.publish-date-in-past-warning':
    'Agende este lançamento para uma data e hora futuras.',
