...
export default removeUndefinedLocaleResources({
  ...
  'release.action.add-to-release': 'Adicionar a {{title}}',
  ...
  'release.chip.tooltip.created-date': 'Criado em {{date}}',
  ...
  'release.chip.tooltip.edited-date': 'Editado em {{date}}',
  ...
  'release.chip.tooltip.published-date': 'Publicado em {{date}}',
  ...
  'release.type.scheduled': 'Em horário programado',
