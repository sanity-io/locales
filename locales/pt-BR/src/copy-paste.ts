...
export default removeUndefinedLocaleResources({
  ...
  'copy-paste.on-copy.validation.copy-item_one-success.title': 'Item "{{typeName}}" copiado',
  ...
  'copy-paste.on-paste.validation.reference-type-incompatible.description':
    'Referências do tipo "{{sourceReferenceType}}" não são permitidas em campo de referência que aceita tipos "{{targetReferenceTypes}}"',
  /** The validation message that is shown when reference does not exist */
  'copy-paste.on-paste.validation.reference-validation-failed.description':
    'O documento referenciado "{{ref}}" não existe',
