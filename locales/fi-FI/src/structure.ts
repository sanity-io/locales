...
export default removeUndefinedLocaleResources({
  ...
  "action.discard-changes.disabled.not-published":
    "Tätä dokumenttia ei ole julkaistu",
  /** Tooltip when action button is disabled because the operation is not ready   */
  ...
  "action.publish.already-published.tooltip":
    "Julkaistu {{timeSincePublished}} sitten",
  ...
  "action.restore.disabled.cannot-restore-initial":
    "Et voi palauttaa alkuperäistä versiota",
  ...
  "doc-title.unknown-schema-type.text":
    "Tuntematon skeematyyppi: {{schemaType}}",
  ...
  "no-document-types-screen.subtitle":
    "Määrittele ainakin yksi dokumenttityyppi skeemaasi.",
  ...
  "pane-item.missing-schema-type.subtitle":
    "Dokumentti: <Code>{{documentId}}</Code>",
  /** The title tor pane item previews if there isn't a matching schema type found */
  "pane-item.missing-schema-type.title":
    "Skeemaa ei löydy tyypille <Code>{{documentType}}</Code>",
  /** The text shown in the tooltip of pane item previews of documents if there are unpublished edits */
  "pane-item.published-status.has-published.tooltip":
    "Julkaistu <RelativeTime/>",
  /** The text shown in the tooltip of pane item previews of documents if there are no unpublished edits */
  ...
  "panes.document-list-pane.max-items.text":
    "Näytetään enintään {{limit}} dokumenttia",
  /** The text of the document list pane if no documents are found for a specified type */
  "panes.document-list-pane.no-documents-of-type.text":
    "Tämän tyyppisiä dokumentteja ei ole",
  ...
  "panes.document-list-pane.no-matching-documents.text":
    "Vastaavia dokumentteja ei löytynyt",
  ...
  "panes.document-operation-results.operation-error":
    "Virhe tapahtui suorittaessa {{context}}",
