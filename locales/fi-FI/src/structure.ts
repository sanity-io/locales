...
export default removeUndefinedLocaleResources({
  ...
  'action.copy-document-id.label': 'Kopioi dokumentin ID',
  ...
  'action.copy-link-to-document.label': 'Kopioi dokumentin URL',
  ...
  'banners.scheduled-draft-override-banner.text':
    'Tälle asiakirjalle on olemassa aikataulutettu luonnos. Jos julkaiset muutoksia nyt, ne korvataan, kun aikataulu suoritetaan.',
  ...
  'banners.variant.waiting.description':
    'Odota hetki, kun dokumenttia lisätään varianttiin. Tämä ei kestä kauaa.',
  ...
  'confirm-delete-dialog.confirm-anyway-button.text_delete_one': 'Poista silti',
  /** The text in the "Delete anyway" button when the document has multiple versions */
  'confirm-delete-dialog.confirm-anyway-button.text_delete_other': 'Poista kaikki versiot silti',
  ...
  'confirm-delete-dialog.confirm-button.text_delete_one': 'Poista asiakirja',
  /** The text in the "Delete now" button when the document has multiple versions */
  'confirm-delete-dialog.confirm-button.text_delete_other': 'Poista kaikki versiot',
  ...
  'document-group-inventory.onboarding-hint': 'Minne versiopainikkeet katosivat?',
  ...
  'document-view.form-view.sync-pending.description':
    'Yritämme edelleen. Muutoksesi säilytetään selaimessasi sillä välin.',
  ...
  'document-view.form-view.sync-stalled.description':
    'Muokkaus on keskeytetty, kunnes muutokset tallentuvat. Muutoksesi säilytetään selaimessasi, joten pidä tämä välilehti auki, kun yritämme edelleen.',
  ...
  'panes.document-operation-results.operation-success_copy-id':
    'Dokumentin ID kopioitu leikepöydälle',
  ...
  'toggle-inline-changes.menu-item.title': 'Sisäiset muutokset',
})
