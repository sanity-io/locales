...
export default removeUndefinedLocaleResources({
  ...
  /** "Latest version" header in about dialog */
  'about-dialog.version-info.latest-version.text': 'Uusin versio on {{latestVersion}}',
  ...
  'release.action.revert-unpublish-version.failure.description':
    'Yritä uudelleen tai tarkista yhteytesi. Asiakirja pysyy julkaisemattomana julkaisun yhteydessä.',
  /** Error message title for when a version is reverted from being unpublished */
  'release.action.revert-unpublish-version.failure.title':
    'Palautus julkaisemattomaksi asettamisesta epäonnistui.',
  ...
  'release.action.revert-unpublish-version.success.title':
    'Palautus julkaisemattomaksi asettamisesta onnistui.',
