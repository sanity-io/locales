...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.delete-schedule-draft.body':
    'Oletko varma, että haluat poistaa tämän ajoitetun luonnoksen? Tätä toimintoa ei voi peruuttaa.',
  ...
  'release.toast.reschedule-scheduled-draft.success':
    'Ajastettu luonnosdokumentti <strong>{{title}}</strong> on uudelleenaikataulutettu.',
