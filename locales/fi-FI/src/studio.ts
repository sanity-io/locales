...
export default removeUndefinedLocaleResources({
  ...
  'document-group-inventory.feedback.sentiment-label':
    'Kuinka helppoa tai vaikeaa uuden version inventaarion käyttäminen on?',
  ...
  'document-group.delete.cdr-summary.document-count_one': '1 dokumentti',
  /** Used in `document-group.delete.cdr-summary.title` */
  'document-group.delete.cdr-summary.document-count_other': '{{count}} dokumenttia',
  ...
  'document-group.delete.cdr-table.copy-id-button.tooltip': 'Kopioi ID leikepöydälle',
  /** The header for the dataset column in the list of cross-dataset references found */
  'document-group.delete.cdr-table.dataset.label': 'Dataset',
  /** The header for the document ID column in the list of cross-dataset references found */
  'document-group.delete.cdr-table.document-id.label': 'Dokumentin ID',
  /** The toast title when the copy button has been clicked but copying failed */
  'document-group.delete.cdr-table.id-copied-toast.title-failed':
    'Dokumentin ID:n kopiointi epäonnistui',
  /** The header for the project ID column in the list of cross-dataset references found */
  'document-group.delete.cdr-table.project-id.label': 'Projektin ID',
  ...
  'document-group.delete.error.message':
    'Dokumentin poistamisessa tapahtui virhe. Tämä tarkoittaa yleensä, että muut dokumentit viittaavat siihen.',
  ...
  'document-group.delete.other-reference-count.tooltip':
    'Emme voi näyttää näiden viittausten metatietoja, koska liittyviltä dataseteiltä puuttuu käyttöoikeustunnus.',
  ...
  'document-group.delete.referring-document-count.text_one':
    '1 asiakirja viittaa kohteeseen "<DocumentTitle/>"',
  /** Tells the user the count of how many other referring documents there are before listing them. (plural) */
  'document-group.delete.referring-document-count.text_other':
    '{{count}} asiakirjaa viittaa kohteeseen "<DocumentTitle/>"',
  /** Describes the list of documents that refer to the one trying to be deleted (delete) */
  'document-group.delete.referring-documents-descriptor.text':
    'Et välttämättä pysty poistamaan kohdetta "<DocumentTitle/>", koska seuraavat asiakirjat viittaavat siihen:',
