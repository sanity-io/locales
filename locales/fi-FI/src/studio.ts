...
export default removeUndefinedLocaleResources({
  ...
  'changes.from-base-variant.label': 'Muutettu perusversiosta',
  ...
  'diagnostics.menu-item': 'Diagnostiikka',
  ...
  'document-status.published-at': 'Julkaistu {{date}}',
  ...
  'form.field.actions-menu.title': 'Kentän toiminnot',
