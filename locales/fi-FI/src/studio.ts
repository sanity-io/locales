...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.tooltip.prerelease': 'Ennakkoversio',
  ...
  'about-dialog.version-info.update-button.tooltip': 'Lue, miten päivität Sanity Studion',
  ...
  'asset-sources.media-library.warning.file-already-exist.description':
    'Käytetään kirjastosta löytyvää olemassa olevaa tiedostoa.',
  ...
  'form.error.unhandled-runtime-error.call-stack.title': 'Kutsupino:',
  /** The title above the error component stack provided by React's underlying ErrorBoundary component */
  'form.error.unhandled-runtime-error.component-stack.title': 'Komponenttipino:',
  /** The error message for the unhandled error that crashed the Input component during render */
  'form.error.unhandled-runtime-error.error-message': 'Virhe: {{message}}',
  /** The title for the error card rendered inside a field in place of a crashing input */
  'form.error.unhandled-runtime-error.title': 'Käsittelemätön suoritusaikainen virhe',
  ...
  'inputs.array.insert-menu.filter.all-items': 'Kaikki',
  /** Label for when the array insert menu search shows no items */
  'inputs.array.insert-menu.search.no-results': 'Kohteita ei löytynyt',
  /** Placeholder for the array insert menu search field */
  'inputs.array.insert-menu.search.placeholder': 'Haku',
  /** Tooltip for the array insert menu grid view toggle */
  'inputs.array.insert-menu.toggle-grid-view.tooltip': 'Vaihda ruudukkonäkymään',
  /** Tooltip for the array insert menu list view toggle */
  'inputs.array.insert-menu.toggle-list-view.tooltip': 'Vaihda listanäkymään',
  ...
  'insufficient-permissions-message.not-authorized-explanation_delete-schedules':
    'Sinulla ei ole oikeuksia poistaa aikatauluja.',
  ...
  'insufficient-permissions-message.not-authorized-explanation_edit-schedules':
    'Sinulla ei ole oikeuksia muokata aikatauluja.',
  ...
  'insufficient-permissions-message.not-authorized-explanation_execute-schedules':
    'Sinulla ei ole oikeuksia suorittaa aikatauluja.',
  ...
  'release.dialog.delete-schedule-draft.header': 'Poista aikataulutettu luonnos',
  /** Body text for change schedule dialog */
  'release.dialog.edit-schedule.body':
    'Valitse uusi päivämäärä ja aika aikataulutetulle julkaisulle.',
  ...
  'release.dialog.publish-scheduled-draft.body':
    'Oletko varma, että haluat julkaista tämän aikataulutetun luonnoksen välittömästi?',
  ...
  'release.schedule-dialog.publish-date-in-past-warning':
    'Aikatauluta tämä julkaisu tulevaisuuden ajankohdalle.',
  /** Label for date picker when scheduling a release */
  'release.schedule-dialog.select-publish-date-label': 'Aikatauluta',
  ...
  'release.toast.delete-schedule-draft.error':
    'Aikataulutetun luonnosdokumentin <strong>{{title}}</strong> poistaminen epäonnistui: {{error}}',
  /** Success toast for deleting a scheduled draft */
  'release.toast.delete-schedule-draft.success':
    'Aikataulutettu luonnosdokumentti <strong>{{title}}</strong> on poistettu.',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.not-found-release.title': "'{{title}}' julkaisua ei löytynyt",
  /** Error toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.error':
    'Aikataulutetun luonnosdokumentin <strong>{{title}}</strong> julkaiseminen epäonnistui: {{error}}',
  /** Success toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.success':
    'Aikataulutettu luonnosdokumentti <strong>{{title}}</strong> on julkaistu.',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'Aikataulutetun luonnosdokumentin <strong>{{title}}</strong> uudelleenaikataulutus epäonnistui: {{error}}',
  /** Success toast for rescheduling a draft */
  'release.toast.reschedule-scheduled-draft.success':
    'Aikataulutettu luonnosdokumentti <strong>{{title}}</strong> on uudelleenaikataulutettu.',
  ...
  'schedule-publish-dialog.description': 'Valitse, milloin tämä asiakirja tulisi julkaista.',
  ...
  'timeline.latest-revision': 'Viimeisin versio',
  /**
   * Label for latest revision for timeline menu dropdown
  ...
  'tree-editing-dialog.breadcrumbs.menu': 'Navigointipolun valikko',
  /** Title placeholder for search input in array of objects */
  'tree-editing-dialog.search-placeholder': 'Haku',
  /** Menu aria label for the search menu */
  'tree-editing-dialog.search.menu-label': 'Hakumenun selite',
  /** Title label for when no search results are found on the tree of objects */
  'tree-editing-dialog.search.no-results-title': 'Tuloksia ei löytynyt',
  /** Label to close the sidebar */
  'tree-editing-dialog.sidebar.action.close': 'Sulje sivupalkki',
  /** Collapse label the menu item in the sidebar  */
  'tree-editing-dialog.sidebar.action.collapse': 'Kutista',
  /** Label to close the dialog */
  'tree-editing-dialog.sidebar.action.done': 'Valmis',
  /** Exapnd label the menu item in the sidebar  */
  'tree-editing-dialog.sidebar.action.expand': 'Laajenna',
