...
export default removeUndefinedLocaleResources({
  ...
  "asset-source.asset-usage-dialog.header_file":
    "Tiedostoa käyttävät dokumentit",
  ...
  "asset-source.usage-list.documents-using-image_unnamed_one":
    "Yksi asiakirja käyttää tätä kuvaa",
  ...
  "calendar.error.must-be-in-format":
    "Täytyy olla muodossa <Emphasis>{{exampleDate}}</Emphasis>",
  ...
  "changes.action.revert-changes-description":
    "Oletko varma, että haluat palauttaa muutokset?",
  /** Prompt for reverting changes for a group change, eg multiple changes */
  "changes.action.revert-changes-description_one":
    "Oletko varma, että haluat palauttaa muutoksen?",
  ...
  "changes.array.item-removed-from-position":
    "Poistettu sijainnista {{position}}",
  ...
  "changes.error-boundary.developer-info":
    "Tarkista kehittäjän konsoli saadaksesi lisätietoja",
  /** Text shown when a diff component crashes during rendering, triggering the error boundary */
  "changes.error-boundary.title":
    "Tämän kentän muutosten renderöinti aiheutti virheen",
  ...
  "changes.portable-text.inline-object_removed":
    "Poistettu sisäkkäinen objekti",
  /** Portable Text diff: An inline object was left unchanged */
  "changes.portable-text.inline-object_unchanged":
    "Muuttumaton sisäkkäinen objekti",
  ...
  "inputs.file.error.unknown-member-kind":
    "Tuntematon jäsenen tyyppi: {{kind}}",
  ...
  "inputs.file.upload-failed.description":
    "Latausta ei voitu suorittaa tällä hetkellä.",
  /** Upload failed */
  ...
  "inputs.image.upload-error.description":
    "Latausta ei voitu suorittaa loppuun tällä hetkellä.",
  /** Upload failed */
  ...
  "inputs.portable-text.activate-on-focus-message_tap":
    "Napauta aktivoidaksesi",
  ...
  "inputs.portable-text.invalid-value.orphaned-marks.action":
    "Poista sallimattomat merkinnät",
  ...
  "inputs.portable-text.invalid-value.title":
    "Virheellinen Portable Text -arvo",
  ...
  "inputs.reference.document-opens-in-new-tab":
    "Tämä asiakirja avautuu uudessa välilehdessä",
  /** Error title for when the document is unavailable (for any possible reason) */
  "inputs.reference.error.document-unavailable-title":
    "Asiakirja ei ole saatavilla",
  ...
  "inputs.reference.image-preview-alt-text":
    "Viitatun asiakirjan kuvan esikatselu",
  ...
  "inputs.reference.metadata-error.title":
    "Viitteen metatietoja ei voitu ladata",
  /** Message shown when no documents were found that matched the given search string */
  "inputs.reference.no-results-for-query":
    "Ei tuloksia haulle <strong>“{{searchTerm}}”</strong>",
  ...
  "inputs.untyped-value.details.json-dump-prefix":
    "Nykyinen arvo (<code>object</code>):",
  ...
  "new-document.no-results":
    "Ei tuloksia haulle <strong>{{searchQuery}}</strong>",
  ...
  "presence.no-one-else-description":
    "Kutsu ihmisiä projektiin nähdäksesi heidän online-tilansa.",
  ...
  "search.action.filter-by-document-type-aria-label":
    "Suodata asiakirjatyypin mukaan",
  ...
  "search.error.display-filter-title":
    "Suodattimen näyttämisessä tapahtui virhe.",
  ...
  "search.error.no-valid-asset-source-title":
    "Kelpaavia omaisuuslähteitä ei löytynyt.",
  /** Helpful description for when search returned an error that we are not able to describe in detail */
  "search.error.unspecified-error-help-description":
    "Yritä uudelleen tai tarkista yhteytesi",
  ...
  "search.no-results-help-description":
    "Kokeile toista hakusanaa tai säädä suodattimiasi",
  ...
  "search.operator.defined.description":
    "<Field/> <Operator>on</Operator> <Value>ei tyhjä</Value>",
  ...
  "timeline.error.load-document-changes-title":
    "Virhe tapahtui asiakirjan muutosten noutamisessa.",
  ...
  "user-menu.login-provider":
    "Kirjauduttu sisään palvelun {{providerTitle}} kautta",
