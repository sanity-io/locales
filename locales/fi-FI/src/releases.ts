...
export default removeUndefinedLocaleResources({
  ...
  'publish-dialog.confirm-publish.update-drafts-description_one':
    'Olemassa oleva luonnos {{draftDocumentsLength}} asiakirjasta poistetaan, jotta luonnokset vastaavat julkaistua releasea. Julkaisemattomat luonnosmuutokset menetetään.',
  ...
  'publish-dialog.confirm-publish.update-drafts-description_other':
    'Olemassa olevat luonnokset {{draftDocumentsLength}} asiakirjasta poistetaan, jotta luonnokset vastaavat julkaistua releasea. Julkaisemattomat luonnosmuutokset menetetään.',
  ...
  'toast.publish.update-drafts-error':
    'Release julkaistiin, mutta olemassa olevia luonnoksia ei voitu päivittää: {{error}}',
