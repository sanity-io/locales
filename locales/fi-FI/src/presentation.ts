...
export default removeUndefinedLocaleResources({
  ...
  'preview-frame.connection.error.text': 'Esikatselu ei voinut muodostaa yhteyttä',
  ...
  'preview-frame.perspective.published.text': 'Tarkastele tätä sivua julkaistulla sisällöllä',
  ...
  'preview-frame.viewport-button.aria-label': 'Vaihda näkymän kokoa',
  /** The viewport size button tooltip text when switching to a full width viewport */
  'preview-frame.viewport-button.tooltip_full': 'Vaihda täyteen näkymään',
  ...
  'share-preview-menu.error_toggle-sharing':
    'Sinulla ei ole oikeutta muuttaa tämän esikatselun jakamisasetusta',
  ...
  /** The status of the clipboard operation when copying a URL */
  'share-url.clipboard.status_unsupported': 'Leikepöytä ei ole tuettu',
