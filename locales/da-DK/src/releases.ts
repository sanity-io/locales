...
export default removeUndefinedLocaleResources({
  ...
  'activity.panel.close': 'Luk aktivitet',
  ...
  'dashboard.details.metadata.created': 'Oprettet',
  ...
  'dashboard.details.metadata.status-errors': 'Fejl',
  ...
  'document-validation.valid': 'Ingen valideringsfejl',
  ...
  'overview.back-to-all-releases': 'Alle udgivelser',
  ...
  'presence.tooltip.one-without-release': '{{displayName}} redigerer dette dokument lige nu',
  ...
  'table-header.edited-by': 'Redigeret af',
  ...
  'table-header.last-edited': 'Sidst redigeret',
