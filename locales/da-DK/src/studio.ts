...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.copy-to-clipboard-button.copied-text':
    'Kopieret til udklipsholderen. God kopiering!',
  ...
  'asset-sources.dataset.file.title': 'Arbejdsområdefiler',
  'asset-sources.dataset.image.title': 'Arbejdsområde billeder',
  ...
  'document.type.not-found': 'Dokumenttypen "{{type}}" blev ikke fundet',
  ...
  'form.reconnecting.toast.title': 'Forbindelse mistet. Genopretter forbindelse…',
  ...
  'inputs.reference.global.invalid-type':
    'Det refererede dokument er af ugyldig type ({{typeName}})',
  ...
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.published-release.title': "'{{title}}' udgivelsen blev udgivet",
