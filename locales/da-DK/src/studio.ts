...
export default removeUndefinedLocaleResources({
  ...
  'changes.from-base-variant.label': 'Ændret fra basisvariant',
  ...
  'diagnostics.menu-item': 'Diagnosticering',
  ...
  'document-status.published-at': 'Udgivet {{date}}',
  ...
  'release.toast.edit-release-error.title': 'Kunne ikke gemme release-detaljer',
  ...
  'user-menu.action.claim-project': 'Overtag dette projekt',
