...
export default removeUndefinedLocaleResources({
  ...
  "asset-source.asset-usage-dialog.header_file":
    "Documenten die bestand gebruiken",
  /** Header in usage dialog for image assets */
  "asset-source.asset-usage-dialog.header_image":
    "Documenten die afbeelding gebruiken",
  ...
  "asset-source.image.asset-list.delete-failed":
    "Afbeelding kon niet worden verwijderd",
  /** Image asset source */
  ...
  "asset-source.usage-list.documents-using-file_unnamed_one":
    "Eén document gebruikt dit bestand",
  ...
  "changes.array.item-removed-from-position":
    "Verwijderd van positie {{position}}",
  ...
  "form.error.missing-keys-alert.add-button.text":
    "Ontbrekende sleutels toevoegen",
  /** The value of the <code>_key</code> property must be a unique string. */
  ...
  "help-resources.latest-sanity-version":
    "De nieuwste versie is {{latestVersion}}",
  ...
  "inputs.array.error.json-representation-description":
    "JSON-representatie van dit item:",
  ...
  "inputs.file.upload-failed.description":
    "De upload kon op dit moment niet worden voltooid.",
  /** Upload failed */
  ...
  "inputs.portable-text.action.insert-inline-object-aria-label":
    "Voeg {{typeName}} in (inline)",
  /** Label for action to remove an annotation */
  "inputs.portable-text.action.remove-annotation": "Verwijder annotatie",
  ...
  "inputs.reference.document-opens-in-new-tab":
    "Dit document wordt geopend in een nieuw tabblad",
  ...
  "inputs.reference.error.search-failed-title":
    "Zoeken naar referentie mislukt",
  /** Alternative text for the image shown in cross-dataset reference input */
  "inputs.reference.image-preview-alt-text":
    "Afbeeldingsvoorbeeld van het gerefereerde document",
  ...
  "inputs.reference.no-results-for-query":
    "Geen resultaten voor <strong>“{{searchTerm}}”</strong>",
  ...
  "inputs.reference.strength-mismatch.weaken-button-label":
    "Converteren naar zwakke referentie",
  ...
  "inputs.untyped-value.details.json-dump-prefix":
    "Huidige waarde (<code>object</code>):",
  ...
  "new-document.no-results":
    "Geen resultaten voor <strong>{{searchQuery}}</strong>",
  ...
  "preview.image.file-is-being-uploaded.alt-text":
    "De afbeelding die momenteel wordt geüpload",
  ...
  "search.document-types-no-matches-found":
    "Geen overeenkomsten voor {{filter}}",
  ...
  "search.error.no-valid-asset-source-title":
    "Geen geldige asset bronnen gevonden.",
  ...
  "search.error.unspecified-error-title":
    "Er is iets misgegaan tijdens het zoeken",
  /**
  ...
  "search.instructions":
    "Gebruik <ControlsIcon/> om uw zoekopdracht te verfijnen",
  /** Helpful description for when no search results are found */
  "search.no-results-help-description":
    "Probeer een ander trefwoord of pas uw filters aan",
  ...
  "search.operator.array-count-gte.description_other":
    "<Field/> <Operator>heeft ≥</Operator> <Value>{{count}} items</Value>",
  "search.operator.array-count-gte.name":
    "hoeveelheid groter dan of gelijk aan",
  ...
  "search.operator.array-count-lte.description_other":
    "<Field/> <Operator>heeft ≤</Operator> <Value>{{count}} items</Value>",
  "search.operator.array-count-lte.name":
    "hoeveelheid minder dan of gelijk aan",
  ...
  "search.operator.date-range.description":
    "<Field/> <Operator>ligt tussen</Operator> <Value/>",
  ...
  "search.operator.date-time-range.description":
    "<Field/> <Operator>is tussen</Operator> <Value/>",
  ...
  "search.operator.not-defined.description":
    "<Field/> <Operator>is</Operator> <Value>leeg</Value>",
