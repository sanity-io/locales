...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.reload-to-update': 'Studio herladen om te updaten',
  ...
  'help-resources.studio-auto-update-now': 'Herladen om bij te werken naar v{{newVersion}}',
  ...
  'release.toast.delete-schedule-draft.error':
    'Het verwijderen van het geplande conceptdocument <strong>{{title}}</strong> is mislukt: {{error}}',
  ...
  'release.toast.publish-scheduled-draft.error':
    'Het publiceren van het geplande conceptdocument <strong>{{title}}</strong> is mislukt: {{error}}',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'Het opnieuw plannen van het geplande conceptdocument <strong>{{title}}</strong> is mislukt: {{error}}',
