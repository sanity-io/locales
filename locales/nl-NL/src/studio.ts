...
export default removeUndefinedLocaleResources({
  ...
  'release.chip.tooltip.created-date': 'Gemaakt op {{date}}',
  /** Label for tooltip in draft chip when it's a live edit document */
  'release.chip.tooltip.draft-disabled.live-edit':
    'Dit document bevindt zich in live bewerkingsmodus, concepten zijn uitgeschakeld',
  /** Label for tooltip in chip with the lasted edited date */
  'release.chip.tooltip.edited-date': 'Bewerkt op {{date}}',
  ...
  'release.chip.tooltip.published-date': 'Gepubliceerd op {{date}}',
  ...
  'release.dialog.tooltip.description':
    'De beoogde uitgavetijd wordt gebruikt om betere voorbeelden en aanwijzingen te creëren over of documenten conflicteren.',
