...
export default removeUndefinedLocaleResources({
  ...
  'banners.deleted-bundle-banner.text': "De '<strong>{{title}}</strong>' release is verwijderd.",
  ...
  'changes.error-title': 'Er is iets misgegaan',
  ...
  'document-status.created': 'Gemaakt {{date}}',
  ...
  'new-document.disabled-published.tooltip': 'U kunt geen nieuwe gepubliceerde documenten maken',
  ...
  'release.action.discard-version.success':
    '<strong>{{title}}</strong> versie is succesvol verwijderd',
  ...
  'release.action.unpublish-version.success':
    'Succesvol ingesteld <strong>{{title}}</strong> om niet gepubliceerd te worden bij release',
  ...
  'release.chip.tooltip.created-date': 'Gemaakt {{date}}',
  ...
  'release.dialog.tooltip.description':
    'De beoogde releasetijd wordt gebruikt om betere previews te maken en aanwijzingen te geven of documenten conflicteren.',
  /** Label for noting that a release time is not final */
  'release.dialog.tooltip.note': 'Je kunt het altijd later wijzigen.',
  /** Title for tooltip to explain release time */
  'release.dialog.tooltip.title': 'Geschatte tijd van release',
  ...
  'release.toast.create-release-error.title': 'Release aanmaken mislukt',
  ...
  'release.tooltip.locked':
    'Deze release is gepland. Plan het uit om meer documenten toe te voegen.',
