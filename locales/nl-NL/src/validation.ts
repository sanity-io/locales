...
export default removeUndefinedLocaleResources({
  ...
  'object.media-not-found': 'Het bestand kon niet gevonden worden in de Media Bibliotheek',
  /** Media object is missing a reference to a document in its `_ref` field */
  'object.not-media-library-asset': 'Moet een verwijzing zijn naar een Media Bibliotheek bestand',
