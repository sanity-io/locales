...
export default removeUndefinedLocaleResources({
  ...
  'copy-paste.on-copy.validation.clipboard-not-supported.description':
    'Toegang tot het klembord is vereist om deze inhoud te kopiëren. Sta klembordmachtigingen toe in uw browserinstellingen en probeer het opnieuw te kopiëren.',
  /** The error message that is shown when the clipboard is not supported */
