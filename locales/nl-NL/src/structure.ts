...
export default removeUndefinedLocaleResources({
  ...
  "action.delete.disabled.nothing-to-delete":
    "Dit document bestaat nog niet of is al verwijderd",
  ...
  "action.discard-changes.disabled.not-published":
    "Dit document is niet gepubliceerd",
  /** Tooltip when action button is disabled because the operation is not ready   */
  ...
  "action.publish.already-published.tooltip":
    "Gepubliceerd {{timeSincePublished}} geleden",
  ...
  "action.publish.waiting":
    "Wachten op het afronden van taken voordat er gepubliceerd wordt",
  ...
  "confirm-delete-dialog.other-reference-count.title_one":
    "1 andere referentie niet getoond",
  /** Shown if there are references to other documents but the user does not have the permission to see the relevant document IDs */
  ...
  "no-document-types-screen.link-text":
    "Leer hoe u een documenttype kunt toevoegen →",
  ...
  "pane-item.published-status.has-published.tooltip":
    "Gepubliceerd <RelativeTime/>",
  /** The text shown in the tooltip of pane item previews of documents if there are no unpublished edits */
  "pane-item.published-status.no-published.tooltip":
    "Geen ongepubliceerde wijzigingen",
  ...
  "panes.document-list-pane.max-items.text":
    "Er worden maximaal {{limit}} documenten weergegeven",
  ...
  "structure-error.header.text":
    "Er is een fout opgetreden bij het lezen van de structuur",
