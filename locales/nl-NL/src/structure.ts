...
export default removeUndefinedLocaleResources({
  ...
  'action.copy-document-id.label': 'Document-ID kopiëren',
  ...
  'action.copy-link-to-document.label': 'Document-URL kopiëren',
  ...
  'action.delete.disabled.target-not-found':
    'De geselecteerde release of variant bevat dit document niet',
  ...
  'action.publish.disabled.not-publishable':
    'Deze versie wordt gepubliceerd als onderdeel van de bijbehorende release',
  ...
  'action.unpublish.disabled.already-unpublished':
    'Dit document staat al ingesteld om gepubliceerd te worden ongedaan gemaakt',
  ...
  'banners.obsolete-draft.actions.compare-draft.tooltip':
    'Het gepubliceerde document bestaat niet, dus dit concept kan niet worden vergeleken.',
  ...
  'banners.release.action.add-to-bundle': 'Toevoegen aan bundle',
  ...
  'banners.variant.action.add-to-variant': 'Variant aanmaken',
  ...
  'banners.variant.definition-not-found':
    'De geselecteerde variant <VariantName>{{name}}</VariantName> kon niet worden gevonden.',
  /** Toast description in case an error occurs when adding a document to a variant */
  'banners.variant.error.description':
    'Er is een fout opgetreden bij het toevoegen van het document aan de variant: {{message}}',
  /** Toast title in case an error occurs when adding a document to a variant */
  'banners.variant.error.title': 'Fout bij het toevoegen van document aan variant',
  /** The text for the banner that appears when a document is not in the selected variant */
  'banners.variant.not-in-variant':
    'Er bestaat geen <PerspectiveTitle>{{perspectiveTitle}}</PerspectiveTitle> variantdocument voor <VariantBadge>{{variantTitle}}</VariantBadge>.',
  /** Description of toast that will appear while the document is added to the variant */
  'banners.variant.waiting.description':
    'Even geduld terwijl het document aan de variant wordt toegevoegd. Dit duurt normaal gesproken niet langer dan een paar seconden.',
  /** Title of toast that will appear while the document is added to the variant */
  'banners.variant.waiting.title': 'Document toevoegen aan variant…',
  ...
  'compare-version.error.loadVersions.title': 'Laden van versies mislukt',
  ...
  'confirm-delete-dialog.confirm-anyway-button.text_delete_one': 'Toch verwijderen',
  /** The text in the "Delete anyway" button when the document has multiple versions */
  'confirm-delete-dialog.confirm-anyway-button.text_delete_other': 'Toch alle versies verwijderen',
  ...
  'confirm-delete-dialog.confirm-button.text_delete_one': 'Document verwijderen',
  /** The text in the "Delete now" button when the document has multiple versions */
  'confirm-delete-dialog.confirm-button.text_delete_other': 'Alle versies verwijderen',
  ...
  'confirm-delete-dialog.confirmation.text_delete_other':
    'Weet je zeker dat je alle versies van dit document wilt verwijderen?',
  /** If no referring documents are found, this text appears above the cancel and confirmation buttons */
  ...
  'document-group-inventory.onboarding-hint': 'Waar zijn de versieknoppen gebleven?',
  ...
  'document-target-badges.not-in-target.tooltip':
    'Document bestaat nog niet in de geselecteerde perspective.',
  ...
  'document-view.form-view.sync-pending.description':
    'We blijven het proberen. Je wijzigingen worden in de tussentijd in je browser bewaard.',
  /** Title of the toast shown when recent edits haven't synced for a while (still retrying) */
  'document-view.form-view.sync-pending.title': 'Je wijzigingen worden niet opgeslagen',
  ...
  'document-view.form-view.sync-recovering.description':
    'Bewerken wordt hervat zodra je wijzigingen zijn opgeslagen.',
  /** Title of the toast shown when the connection is back and buffered edits are being submitted */
  'document-view.form-view.sync-recovering.title': 'Je wijzigingen opslaan…',
  ...
  'document-view.form-view.sync-stalled.description':
    'Bewerken is gepauzeerd totdat ze zijn opgeslagen. Je wijzigingen worden in je browser bewaard, dus houd dit tabblad open terwijl we blijven proberen.',
  /** Title of the toast shown when edits have been unsynced long enough that editing is locked */
  'document-view.form-view.sync-stalled.title': 'Je wijzigingen worden nog steeds niet opgeslagen',
  ...
  'incoming-references-pane.no-references': 'Geen inkomende verwijzingen gevonden.',
  ...
  'menu-items.sort-by.restore-default.disabled-reason': 'Standaardvolgorde is al in gebruik',
  ...
  'panes.document-operation-results.operation-success_copy-id':
    'Document-ID gekopieerd naar klembord',
  ...
  'panes.document-operation-results.operation-success_publishVersion': 'Versie is gepubliceerd',
  ...
  'panes.document-operation-results.operation-success_unpublishVersion':
    'De versie wordt niet meer gepubliceerd zodra de release wordt gepubliceerd',
  ...
  'panes.document-pane.variant-target.loading': 'Document laden…',
