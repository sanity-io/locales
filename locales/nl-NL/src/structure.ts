...
export default removeUndefinedLocaleResources({
  ...
  'banners.archived-release.description':
    'U bekijkt een alleen-lezen document dat werd gearchiveerd als onderdeel van <VersionBadge>{{title}}</VersionBadge>. Het kan niet worden bewerkt',
  ...
  'banners.published-release.description':
    'U bekijkt een alleen-lezen document dat werd gepubliceerd als onderdeel van <VersionBadge>{{title}}</VersionBadge>. Het kan niet worden bewerkt',
  ...
  'banners.release.waiting.title': 'Document aan release toevoegen…',
