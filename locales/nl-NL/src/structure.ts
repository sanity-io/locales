...
export default removeUndefinedLocaleResources({
  ...
  'canvas.banner.editable.linked-text': 'Dit document kan worden bewerkt in Canvas.',
  /** The description for the canvas linked banner popover in editable mode*/
  'canvas.banner.editable.popover-description':
    'Canvas stelt je in staat vrij te schrijven en vervolgens inhoud in Studio bij te werken zonder handmatig kopiëren veld voor veld.',
  /** The heading for the canvas linked banner popover in editable mode*/
  'canvas.banner.editable.popover-heading': 'Vrij vormgeven schrijven',
