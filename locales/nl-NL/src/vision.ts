...
export default removeUndefinedLocaleResources({
  ...
  'settings.perspective.preview-drafts-renamed-to-drafts.description':
    'De "<code>previewDrafts</code>" perspective is hernoemd naar "<code>drafts</code>" en is nu afgekeurd. Deze wijziging is effectief voor alle versies met ondersteuning voor perspectives (>= v2021-03-25).',
