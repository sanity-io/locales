...
export default removeUndefinedLocaleResources({
  ...
  'settings.perspective.preview-drafts-renamed-to-drafts.description':
    'Het "<code>previewDrafts</code>" perspectief is hernoemd naar "<code>drafts</code>" en is nu afgekeurd. Deze wijziging is effectief voor alle versies met ondersteuning voor perspectief (>= v2021-03-25).',
  /** Call to action to read the docs related to "Perspectives" */
  'settings.perspectives.action.docs-link': 'Lees de documentatie',
  /** Option for selecting default perspective */
  'settings.perspectives.default': 'Geen perspectief (API standaard)',
  ...
  'settings.perspectives.new-default.description':
    'Het standaardperspectief zal veranderen van "<code>raw</code>" naar "<code>published</code>" in een aankomende API-versie. Raadpleeg de documentatie voor meer details.',
