...
export default removeUndefinedLocaleResources({
  ...
  'generic.incorrect-type': 'Dự kiến kiểu "{{expectedType}}", nhận được "{{actualType}}"',
  /** Value is not one of the values specifically allowed */
  'generic.not-allowed': 'Giá trị không khớp với bất kỳ giá trị cho phép nào',
  /** Value "$givenValue" is not one of the values specifically allowed */
  'generic.not-allowed_hint': 'Giá trị "{{hint}}" không khớp với bất kỳ giá trị cho phép nào',
  ...
  'string.url.disallowed-scheme': 'Không khớp với các giao thức/scheme cho phép',
