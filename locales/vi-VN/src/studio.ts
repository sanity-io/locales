...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.tooltip.prerelease': 'Phiên bản trước khi phát hành',
  ...
  'release.dialog.edit-schedule.body': 'Chọn ngày và giờ mới cho việc xuất bản đã lên lịch.',
  ...
  'release.dialog.publish-scheduled-draft.header': 'Xuất bản bản nháp ngay bây giờ',
