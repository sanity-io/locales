...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.configuration-issue.missing-appid':
    'Tự động cập nhật được bật, nhưng không có <code>deployment.appId</code> được cấu hình trong <code>sanity.cli.ts</code>. Studio này đang cập nhật theo kênh <strong>mới nhất</strong>.',
  ...
  'about-dialog.version-info.tooltip.prerelease': 'Phiên bản thử nghiệm',
  /** "Up to date" tooltip in About-dialog */
  'about-dialog.version-info.tooltip.up-to-date': 'Đã cập nhật',
  ...
  'asset-sources.media-library.warning.file-already-exist.description':
    'Sử dụng tệp tin đã có sẵn trong thư viện.',
  ...
  'release.dialog.edit-schedule.body': 'Chọn một ngày và giờ mới cho việc xuất bản đã lên lịch.',
  ...
  'release.toast.delete-schedule-draft.error':
    'Không thể xóa bản nháp đã lên lịch <strong>{{title}}</strong>: {{error}}',
  /** Success toast for deleting a scheduled draft */
  'release.toast.delete-schedule-draft.success':
    'Bản nháp đã lên lịch <strong>{{title}}</strong> đã được xóa.',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.not-found-release.title': "Không tìm thấy phiên bản '{{title}}'",
  /** Error toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.error':
    'Không thể xuất bản bản nháp đã lên lịch <strong>{{title}}</strong>: {{error}}',
  /** Success toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.success':
    'Bản nháp đã lên lịch <strong>{{title}}</strong> đã được xuất bản.',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'Không thể lên lịch lại bản nháp đã lên lịch <strong>{{title}}</strong>: {{error}}',
  /** Success toast for rescheduling a draft */
  'release.toast.reschedule-scheduled-draft.success':
    'Bản nháp đã lên lịch <strong>{{title}}</strong> đã được lên lịch lại.',
