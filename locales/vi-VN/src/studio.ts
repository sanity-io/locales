...
export default removeUndefinedLocaleResources({
  ...
  "calendar.error.must-be-in-format":
    "Phải ở định dạng <Emphasis>{{exampleDate}}</Emphasis>",
  ...
  "changes.error-boundary.title":
    "Hiển thị các thay đổi cho trường này gây ra lỗi",
  ...
  "changes.portable-text.empty-inline-object":
    "Đối tượng nội tuyến trống {{inlineObjectType}}",
  /** Portable Text diff: An empty object is the result of adding/removing an annotation */
  "changes.portable-text.empty-object-annotation":
    "Chú thích trống {{annotationType}}",
  ...
  "changes.portable-text.inline-object_changed":
    "Đã thay đổi đối tượng nội tuyến",
  ...
  "changes.portable-text.inline-object_unchanged":
    "Đối tượng nội tuyến không thay đổi",
  ...
  "changes.portable-text.unknown-annotation-schema-type":
    "Loại sơ đồ chú thích không xác định",
  ...
  "form.error.mixed-array-alert.remove-button.text":
    "Xóa các giá trị không phải đối tượng",
  ...
  "inputs.file.error.unknown-member-kind":
    "Loại thành viên không xác định: {{kind}}",
  ...
  "inputs.file.upload-failed.description":
    "Không thể hoàn thành việc tải lên vào lúc này.",
  /** Upload failed */
  ...
  "inputs.files.common.actions-menu.notification.url-copied":
    "URL đã được sao chép vào bảng tạm",
  /** Replace */
  ...
  "inputs.image.actions-menu.edit-details.aria-label":
    "Mở hộp thoại chỉnh sửa hình ảnh",
  ...
  "inputs.image.drag-overlay.cannot-upload-here":
    "Không thể tải lên tệp này ở đây",
  ...
  "inputs.invalid-value.convert-button.text":
    "Chuyển đổi thành <code>{{targetType}}</code>",
  /** The current value (<code>`{{actualType}}`</code>) */
  "inputs.invalid-value.current-type":
    "Giá trị hiện tại (<code>{{actualType}}</code>)",
  ...
  "inputs.object.unknown-fields.warning.title_other":
    "Phát hiện trường không xác định",
  ...
  "inputs.portable-text.invalid-value.title":
    "Giá trị Portable Text không hợp lệ",
  ...
  "inputs.reference.document-opens-in-new-tab":
    "Tài liệu này sẽ mở trong một tab mới",
  ...
  "inputs.reference.error.failed-to-load-document-title":
    "Không tải được tài liệu được tham chiếu",
  ...
  "inputs.reference.image-preview-alt-text":
    "Xem trước hình ảnh của tài liệu được tham chiếu",
  ...
  "inputs.reference.no-results-for-query":
    "Không có kết quả cho <strong>“{{searchTerm}}”</strong>",
  ...
  "inputs.reference.resolving-initial-value":
    "Đang giải quyết giá trị ban đầu…",
  ...
  "inputs.untyped-value.details.json-dump-prefix":
    "Giá trị hiện tại (<code>đối tượng</code>):",
  ...
  "search.document-types-no-matches-found":
    "Không tìm thấy kết quả cho {{filter}}",
  ...
  "search.error.display-filter-title":
    "Đã xảy ra lỗi trong khi hiển thị bộ lọc này.",
  ...
  "search.error.no-valid-asset-source-title":
    "Không tìm thấy nguồn tài sản hợp lệ.",
  ...
  "search.filter-field-tooltip-used-in-document-types":
    "Được sử dụng trong các loại tài liệu",
  ...
  "search.instructions":
    "Sử dụng <ControlsIcon/> để tinh chỉnh tìm kiếm của bạn",
  /** Helpful description for when no search results are found */
  "search.no-results-help-description":
    "Thử từ khóa khác hoặc điều chỉnh bộ lọc của bạn",
  ...
  "search.operator.date-range.description":
    "<Field/> <Operator>nằm giữa</Operator> <Value/>",
