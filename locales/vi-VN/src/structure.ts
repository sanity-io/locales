...
export default removeUndefinedLocaleResources({
  ...
  "action.delete.disabled.nothing-to-delete":
    "Tài liệu này chưa tồn tại hoặc đã bị xóa",
  ...
  "action.discard-changes.disabled.no-change":
    "Tài liệu này không có thay đổi chưa xuất bản",
  ...
  "action.publish.already-published.tooltip":
    "Đã xuất bản {{timeSincePublished}} trước",
  ...
  "action.restore.confirm-dialog.confirm-discard-changes":
    "Bạn có chắc chắn muốn khôi phục tài liệu này không?",
  /** Fallback tooltip for when user is looking at the initial version */
  "action.restore.disabled.cannot-restore-initial":
    "Bạn không thể khôi phục về phiên bản ban đầu",
  ...
  "confirm-delete-dialog.cdr-table.id-copied-toast.title":
    "Đã sao chép ID tài liệu vào bảng tạm!",
  ...
  "doc-title.unknown-schema-type.text":
    "Loại schema không xác định: {{schemaType}}",
  ...
  "no-document-types-screen.link-text":
    "Tìm hiểu cách thêm một loại tài liệu →",
  ...
  "panes.document-operation-results.operation-error":
    "Đã xảy ra lỗi trong quá trình {{context}}",
