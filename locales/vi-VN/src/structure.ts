...
export default removeUndefinedLocaleResources({
  ...
  'action.copy-document-id.label': 'Sao chép ID tài liệu',
  ...
  'action.copy-link-to-document.label': 'Sao chép URL tài liệu',
  ...
  'action.unpublish.disabled.already-unpublished': 'Tài liệu này đã được đặt để bỏ xuất bản',
  ...
  'banners.obsolete-draft.actions.compare-draft.tooltip':
    'Tài liệu đã xuất bản không tồn tại, vì vậy bản nháp này không thể được so sánh.',
  ...
  'compare-version.error.loadVersions.title': 'Không thể tải các phiên bản',
  ...
  'confirm-delete-dialog.confirm-anyway-button.text_delete_other': 'Vẫn xóa tất cả các phiên bản',
  ...
  'confirm-delete-dialog.confirm-button.text_delete_other': 'Xóa tất cả các phiên bản',
  ...
  'confirm-delete-dialog.confirmation.text_delete_other':
    'Bạn có chắc chắn muốn xóa tất cả các phiên bản của tài liệu này không?',
  /** If no referring documents are found, this text appears above the cancel and confirmation buttons */
  ...
  'document-view.form-view.sync-stalled.description':
    'Việc chỉnh sửa bị tạm dừng cho đến khi lưu thành công. Các thay đổi của bạn được lưu trữ trên trình duyệt, vì vậy hãy giữ tab này mở trong khi chúng tôi tiếp tục thử.',
  ...
  'panes.document-operation-results.operation-success_copy-id':
    'ID tài liệu đã được sao chép vào bảng tạm',
  ...
  'panes.document-operation-results.operation-success_unpublishVersion':
    'Phiên bản sẽ được bỏ xuất bản khi bản phát hành được xuất bản',
