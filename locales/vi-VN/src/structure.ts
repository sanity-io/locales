...
export default removeUndefinedLocaleResources({
  ...
  'banners.archived-scheduled-draft.description': 'Bản nháp lên lịch này đã được lưu trữ',
  ...
  'banners.scheduled-draft-override-banner.text':
    'Bản nháp của tài liệu này đã được lên lịch để xuất bản. Những thay đổi bạn thực hiện ở đây có thể sẽ bị ghi đè bởi phiên bản đó.',
