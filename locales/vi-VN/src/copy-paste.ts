...
export default removeUndefinedLocaleResources({
  ...
  'copy-paste.on-copy.validation.clipboard-not-supported.description':
    'Yêu cầu quyền truy cập vào bảng tạm để sao chép nội dung này. Cho phép quyền truy cập bảng tạm trong cài đặt trình duyệt của bạn, sau đó thử sao chép lại.',
  /** The error message that is shown when the clipboard is not supported */
