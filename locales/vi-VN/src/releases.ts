...
export default removeUndefinedLocaleResources({
  ...
  'confirm-active-scheduled-drafts-dialog.description':
    'Lên lịch tất cả các Bản nháp đã lên lịch đang tạm dừng theo ngày xuất bản dự kiến',
  /** Dialog warning when some scheduled drafts have past dates */
  'confirm-active-scheduled-drafts-dialog.past-dates-warning':
    'Một số Bản nháp đã lên lịch này được đặt cho các ngày trong quá khứ. Xác nhận lịch sẽ xuất bản ngay lập tức các phiên bản tài liệu đó.',
  ...
  'copy-to-draft-dialog.description':
    'Đã tồn tại một phiên bản nháp của tài liệu này. Sao chép phiên bản hiện tại vào bản nháp và ghi đè phiên bản nháp hiện có.',
  ...
  'permission-missing-description':
    'Vai trò của bạn hiện giới hạn những gì bạn có thể xem trong bản phát hành này. Bạn không thể xuất bản hoặc lên lịch bản phát hành này.',
  ...
  'toast.unarchive.error': "Không thể bỏ lưu trữ '<strong>{{title}}</strong>': {{error}}",
