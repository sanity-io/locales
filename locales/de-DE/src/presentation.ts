...
export default removeUndefinedLocaleResources({
  ...
  'preview-frame.configuration.error.title': 'Vorschau-URL-Ursprung stimmt nicht überein',
  /** The text shown when the preview frame cannot connect to Presentation */
  'preview-frame.connection.error.text': 'Verbindung zur Vorschau konnte nicht hergestellt werden',
  ...
  'preview-frame.perspective.published.text': 'Diese Seite mit veröffentlichtem Inhalt anzeigen',
  ...
  'preview-location-input.error_missing-origin': 'Die URL muss mit {{origin}} beginnen',
  ...
  'preview-location-input.error_same-base-path':
    'Die URL darf nicht denselben Basispfad wie das Studio haben {{basePath}}',
  ...
  'preview-url-secret.missing-grants':
    'Sie haben keine Berechtigung, URL-Vorschau-Secrets zu erstellen. Dies wird wahrscheinlich dazu führen, dass die Vorschau nicht geladen werden kann.',
  ...
  'share-preview-menu.toggle-button.label_second-line': 'mit jedem, der den Link hat',
