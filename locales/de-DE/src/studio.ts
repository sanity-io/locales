...
export default removeUndefinedLocaleResources({
  ...
  'document-group.delete.cdr-table.id-copied-toast.title-failed':
    'Dokument-ID konnte nicht kopiert werden',
  ...
  'document-group.delete.other-reference-count.tooltip':
    'Wir können die Metadaten für diese Referenzen nicht anzeigen, da ein Zugriffstoken für die zugehörigen datasets fehlt.',
