...
export default removeUndefinedLocaleResources({
  ...
  'asset-sources.media-library.warning.file-already-exist.description':
    'Die bereits vorhandene Datei aus der Bibliothek wird verwendet.',
  ...
  'release.menu.label': 'Freigabemenü',
  ...
  'release.schedule-dialog.publish-date-in-past-warning':
    'Planen Sie diese Veröffentlichung für einen zukünftigen Zeitpunkt.',
  ...
  'release.toast.publish-scheduled-draft.error':
    'Fehler bei der Veröffentlichung des geplanten Entwurfsdokuments <strong>{{title}}</strong>: {{error}}',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'Fehler bei der Neuplanung des geplanten Entwurfsdokuments <strong>{{title}}</strong>: {{error}}',
  ...
  'schedule-publish-dialog.header': 'Entwurf zur Veröffentlichung planen',
