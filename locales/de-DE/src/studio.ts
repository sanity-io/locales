...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.configuration-issue.missing-appid':
    'Automatische Updates sind aktiviert, aber es ist keine <code>deployment.appId</code> in <code>sanity.cli.ts</code> konfiguriert. Dieses Studio aktualisiert sich gegen den <strong>latest</strong>-Kanal.',
  ...
  'about-dialog.version-info.update-button.tooltip':
    'Erfahren Sie, wie Sie Sanity Studio aktualisieren',
  ...
  'asset-sources.media-library.select-dialog.title': '{{assetType}} für {{targetTitle}} auswählen',
  /** Warning message shown when uploading already existing files to the Media Library Asset Source */
  'asset-sources.media-library.warning.file-already-exist.description':
    'Die bereits in der Bibliothek vorhandene Datei wird verwendet.',
  ...
  'release.menu.label': 'Release-Menü',
  ...
  'release.schedule-dialog.publish-date-in-past-warning':
    'Planen Sie diese Veröffentlichung für eine zukünftige Zeit und ein zukünftiges Datum.',
  /** Label for date picker when scheduling a release */
  'release.schedule-dialog.select-publish-date-label': 'Planen am',
  ...
  'schedule-publish-dialog.header': 'Entwurf für Veröffentlichung planen',
