...
export default removeUndefinedLocaleResources({
  ...
  'changes.from-base-variant.label': 'Geändert gegenüber der Basisvariante',
  ...
  'diagnostics.menu-item': 'Diagnose',
  ...
  'document-group-inventory.action.manage-versions': 'Versionen verwalten',
  ...
  'document-status.published-at': 'Veröffentlicht am {{date}}',
  ...
  'form.field.actions-menu.title': 'Feldaktionen',
  ...
  'release.action.edit-details': 'Details bearbeiten',
  ...
  'release.dialog.edit.confirm': 'Speichern',
  /** Field label for the release description in the edit release dialog */
  'release.dialog.edit.description-label': 'Beschreibung',
  /** Title for the edit release dialog */
  'release.dialog.edit.title': 'Release bearbeiten',
  ...
  'release.toast.edit-release-error.title': 'Speichern der Release-Details fehlgeschlagen',
  ...
  'user-menu.action.claim-project': 'Dieses Projekt beanspruchen',
