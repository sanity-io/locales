...
export default removeUndefinedLocaleResources({
  ...
  "asset-source.asset-usage-dialog.header_file":
    "Dokumente, die die Datei verwenden",
  /** Header in usage dialog for image assets */
  "asset-source.asset-usage-dialog.header_image":
    "Dokumente, die das Bild verwenden",
  ...
  "asset-source.file.asset-list.action.select-file.title":
    "Wählen Sie die Datei {{filename}} aus",
  ...
  "asset-source.usage-list.documents-using-file_unnamed_one":
    "Ein Dokument verwendet diese Datei",
  ...
  "asset-source.usage-list.documents-using-image_unnamed_one":
    "Ein Dokument verwendet dieses Bild",
  ...
  "calendar.error.must-be-in-format":
    "Muss im Format <Emphasis>{{exampleDate}}</Emphasis> sein",
  ...
  "changes.action.revert-changes-confirm-change_one":
  ...
  "changes.array.item-added-in-position":
    "Hinzugefügt an Position {{position}}",
  "changes.array.item-moved_down_one":
    "Um {{count}} Position nach unten verschoben",
  "changes.array.item-moved_down_other":
    "Um {{count}} Positionen nach unten verschoben",
  /**
   * Array diff: An item was moved within the array.
   * Receives `{{count}}` representing number of positions it moved.
   * Context is the direction of the move, either `up` or `down`.
   */
  "changes.array.item-moved_up_one":
    "Um {{count}} Position nach oben verschoben",
  "changes.array.item-moved_up_other":
    "Um {{count}} Positionen nach oben verschoben",
  /** Array diff: An item was removed from a given position (`{{position}}`) */
  "changes.array.item-removed-from-position":
    "Entfernt von Position {{position}}",
   ...
   * These are titles for fallback links in the event the help & resources endpoint isn't able to be fetched
   */
  "help-resources.action.join-our-community":
  ...
  "inputs.array.error.json-representation-description":
    "JSON-Darstellung dieses Elements:",
  ...
  "inputs.file.upload-failed.description":
    "Der Upload konnte derzeit nicht abgeschlossen werden.",
  /** Upload failed */
  ...
  /** Drop to upload */
  "inputs.files.common.drop-message.drop-to-upload":
    "Zum Hochladen hierher ziehen",
  ...
  "inputs.image.drag-overlay.drop-to-upload-image":
    "Bild zum Hochladen hier ablegen",
  ...
  "inputs.reference.document-opens-in-new-tab":
    "Dieses Dokument wird in einem neuen Tab geöffnet",
  ...
  "inputs.reference.image-preview-alt-text":
    "Bildvorschau des referenzierten Dokuments",
  ...
  "inputs.reference.metadata-error.title":
    "Referenzmetadaten können nicht geladen werden",
  ...
  "inputs.reference.preview.is-not-published-aria-label":
  ...
  "inputs.reference.preview.published-at-time":
  ...
  "inputs.untyped-value.details.json-dump-prefix":
    "Aktueller Wert (<code>object</code>):",
  ...
  "new-document.no-results":
    "Keine Ergebnisse für <strong>{{searchQuery}}</strong>",
  ...
  "preview.image.file-is-being-uploaded.alt-text":
    "Das Bild wird gerade hochgeladen",
  ...
  "search.action.search-specific-types-truncated":
    "Suche nach {{types, list}} +{{count}} mehr",
  ...
  "search.document-types-no-matches-found":
    "Keine Übereinstimmungen für {{filter}}",
  ...
  "search.error.no-valid-asset-source-title":
    "Keine gültigen Asset-Quellen gefunden.",
  ...
  "search.instructions":
    "Verwenden Sie <ControlsIcon/>, um Ihre Suche zu verfeinern",
  ...
  "timeline.error.unable-to-load-revision":
    "Revision kann nicht geladen werden",
  ...
  "workspaces.action.choose-another-workspace":
    "Einen anderen Arbeitsbereich wählen",
