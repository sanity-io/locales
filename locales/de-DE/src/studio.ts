...
export default removeUndefinedLocaleResources({
  ...
  'release.chip.tooltip.draft-disabled.live-edit':
    'Dieses Dokument befindet sich im Live-Edit-Modus, Entwürfe sind deaktiviert',
  ...
  'release.toast.create-release-error.title': 'Veröffentlichung konnte nicht erstellt werden',
  ...
  'release.type.asap': 'Schnellstmöglich',
