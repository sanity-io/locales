...
export default removeUndefinedLocaleResources({
  ...
  'form.error.unhandled-runtime-error.call-stack.title': 'Aufrufstapel:',
  /** The title above the error component stack provided by React's underlying ErrorBoundary component */
  'form.error.unhandled-runtime-error.component-stack.title': 'Komponentenstapel:',
  /** The error message for the unhandled error that crashed the Input component during render */
  'form.error.unhandled-runtime-error.error-message': 'Fehler: {{message}}',
  /** The title for the error card rendered inside a field in place of a crashing input */
  'form.error.unhandled-runtime-error.title': 'Unbehandelter Laufzeitfehler',
  /** Form field deprecated label */
  'form.field.deprecated-label': 'veraltet',
  /** Fallback title shown above field if it has no defined title */
  'form.field.untitled-field-label': 'Ohne Titel',
  /** The title of the reconnecting toast */
  'form.reconnecting.toast.title': 'Verbindung verloren. Wiederverbinden…',
  ...
  'free-trial.tooltip.days-count_one': '{{count}} Tag verbleibend im Test',
  'free-trial.tooltip.days-count_other': '{{count}} Tage verbleibend im Test',
  /** Tooltip for free trial navbar button, once trial has ended */
  'free-trial.tooltip.trial-finished': 'Projekt upgraden',
  ...
  'inputs.array.insert-menu.search.no-results': 'Keine Elemente gefunden',
  /** Placeholder for the array insert menu search field */
  'inputs.array.insert-menu.search.placeholder': 'Suchen',
  /** Tooltip for the array insert menu grid view toggle */
  'inputs.array.insert-menu.toggle-grid-view.tooltip': 'Rasteransicht umschalten',
  /** Tooltip for the array insert menu list view toggle */
  'inputs.array.insert-menu.toggle-list-view.tooltip': 'Listenansicht umschalten',
  ...
  'inputs.portable-text.action.edit-annotation-aria-label': 'Anmerkung bearbeiten',
  ...
  'inputs.portable-text.action.remove-annotation-aria-label': 'Anmerkung entfernen',
  ...
  'inputs.portable-text.annotation-aria-label': 'Anmerkungsobjekt',
  ...
  'inputs.portable-text.inline-object.edit-aria-label': 'Objekt bearbeiten',
  /** Label for action to remove an inline object item */
  'inputs.portable-text.inline-object.remove': 'Objekt entfernen',
  /** Aria label for icon for action to remove an inline object item */
  'inputs.portable-text.inline-object.remove-aria-label': 'Objekt entfernen',
  ...
  'insufficient-permissions-message.not-authorized-explanation_delete-schedules':
    'Sie haben keine Berechtigung, Zeitpläne zu löschen.',
  ...
  'insufficient-permissions-message.not-authorized-explanation_edit-schedules':
    'Sie haben keine Berechtigung, Zeitpläne zu bearbeiten.',
  ...
  'insufficient-permissions-message.not-authorized-explanation_execute-schedules':
    'Sie haben keine Berechtigung, Zeitpläne auszuführen.',
  ...
  'new-document.disabled-published.tooltip':
    'Sie können keine neuen veröffentlichten Dokumente erstellen',
  /** Tooltip message for add document button when the selected perspective is for inactive release */
  'new-document.disabled-release.tooltip': 'Sie können diesem Release keine Dokumente hinzufügen',
  ...
  'presence.tooltip-content': 'Wer ist hier',
  ...
  'release.action.discard-version.success':
    'Die Version <strong>{{title}}</strong> wurde erfolgreich verworfen',
  /** Action message for when a new release is created off an existing version, draft or published document */
  'release.action.new-release': 'Neues Release',
  /** Tooltip message for not having permissions for creating new releases */
  'release.action.permission.error': 'Sie haben keine Berechtigung, diese Aktion durchzuführen',
  ...
  'release.action.unpublish-version.success':
    'Erfolgreich eingestellt, dass <strong>{{title}}</strong> im Release unveröffentlicht wird',
  /** Action message for when the view release is pressed */
  'release.action.view-release': 'Release anzeigen',
  ...
  'release.chip.tooltip.intended-for-date': 'Vorgesehen für {{date}}',
  ...
  'release.dialog.tooltip.description':
    'Die vorgesehene Veröffentlichungszeit wird verwendet, um bessere Vorschauen zu erstellen und Hinweise darauf zu geben, ob Dokumente in Konflikt stehen.',
  ...
  'release.tooltip.locked':
    'Diese Veröffentlichung wurde geplant. Heben Sie die Planung auf, um weitere Dokumente hinzuzufügen.',
  /** Label for the release type 'as soon as possible' */
  'release.type.asap': 'So bald wie möglich',
  /** Label for the release type 'at time', meaning it's a release with a scheduled date */
  'release.type.scheduled': 'Zu einem Zeitpunkt',
  ...
  'timeline.error.load-document-changes-version-title':
    'Die Historie der Versiondokumente ist nur über die Events API verfügbar.',
  ...
  'timeline.latest-revision': 'Letzte Revision',
  /**
   * Label for latest revision for timeline menu dropdown
  ...
  'timeline.no-previous-events': 'Keine früheren Ereignisse',
  ...
  'tree-editing-dialog.search-placeholder': 'Suchen',
  /** Menu aria label for the search menu */
  'tree-editing-dialog.search.menu-label': 'Suchmenü',
  /** Title label for when no search results are found on the tree of objects */
  'tree-editing-dialog.search.no-results-title': 'Keine Ergebnisse gefunden',
  /** Label to close the sidebar */
  'tree-editing-dialog.sidebar.action.close': 'Seitenleiste schließen',
  /** Collapse label the menu item in the sidebar  */
  'tree-editing-dialog.sidebar.action.collapse': 'Einklappen',
  /** Label to close the dialog */
  'tree-editing-dialog.sidebar.action.done': 'Fertig',
  /** Exapnd label the menu item in the sidebar  */
  'tree-editing-dialog.sidebar.action.expand': 'Ausklappen',
  /** Label to open the sidebar */
  'tree-editing-dialog.sidebar.action.open': 'Seitenleiste öffnen',
  ...
  'workspaces.select-workspace-tooltip': 'Arbeitsbereich auswählen',
