...
export default removeUndefinedLocaleResources({
  ...
  'asset-sources.media-library.select-dialog.title':
    'Auswahl von {{assetType}} für {{targetTitle}}',
  ...
  'release.schedule-dialog.publish-date-in-past-warning':
    'Planen Sie diese Veröffentlichung für einen zukünftigen Zeitpunkt und Datum.',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'Fehler beim Neuplanen des geplanten Entwurfsdokuments <strong>{{title}}</strong>: {{error}}',
