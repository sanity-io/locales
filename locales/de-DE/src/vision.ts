...
export default removeUndefinedLocaleResources({
  ...
  'settings.perspective.preview-drafts-renamed-to-drafts.description':
    'Die "<code>previewDrafts</code>" Perspektive wurde in "<code>drafts</code>" umbenannt und ist jetzt veraltet. Diese Änderung ist wirksam für alle Versionen mit Perspektivenunterstützung (>= v2021-03-25).',
  ...
  'settings.perspectives.new-default.description':
    'Die Standardperspektive wird in einer kommenden API-Version von "<code>raw</code>" auf "<code>published</code>" geändert. Bitte konsultieren Sie die Dokumentation für weitere Details.',
  /** Label for the pinned release perspective */
  'settings.perspectives.pinned-release-label': 'Festgepinnte Veröffentlichung',
