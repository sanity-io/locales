...
export default removeUndefinedLocaleResources({
  ...
  'start-in-create-banner.subtitle':
    'Ein frei gestaltbarer, KI-gesteuerter Editor, der direkt mit Ihren Studio-Dokumenten synchronisiert.',
  /** Header of the "Start writing in Create" banner */
  'start-in-create-banner.title': 'Beginnen Sie mit Sanity Create',
  /** Header badge of the "Start writing in Create" banner */
  'start-in-create-banner.title-badge': 'Frühzeitiger Zugang',
