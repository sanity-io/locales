...
export default removeUndefinedLocaleResources({
  ...
  "action.publish.already-published.no-time-ago.tooltip":
    "Bereits veröffentlicht",
  /** Tooltip when publish button is disabled because the document is already published.*/
  "action.publish.already-published.tooltip":
    "Vor {{timeSincePublished}} veröffentlicht",
  ...
  "action.publish.waiting":
    "Warten auf den Abschluss von Aufgaben vor der Veröffentlichung",
  ...
  "confirm-delete-dialog.other-reference-count.title_one":
    "1 andere Referenz nicht angezeigt",
  /** Shown if there are references to other documents but the user does not have the permission to see the relevant document IDs */
  ...
  "doc-title.unknown-schema-type.text":
    "Unbekannter Schema-Typ: {{schemaType}}",
  ...
  "no-document-types-screen.link-text":
    "Erfahren Sie, wie Sie einen Dokumenttyp hinzufügen →",
  ...
  "pane-item.draft-status.no-draft.tooltip":
  ...
  "panes.document-list-pane.no-matching-documents.text":
    "Keine übereinstimmenden Dokumente",
  ...
  "panes.document-operation-results.operation-success_publish":
    "Das Dokument wurde veröffentlicht",
  ...
  "panes.document-pane-provider.reconnecting.title":
    "Verbindung verloren. Wiederverbindung…",
