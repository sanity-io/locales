...
export default removeUndefinedLocaleResources({
  ...
  'action.archive.tooltip': 'Heben Sie die Planung dieses Release auf, um es zu archivieren',
  ...
  'action.unpublish': 'Veröffentlichung zurückziehen',
  /** Action message for scheduling an unpublished of a document  */
  'action.unpublish-doc-actions': 'Veröffentlichung beim Release zurückziehen',
  /** Action text for unscheduling a release */
  'action.unschedule': 'Release-Planung aufheben',

  /** Text for the summary button in release tool */
  'actions.summary': 'Zusammenfassung',

  'activity.event.add-document': 'Eine Dokumentversion hinzugefügt',
  'activity.event.archive': 'Den Release <strong>{{releaseTitle}}</strong> archiviert',
  'activity.event.create':
    'Den Release <strong>{{releaseTitle}}</strong> erstellt <ScheduleTarget>mit Ziel </ScheduleTarget>',
  'activity.event.discard-document': 'Eine Dokumentversion verworfen',
  'activity.event.edit': 'Release-Zeit auf <ScheduleTarget></ScheduleTarget> gesetzt',
  /**The text to display in the changes when the release type changes to asap */
  'activity.event.edit-time-asap': 'So schnell wie möglich',
  /**The text to display in the changes when the release type changes to undecided */
  'activity.event.edit-time-undecided': 'Unentschieden',
  'activity.event.publish': 'Den Release <strong>{{releaseTitle}}</strong> veröffentlicht',
  'activity.event.schedule': 'Als geplant markiert',
  /** The text for the activity event when the release is unarchived */
  'activity.event.unarchive': 'Den Release <strong>{{releaseTitle}}</strong> aus dem Archiv geholt',
  ...
  'activity.panel.close': 'Aktivität schließen',
  /** The loading text for when releases are loading */
  'activity.panel.error': 'Beim Abrufen der Release-Aktivität ist ein Fehler aufgetreten',
  /** The loading text for when releases are loading */
  'activity.panel.loading': 'Release-Aktivität wird geladen',
  /** The title for the activity panel shown in the releases detail screen */
  'activity.panel.title': 'Aktivität',

  /** Label for the button to proceed with archiving a release */
  'archive-dialog.confirm-archive-button': 'Ja, Release archivieren',
  ...
  'archive-dialog.confirm-archive-header': 'Möchten Sie diesen Release wirklich archivieren?',
  /** Title for the dialog confirming the archive of a release */
  'archive-dialog.confirm-archive-title':
    "Möchten Sie den Release <strong>'{{title}}'</strong> wirklich archivieren?",

  /** Description for information card on a published or archived release to description retention effects */
  'archive-info.description':
    'Er ist für {{retentionDays}} Tage verfügbar und wird dann am {{removalDate}} automatisch entfernt. <Link>Mehr über die Aufbewahrung erfahren</Link>.',
  /** Title for information card on a archived release */
  'archive-info.title': 'Dieser Release ist archiviert',
  ...
  'banner.confirm-active-scheduled-drafts_one':
    'Es gibt {{count}} Scheduled Draft, der eine Terminierungsbestätigung erfordert',
  ...
  'banner.confirm-active-scheduled-drafts_other':
    'Es gibt {{count}} Scheduled Drafts, die eine Terminierungsbestätigung erfordern',
  ...
  'banner.drafts-mode-disabled':
    'Der Entwurfsmodus wurde deaktiviert, aber es gibt noch geplante Entwürfe, die veröffentlicht werden sollen.',
  ...
  'banner.scheduled-drafts-disabled':
    'Scheduled Drafts wurde deaktiviert, aber es gibt noch geplante Entwürfe, die veröffentlicht werden sollen.',
  ...
  'dashboard.details.metadata.status-empty': 'Keine Dokumente',
  /** Status badge value when one or more documents have validation errors. */
  'dashboard.details.metadata.status-errors': 'Fehler',
  /** Status badge value when every document in the release is valid. */
  'dashboard.details.metadata.status-valid': 'Gültig',
  /** Status badge value while document validation is still running. */
  'dashboard.details.metadata.status-validating': 'Wird validiert',
  ...
  'diff.list-empty': 'Änderungsliste ist leer, siehe Dokument',
  /** Text for when there's no changes in a release diff */
  ...
  'document-validation.valid': 'Keine Validierungsfehler',
  ...
  'loading-release-documents.error.description':
    'Die Dokumente für dieses Release konnten nicht geladen werden. Bitte versuchen Sie es später erneut.',
  ...
  'no-paused-release': 'Keine angehaltenen geplanten Entwürfe',
  ...
  'overview.description':
    'Releases sind Sammlungen von Dokumentänderungen, die gemeinsam verwaltet, geplant und zurückgesetzt werden können.',
  ...
  'presence.tooltip.one-without-release': '{{displayName}} bearbeitet dieses Dokument gerade',
  ...
  'publish-dialog.confirm-publish.update-drafts-checkbox': 'Vorhandene Entwürfe aktualisieren',
  ...
  'publish-dialog.confirm-publish.update-drafts-description_one':
    'Der vorhandene Entwurf von {{draftDocumentsLength}} Dokument wird verworfen, damit die Entwürfe mit dem veröffentlichten Release übereinstimmen. Unveröffentlichte Entwurfsänderungen gehen verloren.',
  ...
  'publish-dialog.confirm-publish.update-drafts-description_other':
    'Die vorhandenen Entwürfe von {{draftDocumentsLength}} Dokumenten werden verworfen, damit die Entwürfe mit dem veröffentlichten Release übereinstimmen. Unveröffentlichte Entwurfsänderungen gehen verloren.',
  ...
  'schedule-action.validation.no-documents': 'Es gibt keine Dokumente zum Planen',

  /** Schedule release button tooltip when the release is already scheduled */
  'schedule-button-tooltip.already-scheduled': 'Diese Veröffentlichung ist bereits geplant',
  ...
  'schedule-button.tooltip':
    'Sind Sie sicher, dass Sie die Planung der Veröffentlichung aufheben möchten?',
  ...
  'schedule-unpublish-dialog.confirm': 'Aufhebung der Veröffentlichung planen',
  /** Description for the schedule unpublish dialog */
  'schedule-unpublish-dialog.description':
    'Wählen Sie aus, wann die Veröffentlichung dieses Dokuments aufgehoben werden soll.',
  /** Header for the schedule unpublish dialog */
  'schedule-unpublish-dialog.header': 'Entwurf für die Aufhebung der Veröffentlichung planen',
  ...
  'summary.no-documents-cardinality-one.title': 'Kein Dokument in diesem Release',
  ...
  'table-header.edited-by': 'Bearbeitet von',
  ...
  'table-header.last-edited': 'Zuletzt bearbeitet',
  ...
  'toast.create-version.error': 'Dokument konnte nicht zum Release hinzugefügt werden: {{error}}',
  /** Description for toast when release deletion failed */
  'toast.delete.error': "Löschen von '<strong>{{title}}</strong>' fehlgeschlagen: {{error}}",
  /** Description for toast when release is successfully deleted */
  'toast.delete.success': "Der Release '<strong>{{title}}</strong>' wurde erfolgreich gelöscht",
  /** Description for toast when release duplication failed */
  'toast.duplicate.error': "Duplizieren von '<strong>{{title}}</strong>' fehlgeschlagen: {{error}}",
  /** Description for toast when release is successfully duplicated */
  'toast.duplicate.success': "Der Release '<strong>{{title}}</strong>' wurde dupliziert. <Link/>",
  ...
  'toast.immediate-revert.success': "Der Release '{{title}}' wurde erfolgreich zurückgesetzt",
  /** Text for toast when release failed to publish */
  'toast.publish.error':
    "Veröffentlichung von '<strong>{{title}}</strong>' fehlgeschlagen: {{error}}",
  ...
  'toast.publish.update-drafts-error':
    'Der Release wurde veröffentlicht, aber vorhandene Entwürfe konnten nicht aktualisiert werden: {{error}}',
  /** Text for toast when release has reverted release successfully staged */
  'toast.revert-stage.success':
    "Der Rücksetzungs-Release für '{{title}}' wurde erfolgreich erstellt. <Link/>",
  /** Link text for toast link to the generated revert release */
  'toast.revert-stage.success-link': 'Rücksetzungs-Release anzeigen',
  /** Text for toast when release failed to revert */
  'toast.revert.error': 'Zurücksetzen des Releases fehlgeschlagen: {{error}}',
  /** Text for toast when release failed to schedule */
  'toast.schedule.error': "Planung von '<strong>{{title}}</strong>' fehlgeschlagen: {{error}}",
  /** Text for toast when release has been scheduled */
  'toast.schedule.success': "Der Release '<strong>{{title}}</strong>' wurde geplant.",
  /** Text for toast when release failed to unarchive */
  'toast.unarchive.error':
    "Dearchivierung von '<strong>{{title}}</strong>' fehlgeschlagen: {{error}}",
  /** Text for toast when release failed to unschedule */
  'toast.unschedule.error':
    "Aufheben der Planung von '<strong>{{title}}</strong>' fehlgeschlagen: {{error}}",

  /** Text for tooltip when a release has been scheduled */
  'type-picker.tooltip.scheduled':
    'Der Release ist geplant. Heben Sie die Planung auf, um den Typ zu ändern',
  ...
  'unpublish-dialog.action.unpublish': 'Ja, beim Veröffentlichen depublizieren',
  ...
  'unpublish-dialog.description.lost-changes':
    'Alle Änderungen an dieser Dokumentversion gehen verloren.',
  ...
  'unpublish-dialog.description.to-draft':
    'Dadurch wird die Veröffentlichung des Dokuments im Rahmen des Releases <Label>{{title}}</Label> aufgehoben und ein Entwurf erstellt, falls zum Zeitpunkt des Releases kein Entwurf vorhanden ist.',
  /** Title for the dialog confirming the unpublish of a release */
  'unpublish-dialog.header':
    'Sind Sie sicher, dass Sie die Veröffentlichung dieses Dokuments beim Release aufheben möchten?',

  /** Text for when a document is unpublished */
  'unpublish.already-unpublished':
    'Die Veröffentlichung dieses Dokuments wurde bereits aufgehoben.',
  ...
  'unschedule-dialog.confirm-description':
    'Der Release wird nicht mehr zum geplanten Datum veröffentlicht.',
  /** Title for unschedule release dialog */
  'unschedule-dialog.confirm-title':
    'Sind Sie sicher, dass Sie die Planung des Releases aufheben möchten?',
})
