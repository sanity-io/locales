...
export default removeUndefinedLocaleResources({
  ...
  'action.revert-unpublish-actions': 'Depublizierung beim Release rückgängig machen',
  ...
  'action.schedule-unpublish': 'Depublizierung planen',
  ...
  'action.schedule-unpublish.disabled.not-published':
    'Das Dokument muss veröffentlicht sein, um die Depublizierung zu planen',
  ...
  'archive-dialog.confirm-archive-description_one': 'Dadurch wird 1 Dokumentversion archiviert.',
  ...
  'archive-dialog.confirm-archive-description_other':
    'Dadurch werden {{count}} Dokumentversionen archiviert.',
  ...
  'revert-dialog.confirm-revert.stage-revert-checkbox-label': 'Release sofort zurücksetzen',
  ...
  'schedule-unpublish-dialog.description':
    'Wählen Sie aus, wann dieses Dokument depubliziert werden soll.',
  ...
  'unpublish-dialog.description.to-draft':
    'Dies wird das Dokument im Rahmen des Releases <Label>{{title}}</Label> depublizieren und einen Entwurf erstellen, falls zum Zeitpunkt des Releases kein Entwurf vorhanden ist.',
