...
export default removeUndefinedLocaleResources({
  ...
  'share-preview-menu.qr-code.title': 'QR კოდი, რომელიც შეიცავს URL-ს: {{url}}',
  ...
  'share-preview-menu.toggle-button.tooltip_disable': 'გამორთეთ გაზიარება',
  /** The text shown on the sharing toggle tooltip when sharing is disabled */
  'share-preview-menu.toggle-button.tooltip_enable': 'ჩართეთ გაზიარება',
  ...
  /** The status of the clipboard operation when copying a URL */
  'share-url.clipboard.status_success': 'URL დაკოპირდა კლიპბორდზე',
  /** The status of the clipboard operation when copying a URL */
  ...
  'share-url.menu-item.open.text': 'გახსენით გადახედვა',
})
