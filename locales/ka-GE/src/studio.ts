...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.how-to-upgrade': 'როგორ განაახლოთ',
  ...
  'release.toast.archived-release.description': 'ეს რელიზი განიხილავდა',
  ...
  'release.toast.published-release.description': 'ეს რელიზი განიხილავდა',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
