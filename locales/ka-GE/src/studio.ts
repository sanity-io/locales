...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.delete-schedule-draft.body-already-current':
    'წაშალოთ დაგეგმილი მოსალაპინებელი ჩანაწერი? თქვენი ჩანაწერი უკვე განახლებულია.',
  ...
  'release.dialog.delete-schedule-draft.body-will-save-to-draft':
    'წაშალოთ დაგეგმილი მოსალაპინებელი ჩანაწერი? თქვენი ცვლილებები შეინახება ჩანაწერში.',
  ...
  'release.dialog.delete-schedule-draft.body-with-choice':
    'წაშალოთ დაგეგმილი მოსალაპინებელი ჩანაწერი?',
  ...
  'release.dialog.delete-schedule-draft.copy-checkbox':
    'შეინახეთ დაგეგმილი ცვლილებები, ასლის ჩაწერით ჩანაწერში (რეკომენდირებულია)',
  ...
  'release.dialog.delete-schedule-draft.different-changes-explanation':
    'თქვენი დაგეგმილი ჩანაწერი შეიცავს ცვლილებებს, რომლებიც განსხვავებულია თქვენი მიმდინარე ჩანაწერისგან.',
  ...
  'releases.upsell.misconfiguration.contact-support': 'დაკავშირება მხარდაჭერის სერვისთან',
  ...
  'releases.upsell.misconfiguration.message':
    'თქვენს პროექტში ჩართულია კონტენტის გამოშვებები, თუმცა ჩანს, რომ არსებობს კონფიგურაციის პრობლემა თქვენი გამოშვების ლიმიტებთან. გთხოვთ, დაკავშირდეთ მხარდაჭერის სერვისთან, რათა თქვენი კონტენტის გამოშვებები სწორად იქონფიგურირდეს.',
