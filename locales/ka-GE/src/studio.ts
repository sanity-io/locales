...
export default removeUndefinedLocaleResources({
  ...
  'asset-source.asset-list.menu.delete': 'წაშლა', // 'Delete'
  /** Menu item for showing where a particular asset is used */
  'asset-source.asset-list.menu.show-usage': 'მაჩვენე გამოყენება', // 'Show usage'
  /** Header in usage dialog for file assets */
  'asset-source.asset-usage-dialog.header_file': 'დოკუმენტი იყენებს ფაილს', // 'Documents using file'
  /** Header in usage dialog for image assets */
  'asset-source.asset-usage-dialog.header_image': 'დოკუმენტი იყენებს სურათს', // 'Documents using image'
  /** Text shown in usage dialog when loading documents using the selected asset */
  'asset-source.asset-usage-dialog.loading': 'იტვირთება...', // 'Loading…'
  /** Text for cancel action in delete-asset dialog */
  'asset-source.delete-dialog.action.cancel': 'უკან გამოსვლა', // 'Cancel'
  /** Text for "confirm delete" action in delete-asset dialog */
  'asset-source.delete-dialog.action.delete': 'წაშლა', // 'Delete'
  /** Dialog header for delete-asset dialog when deleting a file */
  'asset-source.delete-dialog.header_file': 'ფაილის წაშლა', // 'Delete file'
  /** Dialog header for delete-asset dialog when deleting an image */
  'asset-source.delete-dialog.header_image': 'წაშალე სურათი', // 'Delete image'
  /** Text shown in delete dialog when loading documents using the selected asset */
  'asset-source.delete-dialog.loading': 'იტვირთება...', // 'Loading…'
  /** Message confirming to delete *named* file */
  'asset-source.delete-dialog.usage-list.confirm-delete-file_named':
    'You are about to delete the file <strong>{{filename}}}</strong> and its metadata. Are you sure?', // 'You are about to delete the file <strong>{{filename}}}</strong> and its metadata. Are you sure?'
  /** Message confirming to delete *unnamed* file */
  'asset-source.delete-dialog.usage-list.confirm-delete-file_unnamed':
    'თქვენ აპირებთ ფაილის და მისი მეტამონაცემების წაშლას. Დარწმუნებული ხარ?', // 'You are about to delete the file and its metadata. Are you sure?'
  /** Message confirming to delete *named* image */
  'asset-source.delete-dialog.usage-list.confirm-delete-image_named':
    'თქვენ აპირებთ წაშალოთ სურათი <strong>{{ფაილის სახელი}}</strong> და მისი მეტამონაცემები. Დარწმუნებული ხარ?', // 'You are about to delete the image <strong>{{filename}}</strong> and its metadata. Are you sure?'
  /** Message confirming to delete *unnamed* image */
  'asset-source.delete-dialog.usage-list.confirm-delete-image_unnamed':
    'თქვენ აპირებთ სურათის და მისი მეტამონაცემების წაშლას. Დარწმუნებული ხარ?', // 'You are about to delete the image and its metadata. Are you sure?'
  /** Alt text showing on image preview in delete asset dialog  */
  'asset-source.delete-dialog.usage-list.image-preview-alt': 'სურათის წინასწარი ნახვა', // 'Preview of image'
  /** Warning message showing when *named* file can't be deleted because it is in use */
  'asset-source.delete-dialog.usage-list.warning-file-is-in-use_named':
    '{{filename}} ვერ წაიშლება, რადგან ის გამოიყენება. ამ ფაილის წასაშლელად, ჯერ უნდა წაშალოთ მისი ყველა გამოყენება', // '{{filename}} cannot be deleted because it\'s being used. In order to delete this file, you first need to remove all uses of it.'
  /** Warning message showing when *unnamed* file can't be deleted because it is in use */
  'asset-source.delete-dialog.usage-list.warning-file-is-in-use_unnamed':
    'ამ ფაილის წაშლა შეუძლებელია, რადგან ის გამოიყენება. იმისათვის, რომ წაშალოთ ის, ჯერ უნდა წაშალოთ მისი ყველა გამოყენება.', // 'This file cannot be deleted because it\'s being used. In order to delete it, you first need to remove all uses of it.'
  /** Warning message showing when *named* image can't be deleted because it is in use */
  'asset-source.delete-dialog.usage-list.warning-image-is-in-use_named':
    "'{{filename}} ვერ წაიშლება, რადგან ის გამოიყენება. ამ სურათის წასაშლელად, ჯერ უნდა წაშალოთ მისი ყველა გამოყენება.'", // '{{filename}} cannot be deleted because it\'s being used. In order to delete this image, you first need to remove all uses of it.'
  /** Warning message showing when *unnamed* image can't be deleted because it is in use */
  'asset-source.delete-dialog.usage-list.warning-image-is-in-use_unnamed':
    "'ამ სურათის წაშლა შეუძლებელია, რადგან ის გამოიყენება. იმისათვის, რომ წაშალოთ ის, ჯერ უნდა წაშალოთ მისი ყველა გამოყენება.'", // 'This image cannot be deleted because it\'s being used. In order to delete it, you first need to remove all uses of it.'
  /** Text shown when the list of assets only include a specific set of types */
  'asset-source.dialog.accept-message':
    'მხოლოდ მიღებული ტიპის აქტივების ჩვენება: <strong>{{acceptTypes}}</strong>', // 'Only showing assets of accepted types: <strong>{{acceptTypes}}</strong>'
  /** Keys shared between both image asset source and file asset source */
  /** Select asset dialog title for files */
  'asset-source.dialog.default-title_file': 'აირჩიე ფაილი', // 'Select file'
  /** Select asset dialog title for images */
  'asset-source.dialog.default-title_image': 'აირჩიე სურათი', // 'Select image'
  /** Select asset dialog load more items */
  'asset-source.dialog.load-more': 'ჩატვირთე მეტი', // 'Load more'
  /** Text shown when selecting a file but there's no files to select from */
  'asset-source.dialog.no-assets_file': 'არ არის ფაილები', // 'No files'
  /** Text shown when selecting an image but there's no images to select from */
  'asset-source.dialog.no-assets_image': 'არ არის სურათები', // 'No images'
  'asset-source.file.asset-list.action.delete.disabled-cannot-delete-current-file':
    'არ შეგიძლია ამჟამად არჩეული ფაილის წაშლა', // 'Cannot delete currently selected file'
  'asset-source.file.asset-list.action.delete.text': 'წაშლა', // 'Delete'
  'asset-source.file.asset-list.action.delete.title': 'წაშალე ფაილი', // 'Delete file'
  'asset-source.file.asset-list.action.select-file.title': 'აირჩიე ფაილი {{filename}}', // 'Select the file {{filename}}'
  'asset-source.file.asset-list.action.show-usage.title': 'მაჩვენე გამოყენება', // 'Show usage'
  'asset-source.file.asset-list.delete-failed': 'ფაილი ვერ წაიშალა', // 'File could not be deleted'
  'asset-source.file.asset-list.delete-successful': 'ფაილი წაიშალა', // 'File was deleted'
  'asset-source.file.asset-list.header.date-added': 'თარითი დაემატა', // 'Date added'
  /** File asset source */
  'asset-source.file.asset-list.header.filename': 'ფაილის სახელი', // 'Filename'
  'asset-source.file.asset-list.header.size': 'ზომა', // 'Size'
  'asset-source.file.asset-list.header.type': 'ტიპი', // 'Type'
  /** Text displayed on button or menu invoking the file asset source */
  'asset-source.file.title': 'ფაილების ატვირთვა', // 'Uploaded files'
  'asset-source.image.asset-list.delete-failed': 'სურათი ვერ წაიშალა', // 'Image could not be deleted'
  /** Image asset source */
  'asset-source.image.asset-list.delete-successful': 'სურათ წაიშალა', // 'Image was deleted'
  /** Text displayed on button or menu invoking the image asset source */
  'asset-source.image.title': 'ატვირთე სურათები', // 'Uploaded images'
  'asset-source.usage-list.documents-using-file_named_one':
    'ერთი დოკუმენტი იყენებს ფაილს <code>{{filename}}</code>', // 'One document is using file <code>{{filename}}</code>'
  'asset-source.usage-list.documents-using-file_named_other':
    '{{count}} დოკუმენტი იყენებს ფაილს <code>{{filename}}</code>', // '{{count}} documents are using file <code>{{filename}}</code>'
  /** Text shown in usage dialog for a file asset when there are zero, one or more documents using the *named* file **/
  'asset-source.usage-list.documents-using-file_named_zero':
    'არცერთი დოკუმენტი არ იყენებს ფაილს <code>{{filename}}</code>', // 'No documents are using file <code>{{filename}}</code>'
  'asset-source.usage-list.documents-using-file_unnamed_one': 'ერთი დოკუმენტი იყენებს ამ ფაილს', // 'One document is using this file'
  'asset-source.usage-list.documents-using-file_unnamed_other':
    '{{count}}  დოკუმენტი იყენებს ამ ფაილს', // '{{count}} documents are using this file'
  /** Text shown in usage dialog for a file asset when there are zero, one or more documents using the *unnamed* file **/
  'asset-source.usage-list.documents-using-file_unnamed_zero':
    'არცერთი დოკუმენტი არ იყენებს ამ ფაილს', // 'No documents are using this file'
  'asset-source.usage-list.documents-using-image_named_one':
    'One document is using image <code>{{filename}}</code>', // 'One document is using image <code>{{filename}}</code>'
  'asset-source.usage-list.documents-using-image_named_other':
    '{{count}} documents are using image <code>{{filename}}</code>', // '{{count}} documents are using image <code>{{filename}}</code>'
  /** Text shown in usage dialog for an image asset when there are zero, one or more documents using the *named* image **/
  'asset-source.usage-list.documents-using-image_named_zero':
    'No documents are using image <code>{{filename}}</code>', // 'No documents are using image <code>{{filename}}</code>'
  'asset-source.usage-list.documents-using-image_unnamed_one': 'ერთი დოკუმენტი იყენებს ამ სურათს', // 'One document is using this image'
  'asset-source.usage-list.documents-using-image_unnamed_other':
    '{{count}} დოკუმენტი იყენებს ამ სურათს', // '{{count}} documents are using this image'
  /** Text shown in usage dialog for an image asset when there are zero, one or more documents using the *unnamed* image **/
  'asset-source.usage-list.documents-using-image_unnamed_zero':
    'არცერთი დოკუმენტი არ იყენებს  ამ სურათს', // 'No documents are using this image'

  /** Action message for navigating to next month */
  'calendar.action.go-to-next-month': 'გადადი შემდეგ თვეზე', // 'Go to next month'
  /** Action message for navigating to next year */
  'calendar.action.go-to-next-year': 'გადადი შემდეგ წელზე', // 'Go to next year'
  /** Action message for navigating to previous month */
  'calendar.action.go-to-previous-month': 'გადადი წინა თვეზე', // 'Go to previous month'
  /** Action message for navigating to previous year */
  'calendar.action.go-to-previous-year': 'გადადი წინა წელზე', // 'Go to previous year'
  /* Label for navigating the calendar to "today", without _selecting_ today. Short form, eg `Today`, not `Go to today` */
  'calendar.action.go-to-today': 'დღევანდელი', // 'Today'
  /* Accessibility label for navigating the calendar to "today", without _selecting_ today */
  'calendar.action.go-to-today-aria-label': 'გადადი დღევანდელზე', // 'Go to today'
  /* Label for navigating the calendar to "tomorrow", without _selecting_ tomorrow. Short form, eg `Tomorrow`, not `Go to tomorrow` */
  'calendar.action.go-to-tomorrow': 'ხვალინდელი', // 'Tomorrow'
  /* Label for navigating the calendar to "yesterday", without _selecting_ yesterday. Short form, eg `Yesterday`, not `Go to yesterday` */
  'calendar.action.go-to-yesterday': 'გუშინდელი', // 'Yesterday'
  /** Label for switch that controls whether or not to include time in given timestamp */
  'calendar.action.include-time-label': 'დროის ჩათვლით', // 'Include time'
  /** Action message for selecting the hour */
  'calendar.action.select-hour': 'საათის ჩათვლით', // 'Select hour'
  /** Action message for selecting the minute */
  'calendar.action.select-minute': 'აირჩიე წუთი', // 'Select minute'
  /** Action message for setting to the current time */
  'calendar.action.set-to-current-time': 'გადაეცი ამჟამინდელი დრო', // 'Set to current time'
  /** Label for selecting an hour preset. Receives a `time` param as a string on hh:mm format and a `date` param as a Date instance denoting the preset date */
  'calendar.action.set-to-time-preset': '{{time}} on {{date, datetime}}', // '{{time}} on {{date, datetime}}'
  /** Error message displayed in calendar when entered date is not the correct format */
  'calendar.error.must-be-in-format': 'უნდა იყოს ამ ფორმატში: {{exampleDate}}', // 'Must be in the format: {{exampleDate}}'
  /** Month name for April */
  'calendar.month-names.april': 'აპრილი', // 'April'
  /** Month name for August */
  'calendar.month-names.august': 'აგვისტო', // 'August'
  /** Month name for December */
  'calendar.month-names.december': 'დეკემბერი', // 'December'
  /** Month name for February */
  'calendar.month-names.february': 'თებერვალი', // 'February'
  /** Month name for January */
  'calendar.month-names.january': 'ინარვარი', // 'January'
  /** Month name for July */
  'calendar.month-names.july': 'ივნისი', // 'July'
  /** Month name for June */
  'calendar.month-names.june': 'ივლისი', // 'June'
  /** Month name for March */
  'calendar.month-names.march': 'მარტი', // 'March'
  /** Month name for May */
  'calendar.month-names.may': 'მაისი', // 'May'
  /** Month name for November */
  'calendar.month-names.november': 'ნოემბერი', // 'November'
  /** Month name for October */
  'calendar.month-names.october': 'ოქტომბერი', // 'October'
  /** Month name for September */
  'calendar.month-names.september': 'სექტემბერი', // 'September'
  /** Short weekday name for Friday */
  'calendar.weekday-names.short.friday': 'პარასკევი', // 'Fri'
  /** Short weekday name for Monday */
  'calendar.weekday-names.short.monday': 'ორშაბათი', // 'Mon'
  /** Short weekday name for Saturdayday */
  'calendar.weekday-names.short.saturday': 'შაბათი', // 'Sat'
  /** Short weekday name for Sunday */
  'calendar.weekday-names.short.sunday': 'კვირა', // 'Sun'
  /** Short weekday name for Thursday */
  'calendar.weekday-names.short.thursday': 'ხუთშაბათი', // 'Thu'
  /** Short weekday name for Tuesday */
  'calendar.weekday-names.short.tuesday': 'სამშაბათი', // 'Tue'
  /** Short weekday name for Wednesday */
  'calendar.weekday-names.short.wednesday': 'ოთხშაბათი', // 'Wed'

  /** Label for the close button label in Review Changes pane */
  'changes.action.close-label': 'გამორთე წინასწარი ცვლილებები', // 'Close review changes'
  /** Cancel label for revert button prompt action */
  'changes.action.revert-all-cancel': 'უკან გამოდი', // 'Cancel'
  /** Revert all confirm label for revert button action - used on prompt button + review changes pane */
  'changes.action.revert-all-confirm': 'ყველაფერი გააუქმე', // 'Revert all'
  /** Prompt for confirming revert change (singular) label for field change action */
  'changes.action.revert-changes-confirm-change_one': 'გააუქმე ცვლილება', // 'Revert change'
  /** Revert for confirming revert (plural) label for field change action */
  'changes.action.revert-changes-confirm-change_other': 'გააუქმე ცვლილებები', // 'Revert changes'
  /** Prompt for reverting changes for a field change */
  'changes.action.revert-changes-description': 'დარწმუნებული ხარ რომ გინდა ცლვილებების გაუქმება?', // 'Are you sure you want to revert the changes?'
  /** Prompt for reverting changes for a group change, eg multiple changes */
  'changes.action.revert-changes-description_one': 'Are you sure you want to revert the change?', // 'Are you sure you want to revert the change?'
  /** Label for when the action of the change was to set something that was previously empty, eg a field was given a value, an array item was added, an asset was selected or similar */
  'changes.added-label': 'დამატებულია', // 'Added'
  /** Array diff: An item was added in a given position (`{{position}}`) */
  'changes.array.item-added-in-position': 'დამატებულია ამ {{position}} ზე', // 'Added in position {{position}}'
  'changes.array.item-moved_down_one': 'Moved {{count}} position down', // 'Moved {{count}} position down'
  'changes.array.item-moved_down_other': 'Moved {{count}} positions down', // 'Moved {{count}} positions down'
  /**
   * Array diff: An item was moved within the array.
   * Receives `{{count}}` representing number of positions it moved.
   * Context is the direction of the move, either `up` or `down`.
   */
  'changes.array.item-moved_up_one': 'Moved {{count}} position up', // 'Moved {{count}} position up'
  'changes.array.item-moved_up_other': 'Moved {{count}} positions up', // 'Moved {{count}} positions up'
  /** Array diff: An item was removed from a given position (`{{position}}`) */
  'changes.array.item-removed-from-position': 'Removed from position {{position}}', // 'Removed from position {{position}}'
  /** Accessibility label for the "change bar" shown when there are edits on a field-level */
  'changes.change-bar.aria-label': 'ცვლილებების მიმოხილვა', // 'Review changes'
  /** Label for when the action of the change was _not_ an add/remove, eg a text field changed value, an image was changed from one asset to another or similar */
  'changes.changed-label': 'შეიცვალა', // 'Changed'
  /** Label and text for tooltip that indicates the authors of the changes */
  'changes.changes-by-author': 'შეიცვალა', // 'Changes by'
  /** Additional text shown in development mode when a diff component crashes during rendering */
  'changes.error-boundary.developer-info': 'შეამოწმე დეველოპერის კონსოლი, მეტი ინფორმაციისთვის', // 'Check the developer console for more information'
  /** Text shown when a diff component crashes during rendering, triggering the error boundary */
  'changes.error-boundary.title': 'Rendering the changes to this field caused an error', // 'Rendering the changes to this field caused an error'
  /** Error message shown when the value of a field is not the expected one */
  'changes.error.incorrect-type-message':
    'Value error: Value is of type "<code>{{actualType}}</code>", expected "<code>{{expectedType}}</code>"', // 'Value error: Value is of type "<code>{{actualType}}</code>", expected "<code>{{expectedType}}</code>"'
  /** File diff: Fallback title for the meta info section when there is no original filename to use  */
  'changes.file.meta-info-fallback-title': 'უსათაურო', // 'Untitled'
  /** Image diff: Text shown in tooltip when hovering hotspot that has changed in diff view */
  'changes.image.crop-changed': 'მოჭრა შეიცვალა', // 'Crop changed'
  /** Image diff: Text shown if the previous image asset was deleted (shouldn't theoretically happen) */
  'changes.image.deleted': 'სურათი წაიშალა', // 'Image deleted'
  /** Image diff: Text shown if the image failed to be loaded when previewing it */
  'changes.image.error-loading-image': 'შეცდომა სურათის ჩატვირთვისას', // 'Error loading image'
  /** Image diff: Text shown in tooltip when hovering hotspot that has changed in diff view */
  'changes.image.hotspot-changed': 'Hotspot changed', // 'Hotspot changed'
  /** Image diff: Fallback title for the meta info section when there is no original filename to use  */
  'changes.image.meta-info-fallback-title': 'უსათაურო', // 'Untitled'
  /** Image diff: Text shown if no asset has been set for the field (but has metadata changes) */
  'changes.image.no-asset-set': 'სურათი არ არის გადაცემული', // 'Image not set'
  /** Image diff: Text shown when the from/to state has/had no image */
  'changes.image.no-image-placeholder': '(არ არის სურათი)', // '(no image)'
  /** Label for the "from" value in the change inspector */
  'changes.inspector.from-label': 'აქედან', // 'From'
  /** Label for the "meta" (field path, action etc) information in the change inspector */
  'changes.inspector.meta-label': 'მეტა', // 'Meta'
  /** Label for the "to" value in the change inspector */
  'changes.inspector.to-label': 'აქამდე', // 'To'
  /** Loading author of change in the differences tooltip in the review changes pane */
  'changes.loading-author': 'იტვირთება', // 'Loading…'
  /** Loading changes in Review Changes Pane */
  'changes.loading-changes': 'იტვირთება ცვლილებები', // 'Loading changes…'
  /** No Changes description in the Review Changes pane */
  'changes.no-changes-description':
    'დაარედაქტირეთ დოკუმენტი ან აირჩიეთ უფრო ძველი ვერსია ვადებში, რათა ნახოთ ცვლილებების სია ამ პანელში.', // 'Edit the document or select an older version in the timeline to see a list of changes appear in this panel.'
  /** No Changes title in the Review Changes pane */
  'changes.no-changes-title': 'აქ არ არის ცვლილებები', // 'There are no changes'
  /** Portable Text diff: An annotation was added */
  'changes.portable-text.annotation_added': 'დამატებულია ანოტაცია', // 'Added annotation'
  /** Portable Text diff: An annotation was changed */
  'changes.portable-text.annotation_changed': 'შეიცვალა ანოტაცია', // 'Changed annotation'
  /** Portable Text diff: An annotation was removed */
  'changes.portable-text.annotation_removed': 'ანოტაცია ამოღებულია', // 'Removed annotation'
  /** Portable Text diff: An annotation was left unchanged */
  'changes.portable-text.annotation_unchanged': 'ცვლილებების გაუქმება ანოტაციაში', // 'Unchanged annotation'
  /** Portable Text diff: A block changed from one style to another (eg `normal` to `h1` or similar) */
  'changes.portable-text.block-style-changed':
    'Changed block style from "{{fromStyle}}" to "{{toStyle}}"', // 'Changed block style from "{{fromStyle}}" to "{{toStyle}}"'
  /** Portable Text diff: Change formatting of text (setting/unsetting marks, eg bold/italic etc) */
  'changes.portable-text.changed-formatting': 'შეიცვალა დაფორმატება', // 'Changed formatting'
  /** Portable Text diff: An empty inline object is part of a change */
  'changes.portable-text.empty-inline-object': 'ცარიელი {{inlineObjectType}}', // 'Empty {{inlineObjectType}}'
  /** Portable Text diff: An empty object is the result of adding/removing an annotation */
  'changes.portable-text.empty-object-annotation': 'ცარიელი {{annotationType}}', // 'Empty {{annotationType}}'
  /** Portable Text diff: Added a block containing no text (eg empty block) */
  'changes.portable-text.empty-text_added': 'დაემატა ახალი ტექსტი', // 'Added empty text'
  /** Portable Text diff: Changed a block that contained no text (eg empty block) */
  'changes.portable-text.empty-text_changed': 'შეიცვალა ცარიელი ტექსტი', // 'Changed empty text'
  /** Portable Text diff: Removed a block containing no text (eg empty block) */
  'changes.portable-text.empty-text_removed': 'ამოღებულია ცარიელი ტექსტი', // 'Removed empty text'
  /** Portable Text diff: An inline object was added */
  'changes.portable-text.inline-object_added': 'დამატებულია შიდა ობიექტი', // 'Added inline object'
  /** Portable Text diff: An inline object was changed */
  'changes.portable-text.inline-object_changed': 'შეიცვალა შიდა ობიექტი', // 'Changed inline object'
  /** Portable Text diff: An inline object was removed */
  'changes.portable-text.inline-object_removed': 'ამოღებულია შიდა ობიექტი', // 'Removed inline object'
  /** Portable Text diff: An inline object was left unchanged */
  'changes.portable-text.inline-object_unchanged': 'უცვლელი შიდა ობიექტი', // 'Unchanged inline object'
  /** Portable Text diff: Added a chunk of text */
  'changes.portable-text.text_added': 'დამატებულია ტექსტი', // 'Added text'
  /** Portable Text diff: Removed a chunk of text */
  'changes.portable-text.text_removed': 'ამოღებულია ტექსტი', // 'Removed text'
  /** Portable Text diff: Annotation has an unknown schema type */
  'changes.portable-text.unknown-annotation-schema-type': 'უცნობი სქემის ტიპი', // 'Unknown schema type'
  /** Portable Text diff: Inline object has an unknown schema type */
  'changes.portable-text.unknown-inline-object-schema-type': 'უცნობი სქემის ტიპი', // 'Unknown schema type'
  /** Label for when the action of the change was a removal, eg a field was cleared, an array item was removed, an asset was deselected or similar */
  'changes.removed-label': 'ამოღებულია', // 'Removed'
  /** Title for the Review Changes pane */
  'changes.title': 'ცვლილებების მიმოხილვა', // 'Review changes'

  /** --- Common components --- */
  /** Tooltip text for context menu buttons */
  'common.context-menu-button.tooltip': 'მაჩვენე მეტი', // 'Show more'
  /** Default text for dialog cancel button */
  'common.dialog.cancel-button.text': 'უკან გამოსვლა', // 'Cancel'
  /** Default text for dialog confirm button */
  'common.dialog.confirm-button.text': 'დადასტურება', // 'Confirm'
  /** Default text in shared loader text / spinner lockup */
  'common.loading': 'Ჩატვირთვა', // 'Loading'

  /** --- Configuration issues --- */
  /** Tooltip displayed on configuration issues button */
  'configuration-issues.button.tooltip': 'ნაპოვნია კონფიგურაციის საკითხები', // 'Found configuration issues'

  /** The fallback title for an ordering menu item if no localized titles are provided. */
  'default-menu-item.fallback-title': 'გაცხრილულია {{title}} ის მიხედვით', // 'Sort by {{title}}'

  /** Title for the default ordering/SortOrder if no orderings are provided and the caption field is found */
  'default-orderings.caption': 'დალაგება წარწერის მიხედვით', // 'Sort by Caption'
  /** Title for the default ordering/SortOrder if no orderings are provided and the description field is found */
  'default-orderings.description': 'დახარისხება აღწერილობის მიხედვით', // 'Sort by Description'
  /** Title for the default ordering/SortOrder if no orderings are provided and the header field is found */
  'default-orderings.header': 'Sort by Header', // 'Sort by Header'
  /** Title for the default ordering/SortOrder if no orderings are provided and the heading field is found */
  'default-orderings.heading': 'Sort by Heading', // 'Sort by Heading'
  /** Title for the default ordering/SortOrder if no orderings are provided and the label field is found */
  'default-orderings.label': 'Sort by Label', // 'Sort by Label'
  /** Title for the default ordering/SortOrder if no orderings are provided and the name field is found */
  'default-orderings.name': 'Sort by Name', // 'Sort by Name'
  /** Title for the default ordering/SortOrder if no orderings are provided and the title field is found */
  'default-orderings.title': 'Sort by Title', // 'Sort by Title'

  /** Label to show in the document footer indicating the last edited date of the document */
  'document-status.edited': 'Edited {{date}}', // 'Edited {{date}}'
  /** Label to show in the document footer indicating the document is not published*/
  'document-status.not-published': 'არ არის გამოქვეყნებული', // 'Not published'
  /** Label to show in the document footer indicating the published date of the document */
  'document-status.published': 'Published {{date}}', // 'Published {{date}}'

  /** The value of the <code>_key</code> property must be a unique string. */
  'form.error.duplicate-keys-alert.details.additional-description':
    'The value of the <code>_key</code> property must be a unique string.', // 'The value of the <code>_key</code> property must be a unique string.'
  /** This usually happens when items are created using an API client, and the <code>_key</code> property of each elements has been generated non-uniquely. */
  'form.error.duplicate-keys-alert.details.description':
    'ეს ჩვეულებრივ ხდება, როდესაც ერთეულები იქმნება API კლიენტის გამოყენებით და თითოეული ელემენტის <code>_key</code> თვისება არაუნიკალურად არის გენერირებული.', // 'This usually happens when items are created using an API client, and the <code>_key</code> property of each elements has been generated non-uniquely.'
  /** Developer info */
  'form.error.duplicate-keys-alert.details.title': 'დეველოპერის ინფორმაცია', // 'Developer info'
  /** Generate unique keys */
  'form.error.duplicate-keys-alert.generate-button.text': 'დააგენერირე უნიკალური გასაღებები', // 'Generate unique keys'
  /** Several items in this list share the same identifier (key). Every item must have an unique identifier. */
  'form.error.duplicate-keys-alert.summary':
    'ამ სიაში რამდენიმე ელემენტი იზიარებს ერთსა და იმავე იდენტიფიკატორს (გასაღებს). ყველა ნივთს უნდა ჰქონდეს უნიკალური იდენტიფიკატორი.', // 'Several items in this list share the same identifier (key). Every item must have an unique identifier.'
  /** Non-unique keys */
  'form.error.duplicate-keys-alert.title': 'არა უნიკალური გასაღებები', // 'Non-unique keys'
  /** Error text shown when a field with a given name cannot be found in the schema or is conditionally hidden but explicitly told to render  */
  'form.error.field-not-found':
    'Field "{{fieldName}}" not found among members - verify that it is defined in the schema and that it has not been conditionally hidden.', // 'Field "{{fieldName}}" not found among members – verify that it is defined in the schema and that it has not been conditionally hidden.'
  /** Add missing keys */
  'form.error.missing-keys-alert.add-button.text': 'დაამატეთ დაკარგული გასაღებები', // 'Add missing keys'
  /** The value of the <code>_key</code> property must be a unique string. */
  ...
  'form.error.missing-keys-alert.details.description':
    'ეს ჩვეულებრივ ხდება, როდესაც ერთეულები იქმნება API კლიენტის გამოყენებით და <code>_key</code> თვისება არ არის ჩართული.', // 'This usually happens when items are created using an API client, and the <code>_key</code> property has not been included.'
  /** Developer info */
  'form.error.missing-keys-alert.details.title': 'დეველოპერის ინფორმაცია', // 'Developer info'
  /** Some items in the list are missing their keys. This must be fixed in order to edit the list. */
  'form.error.missing-keys-alert.summary':
    'სიის ზოგიერთ ელემენტს აკლია გასაღები. ეს უნდა დაფიქსირდეს სიის რედაქტირებისთვის.', // 'Some items in the list are missing their keys. This must be fixed in order to edit the list.'
  /** Missing keys */
  'form.error.missing-keys-alert.title': 'გასაღებები აკლია', // 'Missing keys'
  /** This usually happens when items are created using an API client, or when a custom input component has added invalid data to the list. */
  'form.error.mixed-array-alert.details.description':
    'ეს ჩვეულებრივ ხდება, როდესაც ერთეულები იქმნება API კლიენტის გამოყენებით, ან როდესაც მორგებული შეყვანის კომპონენტმა დაამატა არასწორი მონაცემები სიაში.', // 'This usually happens when items are created using an API client, or when a custom input component has added invalid data to the list.'
  /** Developer info */
  'form.error.mixed-array-alert.details.title': 'დეველოპერის ინფორმაცია', // 'Developer info'
  /**  Remove non-object values */
  'form.error.mixed-array-alert.remove-button.text': 'არაობიექტური მნიშვნელობების წაშლა', // 'Remove non-object values'
  /** Some items in this list are not objects. This must be fixed in order to edit the list. */
  'form.error.mixed-array-alert.summary':
    'ამ სიაში ზოგიერთი ელემენტი არ არის ობიექტი. ეს უნდა დაფიქსირდეს სიის რედაქტირებისთვის.', // 'Some items in this list are not objects. This must be fixed in order to edit the list.'
  /** Invalid list values */
  'form.error.mixed-array-alert.title': 'სიის არასწორი მნიშვნელობები', // 'Invalid list values'
  ...
  'insufficient-permissions-message.not-authorized-explanation':
    'თქვენ არ გაქვთ ამ ფუნქციაზე წვდომის ნებართვა.', // 'You do not have permission to access this feature.'
  /** The explanation when unable to create any document at all */
  'insufficient-permissions-message.not-authorized-explanation_create-any-document':
    'თქვენ არ გაქვთ დოკუმენტის შექმნის უფლება.', // 'You do not have permission to create a document.'
  /** The explanation when unable to create a particular document */
  'insufficient-permissions-message.not-authorized-explanation_create-document':
    'თქვენ არ გაქვთ ამ დოკუმენტის შექმნის უფლება.', // 'You do not have permission to create this document.'
  /** The explanation when unable to create a particular type of document */
  'insufficient-permissions-message.not-authorized-explanation_create-document-type':
    'თქვენ არ გაქვთ ამ სახის დოკუმენტის შექმნის უფლება.', // 'You do not have permission to create this kind of document.'
  /** The explanation when unable to create a new reference in a document */
  'insufficient-permissions-message.not-authorized-explanation_create-new-reference':
    'თქვენ არ გაქვთ ახალი მითითების შექმნის უფლება.', // 'You do not have permission to create a new reference.'
  /** The explanation when unable to delete a particular document */
  'insufficient-permissions-message.not-authorized-explanation_delete-document':
    'თქვენ არ გაქვთ ამ დოკუმენტის წაშლის უფლება.', // 'You do not have permission to delete this document.'
  /** The explanation when unable to discard changes in a particular document */
  'insufficient-permissions-message.not-authorized-explanation_discard-changes':
    'თქვენ არ გაქვთ ამ დოკუმენტში ცვლილებების გაუქმების უფლება.', // 'You do not have permission to discard changes in this document.'
  /** The explanation when unable to duplicate a particular document */
  'insufficient-permissions-message.not-authorized-explanation_duplicate-document':
    'თქვენ არ გაქვთ ამ დოკუმენტის დუბლირების უფლება.', // 'You do not have permission to duplicate this document.'
  /** The explanation when unable to publish a particular document */
  'insufficient-permissions-message.not-authorized-explanation_publish-document':
    'თქვენ არ გაქვთ ამ დოკუმენტის გამოქვეყნების უფლება.', // 'You do not have permission to publish this document.'
  /** The explanation when unable to unpublish a particular document */
  'insufficient-permissions-message.not-authorized-explanation_unpublish-document':
    'თქვენ არ გაქვთ ამ დოკუმენტის გამოქვეყნების ნებართვა.', // 'You do not have permission to unpublish this document.'
  /** Appears after the not-authorized message. Lists the current roles. */
  'insufficient-permissions-message.roles': 'თქვენი როლები: <Roles/>', // 'Your roles: <Roles/>'
  /** The title for the insufficient permissions message component */
  'insufficient-permissions-message.title': 'არასაკმარისი ნებართვები', // 'Insufficient permissions'

  /** Unexpected error: `{{error}}` */
  'member-field-error.unexpected-error': 'Unexpected error: {{error}}', // 'Unexpected error: {{error}}'

  /** Button label for "Create new document" button */
  'new-document.button': 'შექმნა', // 'Create'
  /**
   * Tooltip message displayed when hovering/activating the "Create new document" action,
   * when there are templates/types available for creation
   */
  'new-document.create-new-document-label': 'ახალი დოკუმენტი', // 'New document…'
  /** Placeholder for the "filter" input within the new document menu */
  'new-document.filter-placeholder': 'ფილტრი', // 'Filter'
  /** Loading indicator text within the new document menu */
  'new-document.loading': 'Ჩატვირთვა…', // 'Loading…'
  /** Accessibility label for the list displaying options in the new document menu */
  'new-document.new-document-aria-label': 'ახალი დოკუმენტი', // 'New document'
  /** Message for when there are no document type options in the new document menu */
  'new-document.no-document-types-found': 'დოკუმენტის ტიპები არ მოიძებნა', // 'No document types found'
  /**
   * Tooltip message displayed when hovering/activating the "Create new document" action,
   * when there are no templates/types to create from
   */
  'new-document.no-document-types-label': 'დოკუმენტის ტიპები ალალი', // 'No document types'
  /** Message for when no results are found for a specific search query in the new document menu */
  'new-document.no-results': 'შედეგები არ არის <strong>{{searchQuery}}</strong>-ისთვის', // 'No results for <strong>{{searchQuery}}</strong>'
  /** Aria label for the button that opens the "Create new document" popover/dialog */
  'new-document.open-dialog-aria-label': 'ახალი დოკუმენტის შექმნა', // 'Create new document'
  /** Title for "Create new document" dialog */
  'new-document.title': 'ახალი დოკუმენტის შექმნა', // 'Create new document'

  /** Label for action to manage members of the current studio project */
  'presence.action.manage-members': 'წევრების მართვა', // 'Manage members'
  /** Accessibility label for presence menu button */
  'presence.aria-label': 'გლობალური ყოფნა', // 'Global presence'
  /** Message description for when no one else is currently present */
  'presence.no-one-else-description': 'მოიწვიე ხალხი პროექტში მათი ონლაინ სტატუსის სანახავად.', // 'Invite people to the project to see their online status.'
  /** Message title for when no one else is currently present */
  'presence.no-one-else-title': 'სხვა არავინ არის აქ', // 'No one else is here'
  /** Message for when a user is not in a document (displayed in the global presence menu) */
  'presence.not-in-a-document': 'არ არის დოკუმენტში', // 'Not in a document'
  /** Tooltip content text for presence menu button */
  'presence.tooltip-content': 'ვინ არის აქ', // 'Who is here'

  /** Fallback title shown when a preview does not provide a title */
  'preview.default.title-fallback': 'უსახელო', // 'Untitled'
  /** Fallback preview value for types that have "no value" (eg null, undefined) */
  'preview.fallback.no-value': '(მნიშვნელობის გარეშე)', // '(no value)'
  /** Alternative text for image being shown while image is being uploaded, in previews */
  'preview.image.file-is-being-uploaded.alt-text': 'სურათი ამჟამად იტვირთება', // 'The image currently being uploaded'

  /* Relative time, just now */
  'relative-time.just-now': 'ახლახანს', // 'just now'

  /** Accessibility label to open search action when the search would go fullscreen (eg on narrower screens) */
  'search.action-open-aria-label': 'გახსენით ძებნა', // 'Open search'
  /** Action label for adding a search filter */
  'search.action.add-filter': 'ფილტრის დამატება', // 'Add filter'
  /** Action label for clearing search filters */
  'search.action.clear-filters': 'ფილტრების გასუფთავება', // 'Clear filters'
  ...
  'search.operator.string-not-equal.description':
    '<Field/> <Operator>is not</Operator> <Value>{{value}}</Value>', // '<Field/> <Operator>is not</Operator> <Value>{{value}}</Value>'
  'search.operator.string-not-equal.name': 'არ არის', // 'is not'
  /** Label for the "Best match" search ordering type */
  'search.ordering.best-match-label': 'საუკეთესო დამთხვევები', // 'Best match'
  /** Label for the "Created: Oldest first" search ordering type */
  'search.ordering.created-ascending-label': 'შექმნილი: პირველი უძველესი', // 'Created: Oldest first'
  /** Label for the "Created: Newest first" search ordering type */
  'search.ordering.created-descending-label': 'შექმნილია: ჯერ უახლესი', // 'Created: Newest first'
  /** Label for the "Updated: Oldest first" search ordering type */
  'search.ordering.updated-ascending-label': 'განახლებულია: ჯერ უკანასკნელი', // 'Updated: Oldest first'
  /** Label for the "Updated: Newest first" search ordering type */
  'search.ordering.updated-descending-label': 'განახლებულია: ჯერ უახლესი', // 'Updated: Newest first'
  /** Placeholder text for the global search input field */
  'search.placeholder': 'ძებნა', // 'Search'
  /** Accessibility label for the recent searches section, shown when no valid search terms has been given */
  'search.recent-searches-aria-label': 'ბოლო ძიებები', // 'Recent searches'
  /** Label/heading shown for the recent searches section */
  'search.recent-searches-label': 'ბოლო ძიებები', // 'Recent searches'
  /** Accessibility label for the search results section, shown when the user has typed valid terms */
  'search.search-results-aria-label': 'ძებნის შედეგები', // 'Search results'

  /** Accessibility label for the navbar status button */
  'status-button.aria-label': 'კონფიგურაციის სტატუსი', // 'Configuration status'

  /** Description for error when the timeline for the given document can't be loaded */
  'timeline.error.load-document-changes-description':
    'დოკუმენტის ისტორიის ტრანზაქციებს გავლენა არ მოუხდენია.', // 'Document history transactions have not been affected.'
  /** Title for error when the timeline for the given document can't be loaded */
  'timeline.error.load-document-changes-title': 'დოკუმენტის ცვლილებების მიღებისას მოხდა შეცდომა.', // 'An error occurred whilst retrieving document changes.'
  /** Error description for when the document doesn't have history */
  'timeline.error.no-document-history-description':
    'დოკუმენტის შინაარსის შეცვლისას ამ მენიუში გამოჩნდება დოკუმენტის ვერსიები.', // 'When changing the content of the document, the document versions will appear in this menu.'
  /** Error title for when the document doesn't have history */
  'timeline.error.no-document-history-title': 'არ არის დოკუმენტის ისტორია', // 'No document history'
  /** Error prompt when revision cannot be loaded */
  'timeline.error.unable-to-load-revision': 'რევიზიის ჩატვირთვა შეუძლებელია', // 'Unable to load revision'
  /** Label for when the timeline item is the latest in the history */
  'timeline.latest': 'უკანასკნელი', // 'Latest'
  /** Label for latest version for timeline menu dropdown */
  'timeline.latest-version': 'ბოლო ვერსია', // 'Latest version'
  /** The aria-label for the list of revisions in the timeline */
  'timeline.list.aria-label': 'დოკუმენტის შესწორებები', // 'Document revisions'
  /** Label for loading history */
  'timeline.loading-history': 'ისტორია იტვირთება...', // 'Loading history…'
  /** Label shown in review changes timeline when a document has been created */
  'timeline.operation.created': 'შექმნილია', // 'Created'
  /** Label shown in review changes timeline when a document has been created, with a timestamp */
  'timeline.operation.created_timestamp': 'შექმნილია: {{timestamp, datetime}}', // 'Created: {{timestamp, datetime}}'
  /** Label shown in review changes timeline when a document was initially created */
  'timeline.operation.created-initial': 'შექმნილია', // 'Created'
  /** Label shown in review changes timeline when a document was initially created, with a timestamp */
  'timeline.operation.created-initial_timestamp': 'შექმნილია: {{timestamp, datetime}}', // 'Created: {{timestamp, datetime}}'
  /** Label shown in review changes timeline when a document has been deleted */
  'timeline.operation.deleted': 'წაშლილია', // 'Deleted'
  /** Label shown in review changes timeline when a document has been deleted, with a timestamp */
  'timeline.operation.deleted_timestamp': 'Deleted: {{timestamp, datetime}}', // 'Deleted: {{timestamp, datetime}}'
  /** Label shown in review changes timeline when a draft has been discarded */
  'timeline.operation.draft-discarded': 'გააუქმე მონახაზი', // 'Discarded draft'
  /** Label shown in review changes timeline when a draft has been discarded, with a timestamp */
  'timeline.operation.draft-discarded_timestamp': 'Discarded draft: {{timestamp, datetime}}', // 'Discarded draft: {{timestamp, datetime}}'
  /** Label shown in review changes timeline when a draft has been edited */
  'timeline.operation.edited-draft': 'გადაკეთებულია', // 'Edited'
  /** Label shown in review changes timeline when a draft has been edited, with a timestamp */
  'timeline.operation.edited-draft_timestamp': 'Edited: {{timestamp, datetime}}', // 'Edited: {{timestamp, datetime}}'
  /** Label shown in review changes timeline when a document has been edited live */
  'timeline.operation.edited-live': 'მყისიერი გადაკეთება', // 'Live edited'
  /** Label shown in review changes timeline when a document has been edited live, with a timestamp */
  'timeline.operation.edited-live_timestamp': 'მყისიერად გადაკეთებული {{timestamp, datetime}}', // 'Live edited: {{timestamp, datetime}}'
  /** Label shown in review changes timeline when a document was published */
  'timeline.operation.published': 'გამოქვეყნებული', // 'Published'
  /** Label shown in review changes timeline when a document was published, with a timestamp */
  'timeline.operation.published_timestamp': 'გამოქვეყნებული', // 'Published: {{timestamp, datetime}}'
  /** Label shown in review changes timeline when a document was unpublished */
  'timeline.operation.unpublished': 'გამოუქვეყნებელი', // 'Unpublished'
  /** Label shown in review changes timeline when a document was unpublished, with a timestamp */
  'timeline.operation.unpublished_timestamp': 'გამოუქვეყნებელი', // 'Unpublished: {{timestamp, datetime}}'
  /**
   * Label for determining since which version the changes for timeline menu dropdown are showing.
   * Receives the time label as a parameter (`timestamp`).
   */
  'timeline.since': 'Since: {{timestamp, datetime}}', // 'Since: {{timestamp, datetime}}'
  /** Label for missing change version for timeline menu dropdown are showing */
  'timeline.since-version-missing': 'Since: unknown version', // 'Since: unknown version'

  /**Aria label for the action buttons in the PTE toolbar */
  'toolbar.portable-text.action-button-aria-label': '{{action}}', // '{{action}}'

  /** Label for button showing the free trial days left */
  'user-menu.action.free-trial_one': '{{count}} day left in trial', // '{{count}} day left in trial'
  'user-menu.action.free-trial_other': '{{count}} days left in trial', // '{{count}} days left in trial'
  /** Label for the button showed after trial ended */
  'user-menu.action.free-trial-finished': 'გააუმჯობესე უფასოდ', // 'Upgrade from free'
  /** Label for action to invite members to the current sanity project */
  'user-menu.action.invite-members': 'მოიწვიე წევრები', // 'Invite members'
  /** Accessibility label for action to invite members to the current sanity project */
  'user-menu.action.invite-members-aria-label': 'მოიწვიე წევრები', // 'Invite members'
  /** Label for action to manage the current sanity project */
  'user-menu.action.manage-project': 'პროექტის მართვა', // 'Manage project'
  /** Accessibility label for the action to manage the current project */
  'user-menu.action.manage-project-aria-label': 'პროექტის მართვა', // 'Manage project'
  /** Tooltip helper text when portable text annotation is disabled for empty block*/
  'user-menu.action.portable-text.annotation-disabled_empty-block':
    'შეუძლებელია გავრცელდეს {{name}} to ცარიელი ბლოკისთვის', // 'Cannot apply {{name}} to empty block'
  /** Tooltip helper text when portable text annotation is disabled for multiple blocks */
  'user-menu.action.portable-text.annotation-disabled_multiple-blocks':
    'შეუძლებელია გავრცელდეს {{name}} to ბევრი ბლოკისთვის', // 'Cannot apply {{name}} to multiple blocks'
  /** Label for action to sign out of the current sanity project */
  'user-menu.action.sign-out': 'გამოსვლა', // 'Sign out'
  /** Title for appearance section for the current studio (dark / light / system scheme) */
  'user-menu.appearance-title': 'ვიზუალი', // 'Appearance'
  /** Label for close menu button for user menu */
  'user-menu.close-menu': 'გამორთ მენიუ', // 'Close menu'
  /** Description for using the "dark theme" in the appearance user menu */
  'user-menu.color-scheme.dark-description': 'გამოიყენეთ ბნელი ვიზუალი', // 'Use dark appearance'
  /** Title for using the "dark theme" in the appearance user menu */
  'user-menu.color-scheme.dark-title': 'ბნელი', // 'Dark'
  /** Description for using the "light theme" in the appearance user menu */
  'user-menu.color-scheme.light-description': 'გამოიყენეთ განათების გარეგნობა', // 'Use light appearance'
  /** Title for using the "light theme" in the appearance user menu */
  'user-menu.color-scheme.light-title': 'სინათლე', // 'Light'
  /** Description for using "system apparence" in the appearance user menu */
  'user-menu.color-scheme.system-description': 'გამოიყენეთ სისტემის გარეგნობა', // 'Use system appearance'
  /** Title for using system apparence in the appearance user menu */
  'user-menu.color-scheme.system-title': 'სისტემა', // 'System'
  /** Title for locale section for the current studio */
  'user-menu.locale-title': 'ენა', // 'Language'
  /** Label for tooltip to show which provider the currently logged in user is using */
  'user-menu.login-provider': 'Signed in with {{providerTitle}}', // 'Signed in with {{providerTitle}}'
  /** Label for open menu button for user menu */
  'user-menu.open-menu': 'გახსენი მენიუ', // 'Open menu'

  /**
   * Label for action to add a workspace (currently a developer-oriented action, as this will
   * lead to the documentation on workspace configuration)
   */
  'workspaces.action.add-workspace': 'დაამატე სამუშაო სივრცე', // 'Add workspace'
  /**
   ...
   */
  'workspaces.action.choose-another-workspace': 'აირჩიე სხვა სამუშაო სივრცე', // 'Choose another workspace'
  /** Label for heading that indicates that you can choose your workspace */
  'workspaces.choose-your-workspace-label': 'აირჩიე შენი სამუშაო სივრცე', // 'Choose your workspace'
  /** Label for the workspace menu */
  'workspaces.select-workspace-aria-label': 'აირჩიე სამუშაო სივრცე', // 'Select workspace'
  /** Button label for opening the workspace switcher */
  'workspaces.select-workspace-label': 'აირჩიე სამუშაო სივრცე', // 'Select workspace'
  /** Tooltip for the workspace menu */
  'workspaces.select-workspace-tooltip': 'აირჩიე სამუშაო სივრცე', // 'Select workspace'
  /** Title for Workplaces dropdown menu */
  'workspaces.title': 'საუშაო სივრცე', // 'Workspaces'
})
