...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.new-auto-update-version-available': 'ახალი ვერსია არის მზად',
  ...
  'about-dialog.version-info.tooltip.new-version-available': 'ახალი ვერსია არის მზად',
  ...
  'release.action.publish-now': 'გამოქვეყნება ახლა',
  ...
  'release.dialog.delete-schedule-draft.body':
    'დარწმუნებული ხართ, რომ გსურთ განრიგის წაშლა? ეს ქმედება არ შეიძლება გაუქმება.',
  ...
  'release.dialog.publish-scheduled-draft.body':
    'დარწმუნებული ხართ, რომ გსურთ დაგეგმილი ჩანაწერის მყისიერად გამოშვება?',
  /** Confirm button text for running a scheduled draft immediately */
  'release.dialog.publish-scheduled-draft.confirm': 'დიახ, გაუშვი ახლავე',
  /** Header for the dialog confirming running a scheduled draft immediately */
  'release.dialog.publish-scheduled-draft.header': 'ჩანაწერის ახლავე გამოშვება',
  ...
  'release.toast.delete-schedule-draft.error':
    'დაგეგმილი ჩანაწერის დოკუმენტის <strong>{{title}}</strong> წაშლა ვერ მოხერხდა: {{error}}',
  /** Success toast for deleting a scheduled draft */
  'release.toast.delete-schedule-draft.success':
    'დაგეგმილი ჩანაწერის დოკუმენტი <strong>{{title}}</strong> წაიშალა.',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.not-found-release.title': "ვერ მოიძებნა '{{title}}' რელიზი",
  /** Error toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.error':
    'დაგეგმილი ჩანაწერის დოკუმენტის <strong>{{title}}</strong> გამოშვება ვერ მოხერხდა: {{error}}',
  /** Success toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.success':
    'დაგეგმილი ჩანაწერის დოკუმენტი <strong>{{title}}</strong> გამოიშვა.',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'დაგეგმილი ჩანაწერის დოკუმენტის <strong>{{title}}</strong> გადაგეგმვა ვერ მოხერხდა: {{error}}',
  /** Success toast for rescheduling a draft */
  'release.toast.reschedule-scheduled-draft.success':
    'დაგეგმილი ჩანაწერის დოკუმენტი <strong>{{title}}</strong> გადაიგეგმა.',
  ...
  'schedule-publish-dialog.header': 'ჩანაწერის დაგეგმვა გამოშვებად',
