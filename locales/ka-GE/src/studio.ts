...
export default removeUndefinedLocaleResources({
  ...
  'release.dialog.delete-schedule-draft.body-already-current':
    'წაშალოთ დაგეგმილი მოსახელება? თქვენი მოსახელება უკვე განახლებულია.',
  ...
  'release.dialog.delete-schedule-draft.body-will-save-to-draft':
    'წაშალოთ დაგეგმილი მოსახელება? თქვენი ცვლილებები შეინახება მოსახელებაში.',
  /** Body text when deleting scheduled draft with checkbox shown for user choice */
  'release.dialog.delete-schedule-draft.body-with-choice': 'წაშალოთ დაგეგმილი მოსახელება?',
  ...
  'release.dialog.delete-schedule-draft.copy-checkbox':
    'შეინახეთ დაგეგმილი ცვლილებები, მათი მოსახელებაში კოპირებით (რეკომენდირებულია)',
  ...
  'release.dialog.delete-schedule-draft.different-changes-explanation':
    'თქვენი დაგეგმილი მოსახელება შეიცავს სხვა ცვლილებებს, ვიდრე თქვენი მიმდინარე მოსახელება.',
  ...
  'releases.upsell.misconfiguration.contact-support': 'დაკავშირება მხარდაჭერასთან',
  ...
  'releases.upsell.misconfiguration.message':
    'თქვენს პროექტში ჩართულია კონტენტის გამოშვებები, თუმცა ჩანს, რომ არის კონფიგურაციის პრობლემა თქვენი გამოშვების ლიმიტებთან. გთხოვთ, დაკავშირდით მხარდაჭერასთან, რათა თქვენი კონტენტის გამოშვებები სწორად კონფიგურირდეს.',
