...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.reload-to-update': 'გადატვირთეთ სტუდია განახლებისთვის',
  ...
  'release.action.publish-now': 'გამოაქვეყნეთ ახლავე',
  ...
  'release.dialog.delete-schedule-draft.body':
    'დარწმუნებული ხართ, რომ გსურთ განრიგის წაშლა? ეს ქმედება უკან ვერ მოიქცევა.',
  ...
  'release.dialog.edit-schedule.body': 'აირჩიეთ ახალი თარიღი და დრო განრიგის გამოშვებისთვის.',
  ...
  'release.dialog.publish-scheduled-draft.body':
    'დარწმუნებული ხართ, რომ გსურთ განრიგის გამოშვება ახლავე?',
  /** Confirm button text for running a scheduled draft immediately */
  'release.dialog.publish-scheduled-draft.confirm': 'დიახ, გაუშვი ახლა',
  /** Header for the dialog confirming running a scheduled draft immediately */
  'release.dialog.publish-scheduled-draft.header': 'დრაფტის გამოქვეყნება ახლა',
  ...
  'release.schedule-dialog.publish-date-in-past-warning':
    'დაგეგმეთ ეს გამოშვება მომავალ დროს და თარიღზე.',
  ...
  'release.toast.delete-schedule-draft.error':
    'დრაფტის დაგეგმილი დოკუმენტის <strong>{{title}}</strong> წაშლა ვერ მოხერხდა: {{error}}',
  /** Success toast for deleting a scheduled draft */
  'release.toast.delete-schedule-draft.success':
    'დრაფტის დაგეგმილი დოკუმენტი <strong>{{title}}</strong> წაიშალა.',
  /** The toast title that will be shown when the user has a release perspective which is now deleted */
  'release.toast.not-found-release.title': "ვერ მოიძებნა '{{title}}' რელიზი",
  /** Error toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.error':
    'დრაფტის დაგეგმილი დოკუმენტის <strong>{{title}}</strong> გამოქვეყნება ვერ მოხერხდა: {{error}}',
  /** Success toast for running a scheduled publish immediately */
  'release.toast.publish-scheduled-draft.success':
    'დრაფტის დაგეგმილი დოკუმენტი <strong>{{title}}</strong> გამოქვეყნდა.',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'დრაფტის დაგეგმილი დოკუმენტის <strong>{{title}}</strong> გადაგეგმვა ვერ მოხერხდა: {{error}}',
  /** Success toast for rescheduling a draft */
  'release.toast.reschedule-scheduled-draft.success':
    'დრაფტის დაგეგმილი დოკუმენტი <strong>{{title}}</strong> გადაიგეგმა.',
  ...
  'schedule-publish-dialog.header': 'დრაფტის დაგეგმვა გამოქვეყნებისთვის',
