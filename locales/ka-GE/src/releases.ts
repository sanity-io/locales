...
export default removeUndefinedLocaleResources({
  ...
  /** The loading text for when releases are loading */
  'activity.panel.loading': 'გამოშვების აქტივობა იტვირთება',
  ...
  'banner.confirm-active-scheduled-drafts.button-paused': 'ყველა გრაფიკის განახლება',
  ...
  'confirm-active-scheduled-drafts-dialog.confirm-button': 'გრაფიკების დადასტურება',
  /** Dialog description for confirming active scheduled drafts */
  'confirm-active-scheduled-drafts-dialog.description':
    'ყველა შეჩერებული დაგეგმილი მონახაზის დაგეგმვა მათი განკუთვნილი გამოქვეყნების თარიღებისთვის',
  /** Dialog warning when some scheduled drafts have past dates */
  'confirm-active-scheduled-drafts-dialog.past-dates-warning':
    'ამ დაგეგმილი მონახაზებიდან ზოგიერთი განკუთვნილია წარსული თარიღებისთვის. გრაფიკების დადასტურება დაუყოვნებლივ გამოაქვეყნებს დოკუმენტების ამ ვერსიებს.',
  ...
  'dashboard.details.metadata.status-valid': 'მოქმედი',
  ...
  'delete-dialog.confirm-delete.header': 'დარწმუნებული ხართ, რომ გსურთ ამ release-ის წაშლა?',

  /** Label when a release has been deleted by a different user */
  'deleted-release': "'<strong>{{title}}</strong>' release წაიშალა",
  ...
  'discard-version-dialog.description-release':
    "ეს სამუდამოდ წაშლის ამ დოკუმენტში '<strong>{{releaseTitle}}</strong>' release-ის ფარგლებში შეტანილ ყველა ცვლილებას. ეს მოქმედება შეუქცევადია.",
  /** Title for dialog for discarding a draft of a document */
  'discard-version-dialog.header-draft': 'გაუქმდეს draft?',
  /** Header for discarding a version from a release of a document dialog */
  'discard-version-dialog.header-release':
    "წაიშალოს დოკუმენტი '<strong>{{releaseTitle}}</strong>' release-იდან?",
  /** Title for dialog for discarding a draft of a document */
  'discard-version-dialog.title-draft': 'Draft-ის გაუქმება',
  /** Title for dialog for discarding a version of a document */
  'discard-version-dialog.title-release': 'Release-იდან წაშლა',
  ...
  'duplicate-dialog.confirm-duplicate-description_one':
    'ეს გადაამრავლებს release-ს და 1 დოკუმენტის ვერსიას.',
  ...
  'duplicate-dialog.confirm-duplicate-description_other':
    'ეს გადაამრავლებს release-ს და {{count}} დოკუმენტის ვერსიას.',
  /** Header for the dialog confirming the duplicate of a release */
  'duplicate-dialog.confirm-duplicate-header':
    'დარწმუნებული ხართ, რომ გსურთ ამ release-ის გადამრავლება?',
  ...
  'passed-intended-publish-date': 'ამ release-ს გადაცილებული აქვს გამოქვეყნების დაგეგმილი თარიღი',

  /** Tooltip text for scheduled drafts that have passed their intended publish date */
  'passed-intended-publish-date-draft':
    'ამ პროექტს გადაცილებული აქვს გამოქვეყნების დაგეგმილი თარიღი',
  ...
  'review.edited': 'შეიცვალა <RelativeTime/>',
  ...
  'schedule-unpublish-dialog.header': 'პროექტის დაგეგმვა გამოქვეყნების გასაუქმებლად',
  ...
  'summary.published': 'გამოქვეყნდა <RelativeTime/>',
  ...
  'table-header.edited-by': 'რედაქტირებულია',
  ...
  'toast.copy-release-id.success': 'Release ID დაკოპირდა ბუფერში',
  /** Toast message after copying release link */
  'toast.copy-release-link.success': 'Release-ის ბმული დაკოპირდა ბუფერში',
  /** Toast message after copying release title */
  'toast.copy-release-title.success': 'Release-ის სათაური დაკოპირდა ბუფერში',
  ...
  'toast.duplicate.success': "'<strong>{{title}}</strong>' release დუბლიცირდა. <Link/>",
  /** Link text for toast link to the duplicated release */
  'toast.duplicate.success-link': 'დუბლიცირებული release-ის ნახვა',
  ...
  'toast.unschedule.error':
    "'<strong>{{title}}</strong>'-ის განრიგიდან მოხსნა ვერ მოხერხდა: {{error}}",

  /** Text for tooltip when a release has been scheduled */
  'type-picker.tooltip.scheduled': 'Release დაგეგმილია, ტიპის შესაცვლელად გააუქმეთ განრიგი',
  ...
  'unpublish.already-unpublished': 'ეს დოკუმენტი უკვე გამოქვეყნების გარეშეა.',
