...
export default removeUndefinedLocaleResources({
  ...
  'dialog.link-to-canvas.error': 'Canvas-თან კავშირის შექმნა ჩაიშალა',
  ...
  'dialog.unlink-from-canvas.description':
    'გათიშვის შემდეგ, ის აქ იქნება რედაქტირებადი და მომავალში Canvas-ში გაკეთებული რედაქტირებები აღარ გადაიტანება ამ დოკუმენტზე.',
  /** The text for the "Unlink from Canvas" dialog error message. */
  'dialog.unlink-from-canvas.error': 'Canvas-თან კავშირის გათიშვა ჩაიშალა',
  /** The text for the "Unlink from Canvas" dialog success message. */
  'dialog.unlink-from-canvas.success': 'კავშირი გათიშულია Canvas-თან',
  ...
  'dialog.unlink-from-canvas.unlink-action': 'გათიშვა ახლა',
  ...
  'navigate-to-canvas-doc.error.missing-permissions': 'Canvas-ზე ნავიგაციისთვის ნებართვა აკლია',
})
