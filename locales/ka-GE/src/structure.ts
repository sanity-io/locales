...
export default removeUndefinedLocaleResources({
  ...
  'banners.release.waiting.description':
    'გთხოვთ, დაელოდოთ, სანამ დოკუმენტი რელიზზე დაემატება. ეს არ უნდა მიიღოს მეტი, ვიდრე რამდენიმე წამი.',
