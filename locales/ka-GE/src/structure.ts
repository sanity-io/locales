...
export default removeUndefinedLocaleResources({
  ...
  'action.unpublish.disabled.already-unpublished':
    'ეს დოკუმენტი უკვე მონიშნულია გამოსაქვეყნებლად გაუქმებისთვის',
  ...
  'confirm-delete-dialog.confirm-anyway-button.text_delete_other': 'ყველა ვერსიის მაინც წაშლა',
  ...
  'panes.document-operation-results.operation-success_unpublishVersion':
    'ვერსიის გამოქვეყნება გაუქმდება გამოშვების გამოქვეყნებისას',
