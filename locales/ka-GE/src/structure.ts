...
export default removeUndefinedLocaleResources({
  ...
  'action.copy-document-id.label': 'დოკუმენტის ID-ის კოპირება',
  ...
  'action.copy-link-to-document.label': 'დოკუმენტის URL-ის კოპირება',
  ...
  'action.unpublish.disabled.already-unpublished':
    'ეს დოკუმენტი უკვე დაყენებულია გამოქვეყნების გასაუქმებლად',
  ...
  'banners.archived-scheduled-draft.description': 'ეს დაგეგმილი ჩანაწერი დაარქივებულია',
  ...
  'banners.release.action.add-to-bundle': 'Bundle-ში დამატება',
  ...
  'banners.scheduled-draft-override-banner.text':
    'ამ დოკუმენტისთვის არსებობს დაგეგმილი ჩანაწერი. თუ ახლა გააქტიურებთ ცვლილებებს, ისინი გადაწერილი იქნება, როდესაც დაგეგმვა შესრულდება.',
  ...
  'buttons.focus-pane-button.aria-label.collapse': 'ყველა პანელის შეკუმშვა',
  /** The aria-label for the focus pane button on the document panel header */
  'buttons.focus-pane-button.aria-label.focus': 'პანელის ფოკუსირება',
  /** The tooltip for the collapse pane button on the document panel header */
  'buttons.focus-pane-button.tooltip.collapse': 'ყველა პანელის შეკუმშვა',
  /** The tooltip for the focus pane button on the document panel header */
  'buttons.focus-pane-button.tooltip.focus': 'პანელის ფოკუსირება',
  ...
  'confirm-delete-dialog.confirm-anyway-button.text_delete_one': 'მაინც წაშლა',
  /** The text in the "Delete anyway" button when the document has multiple versions */
  'confirm-delete-dialog.confirm-anyway-button.text_delete_other': 'მაინც წაშალეთ ყველა ვერსია',
  ...
  'confirm-delete-dialog.confirm-button.text_delete_one': 'დოკუმენტის წაშლა',
  /** The text in the "Delete now" button when the document has multiple versions */
  'confirm-delete-dialog.confirm-button.text_delete_other': 'ყველა ვერსიის წაშლა',
  ...
  'incoming-references-pane.no-references': 'შემომავალი მითითებები ვერ მოიძებნა.',
  ...
  'panes.document-operation-results.operation-success_copy-id': 'დოკუმენტის ID დაკოპირდა ბუფერში',
  ...
  'panes.document-operation-results.operation-success_publishVersion': 'ვერსია გამოქვეყნდა',
  ...
  'panes.document-operation-results.operation-success_unpublishVersion':
    'ვერსიის გამოქვეყნება გაუქმდება, როდესაც გამოშვება გამოქვეყნდება',
  ...
  'toggle-inline-changes.menu-item.title': 'შიდა ცვლილებები',
})
