...
export default removeUndefinedLocaleResources({
  ...
  'canvas.banner.linked-text.version': 'Ten wersjonowany dokument jest powiązany z Canvas',
  /** The text for the canvas linked banner popover button */
  'canvas.banner.popover-button-text': 'Dowiedz się więcej',
  /** The description for the canvas linked banner popover */
  'canvas.banner.popover-description':
    'Canvas pozwala na tworzenie w edytorze swobodnej formy, który automatycznie mapuje z powrotem do Studio jako strukturalna treść - podczas pisania.',
