...
export default removeUndefinedLocaleResources({
  ...
  'action.copy-document-id.label': 'Kopiuj identyfikator dokumentu',
  ...
  'action.copy-link-to-document.label': 'Kopiuj adres URL dokumentu',
  ...
  'panes.document-operation-results.operation-success_copy-id':
    'Identyfikator dokumentu skopiowany do schowka',
