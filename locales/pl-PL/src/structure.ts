...
export default removeUndefinedLocaleResources({
  ...
  "action.discard-changes.disabled.no-change":
    "Ten dokument nie ma nieopublikowanych zmian",
  /** Tooltip when action is disabled because the document is not published */
  "action.discard-changes.disabled.not-published":
    "Ten dokument nie jest opublikowany",
  /** Tooltip when action button is disabled because the operation is not ready   */
  ...
  "action.publish.already-published.tooltip":
    "Opublikowano {{timeSincePublished}} temu",
  ...
  "action.restore.confirm-dialog.confirm-discard-changes":
    "Czy na pewno chcesz przywrócić ten dokument?",
  /** Fallback tooltip for when user is looking at the initial version */
  "action.restore.disabled.cannot-restore-initial":
    "Nie możesz przywrócić wersji początkowej",
  ...
  "confirm-delete-dialog.cdr-summary.subtitle_one":
    "Zestaw danych: {{datasets}}",
  /** The text that appears in the subtitle `<summary>` that lists the datasets below the title */
  "confirm-delete-dialog.cdr-summary.subtitle_unavailable_one":
    "Niedostępny zestaw danych",
  /** The text that appears in the title `<summary>` that includes the list of CDRs (singular) */
  "confirm-delete-dialog.cdr-summary.title_one":
    "{{documentCount}} w innym zbiorze danych",
  ...
  "confirm-delete-dialog.cdr-table.id-copied-toast.title":
    "Skopiowano ID dokumentu do schowka!",
  ...
  "no-document-types-screen.link-text":
    "Dowiedz się, jak dodać typ dokumentu →",
  ...
  "pane-item.published-status.has-published.tooltip":
    "Opublikowano <RelativeTime/>",
  /** The text shown in the tooltip of pane item previews of documents if there are no unpublished edits */
  "pane-item.published-status.no-published.tooltip":
    "Brak nieopublikowanych zmian",
  ...
  "panes.document-list-pane.max-items.text":
    "Wyświetlanie maksymalnie {{limit}} dokumentów",
  ...
  "panes.document-pane-provider.reconnecting.title":
    "Utracono połączenie. Ponowne łączenie…",
  ...
  "structure-error.header.text":
    "Napotkano błąd podczas odczytywania struktury",
