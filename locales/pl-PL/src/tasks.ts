...
export default removeUndefinedLocaleResources({
  ...
  'empty-state.list.assigned.text': 'Gdy zostaną Ci przypisane zadania, pojawią się one tutaj',
  ...
  'empty-state.status.list.closed.subscribed.text':
    'Zadania, do których się zapiszesz i które zostaną oznaczone jako wykonane, pojawią się tutaj',
  ...
  'empty-state.status.list.open.document.heading': 'Brak zadań w tym dokumencie',
  'empty-state.status.list.open.subscribed.heading': 'Brak subskrybowanych zadań',
  'empty-state.status.list.open.subscribed.text':
    'Zadania, do których się zapiszesz, pojawią się tutaj',
  ...
  'form.input.assignee.search.placeholder': 'Wybierz nazwę użytkownika',
  ...
  'form.input.target.search.placeholder': 'Wybierz dokument',
