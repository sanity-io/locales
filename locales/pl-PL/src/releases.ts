...
export default removeUndefinedLocaleResources({
  ...
  'menu.label': 'Menu wersji',
  /** Tooltip for the release menu */
  'menu.tooltip': 'Akcje',

  /** Text for when no archived releases are found */
  'no-archived-release': 'Brak zarchiwizowanych wersji',
  ...
  'overview.description':
    'Wersje to zbiory zmian dokumentów, którymi można zarządzać, planować i wycofywać razem.',
  /** Text for the placeholder in the search release input  */
  'overview.search-releases-placeholder': 'Szukaj wersji',
  /** Title for the release tool */
  'overview.title': 'Wersje',

  /** Tooltip text for releases that have passed their intended publish date */
  'passed-intended-publish-date': 'Ta wersja przekroczyła planowaną datę publikacji',

  /** Tooltip text for scheduled drafts that have passed their intended publish date */
  'passed-intended-publish-date-draft': 'Ten szkic przekroczył planowaną datę publikacji',

  /** Description for when a user doesn't have publish or schedule releases */
  'permission-missing-description':
    'Twoja rola ogranicza to, co możesz zobaczyć w tej wersji. Możliwe, że nie możesz opublikować ani zaplanować tej wersji.',
  ...
  'permissions.error.archive': 'Nie masz uprawnień do archiwizowania tej wersji',
  /** Tooltip label when the user doesn't have permission to delete release */
  'permissions.error.delete': 'Nie masz uprawnień do usunięcia tej wersji',
  ...
  'permissions.error.duplicate': 'Nie masz uprawnień do duplikowania tej wersji',
  /** Tooltip label when the user doesn't have permission to unarchive release */
  'permissions.error.unarchive': 'Nie masz uprawnień do przywrócenia tej wersji z archiwum',
  ...
  'presence.tooltip.one': '{{displayName}} edytuje teraz ten dokument w wersji „{{releaseTitle}}"',
  ...
  'toast.immediate-revert.success': "Wydanie '{{title}}' zostało pomyślnie przywrócone",
  /** Text for toast when release failed to publish */
  'toast.publish.error': "Nie udało się opublikować '<strong>{{title}}</strong>': {{error}}",
  /** Text for toast when release has reverted release successfully staged */
  'toast.revert-stage.success':
    "Przywrócenie wydania dla '{{title}}' zostało pomyślnie utworzone. <Link/>",
  /** Link text for toast link to the generated revert release */
  'toast.revert-stage.success-link': 'Zobacz przywrócone wydanie',
  /** Text for toast when release failed to revert */
  'toast.revert.error': 'Nie udało się przywrócić wydania: {{error}}',
