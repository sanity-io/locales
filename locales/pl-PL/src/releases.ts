...
export default removeUndefinedLocaleResources({
  ...
  'dashboard.details.metadata.status-valid': 'Prawidłowy',
  ...
  'overview.back-to-all-releases': 'Wszystkie wydania',
  ...
  'table-header.edited-by': 'Edytowano przez',
  ...
  'table-header.last-edited': 'Ostatnio edytowano',
