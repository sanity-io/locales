...
export default removeUndefinedLocaleResources({
  ...
  "asset-source.usage-list.documents-using-file_unnamed_one":
    "Jeden dokument używa tego pliku",
  ...
  "asset-source.usage-list.documents-using-image_unnamed_one":
    "Jeden dokument używa tego obrazu",
  ...
  "calendar.error.must-be-in-format":
    "Musisz użyć formatu <Emphasis>{{exampleDate}}</Emphasis>",
  ...
  "changes.action.revert-changes-description_one":
    "Czy na pewno chcesz cofnąć zmianę?",
  ...
  "changes.error-boundary.title":
    "Renderowanie zmian w tym polu spowodowało błąd",
  ...
  "changes.portable-text.unknown-annotation-schema-type":
    "Nieznany typ schematu adnotacji",
  ...
  "form.error.mixed-array-alert.remove-button.text":
    "Usuń wartości inne niż obiekty",
  ...
  "help-resources.latest-sanity-version":
    "Najnowsza wersja to {{latestVersion}}",
  ...
  "inputs.array.error.json-representation-description":
    "Reprezentacja JSON tego elementu:",
  ...
  "inputs.file.upload-failed.description":
    "Przesyłanie nie mogło zostać ukończone w tym czasie.",
  /** Upload failed */
  ...
  "inputs.image.drag-overlay.cannot-upload-here":
    "Nie można tutaj przesłać tego pliku",
  ...
  "inputs.image.upload-error.description":
    "Przesyłanie nie mogło zostać ukończone w tym momencie.",
  /** Upload failed */
  ...
  "inputs.portable-text.invalid-value.title":
    "Nieprawidłowa wartość Portable Text",
  ...
  "inputs.reference.document-opens-in-new-tab":
    "Ten dokument otworzy się w nowej karcie",
  ...
  "inputs.reference.error.search-failed-title":
    "Wyszukiwanie referencji nie powiodło się",
  /** Alternative text for the image shown in cross-dataset reference input */
  "inputs.reference.image-preview-alt-text":
    "Podgląd obrazu dokumentu referencyjnego",
  ...
  "inputs.reference.incomplete-reference.strengthen-action-title":
    "Przekształć w silną referencję",
  ...
  "inputs.reference.metadata-error.title":
    "Nie można załadować metadanych referencji",
  ...
  "inputs.reference.resolving-initial-value":
    "Rozwiązywanie wartości początkowej…",
  ...
  "inputs.reference.strength-mismatch.strengthen-button-label":
    "Przekształć w mocne odniesienie",
  ...
  "inputs.reference.strength-mismatch.weaken-button-label":
    "Przekształć w słabe odniesienie",
  ...
  "inputs.slug.error.missing-source":
    "Brak źródła. Sprawdź źródło typu {{schemaType}} w schemacie",
  /** Convert to <code>`{{targetType}}`</code> */
  "inputs.untyped-value.convert-button.text":
    "Przekształć na <code>{{targetType}}</code>",
  ...
  "inputs.untyped-value.details.json-dump-prefix":
    "Aktualna wartość (<code>object</code>):",
  ...
  "inputs.untyped-value.title":
    "Brakująca wartość właściwości <code>_type</code>",
  /** Unset value */
  ...
  "presence.no-one-else-description":
    "Zaproś osoby do projektu, aby zobaczyć ich status online.",
  ...
  "preview.image.file-is-being-uploaded.alt-text":
    "Obraz jest aktualnie przesyłany",
  ...
  "search.error.display-filter-title":
    "Wystąpił błąd podczas wyświetlania tego filtra.",
  ...
  "search.error.no-valid-asset-source-title":
    "Nie znaleziono prawidłowych źródeł zasobów.",
  ...
  "search.error.unspecified-error-title":
    "Coś poszło nie tak podczas wyszukiwania",
  /**
  ...
  "search.ordering.updated-ascending-label":
    "Zaktualizowane: Najstarsze pierwsze",
  /** Label for the "Updated: Newest first" search ordering type */
  "search.ordering.updated-descending-label":
    "Zaktualizowane: Najnowsze pierwsze",
  ...
  "timeline.operation.unpublished_timestamp":
    "Cofnięto publikację: {{timestamp, datetime}}",
  /**
  ...
  "workspaces.action.choose-another-workspace":
    "Wybierz inną przestrzeń roboczą",
