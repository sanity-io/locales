...
export default removeUndefinedLocaleResources({
  ...
  'document-group.delete.cdr-summary.title_one': '{{documentCount}} w innym datasecie',
  ...
  'document-group.delete.other-reference-count.tooltip':
    'Nie możemy wyświetlić metadanych dla tych odwołań z powodu brakującego tokenu dostępu dla powiązanych datasetów.',
