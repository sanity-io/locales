...
export default removeUndefinedLocaleResources({
  ...
  'asset-sources.media-library.file.title': 'Biblioteka multimediów',
  'asset-sources.media-library.image.title': 'Biblioteka multimediów',
  ...
  'inputs.reference.global.invalid-type':
    'Odwołany dokument jest nieprawidłowego typu ({{typeName}})',
