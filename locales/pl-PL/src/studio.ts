...
export default removeUndefinedLocaleResources({
  ...
  'about-dialog.version-info.tooltip.up-to-date': 'Aktualna',
  ...
  'release.toast.reschedule-scheduled-draft.error':
    'Nie udało się zmienić terminu zaplanowanego dokumentu szkicu <strong>{{title}}</strong>: {{error}}',
  /** Success toast for rescheduling a draft */
  'release.toast.reschedule-scheduled-draft.success':
    'Termin zaplanowanego dokumentu szkicu <strong>{{title}}</strong> został zmieniony.',
