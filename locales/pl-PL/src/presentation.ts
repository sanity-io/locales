...
export default removeUndefinedLocaleResources({
  ...
  'preview-frame.overlay.connection-status.label': 'Status połączenia overlay',
  ...
  'preview-frame.overlay.toggle-button.tooltip_disable': 'Wyłącz overlay edycji',
  /** The text shown on the overlay toggle tooltip when overlays are disabled */
  'preview-frame.overlay.toggle-button.tooltip_enable': 'Włącz overlay edycji',
  ...
  'preview-frame.viewport-button.aria-label': 'Przełącz rozmiar widoku',
  /** The viewport size button tooltip text when switching to a full width viewport */
  'preview-frame.viewport-button.tooltip_full': 'Przełącz na pełny widok',
  /** The viewport size button tooltip text when switching to a narrow viewport */
  'preview-frame.viewport-button.tooltip_narrow': 'Przełącz na wąski widok',

  /** The validation error message shown when the preview location input is missing an origin */
  'preview-location-input.error_missing-origin': 'URL musi zaczynać się od {{origin}}',
  ...
  'preview-location-input.error_same-base-path':
    'URL nie może mieć tej samej ścieżki bazowej co Studio {{basePath}}',
  ...
  'preview-search-param.configuration.error.description':
    'Router chce przejść do <Code>{{previewSearchParam}}</Code>, ale origin <Code>{{blockedOrigin}}</Code> nie jest dozwolony. Zaktualizuj konfigurację <Code>presentationTool.allowOrigins</Code>, aby go zezwolić.',
  /** The title of the error toast that shows when attempting to navigate to a preview URL origin that's not in the allow list. */
  'preview-search-param.configuration.error.title': 'Zablokowany URL podglądu',
  ...
  'preview-url-secret.missing-grants':
    'Nie masz uprawnień do tworzenia URL Preview Secrets. Prawdopodobnie spowoduje to błąd ładowania podglądu.',
