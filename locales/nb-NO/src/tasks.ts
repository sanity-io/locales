...
export default removeUndefinedLocaleResources({
  ...
  'dialog.remove-task.title': 'Slett denne oppgaven?',
  ...
  'empty-state.list.document.heading': 'Dette dokumentet har ingen oppgaver ennå',
  /** The text in the tasks sidebar, in the document tab, when the document doesn't have any task*/
  'empty-state.list.document.text': 'Når et dokument har tilknyttede oppgaver, vil de vises her.',
  /** The heading in the tasks sidebar, when viewing the document tab, but there is not an active document*/
  'empty-state.list.no-active-document.heading': 'Åpne et dokument for å se dets oppgave',
  ...
  'empty-state.list.subscribed.text':
    'Når du oppretter, endrer eller kommenterer en oppgave, vil du automatisk bli abonnert',
  ...
  'empty-state.status.list.closed.assigned.text': 'Dine oppgaver merket som ferdige vil vises her',
  ...
  'empty-state.status.list.closed.subscribed.text':
    'Oppgaver du abonnerer på som er merket som ferdige vil vises her',
  ...
  'form.input.assignee.search.placeholder': 'Velg tildeling',
  ...
  'form.input.create-more.text': 'Opprett mer',
  /** The label used in the date input button tooltip when it's empty */
  'form.input.date.buttons.empty.tooltip': 'Sett forfallsdato',
  /** The label used in the date input to remove the current value */
  'form.input.date.buttons.remove.text': 'Fjern',
  /** The label used in the date input button tooltip when it has value */
  'form.input.date.buttons.tooltip': 'Endre forfallsdato',
  ...
  'form.input.target.buttons.remove.text': 'Fjern målinnhold',
  ...
  'panel.close.tooltip': 'Lukk sidepanelet',
