...
export default removeUndefinedLocaleResources({
  ...
  'action.restore.confirm-dialog.confirm-discard-changes':
    'Er du sikker på at du vil gjenopprette dette dokumentet?',
  ...
  'document-inspector.dialog.title': 'Inspeksjon av <DocumentTitle/>',
  /** The title shown in the dialog header, when the document being inspected is not created yet/has no value */
  'document-inspector.dialog.title-no-value': 'Ingen verdi',
  /** Title shown for menu item that opens the "Inspect" dialog */
  'document-inspector.menu-item.title': 'Inspeksjon',
  ...
  'panes.document-operation-results.operation-success':
    'Utførte {{context}} på dokumentet med hell',
  /** The text when a delete operation succeded  */
  'panes.document-operation-results.operation-success_delete': 'Dokumentet ble slettet med hell',
