...
export default removeUndefinedLocaleResources({
  ...
  "action.discard-changes.disabled.no-change":
    "Dette dokumentet har ingen endringer",
  /** Tooltip when action is disabled because the document is not published */
  "action.discard-changes.disabled.not-published":
    "Dette dokumentet er ikke publisert",
  /** Tooltip when action button is disabled because the operation is not ready   */
  ...
  "action.publish.already-published.tooltip":
    "Publisert for {{timeSincePublished}} siden",
  ...
  "action.publish.validation-issues.tooltip":
    "Valideringsfeil må rettes før det kan publiseres",
  ...
  "action.restore.disabled.cannot-restore-initial":
    "Kan ikke gjenopprette til første version",
  ...
  "confirm-delete-dialog.cdr-summary.title_one":
    "{{documentCount}} i et annet datasett",
  /** The text that appears in the title `<summary>` that includes the list of CDRs (plural) */
  "confirm-delete-dialog.cdr-summary.title_other":
    "{{documentCount}} i {{count}} datasett",
  ...
  "confirm-delete-dialog.other-reference-count.title_one":
    "1 annen referanse ikke vist",
  /** Shown if there are references to other documents but the user does not have the permission to see the relevant document IDs */
  "confirm-delete-dialog.other-reference-count.title_other":
    "{{count}} andre referanser ikke vist",
  ...
  "no-document-types-screen.link-text":
    "Lær hvordan du legger til en dokumenttype →",
  /** The subtitle of the no document type screen that appears directly below the title */
  "no-document-types-screen.subtitle":
    "Vennligst definer minst én dokumenttype i ditt skjema.",
  ...
  "panes.document-list-pane.no-matching-documents.text":
    "Ingen dokumenter funnet som samsvarer",
  ...
  "panes.document-pane-provider.reconnecting.title":
    "Forbindelse mistet. Kobler til på nytt…",
