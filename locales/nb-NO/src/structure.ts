...
export default removeUndefinedLocaleResources({
  ...
  'action.discard-changes.confirm-dialog.confirm-discard-changes-draft':
    'Er du sikker på at du vil forkaste alle endringer og slette dette utkastdokumentet?',
  /**Header for the confirm discard dialog */
  'action.discard-changes.confirm-dialog.header.text': 'Forkaste endringer?',
  ...
  'action.unpublish.disabled.already-unpublished':
    'Dette dokumentet er allerede satt til å bli avpublisert',
  ...
  'banners.archived-scheduled-draft.description': 'Dette planlagte utkastet er arkivert',
  ...
  'banners.release.navigate-to-edit-description-none':
    'Dette dokumentet er ikke en del av noen utgivelse',
  ...
  'banners.scheduled-draft-override-banner.text':
    'Et planlagt utkast for dette dokumentet finnes. Hvis du publiserer endringer nå, vil de bli overskrevet når det planlagte utkastet blir publisert.',
  ...
  'buttons.focus-pane-button.aria-label.collapse': 'Skjul alle paneler',
  ...
  'buttons.focus-pane-button.tooltip.collapse': 'Skjul alle paneler',
  ...
  'canvas.banner.editable.linked-text': 'Dette dokumentet kan redigeres i Canvas.',
  /** The description for the canvas linked banner popover in editable mode*/
  'canvas.banner.editable.popover-description':
    'Canvas lar deg skrive fritt, og deretter oppdatere innhold i Studio uten manuell kopiering felt for felt.',
  ...
  'confirm-delete-dialog.confirm-anyway-button.text_delete_one': 'Slett uansett',
  /** The text in the "Delete anyway" button when the document has multiple versions */
  'confirm-delete-dialog.confirm-anyway-button.text_delete_other': 'Slett alle versjoner uansett',
  ...
  'confirm-delete-dialog.confirm-button.text_delete_other': 'Slett alle versjoner',
  ...
  'confirm-delete-dialog.confirmation.text_delete_other':
    'Er du sikker på at du vil slette alle versjonene av dette dokumentet?',
  /** If no referring documents are found, this text appears above the cancel and confirmation buttons */
  ...
  'panes.document-operation-results.operation-success_copy-id':
    'Dokument-ID kopiert til utklippstavlen',
  ...
  'panes.document-operation-results.operation-success_unpublishVersion':
    'Versjonen vil bli avpublisert når utgivelsen publiseres',
  ...
  'toggle-inline-changes.menu-item.title': 'Endringer i teksten',
})
