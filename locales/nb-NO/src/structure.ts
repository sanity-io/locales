...
export default removeUndefinedLocaleResources({
  ...
  'banners.archived-scheduled-draft.description': 'Denne planlagte utkastet er arkivert',
  ...
  'banners.scheduled-draft-override-banner.text':
    'Utkastet til dette dokumentet er allerede planlagt for publisering. Endringer du gjør her kan bli overskrevet av den versjonen.',
