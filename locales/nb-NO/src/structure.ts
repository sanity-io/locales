...
export default removeUndefinedLocaleResources({
  ...
  'action.delete.disabled.nothing-to-delete':
    'Dette dokumentet eksisterer ikke ennå eller er allerede slettet',
  ...
  'action.discard-changes.confirm-dialog.confirm-discard-changes':
    'Er du sikker på at du vil forkaste alle endringer siden sist publisert?',
  /** Tooltip when action is disabled because the document has no unpublished changes */
  'action.discard-changes.disabled.no-change': 'Dette dokumentet har ingen upubliserte endringer',
  ...
  'action.publish.live-edit.publish-disabled':
    'Kan ikke publisere siden Live Edit er aktivert for denne dokumenttypen',
  /** Tooltip for the "Publish" document action when the document has live edit enabled.*/
  'action.publish.live-edit.tooltip':
    'Live Edit er aktivert for denne innholdstypen og publisering skjer automatisk når du gjør endringer',
  ...
  'action.restore.disabled.cannot-restore-initial':
    'Du kan ikke gjenopprette til den opprinnelige versjonen',
  ...
  'action.unpublish.live-edit.disabled':
    'Dette dokumentet har live redigering aktivert og kan ikke avpubliseres',
  ...
  'confirm-delete-dialog.header.text_delete': 'Slette dokument?',
  /** The header of the confirm delete dialog */
  ...
  'confirm-delete-dialog.other-reference-count.tooltip':
    'Vi kan ikke vise metadata for disse referansene på grunn av en manglende tilgangstoken for de relaterte datasettene.',
  ...
  'document-inspector.view-mode.parsed': 'Analyserbar',
  ...
  'document-view.form-view.form-title-fallback': 'Uten tittel',
  /** The text for when the form view is loading a document */
  'document-view.form-view.loading': 'Laster dokument…',
  /** The description of the sync lock toast on the form view */
  'document-view.form-view.sync-lock-toast.description':
    'Vennligst vent mens dokumentet synkroniseres. Dette skjer vanligvis rett etter at dokumentet er publisert, og det bør ikke ta mer enn noen få sekunder',
  ...
  'pane-header.disabled-created-button.aria-label': 'Utilstrekkelige tillatelser',

  /** The text shown in the tooltip of pane item previews of documents if there are unpublished edits */
  'pane-item.draft-status.has-draft.tooltip': 'Redigert <RelativeTime/>',
  /** The text shown in the tooltip of pane item previews of documents if there are no unpublished edits */
  'pane-item.draft-status.no-draft.tooltip': 'Ingen upubliserte redigeringer',
  ...
  /** The text shown in the tooltip of pane item previews of documents if there are no unpublished edits */
  'pane-item.published-status.no-published.tooltip': 'Ingen upubliserte endringer',
  ...
  'panes.document-operation-results.operation-success':
    'Utførte {{context}} på dokumentet vellykket',
  ...
  'panes.document-operation-results.operation-success_publish':
    '<Strong>{{title}}</Strong> ble publisert',
  /** The text when a restore operation succeeded  */
  'panes.document-operation-results.operation-success_restore':
    '<Strong>{{title}}</Strong> ble gjenopprettet',
  /** The text when an unpublish operation succeeded  */
  'panes.document-operation-results.operation-success_unpublish':
    '<Strong>{{title}}</Strong> ble avpublisert. Et utkast har blitt opprettet fra den siste publiserte versjonen.',
  /** The document title shown when document title is "undefined" in operation message */
  'panes.document-operation-results.operation-undefined-title': 'Uten tittel',
  /** The title of the reconnecting toast */
  'panes.document-pane-provider.reconnecting.title': 'Tilkoblingen er tapt. Kobler til på nytt…',
  ...
  'panes.unknown-pane-type.missing-type.text':
    'Strukturelement mangler nødvendig <Code>type</Code> egenskap.',
  ...
  'status-bar.review-changes-button.aria-label': 'Gjennomgå endringer',
  /** Label for button when status is saved */
  ...
  'status-bar.review-changes-button.tooltip.text': 'Gjennomgå endringer',
