...
export default removeUndefinedLocaleResources({
  ...
  "asset-source.usage-list.documents-using-file_unnamed_one":
    "Ett dokument bruker denne filen",
  ...
  "asset-source.usage-list.documents-using-image_unnamed_one":
    "Ett dokument bruker dette bildet",
  ...
  "calendar.error.must-be-in-format":
    "Må være i formatet <Emphasis>{{exampleDate}}</Emphasis>",
  ...
  "changes.action.revert-changes-description":
    "Er du sikker på at du vil angre endringene?",
  /** Prompt for reverting changes for a group change, eg multiple changes */
  "changes.action.revert-changes-description_one":
    "Er du sikker på at du vil angre endringen?",
  ...
  "form.error.mixed-array-alert.remove-button.text":
    "Fjern verdier som ikke er objekter",
  ...
  "inputs.file.upload-failed.description":
    "Opplastingen kunne ikke fullføres akkurat nå.",
  /** Upload failed */
  ...
  "inputs.invalid-value.current-type":
    "Den nåværende verdien (<code>{{actualType}}</code>)",
  ...
  "inputs.reference.image-preview-alt-text":
    "Forhåndsvisning av referert dokument",
  ...
  "inputs.reference.metadata-error.title":
    "Kan ikke laste metadata for referansen",
  /** Message shown when no documents were found that matched the given search string */
  "inputs.reference.no-results-for-query":
    "Ingen resultater for <strong>«{{searchTerm}}»</strong>",
  ...
  "inputs.untyped-value.description":
    "Møtte på en objektverdi uten <code>_type</code>-attributt.",
  ...
  "inputs.untyped-value.details.json-dump-prefix":
    "Nåværende verdi (<code>object</code>):",
  ...
  "new-document.no-results":
    "Ingen resultater for <strong>«{{searchQuery}}»</strong>",
  ...
  "presence.no-one-else-description":
    "Inviter folk til prosjektet for å se deres onlinestatus.",
  ...
  "search.action.search-specific-types-truncated":
    "Søk etter {{types, list}} +{{count}} flere",
  ...
  "search.error.display-filter-title":
    "En feil oppstod under visning av dette filteret.",
  ...
  "search.no-results-help-description":
    "Prøv et annet nøkkelord eller juster filtrene dine",
  ...
  "search.operator.defined.description":
    "<Field/> <Operator>er</Operator> <Value>definert</Value>",
  ...
  "timeline.error.load-document-changes-description":
    "Historikk har ikke blitt påvirket.",
  ...
  "timeline.operation.draft-discarded_timestamp":
    "Forkastet utkast: {{timestamp, datetime}}",
