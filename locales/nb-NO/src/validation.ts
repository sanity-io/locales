...
export default removeUndefinedLocaleResources({
  ...
  'date.invalid-format': 'Må være en gyldig ISO-8601 formatert datostreng',
  ...
  'generic.not-allowed': 'Verdien samsvarer ikke med noen tillatte verdier',
  /** Value "$givenValue" is not one of the values specifically allowed */
  'generic.not-allowed_hint': 'Verdien "{{hint}}" samsvarer ikke med noen tillatte verdier',
  ...
  'string.regex-does-not-match': 'Matcher ikke "{{name}}"-mønster',
  /** String matches the given regular expression, but should not */
  'string.regex-match': 'Bør ikke matche "{{name}}"-mønster',
  /** String contains characters that are not in uppercase */
  'string.uppercase': 'Må være alle store bokstaver',
  /** String contains a protocol/scheme that is not allowed, eg (`ftp`, `mailto`…) */
  'string.url.disallowed-scheme': 'Matcher ikke tillatte protokoller/skjemaer',
