...
export default removeUndefinedLocaleResources({
  ...
  'action.publish-all-documents': 'Kjør utgivelse',
  /** Menu item label for showing releases (multi-document releases) */
  'action.releases': 'Utgivelser',
  /** Action text for reverting a release */
  'action.revert': 'Tilbakestill utgivelse',
  /** Action message for when document is scheduled for unpublishing a document and you want to no longer unpublish it */
  'action.revert-unpublish-actions': 'Tilbakestill avpublisering ved utgivelse',
  /** Text for the review changes button in release tool */
  'action.review': 'Gjennomgå endringer',
  /** Action text for scheduling a release */
  'action.schedule': 'Planlegg utgivelse...',
  ...
  'action.unarchive': 'Gjenopprett utgivelse fra arkiv',
  ...
  'activity.panel.close': 'Lukk aktivitet',
  ...
  'copy-to-draft-dialog.description':
    'En utkastversjon av dette dokumentet finnes allerede. Kopier gjeldende versjon til utkastet og overskriv den eksisterende utkastversjonen.',
  ...
  'dashboard.details.metadata.status-empty': 'Ingen dokumenter',
  /** Status badge value when one or more documents have validation errors. */
  'dashboard.details.metadata.status-errors': 'Feil',
  /** Status badge value when every document in the release is valid. */
  'dashboard.details.metadata.status-valid': 'Gyldig',
  /** Status badge value while document validation is still running. */
  'dashboard.details.metadata.status-validating': 'Validerer',
  ...
  'document-validation.valid': 'Ingen valideringsfeil',
  ...
  'overview.back-to-all-releases': 'Alle utgivelser',
  ...
  'table-header.edited-by': 'Redigert av',
  ...
  'table-header.last-edited': 'Sist redigert',
