...
export default removeUndefinedLocaleResources({
  ...
  'preview-frame.configuration.error.description':
    'Forhåndsvisnings-iframen er konfigurert til å laste <Code>{{targetOrigin}}</Code>, men den rapporterte opprinnelsen er <Code>{{reportedOrigin}}</Code>. Presentation Tool kan ikke koble til ukjente opprinnelser av sikkerhetshensyn. Oppdater <Code>presentationTool.allowOrigins</Code>-konfigurasjonen din for å tillate tilkobling til Visual Editing og Loaders.',
  ...
  'preview-frame.configuration.error.title': 'Forhåndsvisnings-URL-opprinnelse samsvarer ikke',
  ...
  'preview-frame.continue-button.text': 'Fortsett likevel',
  /** The label for the loader's connection status */
  'preview-frame.loader.connection-status.label': 'Loader-tilkoblingsstatus',
  ...
  'preview-url-secret.missing-grants':
    'Du har ikke tillatelse til å opprette URL Preview Secrets. Dette vil sannsynligvis føre til at forhåndsvisningen ikke laster.',
